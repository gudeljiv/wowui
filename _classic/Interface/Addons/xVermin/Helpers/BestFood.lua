...
function NeedsFoodBadly:UpdateMacros()
	...
	if UnitExists("pet") and xVermin.Class == "HUNTER" then
		local petfoodMacro = defaultPetFoodMacro:gsub("<%a+>", {
...
function NeedsFoodBadly:IsUsableHealthstone(healthstone)
	...
	local _, _, _, _, requiredLevel = GetItemInfo(healthstone.id)
	if not requiredLevel then
		return false
	end

	return requiredLevel <= UnitLevel("player")
end
...
NeedsFoodBadly.Food = {
	...
	[30361] = {
		id = 30361,
		name = "Oronok's Tuber of Spell Power",
		lvl = 65,
		conj = false,
		hp = 7500,
		spi = 20,
	...
	[30357] = {
		id = 30357,
		name = "Oronok's Tuber of Healing",
		lvl = 65,
		conj = false,
		hp = 7500,
		spi = 20,
	...
	[29293] = {
		id = 29293,
		name = "Bonestripper Buzzard Hotwings",
		lvl = 55,
		conj = false,
		hp = 2148,
		spi = 14,
	...
	[35951] = { id = 35951, name = "Poached Emperor Salmon", lvl = 75, conj = false, hp = 22500 },
...
NeedsFoodBadly.Potion = {
	...
	[33448] = { id = 33448, name = "Runic Mana Potion", lvl = 70, low = 4200, high = 4400, mp = true },
}
