...
xVermin.CheckIfLoadedWithTimer("RadialWheel1", function()
	RadialWheel1:HookScript("OnShow", function()
		if InCombatLockdown() then
			return
		end
		RadialWheel1:ClearAllPoints()
		RadialWheel1:SetPoint(
			"CENTER",
			UIParent,
			"BOTTOMLEFT",
			UIParent:GetWidth() / 2 + 400,
			UIParent:GetHeight() / 2 + 250
		)
