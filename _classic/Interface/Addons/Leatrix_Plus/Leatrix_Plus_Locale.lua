...
L["If checked, addon buttons will be combined into a single button frame which you can toggle by right-clicking the minimap.|n|nNote that enabling this option will lock out the 'Hide addon buttons' setting."] = "Si está seleccionado, los botones de addon se combinarán en un solo marco de botón que puede alternar haciendo clic derecho en el minimapa.|n|nTen en cuenta que habilitar esta opción bloqueará la configuración 'Ocultar botones de addon'."
...
L["If checked, helm and cloak toggle checkboxes will be shown in the character frame.|n|nYou can hold shift and right-click the checkboxes to switch layouts."] = "Si está seleccionado, las casillas de alternar cabeza y espalda se mostrarán en la información del personaje.|n|nPuede mantener presionada la tecla mayús y hacer clic con el botón derecho en las casillas de verificación para cambiar de visualización."
...
L["If checked, party invitations from friends will be automatically accepted unless you are queued for a battleground."] = "Si está seleccionado, las invitaciones de grupo de amigos se aceptarán automáticamente a menos que esté en la cola de un campo de batalla."
...
L["Remove all items"] = "Elimina todo el equipo"
...
L["Universal group color"] = "Color de grupo"
...
L["Reload"] = "Recargar"
L["Remember Alterac Valley!"] = "¡Recuerda el Valle de Alterac!"
L["Remove all items"] = "Remove todo el equipo"
L["Remove tabard"] = "Eliminar tabardo"
L["Repair automatically"] = "Reparar"
L["Repaired for"] = "Reparado por"
L["Replace non-standard buttons"] = "Reemplazar botones no estándar"
...
L["Hide keybind text"] = "Masquer le texte des raccourcis clavier"
...
L["Manage timer"] = "Gérer le chronomètre"
...
L["Show flight times"] = "Mostrar tempos de voo"
...
L["Show ready timer"] = "Mostrar cronômetro de pronto"
...
L["sounds"] = "sons"
L["Speak the remaining time"] = "Fale o tempo restante"
L["Spell"] = "Feitiço"
