...
L["Classic"] = "Clásico"
L["click here for new selection"] = "haz lic para nueva selección"
...
L["Click to configure the settings for this option."] = "Haz clic para configurar la configuración para esta opción"
...
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword as long as you are ungrouped, group leader or raid assistant and not queued for a battleground.|n|nFriends who message the keyword using Battle.net will not be sent a group invite if they are appearing offline.  They need to either change their online status or use character whispers."] = "Si está seleccionado, se enviará una invitación de grupo a cualquiera que te susurre con una palabra clave establecida, siempre que no estés agrupado, seas líder de grupo o asistente de banda y no estés en la cola de un campo de batalla.|n|nLos amigos que envíen mensajes con la palabra clave usando Battle.net no se les enviará una invitación de grupo si aparecen sin conexión. Necesitan cambiar su estado en línea o usar susurros de personajes."
...
L["If checked, chat frame buttons will be hidden.|n|nClicking chat tabs will automatically show the latest messages.|n|nUse the mouse wheel to scroll through the chat history.  Hold down SHIFT for page jump or CTRL to jump to the top or bottom of the chat history."] = "Si está seleccionado, los botones del marco de chat estarán ocultos.|n|nAl hacer clic en las pestañas de chat, se mostrarán automáticamente los últimos mensajes.|n|nUsa la rueda del ratón para desplazarse por el historial de chat. Mantenga presionada la tecla mayús para saltar de página o Ctrl para saltar a la parte superior o inferior del historial de chat."
...
L["If checked, you will be able to zoom out to a greater distance."] = "Si está seleccionado, se podrá alejar a una distancia mayor."
