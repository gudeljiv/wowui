...
L["If checked, you will be able to change the position and scale of the player frame, target frame and timer bar.|n|nNote that enabling this option will prevent you from using the default UI to move the player and target frames."] = "勾选后，你可以修改位置及缩放玩家框体、目标框体以及计时条。|n|n启用这个选项，会阻止你使用默认UI提供的玩家及目标框体的移动功能。"
...
L["If checked, you will be able to change the position and scale of the player frame, target frame and timer bar.|n|nNote that enabling this option will prevent you from using the default UI to move the player and target frames."] = "Если флажок установлен, вы сможете изменять положение и масштаб фрейма игрока, фрейма цели, фрейма духа и шкалы таймера.|n|nПримечание: включение этой опции не позволит вам использовать стандартный пользовательский интерфейс для перемещения фреймов игрока и цели."
...
L["Click to close the currently active flight progress bar."] = [=[Haga clic para cerrar la barra de progreso del vuelo actualmente activa.
]=]
L["Click to configure the settings for this option."] = "Haga clic para configurar la configuración para esta opción"
L["Click to mute sounds in the list."] = "Haga clic para silenciar los sonidos de la lista."
...
L["Click to toggle the addon buttons editor."] = "Haga clic para alternar el editor de botones de addons."
L["Click to toggle the frame alignment grid."] = "Haga clic para alternar la cuadrícula de alineación del marco."
L["Click to unmute sounds in the list."] = "Haga clic para reactivar los sonidos de la lista."
L["Cloak"] = "Espalda"
L["Close"] = "Cerrar"
...
L["Drag to set the number of milliseconds before you are automatically released.|n|nYou can hold down shift as the timer is ending to cancel the automatic release."] = "Arrastra para establecer el número de milisegundos antes de que te liberes automáticamente.|n|nPuedes mantener presionada la tecla shift mientras el temporizador finaliza para cancelar la liberación automática."
...
L["Filter chat messages"] = "Filtrar mensajes de chat"
L["Find Item"] = "Buscar objeto"
L["Five minutes"] = "Cinco minutos"
L["Fizzle"] = "Efervescencia"
...
L["Hide keybind text"] = "Ocultar texto de atajos"
...
L["Hide the world map button (SoM only)"] = "Ocultar el botón del mapa mundial (solo SoM)"
...
L["If checked, a button will be added to the character frame which will show your equipped item durability when you hover the pointer over it.|n|nIn addition, an overall percentage will be shown in the chat frame when you die."] = "Si está seleccionado, se agregará un botón a la información del personaje que mostrará la durabilidad de su equipo cuando pase el cursor sobre él.|n|nAdemás, se mostrará un porcentaje general en el marco del chat cuando muera."
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword as long as you are ungrouped, group leader or raid assistant and not queued for a battleground.|n|nFriends who message the keyword using Battle.net will not be sent a group invite if they are appearing offline.  They need to either change their online status or use character whispers."] = "Si está seleccionado, se enviará una invitación de grupo a cualquiera que le susurre con una palabra clave establecida, siempre que no esté agrupado, sea líder de grupo o asistente de banda y no esté en la cola de un campo de batalla.|n|nLos amigos que envíen mensajes con la palabra clave usando Battle.net no se les enviará una invitación de grupo si aparecen sin conexión. Necesitan cambiar su estado en línea o usar susurros de personajes."
...
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT-click - Toggle music.|n|nALT-click - Toggle errors (if enabled).|n|nCTRL/SHIFT-click - Toggle windowed mode.|n|nCTRL/ALT-click - Toggle Zygor (if installed)."] = "Si está seleccionado, habrá un botón de minimapa disponible.|n|nHaga clic: Alternar panel de opciones.|n|nMAYÚS-clic: Alternar música.|n|nALT-clic: Alternar errores (si está habilitado).|n|nCTRL/MAYÚS y clic: Alternar el modo de ventana.|n|nCTRL/ALT-clic: Alternar Zygor (si está instalado)."
...
L["If checked, a repair summary will be shown in chat when your gear is automatically repaired."] = "Si está seleccionado, se mostrará un resumen de reparación en el chat cuando su equipo se repare automáticamente."
...
L["If checked, a train all skills button will be shown in the skill trainer frame allowing you to train all available skills instantly."] = "Si está seleccionado, se mostrará un botón de aprender todas las habilidades en el marco del instuctor de habilidades, lo que le permitirá aprender todas las habilidades disponibles al instante."
...
L["If checked, addon buttons will be combined into a single button frame which you can toggle by right-clicking the minimap.|n|nNote that enabling this option will lock out the 'Hide addon buttons' setting."] = "Si está seleccionado, los botones de addon se combinarán en un solo marco de botón que puede alternar haciendo clic derecho en el minimapa.|n|nTenga en cuenta que habilitar esta opción bloqueará la configuración 'Ocultar botones de addon'."
...
L["If checked, duel requests will be blocked unless the player requesting the duel is a friend."] = "Si está seleccionado, las solicitudes de duelo se bloquearán a menos que el jugador que solicita el duelo sea un amigo."
...
L["If checked, group invites will only be sent to friends.|n|nIf unchecked, group invites will be sent to everyone."] = "Si está seleccionado, las invitaciones grupales solo se enviarán a amigos.|n|nSi no está seleccionado, las invitaciones grupales se enviarán a todos."
...
L["If checked, raid chat will be colored blue (to match the default party chat color)."] = "Si está seleccionado, el chat de banda se coloreará de azul (para que coincida con el color predeterminado del chat del grupo)."
L["If checked, recent chat will be restored when you reload your interface."] = [=[Si está seleccionado, el chat reciente se restaurará cuando recargue tu interfaz.
]=]
...
L["If checked, the clock will be hidden."] = "Si está seleccionado, el reloj estará oculto."
...
L["If checked, the scale slider will apply to the entire minimap cluster.|n|nNote that if you are using the default action bars, rescaling the cluster will also rescale the right action bars at startup so you may want to leave the scale slider at 100%.|n|nIf unchecked, the scale slider will only apply to the minimap."] = "Si está seleccionado, el control deslizante de escala se aplicará a todo el grupo del minimapa.|n|nTenga en cuenta que si está utilizando las barras de acción predeterminadas, al cambiar la escala del grupo también se cambiará la escala de las barras de acción correctas al inicio, por lo que es posible que desee dejar el control deslizante de escala en 100%.|n|nSi no está seleccionado, el control deslizante de escala solo se aplicará al minimapa."
...
L["If checked, the spell fizzle sounds will be muted."] = "Si está seleccionado, los sonidos de efervescencia del hechizo serán silenciados."
...
L["If checked, the tracking button will be hidden while the pointer is not over the minimap."] = [=[Si está seleccionado, el botón de seguimiento estará oculto mientras el cursor no esté sobre el minimapa.
]=]
...
L["If checked, the world map button will be hidden.|n|nThis setting only applies to Season of Mastery."] = "Si está seleccionado, el botón del mapa mundial se ocultará.|n|nEsta configuración solo se aplica a Season of Mastery."
...
L["If checked, tooltips for world units will be hidden during combat."] = "Si está seleccionado, los tooltips de las unidades mundiales se ocultará durante el combate."
...
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip item.|n|nIf the gossip item type is banker, taxi, trainer, vendor or battlemaster, gossip will be skipped without needing to hold the alt key.  You can hold the shift key down to prevent this."] = "Si está seleccionado, se puede mantener presionada la tecla Alt mientras abres una ventana de diálogo para seleccionar automáticamente un solo tipo de diálogo.|n|nSi el tipo de diálogo es banquero, taxi, instructor, vendedor o maestro de batalla, se omitirán los diálogos sin necesidad de mantener presionada la tecla Alt. Se Puede mantener presionada la tecla Mayús para evitar esto."
...
L["If checked, you will be able to cancel cinematics without being prompted for confirmation."] = "Si está seleccionado, se podrá cancelar cinemáticas sin que se le solicite confirmación."
...
L["If checked, you will be able to change the position and scale of the player frame, target frame and timer bar.|n|nNote that enabling this option will prevent you from using the default UI to move the player and target frames."] = "Si está seleccionado, se podrá cambiar la posición y la escala del marco del jugador, el marco del objetivo y la barra de tiempo.|n|nTenga en cuenta que habilitar esta opción le impedirá usar la interfaz de usuario predeterminada para mover los marcos de jugador y del objetivo."
L["If checked, you will be able to change the position and scale of the timer bar."] = "Si está seleccionado, se podrá cambiar la posición y escala de la barra del temporizador."
...
L["If checked, you will be able to show a rare, elite or rare elite chain around the player frame."] = "Si está seleccionado, se podrá mostrar una cadena de élite rara, élite o rara alrededor del marco del jugador."
L["If checked, you will be able to zoom out to a greater distance."] = "Si está seleccionado, se podrá alejarse a una distancia mayor."
...
L["If checked, you will be dismounted when you instruct a flight master to open the flight map."] = "Si está seleccionado, serás desmontado cuando le indique a un maestro de vuelo que abra el mapa de vuelo."
...
L["If checked, you will need to hold the override key down for quests to be automated.|n|nIf unchecked, holding the override key will prevent quests from being automated."] = "Si está seleccionado, deberá mantener presionada la tecla de anulación para que las misiones se automaticen.|n|nSi no está seleccionado, al mantener presionada la tecla de anulación evitará que las misiones se automaticen."
L["If checked, you will no longer need to type delete when destroying a superior quality item.|n|nIn addition, item links will be shown in all item destroy confirmation windows."] = "Si está seleccionado, ya no necesitará escribir eliminar al destruir un objeto de calidad superior.|n|nAdemás, los enlaces de objetos se mostrarán en todas las ventanas de confirmación de eliminación de objetos."
...
L["Links go directly to the comments section"] = "Los enlaces van directamente a la sección de comentarios."
...
L["Manage buffs"] = "Gestionar beneficios"
L["Manage durability"] = "Gestionar durabilidad"
L["Manage frames"] = "Gestionar marcos"
L["Manage timer"] = "Gestionar temporizador"
...
L["More font sizes"] = "Más tamaños de fuente"
...
L["Mute"] = "Silenciar"
L["Mute custom sounds"] = "Silenciar sonidos personalizados"
...
L["No supported addons."] = "No hay addons soportados."
L["No tooltip showing."] = "No se muestra tooltip."
L["None"] = "Ninguno"
L["Not completed."] = "No completado."
L["Not minimap"] = "No minimapa"
L["Note that this will not reset settings that require a UI reload."] = "Tenga en cuenta que esto no restablecerá la configuración que requiere una recarga de la interfaz de usuario."
L["Note that this will not reset your exclusions list."] = [=[Tenga en cuenta que esto no restablecerá tu lista de exclusiones.
]=]
...
L["Remove all items"] = "Eliminar todos los objetos"
...
L["Restore chat messages"] = "Restaurar mensajes de chat"
...
L["Show druid power bar"] = "Mostrar barra de poder de druida"
L["Show durability status"] = "Durabilidad"
L["Show flight times"] = "Mostrar tiempo de vuelo"
...
L["Show ready timer"] = "Mostrar temporizador listo"
...
L["Show target model"] = "Mostrar modelo del objetivo"
...
L["Toggle buttons"] = "Alternar botones"
