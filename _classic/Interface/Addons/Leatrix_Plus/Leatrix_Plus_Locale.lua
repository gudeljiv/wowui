...
L["If checked, you will be able to change the position and scale of the player frame and target frame.|n|nNote that enabling this option will prevent you from using the default UI to move the player and target frames."] = "Si está seleccionado, se podrá cambiar la posición y la escala del marco del jugador y del marco de objetivo.|n|nTenga en cuenta que habilitar esta opción le impedirá utilizar la interfaz de usuario predeterminada para mover el jugador y los marcos de objetivo."
