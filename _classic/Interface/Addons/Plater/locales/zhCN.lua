...
L["OPTIONS_NAMEPLATE_SHOW_ENEMY_DESC"] = "显示敌方和中立部队的铭牌|cFFFF7700[*]|r|cFFa0a0CVar，保存在Plater配置文件中，并在加载配置文件时恢复|r"
L["OPTIONS_NAMEPLATE_SHOW_FRIENDLY"] = "显示友好的铭牌|cFFFF7700*|r"
...
L["OPTIONS_NOTHING_TO_EXPORT"] = "没有什么可出口的。"
L["OPTIONS_OKAY"] = "确定"
