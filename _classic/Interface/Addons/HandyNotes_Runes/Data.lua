...
st.mage.icyVeins = "You must collect ten books from across Azeroth.\nThere are 16 all told, with three each per faction\n"
			.."for a total of 13 possible per faction.\n\nThere is no special sequencing. You hand the books\n"
			.."to your Librarian: Owen Thadd in the Mages Quarter\nof Undercity (H) or Garion Wendell in the Mage\n"
			.."Tower portal room in Stormwind (A).\n\nOwen and Garion keep count, allowing you to hand\n"
			.."in whenever it's convenient.\n\nEach deposit will yield a Comprehension Charm too!\n\n"
			.."When the time is right, you'll receive your reward!"
...
st.voidTouchedGuideTitle = "Void Touched Gear Guide"
st.voidTouched = "(1) Reach level 25 and 100 in one of\nBlacksmithing, Leatherworking or Tailoring.\n\n"
