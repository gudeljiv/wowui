...
L["TrailPathOnMinimap"] = "Show on minimap"
L["TrailPathOnMinimapDesc"] = "Display the trail path on minimap too."
...
L["TrailPathOnMinimap"] = "Auf der Minimap anzeigen"
L["TrailPathOnMinimapDesc"] = "Zeige den Wanderweg auch auf der Minimap an."
...
L["AddOnLoadedDesc"] = "로그인 및 UI 새로고침 시 '애드온 불러옴...' 메시지를 표시합니다."
L["AddOnLoadedDescAlt"] = "또는 로딩 화면에서 shift 키를 누르고 있으면 이 로그인에 대해서만 이 메시지가 표시됩니다."
...
L["DataBrokerToggleBackground"] = "- 미니맵 배경 켜고 끄기"
...
L["QuestArrowInfoMsgDisabled"] = "퀘스트 추적 꺼짐"
L["QuestArrowInfoMsgRestored"] = "퀘스트 추적 켜짐"
L["RangeCircles"] = "범위 원"
L["ResetColor"] = "색상 초기화"
L["Rotation"] = "회전"
...
L["TrailPath"] = "발자국 경로"
L["TrailPathColorsDesc"] = "발자국 경로 아이콘의 색상 조정"
L["TrailPathCount"] = "발자국 수"
L["TrailPathCountDesc"] = "미니맵/FarmHud 내 최대 발자국 수를 조정합니다."
L["TrailPathIcon"] = "아이콘"
L["TrailPathIconDesc"] = "발자국 아이콘을 선택합니다."
L["TrailPathScale"] = "아이콘 크기 비율"
L["TrailPathScaleDesc"] = "발자국 크기를 조정합니다."
L["TrailPathShow"] = "발자국 경로 표시"
L["TrailPathTimeout"] = "사라짐 (초)"
L["TrailPathTimeoutDesc"] = "미니맵/FarmHud에서 발자국이 제거되는 시간을 조정합니다."
L["W"] = "서"
...
L["AddOnLoaded"] = "插件已加载......"
L["AddOnLoadedDesc"] = "在登录和界面加载时显示“插件已加载”的提示信息。"
L["AddOnLoadedDescAlt"] = "你也可以在加载界面时按住Shift键来临时显示此信息。"
L["AnotherAddOnsHijackedFunc"] = "警告：另一个插件劫持了一些基本功能。请参阅以下列表："
L["BgTransparency"] = "背景透明度"
L["Black player dot"] = "黑色玩家点"
L["Blizzards player arrow"] = "暴雪玩家箭头"
L["Blizzards player arrow (smaller)"] = "暴雪玩家箭头（较小）"
L["CardinalPoints"] = "方位"
...
L["ChangeRadius"] = "距中心的距离"
L["ChangeRadiusDesc"] = "更改 HUD 中心距离"
L["Coords"] = "坐标"
L["CoordsBottom"] = "底部坐标"
L["CoordsBottomDesc"] = "在底部显示玩家坐标"
L["CoordsColorDesc"] = "调整坐标的颜色"
L["CoordsColorResetDesc"] = "重置坐标的颜色"
L["CoordsShow"] = "显示坐标"
L["CoordsShowDesc"] = "在 HUD 上显示玩家坐标"
L["DataBrokerOptions"] = "打开 FarmHud 选项"
L["DataBrokerToggle"] = "切换 FarmHud"
L["DataBrokerToggleBackground"] = "切换小地图背景"
L["DebugOptFrames"] = "打印不需要的元素"
L["DebugOptFramesDesc"] = "如果启用了 FarmHud，则打印小地图上锚定的不需要的元素的列表"
L["DebugOptInfo"] = "本节包含帮助跟踪其他插件问题的选项。"
L["E"] = "东"
L["ExtraAddOnLoaded"] = "额外插件%s已启用！"
L["ExtraAddOnNotLoaded"] = "此选项必须启用额外插件%s！"
L["GatherCircle"] = "采集指示圈"
L["GatherCircleColorDesc"] = "调整采集指示圈的颜色"
L["GatherCircleDesc"] = "采集指示圈是一个视觉上的辅助线。它代表在以你为中心、它代表在以你为中心的距离内，关注点（邮箱、矿石、草药等）在微缩地图和FarmHud上可见的范围。"
L["GatherCircleShow"] = "显示采集指示圈"
L["GatherCircleShowDesc"] = "在HUD模式下显示采集指示圈"
L["Golden player dot"] = "金色玩家点"
L["HealCircle"] = "治疗范围指示圈"
L["HealcircleColorDesc"] = "调整治疗范围指示圈的颜色"
L["HealcircleDesc"] = "治疗范围指示圈是一个视觉上的辅助线。它代表在以你为中心、可治疗其他玩家的范围。"
L["HealcircleShow"] = "显示治疗范围指示圈"
L["HealcircleShowDesc"] = "在HUD模式下显示治疗范围指示圈"
L["Hide player arrow"] = "隐藏玩家箭头"
L["HudSize"] = "HUD尺寸"
L["HudSizeDesc"] = "将 HUD 大小设置为屏幕高度的百分比"
L["HudSymbolScale"] = "HUD符号比例"
L["HudSymbolScaleDesc"] = "缩放 HUD 上的符号"
L["KeyBindBackground"] = "切换 FarmHud 的小地图背景"
L["KeyBindBackgroundDesc"] = "设置键绑定以显示小地图背景。"
L["KeyBindMouse"] = "切换 FarmHud 的工具提示（无法点击 Hud）"
L["KeyBindMouseDesc"] = "设置键绑定以允许将鼠标悬停在感兴趣点节点（如矿石、草药或任务提供者）的工具提示上。 或者单击 HUD 向您的团队或团队提交 ping。"
L["KeyBindToggle"] = "切换 FarmHud 的显示"
L["KeyBindToggleDesc"] = "设置键绑定以显示 FarmHud。"
L["KnownProblematicAddOnDetected"] = "警告：您正在使用的插件会导致与 FarmHud 的顺利合作变得困难。 可能的解决方法：您可以尝试隐藏令人不安的元素。 在 FarmHud 选项中禁用“显示元素”。"
L["MinimapIcon"] = "微缩地图按钮"
L["MinimapIconDesc"] = "显示微缩地图按钮。"
L["MouseOn"] = "鼠标打开"
L["MouseOver"] = "鼠标悬停在选项上"
L["MouseOverInfoColorDesc"] = "调整 HUD 上文本“MOUSE ON”的颜色"
L["MouseOverOnHold"] = "将鼠标悬停在按住修改键上"
L["MouseOverOnHoldDesc"] = "这是一个在您按住 Alt 等修饰键时启用鼠标悬停模式的选项"
L["N"] = "北"
L["NE"] = "东北"
L["NW"] = "西北"
L["OnScreen"] = "屏幕按钮"
L["OnScreenAlphaDesc"] = "调整屏幕按钮的透明度"
L["OnScreenBottom"] = "屏幕按钮位于底部"
L["OnScreenBottomDesc"] = "在 HUD 中心底部显示屏幕按钮"
L["OnScreenShow"] = "显示屏幕按钮"
L["OnScreenShowDesc"] = "显示屏幕按钮（“鼠标打开”模式、隐藏关闭按钮等）"
L["PlaceholderDesc"] = "占位符是一个元素，用于在 Farmhud 处于活动状态时将小地图的所有可见元素固定到位。"
L["PlayerDot"] = "玩家箭头或点"
L["PlayerDotDesc"] = "更改打开的 FarmHud 上玩家点/箭头的外观"
L["PleaseReportThisMessage"] = "请以屏幕截图或文本形式报告有关curseforge问题的此消息。"
L["QuestArrow"] = "任务箭头"
L["QuestArrowDesc"] = "在打开的 HUD 上显示任务箭头"
L["QuestArrowHide"] = "隐藏打开的 HUD 上的任务箭头"
L["QuestArrowInfoMsg"] = "显示信息消息"
L["QuestArrowInfoMsgDesc"] = "在常规聊天窗口中显示信息消息"
L["QuestArrowInfoMsgDisabled"] = "任务追踪已禁用"
L["QuestArrowInfoMsgRestored"] = "任务追踪已恢复"
L["RangeCircles"] = "范围指示圈"
L["ResetColor"] = "重置颜色"
L["Rotation"] = "旋转"
L["RotationDesc"] = "HUD模式下强制启用微缩地图旋转。"
L["S"] = "南"
L["SE"] = "东南"
L["ShowPlaceholder"] = "显示元素"
L["ShowPlaceholderBg"] = "显示背景"
L["ShowPlaceholderBgDesc"] = "当 FarmHud 处于活动状态时，显示黑色背景而不是小地图。"
L["ShowPlaceholderDesc"] = "即使 FarmHud 处于活动状态，小地图的元素仍然可见。"
L["SupportBlizzard"] = "暴雪做了一些改变，使得提供单个插件或库的可选支持变得毫无用处"
L["SupportHereBeDragon"] = "Tomtom 和 HandyNotes 通过 HereBeDragon 库得到支持，但 HandyNotes 在 Hud 切换方面存在问题。 通过切换 FarmHud，您周围的所有图标都会消失。 但经过一点点步行/飞行应该再次显示。"
L["SupportOptions"] = "支持选项"
L["SW"] = "西南"
L["TextScale"] = "文字比例"
L["TextScaleDesc"] = "HUD 上的文本缩放以显示基点、鼠标和坐标"
L["Time"] = "时间"
L["TimeBottom"] = "底部时间"
L["TimeBottomDesc"] = "底部显示时间"
L["TimeColorDesc"] = "调整时间颜色"
L["TimeColorResetDesc"] = "重置时间的颜色"
L["TimeLocal"] = "本地时间"
L["TimeLocalDesc"] = "显示本地时间。"
L["TimeServer"] = "服务器时间"
L["TimeServerDesc"] = "显示服务器时间。"
L["TimeShow"] = "显示时间"
L["TimeShowDesc"] = "在HUD模式下显示本地时间或服务器时间。"
L["TrackingOptions"] = "追踪选项"
L["TrackingOptionsDesc"] = "在FarmHud模式下切换图标。|n|n“同微缩地图”表示FarmHud会使用你的微缩地图追踪设置。"
L["TrackingOptionsLikeMinimap"] = "同微缩地图"
L["TrailPath"] = "小径路径"
L["TrailPathColorsDesc"] = "调整路径图标的颜色"
L["TrailPathCount"] = "点数"
L["TrailPathCountDesc"] = "调整小地图/farmhud 上的最大覆盖区数量。"
L["TrailPathIcon"] = "图标"
L["TrailPathIconDesc"] = "为您的足迹选择一个图标。"
L["TrailPathOnMinimap"] = "在小地图上显示"
L["TrailPathOnMinimapDesc"] = "也在小地图上显示路径"
L["TrailPathScale"] = "图标缩放"
L["TrailPathScaleDesc"] = "调整足迹的大小"
L["TrailPathShow"] = "显示路径"
L["TrailPathTimeout"] = "淡出（秒）"
L["TrailPathTimeoutDesc"] = "调整从小地图/farmhud 中删除轮廓线的时间。"
L["W"] = "西"
L["White player dot"] = "白色玩家点"

elseif LOCALE_zhTW then
L["AddOnLoaded"] = "插件已載入..."
L["AddOnLoadedDesc"] = "再登入和重載UI後顯示  '插件已載入...' 的訊息"
L["BgTransparency"] = "背景透明度"
L["Coords"] = "座標"
L["CoordsBottom"] = "底部座標"
L["CoordsBottomDesc"] = "在底部顯示玩家座標"
L["CoordsColorDesc"] = "調整座標顏色"
L["CoordsColorResetDesc"] = "重置座標顏色"
