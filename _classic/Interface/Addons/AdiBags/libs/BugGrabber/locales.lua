...
function addon:LoadTranslations(locale, L)
	if locale == "koKR" then
		...
		L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
			"아이템의 분류 항목을 직접 지정합니다. 항목 이름 위에 아이템을 드래그하세요."
		...
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			'장비 구성을 하나의 개별 항목으로 표시합니다. 비활성하면 하나의 큰 "장비 구성" 항목으로 표시됩니다.'
		L["Check this to display only one value counting all equipped bags, ignoring their type."] =
			"착용한 모든 가방을 유형을 무시하고 하나의 값으로 표시합니다."
		...
		L["Click on a item to remove it from the list. You can drop an item on the empty slot to add it to the list."] =
			"목록에서 제거할 아이템을 클릭하세요. 빈 칸에 아이템을 끌어다 놓으면 목록에 추가할 수 있습니다."
		...
		L["Click to select which sections should be shown or hidden. Section visibility is common to all bags."] =
			"표시하거나 숨길 항목을 클릭하세요. 항목 표시 설정은 모든 가방에 적용됩니다."
		...
		L["Display a smaller money frame. This setting will take effect on next reload."] =
			"소지금 창을 작게 표시합니다. 이 설정은 UI를 다시 불러온 이후 적용됩니다."
		...
		L["Display the level of equippable item in the top left corner of the button."] =
			"버튼의 좌측 상단 모서리에 장착 가능한 아이템의 레벨을 표시합니다."
		...
		L["Enter the name, link or itemid of the item to associate with the section. You can also drop an item into this box."] =
			"항목과 연결시킬 아이템의 이름, 링크 또는 아이템id를 입력하세요. 아이템을 이 박스에 끌어다 놓을 수 있습니다."
		L["Equipment"] = "착용 장비"
		...
		L[
			...
			] = "필터는 가방 항목으로 아이템을 보내기 위해 사용됩니다. 하나의 항목에 하나의 아이템만 나타날 수 있습니다. 여러 필터에 동일한 아이템이 선택되면 우선 순위가 높은 항목에 표시됩니다."
		L["Font"] = "글꼴"
		...
		L[
			...
			] = "애드온이 제대로 동작하지 않을 경우, 버그 티켓을 제출하기 전에 오류 보고 기능을 켜고 다시 확인해주세요."
		...
		L["Items in this list are always considered as junk. Click an item to remove it from the list."] =
			"이 목록의 아이템들은 항상 잡동사니로 간주됩니다. 아이템을 클릭하면 목록에서 제거합니다."
		L["Items in this list are never considered as junk. Click an item to remove it from the list."] =
			"이 목록의 아이템들은 잡동사니로 간주하지 않습니다. 아이템을 클릭하면 목록에서 제거합니다."
		L["Jewelry"] = "장신구"
		...
		L["Please note this filter matchs every item. Any filter with lower priority than this one will have no effect."] =
			"이 필터는 모든 아이템에 적용됩니다. 이 필터보다 낮은 우선 순위를 가진 필터는 적용되지 않습니다."
		L["Plugins"] = "플러그인"
		...
		L["Select the category of the section to associate. This is used to group sections together."] =
			"연결시킬 항목의 분류를 선택하세요. 그룹 항목과 함께 사용됩니다."
		...
		L[
			...
			] = '각 가방에서 새로운 아이템을 추적합니다, 빛나는 오라가 주변에 표시되며 특별한 항목으로 분류합니다. "새 아이템" 상태는 가방의 좌측 상단에 있는 작은 "N" 버튼을 클릭하면 초기화됩니다.'
		...
		L["Use this to adjust the quality-based border opacity. 100% means fully opaque."] =
			"품질에 따른 테두리의 투명도를 조절합니다. 100%는 투명도를 적용하지 않습니다."
		...
		L["Virtual stacks display in one place items that actually spread over several bag slots."] =
			"가상으로 겹치기는 실제로 여러 가방 칸에 흩어져 있는 아이템들을 한 곳에 표시합니다."
		...
		L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] =
			"체크하면 가방의 빈 공간을 오른쪽 클릭으로 설정 창을 엽니다."
		...
		L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] =
			"은행원과 대화할 때 보조 키를 누르고 있으면 자동 보관 기능을 방지할 수 있습니다."
	elseif locale == "deDE" then
		...
		L["Add a dropdown menu to bags that allow to hide the sections."] =
			"Fügt den Taschen ein Auswahlmenü hinzu, womit Bereiche versteckt werden können."
		L["Add association"] = "Füge Zuweisung hinzu"
		L["Add more information in tooltips related to items in your bags."] =
			"Fügt mehr Informationen bezüglich der Gegenstände in deinen Taschen zum Tooltip hinzu."
		...
		L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
			"Erlaubt eine manuelle Festlegung des Bereiches, in dem ein Gegenstand abgelegt werden soll. Ziehe den Gegenstand einfach auf den betreffenden Bereichsnamen."
		...
		L["Automatically open the bags at merchant's, bank, ..."] =
			"Öffnet Taschen bei Händlern, in der Bank, usw. automatisch"
		L["auto-sort"] = "Automatisches Sortieren"
		L["Auto-sort can cause freeze when the bag is closed."] =
			"Das automatische Sortieren kann ein Einfrieren der Anzeige bewirken, wenn die Tasche geschlossen ist."
		L["Backpack"] = "Rucksack"
		...
		L["By category, subcategory, quality and item level (default)"] =
			"Nach Kategorie, Unterkategorie, Qualität und Gegenstandsstufe. (Standard)"
		L["By name"] = "Nach Name"
		L["By quality and item level"] = "Nach Qualität und Gegenstandsstufe"
		L["Category"] = "Kategorie"
		L["Change stacking at merchants', auction house, bank, mailboxes or when trading."] =
			"Ändere das Stapelverhalten bei Händlern, im Auktionshaus, in der Bank, beim Postfach oder beim Handeln."
		L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
			"Wähle diejenigen Sets aus, welche in einem individuellen Set-Bereich zusammengeführt werden sollen. Das ist eine Einstellung, die für jeden Charakter einzeln konfiguriert wird."
		L["Check this so armors are dispatched in four sections by type."] =
			"Auswählen, um Rüstungen gemäß ihrer Art (Stoff, Leder, Kette, Platte) in vier Bereiche einzuteilen."
		...
		L["Check this to display a colored border around items, based on item quality."] =
			"Aktivieren, um einen nach Qualität gefärbten Rahmen um Gegenstände herum anzuzeigen."
		L["Check this to display an icon after usage of each type of bags."] =
			"Aktivieren, um ein Symbol für die Taschenart nach der Auslastungsinformation anzuzeigen."
		L["Check this to display an indicator on quest items."] =
			"Aktivieren, um Questgegenstände mit einem farbigen Rahmen hervorzuheben."
		L["Check this to display an textual tag before usage of each type of bags."] =
			"Aktivieren, um für jede Taschenart die Kurzbezeichnung vor der Auslastung anzeigen zu lassen."
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			"Aktivieren, um einen individuellen Bereich für jedes Set anzuzeigen. Wenn diese Option nicht aktiviert ist, wird nur ein großer Sets- Bereich angezeigt."
		L["Check this to display only one value counting all equipped bags, ignoring their type."] =
			"Aktivieren, um nur einen Wert anzuzeigen, der alle Taschenplätze unabhängig von der Taschenart zählt."
		...
		L["Check this to show space at your bank in the plugin."] =
			"Aktivieren, um die Anzahl der freien Plätze in der Bank anzuzeigen."
		L["Check this to show this section. Uncheck to hide it."] =
			"Auswählen, um diesen Bereich anzuzeigen; abwählen, um sie zu verbergen."
		...
		L["Click on a item to remove it from the list. You can drop an item on the empty slot to add it to the list."] =
			"Klicke auf einen Gegenstand, um ihn aus der Liste zu entfernen. Platziere einen Gegenstand auf dem freien Platz, um ihn der Liste hinzuzufügen."
		...
		L["Click there to reset the bag positions and sizes."] =
			"Hier klicken, um die Taschenposition und -größe zurückzusetzen."
		L["Click to purchase"] = "Klicken, um zu kaufen"
		L["Click to reset item status."] = "Klicken, um den Gegenstandsstatus zurückzusetzen."
		L["Click to select which sections should be shown or hidden. Section visibility is common to all bags."] =
			"Anklicken, um festzulegen, welche Bereiche angezeigt werden sollen und welche nicht. Die Sichtbarkeit der Untergliederungen gilt für alle Taschen."
		...
		L["Click to toggle the equipped bag panel, so you can change them."] =
			"Klicken, um die Taschenleiste anzuzeigen, sodass die Behälter gewechselt oder belegt werden können."
		L["Close"] = "Schließen"
		L["Color"] = "Farbe"
		...
		L["Display a smaller money frame. This setting will take effect on next reload."] =
			"Zeigt einen kleineren Geldbereich. Diese Einstellung wird erst nach dem Neuladen des Interfaces wirksam."
		L["Display character currency at bottom left of the backpack."] =
			"Zeigt die Währungen des Charakters rechts unten im Rucksack an."
		L["Display character money at bottom right of the backpack."] =
			"Zeigt das Gold des Charakters rechts unten im Rucksack an"
		L["Display the level of equippable item in the top left corner of the button."] =
			"Zeigt die Stufe von ausrüstbaren Gegenständen in der linken oberen Ecke an."
		...
		L["Do not show level of items that cannot be equipped."] =
			"Zeigt die Stufe bei nicht anlegbaren Gegenständen nicht an."
		L["Do not show level of poor quality items."] =
			"Zeigt die Gegenstandsstufe bei Gegenständen minderwertiger Qualität nicht an."
		...
		L["Enter the name, link or itemid of the item to associate with the section. You can also drop an item into this box."] =
			"Gib den Namen, den Link oder die Gegenstand-ID des Gegenstandes ein, der dem Bereich zugewiesen werden soll. Du kannst auch einen Gegenstand in dieses Feld ziehen."
		...
		L[
			...
			"Filter werden benutzt, um Gegenstände in Bereiche innerhalb der Tasche einzuordnen. Ein Gegenstand kann immer nur in einem Bereich auftauchen. Wenn für den Gegenstand mehrere Filter zutreffen, dann wird der Filter mit der höchsten Priorität verwendet."
		L["Font"] = "Schriftart"
		...
		L["Hide the colored corner shown when you move the bag."] =
			"Versteckt die farbige Ecke, die beim Verschieben der Tasche angezeigt wird."
		...
		L["Highlight what changes in bags with a little sparkle."] =
			"Hebt Änderungen in den Taschen mit einem kleinen Funkeln hervor."
		L[
				"If the addon seems not to work properly, please re-enable error reporting and check again before filing a bug ticket."
			] =
			"Falls das Addon nicht richtig zu funktionieren scheint, bitte aktiviere die Fehlerberichterstattung und überprüfe das Verhalten erneut, bevor du einen offiziellen Fehlerbericht erstellst."
		...
		L["Items"] = "Gegenstände"
		L["Items in this list are always considered as junk. Click an item to remove it from the list."] =
			"Gegenstände in dieser Liste werden immer als Plunder behandelt. Klicke auf einen Gegenstand, um ihn aus der Liste zu entfernen."
		L["Items in this list are never considered as junk. Click an item to remove it from the list."] =
			"Gegenstände in dieser Liste werden nie als Plunder behandelt. Klicke auf einen Gegenstand, um ihn aus der Liste zu entfernen."
		L["Jewelry"] = "Schmuck"
		...
		L["Move items from and to the bank by right-clicking on section headers."] =
			"Verschiebe Gegenstände durch Rechtsklick auf den Bereichsnamen von und zu der Bank."
		L["Never"] = "Niemals"
		L["New"] = "Neu"
		...
		L["Please note this filter matchs every item. Any filter with lower priority than this one will have no effect."] =
			"Bitte beachten: Dieser Filter betrifft jeden Gegenstand. Alle Filter mit niedriger Priorität als dieser werden keinen Effekt haben."
		L["Plugins"] = "Plugins"
		...
		L["Provides a LDB data source to be displayed by LDB display addons."] =
			"Stellt eine LDB-Datenquelle zur Verfügung, welche von DataBroker-Addons angezeigt werden kann."
		L['Put any item that can be equipped (including bags) into the "Equipment" section.'] =
			'Ordnet jeden ausrüstbaren Gegenstand (inklusive Taschen) im Bereich "Ausrüstung" an.'
		L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] =
			"Ordnet Gegenstände, die zu einem oder mehreren Sets des Ausrüstungsmanagers gehören, in dementsprechenden Bereichen an."
		L["Put items in sections depending on their first-level category at the Auction House."] =
			"Ordnet Gegenstände basierend auf der Hauptkategorie des Auktionshauses in Bereiche ein."
		L['Put items of poor quality or labeled as junk in the "Junk" section.'] =
			'Ordnet Gegenstände geringer Qualität oder als Plunder gekennzeichnete Gegenstände im Bereich "Plunder" an.'
		...
		L["Select how items should be sorted within each section."] =
			"Wähle aus, wie die Gegenstände innerhalb eines Bereichs sortiert werden sollen."
		L["Select how the bags are positionned."] = "Wähle, wie die Taschen positioniert werden."
		L["Select the category of the section to associate. This is used to group sections together."] =
			"Wähle die Kategorie aus, die dem Bereich zugewiesen werden soll. Damit werden Bereiche miteinander gruppiert."
		L["Select the sections in which the items should be dispatched."] =
			"Wähle die Aufteilung der Bereiche, in welche die Gegenstände abgelegt werden sollen."
		...
		L["Select which first-level categories should be split by sub-categories."] =
			"Wähle aus, welche Hauptkategorien in Unterkategorien aufgeteilt werden sollen."
		...
		L[
			...
			'Markiert neue Gegenstände in jeder Tasche mit einer glühenden Aura und ordnet sie in einem spezielle Bereich an. Der Status "Neu" kann durch Klicken auf den kleinen Knopf "N" oben links im Taschenfenster zurückgesetzt werden.'
		...
		L["Use this section to define any item-section association."] =
			"Hier können beliebige Zuordnungen von Gegenständen und Bereichen definiert werden."
		L["Use this to adjust the bag scale."] = "Skalierung der Taschen anpassen."
		L["Use this to adjust the quality-based border opacity. 100% means fully opaque."] =
			"Deckkraft der Qualitätsumrandung der Gegenstände anpassen. 100% bedeutet volle Deckkraft."
		L["Virtual stack slots"] = "Virtuelle Stapelplätze"
		L["Virtual stacks"] = "Virtuelle Stapel"
		L["Virtual stacks display in one place items that actually spread over several bag slots."] =
			"Virtuelle Stapel zeigen Gegenstände an einem Platz, die eigentlich in verschiedenen Taschen verteilt sind."
		...
		L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] =
			"Auswählen, um die Einstellungen durch einen Rechtsklick auf einen leeren Bereich in den Taschen zu öffnen."
		...
		L["Which color scheme should be used to display the item level ?"] =
			"Welches Farbschema soll benutzt werden, um die Gegenstandsstufen anzuzeigen?"
		L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] =
			"Automatisches Einlagern kann durch gleichzeitiges Drücken einer Modifikator-Taste beim Öffnen der Bank unterdrückt werden."
	elseif locale == "esES" then
		L["%s is: %s."] = "%s es: %s."
		L["... including incomplete stacks"] = "... incluyendo montones incompletos."
		L["6.0"] = "6.0"
		L["Add a dropdown menu to bags that allow to hide the sections."] =
			"Añade un menú desplegable a las bolsas que te permite esconder las secciones."
		L["Add association"] = "Añadir asociación"
		L["Add more information in tooltips related to items in your bags."] =
			"Añade más información en la información del objeto relacionado con los objetos de tus bolsas."
		...
		L["Automatically open the bags at merchant's, bank, ..."] =
			"Automáticamente abre las bolsas en la tienda del comerciante, banco, ..."
		L["Auto-sort can cause freeze when the bag is closed."] =
			"La clasificación automática puede causar congelación cuando la bolsa está cerrada."
		L["Backpack"] = "Mochila"
		...
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			'Marca esto para mostrar una sección por cada grupo. Si está desactivado, habra una gran sección de "Grupos"'
		L["Check this to display only one value counting all equipped bags, ignoring their type."] =
		...
		L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] =
			"Coloca los artículos pertenecientes a uno o más conjuntos del gestor de equipamiento en secciones específicas."
		L["Put items in sections depending on their first-level category at the Auction House."] =
...
( not quest section?)]=]
	...
	elseif locale == "zhTW" then
		...
		L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
			"勾選裝備設定將其合併成一個「套裝」類別。此項設定顯然為角色獨用。"
		...
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			"依各個套裝獨立分組。若停用此選項，將會合併成一個大「套裝」分組。"
		...
		L["Enter the name, link or itemid of the item to associate with the section. You can also drop an item into this box."] =
			"輸入物品名稱、連結或物品ID，來與類別建立關連；也可以直接將物品拖曳至此處。"
		L["Equipment"] = "裝備"
		...
		L[
				"Filters are used to dispatch items in bag sections. One item can only appear in one section. If the same item is selected by several filters, the one with the highest priority wins."
			] = "篩檢條件是用來分類背包中的物品。一件物品只能被分類到一個類別。如果一項物品符合多個篩選條件，會以優先順序最高者為準。"
		L["Font"] = "字型"
		...
		L[
				"If the addon seems not to work properly, please re-enable error reporting and check again before filing a bug ticket."
			] = "如果該插件似乎不能正常運作，在提交問題回報(bug ticket)前，請重新啟用錯誤報告(error reporting)來檢查。"
		...
		L["Items"] = "物品"
		L["Items in this list are always considered as junk. Click an item to remove it from the list."] =
			"在此列表中的物品總是視為垃圾。可從列表中點擊要剔除的物品。"
		L["Items in this list are never considered as junk. Click an item to remove it from the list."] =
			"在此列表中的物品不會視為垃圾。可從列表中點擊要剔除的物品。"
		L["Jewelry"] = "飾品"
		...
		L[
				'Track new items in each bag, displaying a glowing aura over them and putting them in a special section. "New" status can be reset by clicking on the small "N" button at top left of bags.'
			] = "追蹤新進物品，在新物品上顯示光環並分類至一個特殊的「新物品」分類。點擊右上角的「N」按鈕可還原新進物品至一般分類。"
	...
	elseif locale == "zhCN" then
		...
		L["Category"] = "分类"
		L["Change stacking at merchants', auction house, bank, mailboxes or when trading."] =
			"在交易, 拍卖, 银行, 邮局以及实施商业技能时更改堆叠效果."
		L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
			"根据套装分组物品, 此项根据每个角色设置有所不同."
		...
		L[
				"If the addon seems not to work properly, please re-enable error reporting and check again before filing a bug ticket."
			] = "如果插件看上去不能正常工作，请在向作者提交报告之前启用错误报告并检查一次。"
		...
		L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] =
			"在与银行职员对话的同时按住「辅助按键」，可避免自动存放。"
	elseif locale == "ruRU" then
		L["%s is: %s."] = "%s это: %s."
		L["... including incomplete stacks"] = "... включая не полные стопки"
		L["6.0"] = "6.0"
		L["Add a dropdown menu to bags that allow to hide the sections."] =
			"Показывать выпадающее меню для групп, которые можно скрывать."
		L["Add association"] = "Добавить объединение"
		L["Add more information in tooltips related to items in your bags."] =
			"Показывать расширенную информацию в подсказках к предметам в сумках."
		L["AdiBags Anchor"] = "Крепление AdiBags"
		L["Adjust the maximum height of the bags, relative to screen size."] =
			"Настройка высоты окна рюкзака относительно размера экрана.."
		...
		L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
			"Позволяет вручную изменять группу в которую следует помещать предмет. Просто перетащите элемент на название группы."
		...
		L["Auto-sort can cause freeze when the bag is closed."] =
			"Автоматическая сортировка может вызывать задержки когда сумка закрыта."
		L["Backpack"] = "Рюкзак"
		...
		L["By category, subcategory, quality and item level (default)"] =
			"По категориям, качеству и уровню предмета (по умолчанию)"
		L["By name"] = "По имени"
		L["By quality and item level"] = "По качеству и уровню"
		L["Category"] = "Раздел"
		L["Change stacking at merchants', auction house, bank, mailboxes or when trading."] =
			"Переключать стопки у торговцев, на аукционе, в банке, при отправке по почте или обмене."
		L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
			'Отмеченные наборы будут отображаться в единой группе "Наборы". Это персональная настройка.'
		L["Check this so armors are dispatched in four sections by type."] =
			"Разделять броню по типам: Ткань, Кожа, Кольчуга и Латы."
		L["Check this to display a bag type tag in the top left corner of items."] =
			"Показывать тип особой сумки в левом верхнем углу иконки предмета."
		L["Check this to display a colored border around items, based on item quality."] =
			"Включите флажок, чтобы предметы подсвечивались в соответствии с их качеством."
		L["Check this to display an icon after usage of each type of bags."] =
			"Включите флажок, чтобы отображалась иконка типа сумки."
		L["Check this to display an indicator on quest items."] =
			"Включите флажок, чтобы подсвечивались предметы, необходимые для задания."
		L["Check this to display an textual tag before usage of each type of bags."] =
			"Показывать подсказку перед использованием каждого типа сумок."
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			'Включите флажок, чтобы каждый набор выводился в отдельной группе. Когда флажок снят, то все наборы отображаются в группе "Наборы".'
		L["Check this to display only one value counting all equipped bags, ignoring their type."] =
			"Показывать общее количество свободных ячеек, не разделяя по типам сумок."
		L["Check this to have poor quality items dimmed."] = "Затенять вещи плохого качества."
		L["Check this to show space at your bank in the plugin."] =
			"Включите флажок, чтобы в окне банка показывались свободные ячейки."
		...
		L["Click on a item to remove it from the list. You can drop an item on the empty slot to add it to the list."] =
			"Кликните по предмету для его удаления. Для добавления перетащите предмет в свободную ячейку."
		...
		L["Display a smaller money frame. This setting will take effect on next reload."] =
			"Уменьшить надпись с золотом. Изменения применятся после перезагрузки интерфейса."
		...
		L["Display the level of equippable item in the top left corner of the button."] =
			"Показывать уровень предметов, которые можно одеть."
		...
		L["Do not show level of items that cannot be equipped."] =
			"Показывать уровень только тех предметов, которые можно одеть."
		...
		L[
			...
			"Фильтры используются для группировки предметов. Один предмет выводится только в одной группе. Если предмет указан в нескольких группах, то он будет выводиться в группе с наивысшим приоритетом."
		L["Font"] = "Шрифт"
		...
		L[
				"If the addon seems not to work properly, please re-enable error reporting and check again before filing a bug ticket."
			] = "Перед тем как сообщить об ошибке, пожалуйста, заново включите вывод ошибок и перепроверьте поведение."
		...
		L["Items"] = "Предметы"
		L["Items in this list are always considered as junk. Click an item to remove it from the list."] =
			"Эти предметы считаются хламом. Кликните по предмету для удаления из списка хлама."
		L["Items in this list are never considered as junk. Click an item to remove it from the list."] =
			"Эти предметы не считаются хламом. Кликните по предмету для удаления из списка исключений."
		...
		L["Money"] = "Золото"
		L["Move items from and to the bank by right-clicking on section headers."] =
			"Перемещать всю группу предметов по клику правой кнопкой мыши на заголовке группы."
		L["Never"] = "Никогда"
		L["New"] = "Новое"
		...
		L["Provides a LDB data source to be displayed by LDB display addons."] =
			"Отображает источники данных LDB при помощи LDB аддонов. LDB это LibDataBroker."
		L['Put any item that can be equipped (including bags) into the "Equipment" section.'] =
			'Поместить все предметы которые могут быть одеты на персонажа (включая сумки) в группу "Экипировка"'
		L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] =
			"Помещает вещи, являющиеся частью одного из наборов, созданных с помощью управления экипировкой, в отдельные группы."
		L["Put items in sections depending on their first-level category at the Auction House."] =
			"Раскладывать вещи в сумках, используя общие категории аукциона."
		L['Put items of poor quality or labeled as junk in the "Junk" section.'] =
			'Показывать хлам и предметы низкого качества в группе "Хлам".'
		L["Put quest-related items in their own section."] =
			'Показывать предметы, связанные с выполнением заданий, в группе "Задания".'
		...
		L["Right-click to (un)lock the bag anchor."] =
			"Щелкните правой кнопкой мыши чтобы включить или отключить привязку к якорю."
		...
		L["Select how bag usage should be formatted in the plugin."] =
			"Выберите как использование сумок должно быть отображено в плагине."
		L["Select how items should be sorted within each section."] =
		...
		L["Select the sections in which the items should be dispatched."] =
			"Укажите секцию, в которую предметы будут отправлены."
		...
		L["Uncheck this to disable AdiBags."] =
			"Использование AdiBags. Снимите этот флажок когда нужно на время отключить AdiBags."
		L["Unlock anchor"] = "Разблок. якорь"
		L["Use SyLevel"] = "Использовать SyLevel"
		L["Use this section to define any item-section association."] =
			"Использовать эту секцию что бы задать любую связь предмет-секция."
		L["Use this to adjust the bag scale."] = "Регулировка масштаба сумок."
		L["Use this to adjust the quality-based border opacity. 100% means fully opaque."] =
			"Настройте прозрачность рамки. При 100% рамка полностью видна."
		L["Virtual stack slots"] = "Виртуальное сложение слотов"
		L["Virtual stacks"] = "Виртуальные стопки"
		L["Virtual stacks display in one place items that actually spread over several bag slots."] =
			"Виртуальные стопки объединяют предметы, разбросанные по сумкам."
		...
		L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] =
			"Когда включено, Правый клик в незанятой области Рюкзака откроет Окно параметров."
		L["When ctrl is held down"] = "Когда кнопка Ctrl нажата"
		L["When shift is held down"] = "Когда кнопка Shift нажата"
		L["Which color scheme should be used to display the item level ?"] =
			"Каким цветом следует отображать уровень предметов?"
		L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] =
			"Для блокирования Авто-вклада реагентов нажмите клавишу-модификатор перед разговором с банкиром."
	elseif locale == "frFR" then
		...
		L["Automatically open the bags at merchant's, bank, ..."] =
			"Ouvre automatiquement les sacs chez un marchand, à la banque, ..."
		L["auto-sort"] = "tri automatique"
		L["Auto-sort can cause freeze when the bag is closed."] =
			"Le tri automatique peut geler l'affichage à la fermeture du sac."
		...
		L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
			'Cochez les ensembles qui doivent être fusionnés en une section "Ensembles" unique. C\'est évidemment un réglage spécifique à ce personnage.'
		L["Check this so armors are dispatched in four sections by type."] =
		...
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			'Cochez ceci pour afficher une section individuelle par ensemble d\'équipement. Sinon, il n\'y aura qu\'une seule section "Ensembles".'
		L["Check this to display only one value counting all equipped bags, ignoring their type."] =
		...
		L["Check this to show space at your bank in the plugin."] =
			"Cochez ceci pour afficher l'espace libre de votre banque."
		L["Check this to show this section. Uncheck to hide it."] =
		...
		L["Display a smaller money frame. This setting will take effect on next reload."] =
			"Affiche les monnaies en plus petit. Effectif après rechargement."
		L["Display character currency at bottom left of the backpack."] =
			"Affiche les insignes du personnage en bas à gauche du sac à dos."
		L["Display character money at bottom right of the backpack."] =
			"Affiche l'or du personnage en bas à droite du sac à dos."
		L["Display the level of equippable item in the top left corner of the button."] =
			"Afficher le niveau objets des équipements dans le coin supérieur gauche du bouton."
		...
		L["Do not show level of items that cannot be equipped."] =
			"N'affiche pas le niveau des objets qu'on ne peut pas équiper"
		...
		L["HERB_BAG_TAG"] = "He"
		L["Hide the colored corner shown when you move the bag."] =
			"Masquer le coin coloré affiché quand vous déplacez le sac."
		...
		L["Highlight what changes in bags with a little sparkle."] =
			"Mettre en évidence les changements dans les sacs avec un halo."
		L[
				"If the addon seems not to work properly, please re-enable error reporting and check again before filing a bug ticket."
			] =
			"Si l'addon semble ne pas fonctionner correctement, veuillez réactiver les rapports d'erreurs et vérifier à nouveau avant de créer un ticket d'incident."
		...
		L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] =
			"Place les objets appartenant à un ou plusieurs ensembles d'objet du gestionnaire d'objets dans des sections spécifiques."
		L["Put items in sections depending on their first-level category at the Auction House."] =
		...
		L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] =
			"Quand coché, un clic droit sur un espace vide d'un sac ouvre le panneau de configuration."
		L["When ctrl is held down"] = "Quand CONTROL est enfoncé"
		L["When shift is held down"] = "Quand MAJ est enfoncé"
		L["Which color scheme should be used to display the item level ?"] =
			"Quel thème de couleur doit être utilisé pour afficher le niveau d'objet ?"
		L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] =
			"Vous pouvez bloquer temporairement le dépôt automatique en pressant une touche de modification quand vous parlez au banquier."
	...
	elseif locale == "ptBR" then
		...
		L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
			"Permite redefinir manualmente a seção na qual um item deve ser colocado. Basta arrastar o item no título de seleção."
		...
		L["Auto-sort can cause freeze when the bag is closed."] =
			"Auto-ordenar pode causar congelamento quando a bolsa é fechada."
		L["Backpack"] = "Mochila"
		...
		L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
			'Verifica equipamentos que deveriam ser fundidos numa única seção "sets". Isso é obviamente uma configuração por personagem'
		L["Check this so armors are dispatched in four sections by type."] =
		...
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			'Marque para mostrar uma seção individual por conjunto de equipamentos. Se desabilitado mostrará uma enorme seção de "sets".'
		L["Check this to display only one value counting all equipped bags, ignoring their type."] =
		...
		L["Check this to show this section. Uncheck to hide it."] =
			"Marque para mostrar essa seção. Desmarque para escondê-la"
		...
		L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] =
			"Põe itens pertencentes a um ou mais sets do gerenciador de equipamentos padrão em seções específicas"
		L["Put items in sections depending on their first-level category at the Auction House."] =
		...
		L["You can block auto-deposit ponctually by pressing a modified key while talking to the banker."] =
			"Você pode bloquear o auto-deposito pressionando a tecla modificada enquanto fala com o banqueiro."
	elseif locale == "itIT" then
		L["AH category"] = "AH categoria"
		L["AH subcategory"] = "AH sottocategoria"
		L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
			"Permette di ridefinire manualmente la sezione in cui dovrebbe essere collocato un oggetto. Semplicemente trascinando un oggetto sul titolo della sezione."
		L["Always"] = "Sempre"
		L["Ammunition"] = "Munizioni"
		L["Anchored"] = "Ancorato"
		L["auto-deposit"] = "auto-deposita"
		L["Automatically open the bags at merchant's, bank, ..."] =
			"Apre automaticamente le borse se parli a un mercante, banchiere, ..."
		...
		L["By category, subcategory, quality and item level (default)"] =
			"Per categoria, sottocategoria, qualità e livello dell'oggetto (predefinito)"
		L["By name"] = "Per nome"
		L["By quality and item level"] = "Per qualità e livello dell'oggetto."
		L["Category"] = "Categoria"
		L["Check this to display a colored border around items, based on item quality."] =
			"Selezionare questa opzione per visualizzare un bordo colorato attorno agli oggetti in base alla qualità dell'oggetto."
		L["Check this to display an icon after usage of each type of bags."] =
			"Selezionare questa opzione per visualizzare un icona dopo l'utilizzo di ogni tipo di borsa."
		L["Check this to display an indicator on quest items."] =
			[=[Selezionare questa opzione per visualizzare un indicatore sugli oggetti di missione.
]=]
		L["Check this to display an textual tag before usage of each type of bags."] =
			"Selezionare questa opzione per visualizzare un'etichetta testuale prima dell'uso di ogni tipo di borsa."
		L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
			'Selezionare questa opzione per visualizzare una sezione separata per ogni collezione. Se disabilitata, ci sarà una sola sezione denominata "Collezioni".'
		L["Check this to show space at your bank in the plugin."] =
			"Spunta questo per mostrare lo spazio nella tua banca nel plugin"
		L["Check to enable this module."] = [=[Selezionare per abilitare questo modulo.
]=]
		L["Click there to reset the bag positions and sizes."] =
			[=[Clicca per ripristinare la posizione e le dimensioni delle borse.
]=]
		L["Click to purchase"] = "Clicca per acquistare"
		L["Click to reset item status."] = "Clicca per resettare lo stato degli oggetti"
		L["Click to select which sections should be shown or hidden. Section visibility is common to all bags."] =
			"Clicca per selezionare quali sezioni mostrare o nascondere. La visibilità è comune a tutte le borse."
		...
		L["Click to toggle the equipped bag panel, so you can change them."] =
			"Clicca per mostare / nascondere il pannello delle borse equipaggiate, in modo da poterle sostituire."
		L["Close"] = [=[Chiudi
]=]
		L["Color"] = "Colore"
		...
		L["Display character money at bottom right of the backpack."] =
			"Mostra i soldi del personaggio in basso a destra nello zaino."
		...
		L[
			...
			"I filtri vengono utilizzati per allocare gli oggetti nelle sezioni delle borse. Un oggetto può comparire solo in una sezione. Se lo stesso oggetto è selezionato da diversi filtri verrà utilizzato il filtro con priorità più alta."
		L["Font"] = "Carattere"
