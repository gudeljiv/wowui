...
if locale == "frFR" then
	...
	L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
		"Vous permet de redéfinir manuellement la section dans laquelle un objet doit être mis. Tirez simplement un objet sur le titre de section."
	...
	L["Enter the name, link or itemid of the item to associate with the section. You can also drop an item into this box."] =
		"Entrez le nom, le lien ou l'identifiant de l'objet à associer à la section. Vous pouvez aussi déposer un objet dans cette boîte."
	...
	L["Please note this filter matchs every item. Any filter with lower priority than this one will have no effect."] =
		"Veuillez notez que ce filtre correspond à tous les objets. Tout filtre avec une priorité plus faible que celle de ce filtre n'aura aucun effet."
	L["Plugins"] = "Plugins"
...
elseif locale == "deDE" then
	...
	L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
		"Erlaubt eine manuelle Neudefinierung eines Bereiches, in dem ein Gegenstand abegelegt werden soll. Ziehe den Gegenstand einfach auf die Sektionsleiste."
	L["Always"] = "Immer"
	L["AMMO_TAG"] = "Mu"
	...
	L["Please note this filter matchs every item. Any filter with lower priority than this one will have no effect."] =
		"Bitte beachten: dieser Filter bezieht sich auf jeden Gegenstand. Alle Filter mit niedriger Priorität als dieser wird keinen Effekt haben."
	L["Plugins"] = "Plugins"
...
elseif locale == "ptBR" then
	...
	L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] =
		"Permite-lhe redefinir manualmente a seção na qual um item deve ser colocado. Basta arrastar o item no título de seleção."
	...
	L["Click on a item to remove it from the list. You can drop an item on the empty slot to add it to the list."] =
		"Clique em um item para removê-lo da lista. Você pode soltar um item num espaço vazio para adicioná-lo a lista"
	...
	L["Enter the name, link or itemid of the item to associate with the section. You can also drop an item into this box."] =
		"Entre com o nome, link ou ID do item para associá-lo com a seção. Você também pode arrastar e soltar o item nesta caixa"
	...
	L["Please note this filter matchs every item. Any filter with lower priority than this one will have no effect."] =
		"Por favor note que este filtro engloba todos os itens. qualquer filtro com menor prioridade não terá efeito algum."
	L["Plugins"] = "Plugins"
