...
TomTomLocals = {
	...
	["Coordinates can be moved from the default location, this setting allows you to control that offset"] = "Coordinates can be slid from the default location, to accomodate other addons.  This setting allows you to control that offset",
