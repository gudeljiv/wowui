...
TomTomLocals = {
	...
	["Resets the position of the waypoint arrow if it has been dragged off screen"] = "重設的路徑點箭頭的位置，如果它被拖離螢幕",
	...
	["TomTom can display a tooltip containing information about waypoints, when they are moused over.  This setting toggles that functionality"] = "當滑鼠指向路徑點時,TomTom 可以顯示包含本路徑點資訊的滑鼠提示. 這個設置可以切換本功能",
	...
	["|cffffff78/way <x> <y> [desc]|r - Adds a waypoint at x,y with description desc"] = "|cffffff78/way <x> <y> [注釋]|r - 於X，Y座標處添加一路徑點並添加注釋描述",
