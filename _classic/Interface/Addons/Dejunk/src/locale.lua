...
L["AUTO_JUNK_FRAME_TOOLTIP"] = "Автоматически переключайте окно Junk при взаимодействии с торговцем."
...
L["GLOBAL"] = "Общие"
L["IMPORT"] = "Импорт"
L["INCLUDE_ARTIFACT_RELICS_TEXT"] = "Включите реликвии артефактов"
...
L["KEYBINDS"] = "按键绑定"
L["LEFT_CLICK"] = "点击左键"
L["LIST_FRAME_SWITCH_BUTTON_TEXT"] = "切换视图"
L["LIST_FRAME_SWITCH_BUTTON_TOOLTIP"] = "显示%s列表。"
