...
function LuaUtils:DrawMarkDugi(texture, canvasFrame, startX, startY, endX, endY, markSize, textureOffset)
    ...
    texture:SetRotation(math.atan2(dy / lineLength, dx / lineLength) + 3.14159)
...
LuaUtils.UIFrameCache = CreateFrame("FRAME");
local caches = {};
function LuaUtils.UIFrameCache:New (frameType, baseName, parent, template)
	if ( self ~= LuaUtils.UIFrameCache ) then
...
function LuaUtils.UIFrameCache:GetFrame ()
...
function LuaUtils.UIFrameCache:ReleaseFrame(frame)
