...
L["/wa pprint - Show the results from the most recent profiling"] = "/wa pprint - 가장 최근의 분석 결과 표시"
L["/wa pstart - Start profiling. Optionally include a duration in seconds after which profiling automatically stops. To profile the next combat/encounter, pass a \"combat\" or \"encounter\" argument."] = "/wa pstart - 분석을 시작합니다. 분석이 자동으로 중지되는 시간(초)을 옵션으로 넣을 수 있습니다. 다음 전투(combat)/보스 전투(encounter)때 분석하려면 인수로 \"combat\"이나 \"encounter\"를 넣으면 됩니다."
L["/wa pstop - Finish profiling"] = "/wa pstop - 분석 종료"
...
L["|cffeda55fRight-Click|r to toggle performance profiling window."] = "|cffeda55f우클릭|r으로 성능 분석 창을 켜고 끕니다."
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[당신의 위크오라와 WeakAuras 시스템의 상세 개요
도움이 필요할 경우 이 텍스트를 모두 복사해서 WeakAura의 디스코드로 가져오세요.]=]
...
참고: 이 활성 조건은 BigWigs나 DBM을 사용하며 둘 다 설치했을 경우 BigWigs를 사용합니다.]=]
L["Add"] = "추가"
L["Add Missing Auras"] = "빠진 위크오라 추가"
L["Additional Trigger Replacements"] = "추가 활성 조건 대체 코드"
...
L["All States table contains a non table at key: '%s'."] = "올 스테이트 테이블의 키에 테이블이 아닌 것을 포함하고 있습니다: '%s'."
...
L["Can be used for e.g. checking if \"boss1target\" is the same as \"player\"."] = "예를 들어 \"boss1target\"이 \"player\"와 같은지 확인하는데 사용할 수 있습니다."
L["Cancel"] = "취소"
L[ [=[Cannot change secure frame in combat lockdown. Find more information:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] = [=[전투중에는 보안 프레임을 변경할 수 없습니다. 자세한 정보:
...
L["Capped"] = "한계치 도달"
L["Capped at Season Max"] = "시즌 최대 한계치 도달"
L["Capped at Weekly Max"] = "주간 최대 한계치 도달"
L["Cast"] = "시전"
L["Cast Bar"] = "시전바"
L["Cast Failed"] = "시전 실패"
L["Cast Start"] = "시전 시작"
...
L["Character Stats"] = "캐릭터 스탯"
L["Character Type"] = "캐릭터 유형"
L["Charge gained/lost"] = "충전량 획득/손실"
L["Charged Combo Point (1)"] = "충전된 연계 점수 (1)"
L["Charged Combo Point (2)"] = "충전된 연계 점수 (2)"
L["Charged Combo Point (3)"] = "충전된 연계 점수 (3)"
L["Charged Combo Point (4)"] = "충전된 연계 점수 (4)"
L["Charged Combo Point 1"] = "충전된 연계 점수 1"
L["Charged Combo Point 2"] = "충전된 연계 점수 2"
L["Charged Combo Point 3"] = "충전된 연계 점수 3"
L["Charged Combo Point 4"] = "충전된 연계 점수 4"
...
L["Cooldown Progress (Slot)"] = "쿨타임 진행 상황 (장비 슬롯)"
L["Cooldown Ready Event"] = "쿨타임 준비 이벤트"
L["Cooldown Ready Event (Item)"] = "쿨타임 준비 이벤트 (아이템)"
L["Cooldown Ready Event (Slot)"] = "쿨타임 준비 이벤트 (장비 슬롯)"
L["Cooldown Reduction changes the duration of seconds instead of showing the real time seconds."] = "쿨타임 시간 축소는 실제 초를 표시하지 않고 초의 지속시간을 바꿉니다."
...
L["Currency"] = "화폐"
L["Current Combo Point charged"] = "현재 충전된 연계 점수"
L["Current Essence"] = "현재 정수"
L["Current Experience"] = "현재 경험치"
L["Current Instance"] = "현재 있는 인스턴스"
L["Current Movement Speed (%)"] = "현재 이동 속도 (%)"
L["Current Stage"] = "현재 단계"
L["Current Zone"] = "현재 있는 지역"
L["Current Zone Group"] = "현재 있는 지역 그룹"
L["Curse"] = "저주"
L["Custom"] = "사용자 정의"
...
L["Destination unit's raid mark texture"] = "대상자 유닛의 공격대 징표 텍스쳐"
L["Difficulty"] = "난이도"
...
L["Drain"] = "마력 소진"
L["Dreamscythe and Weaver"] = "드림사이드와 위버"
...
L["Duration Function (fallback state)"] = "지속시간 함수 (폴백 스테이트)"
L["Ease In"] = "시작시 지연"
...
L["Empower Cast Interrupt"] = "강화 시전 방해받음"
L["Empower Cast Start"] = "강화 시전 시작"
L["Empowered"] = "강화 시전 완료"
...
L["Empowered Cast Fully Charged"] = "강화 시전 완료 완전 충전"
L["Empowered Fully Charged"] = "강화 시전 완료 완전 충전"
L["Empty"] = "비었을 때"
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] = [=['%s' 오류가 보호 대상 복제품을 생성했습니다. 이 위크오라는 삭제할 것을 권장합니다. 자세한 정보:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
...
L["Festering Rotslime"] = "곪아가는 부식수액"
L["Fetch Absorb"] = "흡수량 가져오기"
L["Fetch Heal Absorb"] = "치유 흡수 가져오기"
...
L["Forward"] = "앞으로"
L["Forward, Reverse Loop"] = "앞으로 뒤로 반복"
...
L["GetNameAndIcon Function (fallback state)"] = "GetNameAndIcon 함수 (폴백 스테이트)"
L["Ghamoo-ra"] = "가무라"
L["Glancing"] = "빗맞음"
...
L["Icon Function (fallback state)"] = "아이콘 함수 (폴백 스테이트)"
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/weakauras!"] = "더 많은 도움이 필요하다면 GitHub에서 티켓을 열거나 저희 디스코드 https://discord.gg/weakauras를 방문해 주세요!"
L["Ignore Dead"] = "죽음 무시"
...
L["Increase Precision Below"] = "아래보다 적으면 정밀도 증가"
...
L["Is Away from Keyboard"] = "자리비움 상태일 때"
L["Is Current Specialization"] = "현재 전문화일 때"
L["Is Death Rune"] = "죽음 룬일 때"
L["Is Exactly"] = "정확할 때"
L["Is Moving"] = "이동 중일 때"
L["Is Off Hand"] = "보조장비 착용시"
L["Is Paragon Reputation"] = "불멸의 동맹 평판일 때"
L["Is Paused"] = "휴식 상태일 때"
L["is useable"] = "사용 가능할 때"
L["Is Weekly Renown Capped"] = "주간 영예 한계치일 때"
...
L["Lua error"] = "Lua 오류"
L["Lua error in aura '%s': %s"] = "'%s' 오라에 Lua 오류 발생: %s"
L["Lucifron"] = "루시프론"
L["Maexxna"] = "맥스나"
L["Magic"] = "마법"
L["Magmadar"] = "마그마다르"
...
L["Name Function (fallback state)"] = "이름 함수 (폴백 스테이트)"
...
L["Names of unaffected Players"] = "오라에 걸리지 않은 플레이어 이름"
...
L["Note: Due to how complicated the swing timer behavior is and the lack of APIs from Blizzard, results are inaccurate in edge cases."] = "참고: 근접 평타 타이머의 동작 방식이 복잡하고 Blizzard API도 없기 때문에 극단적인 경우 타이머가 안맞을 수도 있습니다."
...
Works only if Boss Mod addon show counter]=] ] = [=[이벤트의 발동
값의 범위를 정할 수 있습니다
...
Only if BigWigs shows it on it's bar]=] ] = [=[위크오라를 불러오지 않았을땐 이 이벤트의 발동은 초기화 됩니다
값의 범위를 정할 수 있습니다
쉼표나 공백으로 구분해서 여러 값을 가질 수 있습니다
...
Only if DBM shows it on it's bar]=] ] = [=[위크오라를 불러오지 않았을땐 이 이벤트의 발동은 초기화 됩니다
값의 범위를 정할 수 있습니다
쉼표나 공백으로 구분해서 여러 값을 가질 수 있습니다
...
L["On Taxi"] = "그리핀/와이번 탑승 중"
L["Only if on a different realm"] = "다른 서버일때만"
...
L["Player Effective Level"] = "플레이어 실질 레벨"
...
L["Player(s) Affected"] = "플레이어가 오라에 걸림"
L["Player(s) Not Affected"] = "플레이어가 오라에 걸리지 않음"
L["Player/Unit Info"] = "플레이어/유닛 정보"
L["Players and Pets"] = "플레이어와 소환수"
L["Poison"] = "독"
L["Power"] = "자원"
L["Power (%)"] = "자원 (%)"
L["Power Deficit"] = "잃은 기력"
L["Power Type"] = "자원 종류"
L["Precision"] = "정밀도"
L["Preset"] = "프리셋"
...
L["Rune #6"] = "룬 #6"
L["Rune Count"] = "룬 갯수"
L["Rune Count - Blood"] = "룬 갯수 - 혈기"
L["Rune Count - Frost"] = "룬 갯수 - 냉기"
L["Rune Count - Unholy"] = "룬 갯수 - 부정"
L["Sapphiron"] = "사피론"
L["Say"] = "일반 대화"
L["Scale"] = "크기 비율"
L["Scenario"] = "시나리오"
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] = [=[보안 프레임을 감지했습니다. 자세한 정보:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
...
L["Show charged duration for empowered casts"] = "강화 시전시 충전 시간 표시"
...
L["Show On"] = "표시 조건"
L["Show Override"] = "정신지배 상태 표시"
L["Show Override Spell"] = "정신지배 주문 표시"
...
L["Source unit's raid mark texture"] = "행위자 유닛의 공격대 징표 텍스쳐"
L["Space"] = "공간"
L["Spacing"] = "간격"
L["Spark"] = "섬광"
L["Spec Position"] = "전문화 활동위치"
L["Spec Role"] = "전문화 역할"
...
L["Stacks Function (fallback state)"] = "중첩 함수 (폴백 스테이트)"
L["Stage"] = "단계"
L["Stage Counter"] = "단계 카운터"
L["Stagger (%)"] = "시간차 (%)"
L["Stagger against Target (%)"] = "대상에 대한 시간차 (%)"
L["Stagger Scale"] = "시간차 스케일"
L["Stamina"] = "체력"
...
L["Subtract Cast"] = "시전시간 빼기"
L["Subtract Channel"] = "정신 집중 지속시간 빼기"
L["Subtract GCD"] = "전역 대사용 대기시간 빼기"
...
L["Supports multiple entries, separated by commas. Escape ',' with \\"] = "여러 항목을 지원하며 쉼표로 구분합니다. \\로 ',' 이스케이프"
...
Supports Instance IDs prefixed with 'i'.]=] ] = [=[여러 항목을 지원하며 쉼표로 구분해서 입력 가능합니다. 하위 지역 id를 포함하려면 접두사 'c'를 넣으면 됩니다. 예: 'c2022'
그룹 지역 ID에는 반드시 'g' 접두사가 와야합니다 예: 'g277'
지역(Area) ID를 지원합니다. https://wago.tools/db2/AreaTable에서 확인 가능하며 'a' 접두사를 넣어야 합니다.
인스턴스 ID를 지원하며 'i' 접두사입니다.]=]
L["Swing"] = "근접 평타"
...
L["Text-to-speech"] = "텍스트 음성 변환"
L["Texture"] = "텍스쳐"
L["Texture Function"] = "텍스쳐 함수"
L["Texture Function (fallback state)"] = "텍스쳐 함수 (폴백 스테이트)"
L["Texture Picker"] = "텍스쳐 선택"
L["Texture Rotation"] = "텍스쳐 회전"
L["Thaddius"] = "타디우스"
L["The aura has overwritten the global '%s', this might affect other auras."] = "이 위크오라가 전역 '%s'|1을;를; 덮어썼습니다. 다른 위크오라들도 같이 적용됩니다."
L["The effective level differs from the level in e.g. Time Walking dungeons."] = "실질 레벨은 예를 들면 시간여행 던전에서 적용된 레벨과는 다른 것입니다."
...
L["The trigger number is optional, and uses the trigger providing dynamic information if not specified."] = "활성 조건 번호는 선택 사항이며, 지정되지 않은 경우 동적 정보를 제공하는 활성 조건을 사용합니다."
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the WeakAuras Discord server for help."] = "이 필터는 위치 활성 조건으로 이전됐습니다. 새로운 위치 활성 조건을 사용하려면 위크오라를 수정하십시오. 도움이 필요하다면 WeakAuras Discord 서버로 들어오세요."
...
L["Time"] = "시간"
L["Time Format"] = "시간 형식"
L["Time in GCDs"] = "전역 재사용 대기시간 내 시간"
...
L["Track Cooldowns"] = "쿨기 추적"
L["Tracking Charge %i"] = "%i 충전 추적"
L["Tracking Charge CDs"] = "충전 재사용 대기시간 추적"
L["Tracking Only Cooldown"] = "쿨기만 추적"
L["Transmission error"] = "전송 오류"
L["Treat charged combo point as 7 combo points"] = "충전 가능한 연계 점수를 7개로 늘림"
L["Trigger"] = "활성 조건"
L["Trigger %i"] = "활성 조건 %i"
L["Trigger %s"] = "활성 조건 %s"
L["Trigger 1"] = "활성 조건 1"
L["Trigger State Updater (Advanced)"] = "활성 조건 스테이트 업데이터 (고급)"
...
L["Units Affected"] = "유닛이 오라에 걸림"
L["Units of affected Players in a table format"] = "테이블 형식 내 오라에 걸린 플레이어 유닛들"
L["Units of unaffected Players in a table format"] = "테이블 형식 내 오라에 걸리지 않은 플레이어 유닛들"
...
L["Warning: Anchoring to your own child '%s' in aura '%s' is imposssible."] = "경고: '%2$s' 위크오라 내 하위 개체 '%1$s'에 붙이는 것은 불가능합니다."
L["Warning: Full Scan auras checking for both name and spell id can't be converted."] = "경고: 이름과 주문 ID 모두 검사하는 완전한 오라 검사 기능은 변환되지 않습니다."
...
L["WeakAuras has encountered an error during the login process. Please report this issue at https://github.com/WeakAuras/Weakauras2/issues/new."] = "로그인 과정 중 WeakAuras에 오류가 발생했습니다. 이 문제를 https://github.com/WeakAuras/Weakauras2/issues/new에 제보해주세요."
...
L["Your total threat on the mob."] = "이 몹에 대한 당신의 총 위협 수준입니다."
