...
L["Absorb"] = "吸收量"
L["Absorb Heal Overlay"] = "吸收治療塗層"
L["Absorb Overlay"] = "吸收塗層"
L["Absorbed"] = "已吸收量"
...
L["Alive"] = "存活"
L["All"] = "全部"
L["All children of this aura will also not be loaded, to minimize the chance of further corruption."] = "所有此光環的子項不會被載入，以盡量減少進一步損壞的機會。"
...
L["Aura is using deprecated SetDurationInfo"] = "光環正在使用已棄置的SetDurationInfo"
...
L["Bar Color/Gradient Start"] = "條顏色/漸變開始"
...
L["C'thun"] = "克蘇恩"
L["Currency"] = "兌換通貨"
L["Current Combo Point charged"] = "當前連擊點已充能"
...
L["Form"] = "形態"
L["Format"] = "格式"
L["Formats |cFFFFCC00%unit|r"] = "格式 |cFFFFCC00%unit|r"
...
L["Swing Timer"] = "揮擊計時條"
L["Swipe"] = "轉圈"
L["Syntax /wa feature <toggle|on|enable|disable|off> <feature>"] = "Syntax /wa 功能 <切換|on|啟用|停用|off> <功能>"
L["System"] = "系統"
L["Tab "] = "標籤頁面"
L["Talent"] = "天賦"
...
L["Treat charged combo point as 7 combo points"] = "充能連擊點視為7連擊點"
...
L["Twilight Lord Kelris"] = "暮光領主凱里斯"
L["Twin Emperors"] = "雙子皇帝"
L["Type"] = "類型"
L["Ulduar"] = "奧杜亞"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to the WeakAuras team."] = "無法制度化光環 '%s'。這可能是由於資料損壞或遷移錯誤造成的，請將此問題報告給 WeakAuras 團隊。"
L["Unaffected"] = "未受影響"
L["Undefined"] = "未定義"
L["Unholy"] = "穢邪"
