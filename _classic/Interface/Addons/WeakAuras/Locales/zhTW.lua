...
L["Supports multiple entries, separated by commas. Group Zone IDs must be prefixed with 'g', e.g. g277. Supports Area IDs from https://wago.tools/db2/AreaTable prefixed with 'a'. Supports Instance IDs prefixed with 'i'."] = "支援輸入多個項目，使用逗號分隔。群組區域 ID 必須以 'g' 開頭，例如 g277。支援的區域 ID (來自 https://wago.tools/db2/AreaTable) 以 'a' 開頭。支援的副本 ID 以 'i' 開頭。"
L["Swing"] = "揮動"
L["Swing Timer"] = "揮擊計時條"
L["Swipe"] = "轉圈"
L["System"] = "系統"
