...
L["Error in aura '%s' in %s. trigger. All States table contains a non table at key: '%s'."] = "提醒效果 '%s' 的 %s 觸發發生錯誤。所有狀態表格在 key: '%s' 包含非表格的值。"
...
L["Note: Due to how complicated the swing timer behaviour is and the lack of APIs from Blizzard, results are inaccurate in edge cases."] = "注意：由於普攻計時器行為的複雜性以及缺乏暴雪API，結果在邊緣情況下是不準確的。"
...
L["This aura tried to show a tooltip on a anchoring restricted region"] = "此光環試圖在定位限制區域上顯示工具提示"
...
L["This import requires a newer WeakAuras version."] = "此次匯入需要較新版本的 WeakAuras。"
