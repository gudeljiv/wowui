...
TOCA.Button.TotemicCall.highlight= TOCA.Button.TotemicCall:CreateTexture(nil, "ARTWORK")
...
for totemCat,v in pairsByKeys(TOCA.totems) do
  ...
  TOCA.Slot.highlight[totemCat]:Hide()
	TOCA.Slot.Radius[totemCat]= TOCA.Slot[totemCat]:CreateTexture(nil, "ARTWORK")
	...
	TOCA.Slot.Radius.Border[totemCat] = TOCA.Slot[totemCat]:CreateTexture(nil, "ARTWORK")
...
for totemCat,v in pairsByKeys(TOCA.totems) do
  ...
  for i,totemSpell in pairs(TOCA.totems[totemCat]) do
    ...
    TOCA.SlotGrid.VerticalTotemButton[totemCat][i].action.highlight= TOCA.SlotGrid.VerticalTotemButton[totemCat][i]:CreateTexture(nil, "ARTWORK")
    ...
    TOCA.SlotGrid.HorizontalTotemButton[totemCat][i].action.highlight= TOCA.SlotGrid.HorizontalTotemButton[totemCat][i]:CreateTexture(nil, "ARTWORK")
