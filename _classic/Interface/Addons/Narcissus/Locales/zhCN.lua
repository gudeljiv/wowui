...
NARCI_CLASSIC_NOT_AVAILABLE = "|cffff5050暂时在怀旧服中不可用|r";
...
L["Item ID"] = "物品ID";
L["Paperdoll"] = "角色面板";
L["Equipment Manager Description"] = "保存装备方案来快速切换装备。";
...
L["Cannot Unequip Combat"] = "不能在战斗中改变装备状态";
L["Equipment Gesture Use"] = "双击使用";
L["Equipment Gesture Edit"] = "右键编辑";
L["Equipment Gesture Create"] = "点击创建";
L["Equipment Overwrite"] = "覆盖";
L["Equipment Overwrite Items"] = "覆盖方案";
L["Equipment Overwrite Tooltip"] = "按住左键以使用当前装备覆盖方案";
L["Equipment Overwrite Same"] = "装备没有变化";
L["Equipment Delete Set"] = "删除";
L["Equipment Delete Tooltip"] = "按住左键以删除此装备方案";
L["Equipment Save Name"] = "保存名称和图标";
L["Item Switching In Progress"] = "弹药切换中...";
...
L["Look Saved"] = "已保存";
L["Cannot Save Forms"] = "不支持保存形态";
L["Profiles"] = "存档管理";
L["Save Notify"] = "提示你保存新外观";
L["Save Notify Tooltip"] = "在你应用新外观后提示你是否要保存此方案。";
...
L["Import"] = "导入";
L["Paste Here"] = "粘贴到此处";
L["Press To Copy"] = "按下 |cffcccccc".. NARCI_SHORTCUTS_COPY.."|r 复制";
L["String Copied"] = NARCI_COLOR_GREEN_MILD.. "已复制";
L["Failure Reason Unknown"] = "未知错误";
L["Failure Reason Decode"] = "解码失败";
L["Failure Reason Wrong Character"] = "当前角色的种族/性别/形态与导入的数据不匹配。";
L["Failure Reason Dragonriding"] = "This profile is for Dragonriding.";
L["Wrong Character Format"] = "需要 %s %s."; --e.g. Rquires Male Human
L["Import Lack Option"] = "%d个类别缺失";
L["Import Lack Choice"] = "%d个选项缺失";
L["Decode Good"] = "解码成功";
L["Barbershop Export Tooltip"] = "将当前人物形象转换为一串可供分享的字符。\n你可以修改冒号(:)左侧的文字。";
...
L["Weapon Browser Specify Hand"] = "|cffffd100"..NARCI_MODIFIER_CONTROL.." + 左键|r将物品放入主手\n|cffffd100"..NARCI_MODIFIER_ALT.." + 左键|r 将物品放入副手";

--Pet Stables--
L["PetStable Tooltip"] = "从兽栏中选择宠物。";
L["PetStable Loading"] = "正在获取宠物信息";
L["PetStable Alert NoData"] = "访问兽栏管理员以获取宠物数据";
