...
function NarciUIColorPickerMixin:Preload()
    ...
    for i = 1, numBlocks do
        ...
        SetGradientTexture(gt, "HORIZONTAL", colors[i][1], colors[i][2], colors[i][3],  colors[i+1][1], colors[i+1][2], colors[i+1][3]);
    end
    ...
    SetGradientTexture(gt2, "HORIZONTAL", 1, 1, 1, 1, 0, 0);
    ...
    SetGradientTexture(gt3, "HORIZONTAL", 0, 0, 0, 1, 0, 0);
...
function NarciUIColorPickerMixin:Update()
    ...
    SetGradientTexture(self.SaturationSlider.Gradient, "HORIZONTAL", v, v, v, r, g, b);
    r, g, b = HSV2RGB(h, s, 1);
    SetGradientTexture(self.BrightnessSlider.Gradient, "HORIZONTAL", 0, 0, 0, r, g, b);
