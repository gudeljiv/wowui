...
function NarciEquipmentEnchantActionButtonMixin:InitFromButton(button, slotID, inUseEnchantID)
    ...
    local inUseEnchant =  NarciAPI.GetEnchantTextBySlot(slotID);
    if inUseEnchant then
        ...
        self.Header:SetTextColor(1, 0.3137, 0.3137);
    else
        self.Header:SetText(L["Click To Apply"]);
...
function NarciEquipmentEnchantActionButtonMixin:PreClick(button)
