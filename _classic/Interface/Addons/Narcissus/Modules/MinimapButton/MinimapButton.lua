...
function NarciMinimapButtonMixin:ShowSimpleTooltip()
	local tooltip = GameTooltip;
	tooltip:SetOwner(self, "ANCHOR_NONE");
	tooltip:SetPoint("TOPRIGHT", self, "BOTTOM", 0, 0);
	--tooltip:SetText(NARCI_GRADIENT);
	tooltip:AddDoubleLine(NARCI_GRADIENT, NARCI_VERSION_INFO, 1, 1, 1, 0.5, 0.5, 0.5);
	...
	tooltip:AddLine(LeftClickText.." |cffffffff"..CHARACTER_INFO.."|r", nil, nil, nil, false);
	tooltip:AddLine(L["Minimap Tooltip Right Click"].." |cffffffff"..L["Photo Mode"].."|r", nil, nil, nil, false);
...
function NarciMinimapButtonMixin:Init()
    local iconSize = 32;	--Reduced size for Classic due to small minimap
