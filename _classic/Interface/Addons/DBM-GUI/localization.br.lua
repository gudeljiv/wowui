...
L.LogCurrentMythicRaids 			= "Raides míticas atuales" -- Retail Only
L.LogCurrentRaids 					= "Raides atuales"
L.LogTWRaids 						= "Raides de Caminhada Temporal ou Tempo de Crona" -- Retail Only
L.LogTrivialRaids 					= "Raides triviais (de baixo nível)"
L.LogCurrentMPlus 					= "Masmorras atuales M+" -- Retail Only
L.LogCurrentMythicZero 				= "Masmorras atuales Míticas 0" -- Retail Only
L.LogTWDungeons 					= "Masmorras de Caminhada Temporal ou Tempo de Crona" -- Retail Only
L.LogCurrentHeroic 					= "Masmorras heroicas atuales"
L.LogDelves							= "Imersões atuales"--Retail Only
L.LogChallenges						= "Desafios especiais atuales"--Retail Only
...
L.ShowRespawn 				= "Exibir o cronômetro de reaparência do chefe após uma derrota"
L.ShowQueuePop 				= "Exibir o tempo restante para aceitar um pop de fila (Procurando grupo, CB, etc)"
L.ShowBerserkWarnings 		= "Exibir anúncios a 10/5/3/1 minutos e a 30/10 segundos restantes no cronômetro de $spell:26662"
...
L.Warn_Duration				= "Duração: %0.1f seg"
L.None						= "Nenhum"
L.Outline					= "Contorno"
...
L.ShortTextSpellname 				= "Usar texto abreviado quando possível"
...
L.SpecWarn_FlashDur 				= "Duração: %0.1f seg"
L.SpecWarn_FlashAlpha 				= "Transparência: %0.1f"
L.SpecWarn_DemoButton 				= "Exibir exemplo"
L.SpecWarn_ResetMe 					= "Redefinir padrões"
L.SpecialWarnSoundOption 			= "Som padrão"
...
L.VarianceColor				= "Cor de variação"
L.VarianceTransparency		= "Transparência das barras: %0.1f"
L.VarianceTimerTextBehavior = "Comportamento do texto"
...
L.ReplacesAnnounce 			= "Substituir os sons de anúncio"
L.ReplacesSADefault 		= "Substituir os sons padrão de anúncio especial"
...
L.EventVictorySound 			= "Som para vitória"
L.EventWipeSound 				= "Som para derrota"
L.EventEngagePT 				= "Som para o início do cronômetro de puxada"
L.EventEngageSound 				= "Som para o início"
...
L.PT_Threshold				= "Não reproduzir o áudio do cronômetro acima de: %d"

-- Panel: Reduce Information
L.Panel_ReducedInformation 			= "Reduzir informações"

L.Area_SpamFilter_Anounces 			= "Filtros de anúncios"
L.SpamBlockNoShowTgtAnnounce 		= "Não exibir texto nem reproduzir som para anúncios gerais de ALVO que não afetam você, exceto onde indicado que um anúncio específico ignora este filtro"
L.SpamBlockNoTrivialSpecWarnSound 	= "Não reproduzir sons de anúncio especial nem exibir piscada de tela para conteúdo trivial para o seu nível"
...
L.FilterVoidFormSay2 				= "Não enviar ícone de bate-papo nem gritos de contagem regressiva no bate-papo quando estiver na forma do vazio"
...
L.FilterTrashWarnings 				= "Filtrar todos os anúncios de lixos em masmorras de seguidor, normais e triviais"
...
L.FontTypeTimer 			= "Selecionar fonte do cronômetro"
...
L.Area_AutoLogging			= "Opções de registro automático"
L.AutologBosses 			= "Registrar encontros automaticamente com o registro de combate de Blizzard"
L.AdvancedAutologBosses 	= "Registrar encontros automaticamente com Transcriptor"
...
L.DualProfile				= "Ativar suporte para outros mods de chefes de acordo com a especialização"
