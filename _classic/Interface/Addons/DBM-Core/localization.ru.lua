...
L.NOTEFOOTER						= "Нажмите 'ОК', чтобы применить изменения или 'Отмена', чтобы отменить их"
...
L.TIMER_FORMAT_MINS					= "%d |4минута:минуты:минут;"
L.TIMER_FORMAT						= "%d |4минута:минуты:минут; и %.2f |4секунда:секунды:секунд;"
...
L.VERSIONCHECK_FOOTER				= "Найдено %d игроков с " .. L.DBM .. " и %d игроков с Bigwigs"
L.VERSIONCHECK_OUTDATED				= "Следующие %d игроки имеют устаревшую версию Boss Mod: %s"
...
L.TIMER_USAGE = {
	...
	"Добавьте 'broadcast' перед 'timer' или 'ltimer', чтобы поделиться им с рейдом (требуются права лидера или помощника).",
...
L.AUTO_ANNOUNCE_TEXTS.stack 		= "%s на >%%s< (%%d)"
...
L.AUTO_SPEC_WARN_TEXTS.dispel 			= "%s на >%%s< - рассейте заклинание"
...
L.AUTO_SPEC_WARN_TEXTS.target 			= "%s на (>%%s<)"
...
L.AUTO_SPEC_WARN_TEXTS.reflect 			= "%s на >%%s< - прекратите атаку"
...
L.AUTO_SPEC_WARN_OPTIONS.sooncount		= "Спецпредупреждение, что скоро $spell:%s (со счётчиком)"
L.AUTO_SPEC_WARN_OPTIONS.bait			= "Спецпредупреждение, что скоро $spell:%s (для байта)"
...
L.AUTO_SPEC_WARN_OPTIONS.link			= "Спецпредупреждение, когда Вы связаны с другим игроком с помощью $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.defensive 		= "Спецпредупреждение для использования защитных способностей от $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.taunt 			= "Спецпредупреждение \"затаунти\" (если текущая специализация танка), когда на другом танке $spell:%s"
...
L.AUTO_TIMER_OPTIONS.castpnp 		= "Приоритетный отсчёт времени применения заклинания $spell:%s (только индикаторы здоровья)"
...
L.AUTO_TIMER_OPTIONS.cdnp 			= "Отсчёт времени до восстановления $spell:%s (только индикаторы здоровья)"
L.AUTO_TIMER_OPTIONS.cdpnp			= "Приоритетный отсчёт времени до восстановления $spell:%s (только индикаторы здоровья)"
...
L.AUTO_TIMER_OPTIONS.nextnp 		= "Отсчёт времени до следующего $spell:%s (только индикаторы здоровья)"
L.AUTO_TIMER_OPTIONS.nextpnp 		= "Приоритетный отсчёт времени до следующего $spell:%s (только индикаторы здоровья)"
...
L.AUTO_TIMER_OPTIONS.roleplay		= "Показывать таймер продолжительности ролевой игры"
...
L.AUTO_ICONS_OPTION_TARGETS_TOH			= "Устанавливать метки на цели $spell:%s с приоритетом танка над ближним боем и дальним, над целителем и рейдового состава"
...
L.AUTO_YELL_OPTION_TEXT.combo		= "Кричать (с пользовательским текстом), когда на Вас $spell:%s и другие заклинания"
...
L.AUTO_YELL_ANNOUNCE_TEXT.iconfadenoicon	= "%%1$d"
L.AUTO_YELL_ANNOUNCE_TEXT.position 	= "%s %%s на {rt%%d}"..UnitName("player").."{rt%%d}"
L.AUTO_YELL_ANNOUNCE_TEXT.positionnoIcon 	= "%s %%s на " ..UnitName("player")
L.AUTO_YELL_ANNOUNCE_TEXT.shortposition 	= "{rt%%1$d}%s"
L.AUTO_YELL_ANNOUNCE_TEXT.shortpositionnoicon 	= "%s"
...
L.AUTO_YELL_ANNOUNCE_TEXT.icontarget	= "{rt%%1$d}{rt%%1$d}{rt%%1$d}"

L.AUTO_YELL_CUSTOM_POSITION				= "{rt%d}%s"--Перевод не требуется
L.AUTO_YELL_CUSTOM_FADE				= "%s спал"
L.AUTO_HUD_OPTION_TEXT				= "Показывать HudMap для $spell:%s (удалено)"
L.AUTO_HUD_OPTION_TEXT_MULTI		= "Показывать HudMap для различных механик (удалено)"
...
L.HUD_SUCCESS						= "HUD успешно запущен с Вашими параметрами. Он будет отключён через %s или с помощью '/dbm hud hide'."
L.HUD_USAGE	= {
...
L.DBM_INSTALL_PACKAGE_VANILLA	= "Модуль 'Классика и Сезон Открытий'"
L.DBM_INSTALL_PACKAGE_BCC		= "Модуль 'Burning Crusade'"
