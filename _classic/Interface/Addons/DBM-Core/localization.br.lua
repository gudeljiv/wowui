...
L.SCENARIO_COMPLETE_I				= "%s completado! Você tem %d |4vitória:vitórias; no total."
L.SCENARIO_COMPLETE_L				= "%s completado após %s! A sua ultima vitória demorou %s e a mais rápida %s. Você tem %d |4vitória:vitórias; no total."
L.SCENARIO_COMPLETE_NR				= "%s completado após %s! Esse é o seu novo recorde! (Ultimo recorde era %s). Você tem %d |4vitória:vitórias; no total."
L.COMBAT_ENDED_AT					= "Combate contra %s (%s) encerrado após %s." -- Health included
L.COMBAT_ENDED						= "Combate contra %s encerrado após %s." -- No health (post midnight)
L.COMBAT_ENDED_AT_LONG				= "Combate contra %s (%s) encerrado após %s. Você tem um total de %d |4derrota:derrotas; nessa dificuldade." -- Health included
L.COMBAT_ENDED_LONG					= "Combate contra %s encerrado após %s. Você tem um total de %d |4derrota:derrotas; nessa dificuldade." -- No health (post midnight)
L.GUILD_COMBAT_ENDED_AT				= "Guilda foi derrotada por %s (%s) após %s."
L.GUILD_COMBAT_ENDED				= "Guilda foi derrotada por %s após %s."
L.SCENARIO_ENDED_AT					= "%s finalizado após %s."
L.SCENARIO_ENDED_AT_LONG			= "%s finalizado após %s. Você tem %d |4vitória:vitórias; parciais nessa dificuldade."
L.COMBAT_STATE_RECOVERED			= "Luta contra %s começou %s atrás, reajustando cronômetros..."
L.TRANSCRIPTOR_LOG_START			= "Gravação do Transcriptor começou."
L.TRANSCRIPTOR_LOG_END				= "Gravação do Transcriptor finalizado."
...
L.ANNOUNCE_PULL						= "Puxando em %d |4segundo:segundos; (Enviado por %s)"
L.ANNOUNCE_PULL_NOW					= "Puxando agora!"
L.ANNOUNCE_PULL_TARGET				= "Puxando %s em %d |4segundo:segundos; (Enviado por %s)"
