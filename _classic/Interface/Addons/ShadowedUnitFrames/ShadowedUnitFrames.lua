...
ShadowUF.fakeUnits = {
	...
	['battlegroundtarget'] = true,
	['partytargettarget'] = true,
	['battlegroundtargettarget'] = true,
...
L.units = {
	...
	['PET'] = L['Pet'],
	['arena'] = L['Arena'],
	['arenapet'] = L['Arena Pet'],
	['arenatarget'] = L['Arena Target'],
	['arenatargettarget'] = L['Arena Target of Target'],
	['boss'] = L['Boss'],
	['bosstarget'] = L['Boss Target'],
	['focus'] = L['Focus'],
	['focustarget'] = L['Focus Target'],
	['mainassist'] = L['Main Assist'],
	['mainassisttarget'] = L['Main Assist Target'],
	['maintank'] = L['Main Tank'],
	['maintanktarget'] = L['Main Tank Target'],
	['party'] = L['Party'],
	['partypet'] = L['Party Pet'],
	['partytarget'] = L['Party Target'],
	['pet'] = L['Pet'],
	...
	['battlegroundpet'] = L['Battleground Pet'],
	['battlegroundtarget'] = L['Battleground Target'],
	['partytargettarget'] = L['Party Target of Target'],
	['battlegroundtargettarget'] = L['Battleground Target of Target'],
	['maintanktargettarget'] = L['Main Tank Target of Target'],
	['mainassisttargettarget'] = L['Main Assist Target of Target'],
	['bosstargettarget'] = L['Boss Target of Target']
}
L.shortUnits = {
	['battleground'] = L['BG'],
	['battlegroundtarget'] = L['BG Target'],
	['battlegroundpet'] = L['BG Pet'],
	['battlegroundtargettarget'] = L['BG ToT'],
	['arenatargettarget'] = L['Arena ToT'],
	['partytargettarget'] = L['Party ToT'],
	['bosstargettarget'] = L['Boss ToT'],
	['maintanktargettarget'] = L['MT ToT'],
	['mainassisttargettarget'] = L['MA ToT']
}
...
for i = 1, MAX_PARTY_MEMBERS do
	ShadowUF.partyUnits[i] = 'party' .. i
end
for i = 1, MAX_RAID_MEMBERS do
	ShadowUF.raidUnits[i] = 'raid' .. i
end
for i = 1, MAX_RAID_MEMBERS do
	ShadowUF.raidPetUnits[i] = 'raidpet' .. i
end
for i = 1, MAX_BOSS_FRAMES do
	ShadowUF.bossUnits[i] = 'boss' .. i
end
for i = 1, 5 do
	ShadowUF.arenaUnits[i] = 'arena' .. i
end
for i = 1, 4 do
	ShadowUF.battlegroundUnits[i] = 'arena' .. i
end
...
local TagEnv =
	...
	{__index = _G, __newindex = function(k, v)
			_G[k] = v
		end}
)
...
function ShadowUF:CheckBuild()
	...
	if (self.db.profile.wowBuild == build) then
		return
	end
...
function ShadowUF:ShowInfoPanel()
	...
	if (ShadowUF.ComboPoints and infoID < 3) then
		infoID = 3
	end

	ShadowUF.db.global.infoID = #(infoMessages)
	if (infoID < 0 or infoID >= #(infoMessages)) then
		return
	end
