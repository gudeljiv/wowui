...
local function checkRange(self)
	...
	-- Nope, fall back to interaction :(
		...
		frame:SetRangeAlpha(xInRange(30, frame.unit) and ShadowUF.db.profile.units[frame.unitType].range.inAlpha or ShadowUF.db.profile.units[frame.unitType].range.oorAlpha)
	end
end
