...
L["STRING_OPTIONS_MPLUS_MAKEOVERALL"] = "Создать полный сегмент"
L["STRING_OPTIONS_MPLUS_MAKEOVERALL_DESC"] = "По завершении рана эта опция создает общий сегмент с данными по всем боям."
L["STRING_OPTIONS_MPLUS_MERGETRASH"] = "Слияние мусора"
L["STRING_OPTIONS_MPLUS_PANELS_ANCHOR"] = "Панели"
L["STRING_OPTIONS_MPLUS_SHOWENDPANEL"] = "Показывать конец панели M+"
L["STRING_OPTIONS_MPLUS_TIME_INCOMBAT"] = "Время в бою"
L["STRING_OPTIONS_MPLUS_TIME_INCOMBAT_DESC"] = "УВС по всему мифическому+ рану вычисляется по формуле (общий урон)/(общее время боя)."
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME"] = "Время прохождения подземелья"
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME_DESC"] = "УВС по всему мифическому+ рану вычисляется по формуле (общий урон)/(общее время боя)."
