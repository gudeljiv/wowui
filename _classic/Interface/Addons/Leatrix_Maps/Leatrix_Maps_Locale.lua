...
L["Raid"] = "Рейд"
L["Ratchet"] = "Кабестан"
L["Ravenholdt Manor"] = "Манор Рейвенхольдт"
...
L["North"] = "Norden"
L["North Gate Pass"] = "North Gate Pass"
...
L["Raid"] = "Schlachtzug"
L["Ratchet"] = "Ratchet"
L["Ravenholdt Manor"] = "Ravenholdt Manor"
...
L["South"] = "Süden"
L["South Gate Pass"] = "South Gate Pass"
...
L["Center map on player"] = "Centrar el mapa en el jugador"
...
L["If checked, the map will stay centered on your location as long as you are not in a dungeon.|n|nYou can hold shift while panning the map to temporarily prevent it from centering."] = "Si está seleccionado, el mapa permanecerá centrado en su ubicación siempre que no esté en una mazmorra.|n|nPuedes mantener presionada la tecla shift mientras desplaza el mapa para evitar que se centre temporalmente."
...
L["If checked, unexplored areas of the map will be shown on the world map and the battlefield map."] = "Si está seleccionado, las áreas inexploradas del mapa se mostrarán en el mapa mundial y en el mapa del campo de batalla."
...
L["If checked, you will be able to zoom further into the world map."] = "Si está seleccionado, podrá hacer zoom más en el mapa mundial."
...
L["Increase zoom level"] = "Aumentar el nivel de zoom"
...
L["Set the maximum zoom scale."] = "Establezca la escala de zoom máxima."
...
L["Drag to set the player arrow size."] = "Arrastra para establecer el tamaño de la flecha del jugador."
L["Drag to set the player arrow size.|n|nWow Classic default is 16.|nWow Retail default is 27."] = "Arrastra para establecer el tamaño de la flecha del jugador.|n|nEl valor predeterminado de WoW Classic es 16.|nEl valor predeterminado de WoW Retail es 27."
L["Drag to set the world map scale.|n|nYou can also rescale the world map by dragging the bottom-right corner."] = "Arrastra para establecer la escala del mapa mundial.|n|nTambién puedes redimensionar el mapa mundial arrastrando la esquina inferior derecha."
L["Druid only flight point to Darnassus"] = "Punto de vuelo a Darnassus solo para druidas"
L["Druid only flight point to Thunder Bluff"] = "Punto de vuelo a Cima del Trueno solo para druidas"
L["Dun Algaz"] = "Dun Algaz"
L["Dun Morogh"] = "Dun Morogh"
...
L["If checked, zone and continent dropdown menus will be shown in the map frame."] = "Si coché, les menus déroulants de la zone et du continent s'afficheront dans le cadre de la carte."
...
L["If checked, travel points for the opposing faction will be shown.|n|nThis includes flight points, boat harbors, zeppelin towers and tram stations."] = "Se marcado, os pontos de viagem para a facção adversária serão mostrados.|n|nIsso inclui pontos de voo, portos de barco, torres de zepelim e estações de metrô."
L["If checked, travel points for the same faction will be shown.|n|nThis includes flight points, boat harbors, zeppelin towers and tram stations."] = "Se marcado, os pontos de viagem para a mesma facção serão mostrados.|n|nIsso inclui pontos de voo, portos de barco, torres de zepelim e estações de metrô."
L["If checked, unexplored areas of the map will be shown on the world map and the battlefield map."] = "Se marcado, as áreas inexploradas do mapa serão mostradas no mapa do mundo e no mapa do campo de batalha."
...
L["Ravenholdt Manor"] = "Mansão Ravenholdt"
...
L["Show travel points for opposing faction"] = "Mostrar pontos de viagem para facção adversária"
L["Show travel points for same faction"] = "Mostrar pontos de viagem para a mesma facção"
L["Show unexplored areas"] = "Áreas inexploradas"
L["Show zone crossings"] = "Mostrar cruzamentos de zona"
