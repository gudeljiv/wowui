...
L["Center map on player"] = "Centrar mapa en jugador"
...
L["Enhance battlefield map"] = "Mejorar mapa de campo de batalla"
...
L["If checked, you will be able to scale and move the map.|n|nScale the map by dragging the scale handle in the bottom-right corner.|n|nMove the map by dragging the border and frame edges."] = "Si está seleccionado, se podrá escalar y mover el mapa.|n|nEscale el mapa arrastrando el controlador de escala en la esquina inferior derecha.|n|nMueva el mapa arrastrando el borde y los bordes del marco."
