...
function SAO.SPELLS_CHANGED(self, ...)
    SAO:Debug(Module, "SPELLS_CHANGED event received: refreshing known spell IDs for glow effects of " .. tostring(#self.RegisteredGlowSpellNames) .. " spells");
    for glowID, _ in pairs(self.RegisteredGlowSpellNames) do
        SAO:Debug(Module, "  Refreshing spell IDs for glow effect with spell name "..tostring(glowID));
