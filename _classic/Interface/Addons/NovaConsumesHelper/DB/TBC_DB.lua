...
NCH.potions = {
	...
	[12] = {
		...
		spellID = 17038,
		sharedSpellIDs = {473469}, --Cleansed Firewater, SoD cauldron, probably need to make spellIDs a table in the future if there ends up being more items with more than 1 spellID.
		itemID = 12820,
		icon = 134872,
