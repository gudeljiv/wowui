...
_detalhes_global = {
	...
	["spell_pool"] = {
		...
		["Power of the Moon"] = 11,
		["Waist Rune Ability"] = 11,
		...
		["Sapta Sight"] = 7,
		["Lightning Breath"] = "Wind Serpent <Dopesnare>",
		["Holy Strength"] = 1,
		...
		["Wild Strike"] = 11,
		["Improved Mend Pet"] = 3,
		["Engrave Pants - Prayer of Mending"] = 5,
		["Smite"] = 5,
		["Ursine Rage"] = 11,
