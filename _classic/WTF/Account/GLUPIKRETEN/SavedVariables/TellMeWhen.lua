					...
					["Icons"] = {
						...
						}, -- [1]
						{
							...
							["Conditions"] = {
								...
								{
									["Type"] = "LUA",
									["Name"] = "-- xGetRange() >= 8\nIsSpellInRange(\"Arcane Shot\", \"target\") and not xImmune(UnitName(\"target\"), \"Arcane Shot\")",
								}, -- [3]
								["n"] = 3,
							},
						...
						}, -- [3]
						{
							...
							["Conditions"] = {
								...
								}, -- [4]
								{
									["Type"] = "LUA",
									["PrtsAfter"] = 1,
									["Name"] = "xImmune(UnitName(\"target\"), \"Serpent Sting\")",
									["AndOr"] = "OR",
								}, -- [5]
								{
									["Type"] = "LUA",
									["Name"] = "not xImmune(UnitName(\"target\"), \"Chimera Shot\")",
								}, -- [6]
								["n"] = 6,
							},
							["States"] = {
						...
						}, -- [41]
						{
							...
							["Conditions"] = {
								{
									["Type"] = "LUA",
									["Name"] = "xThreat() > 80 and xInRange(5,\"target\",\"max\")",
								}, -- [1]
								{
									["Type"] = "GROUP2",
									["Checked"] = true,
					...
					["Icons"] = {
						{
							...
							["Icons"] = {
								...
								"TMW:icon:1bylVkrBRZaw", -- [6]
								"TMW:icon:1bylVkrAep8k", -- [7]
								"TMW:icon:1ZDRwPNU7Z0Z", -- [8]
								"TMW:icon:1X=OmHlbqz67", -- [9]
								"TMW:icon:1ZuahEVFckqw", -- [10]
								"TMW:icon:1TeVAjjXQ0WB", -- [11]
								"TMW:icon:1ZDQ16jnm6W=", -- [12]
								"TMW:icon:1YS2u64Alj4P", -- [13]
								"TMW:icon:1bUm6EYv4OSE", -- [14]
								"TMW:icon:1bUm6EYv_P02", -- [15]
								"TMW:icon:1bX1IpjvoyWh", -- [16]
								"TMW:icon:1V6lsULwY3_Y", -- [17]
								"TMW:icon:1bW6OhXywJms", -- [18]
								"TMW:icon:1ZEKCuryiveD", -- [19]
								"TMW:icon:1bVNaN3WNJKD", -- [20]
								"TMW:icon:1ayCWLUPE1CN", -- [21]
								"TMW:icon:1c0PDduo4KeH", -- [22]
							},
							["Enabled"] = true,
							["Conditions"] = {
								{
					...
					["Icons"] = {
						...
						}, -- [9]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "IsSpellKnownOrOverridesKnown(403195) and not xImmune(UnitName(\"target\"), \"Sunder Armor\")",
									["Type"] = "LUA",
								}, -- [2]
								{
									["Name"] = "xAOE(8) < 2",
					...
					["Icons"] = {
						{
							...
							["Icons"] = {
								...
								"TMW:icon:1bT8WARkiJ4z", -- [5]
								"TMW:icon:1TU=hLnlwyeY", -- [6]
								"TMW:icon:1bUScRbv99y1", -- [7]
								"TMW:icon:1TWYMfcUzmi6", -- [8]
								"TMW:icon:1TQv_Ltf40Wl", -- [9]
								"TMW:icon:1c3jX2rNsAGN", -- [10]
								...
								"TMW:icon:1TZvNvflXM0_", -- [20]
								"TMW:icon:1byi=FOzUEvn", -- [21]
							},
							["Unit"] = "target",
							["OnlyMine"] = true,
							["Name"] = "Rend",
					...
					["Icons"] = {
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Lightning Bolt\")",
									["Type"] = "LUA",
								}, -- [5]
								["n"] = 5,
							},
						...
						}, -- [1]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Flame Shock\")",
									["Type"] = "LUA",
								}, -- [3]
								["n"] = 3,
							},
						...
						}, -- [2]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Earth Shock\")",
									["Type"] = "LUA",
								}, -- [2]
								["n"] = 2,
							},
						...
						}, -- [3]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Frost Shock\")",
									["Type"] = "LUA",
								}, -- [3]
								{
									["PrtsBefore"] = 1,
						...
						}, -- [4]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Chain Lightning\")",
									["Type"] = "LUA",
								}, -- [3]
								["n"] = 3,
							},
						...
						}, -- [5]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Molten Blast\")",
									["Type"] = "LUA",
								}, -- [4]
								["n"] = 4,
							},
						...
						}, -- [6]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Lava Lash\")",
									["Type"] = "LUA",
								}, -- [2]
								{
									["Type"] = "SPELLCD",
						...
						}, -- [8]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Stormstrike\")",
									["Type"] = "LUA",
								}, -- [2]
								{
									["Type"] = "SPELLCD",
						...
						}, -- [20]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Lightning Shield\")",
									["Type"] = "LUA",
								}, -- [4]
								["n"] = 4,
							},
					...
					["Icons"] = {
						{
							...
							["Icons"] = {
								...
								"TMW:icon:1c4GQPDcviWr", -- [5]
								"TMW:icon:1c3c6f9pDkKm", -- [6]
								"TMW:icon:1c3cjX9efOO3", -- [7]
								"TMW:icon:1Zhjpe9Lw_WF", -- [8]
								"TMW:icon:1c06wqPbwWum", -- [9]
								"TMW:icon:1bhfVRNgDzW5", -- [10]
								"TMW:icon:1Zi=Lf3qDCmn", -- [11]
								"TMW:icon:1b_18Nq2vIuM", -- [12]
								"TMW:icon:1az3vfr0teCJ", -- [13]
								"TMW:icon:1biD7YNstx0_", -- [14]
								"TMW:icon:1Zi_P9NDuquZ", -- [15]
								"TMW:icon:1bhuQwl8Qyyf", -- [16]
								"TMW:icon:1b_lp7goF64O", -- [17]
								"TMW:icon:1b_lp7gtOeie", -- [18]
								"TMW:icon:1c3bXU2OLKG1", -- [19]
								"TMW:icon:1bhfVRMJ6c4p", -- [20]
								"TMW:icon:1Zi_P9LYFYqt", -- [21]
								"TMW:icon:1bhCUZbAne4p", -- [22]
								"TMW:icon:1TeVAjjXQ0WB", -- [23]
							},
							["States"] = {
								{
								}, -- [1]
					...
					["Icons"] = {
						...
						}, -- [23]
						{
							...
							["Conditions"] = {
								...
								{
									["Name"] = "not xImmune(UnitName(\"target\"), \"Rake\")",
									["Type"] = "LUA",
								}, -- [5]
								["n"] = 5,
							},
					...
					["Icons"] = {
						{
							...
							["Icons"] = {
								...
								"TMW:icon:1bStUtJWGryB", -- [18]
								"TMW:icon:1bcfSaepd_eV", -- [19]
							},
							["States"] = {
								{
								}, -- [1]
					...
					["Icons"] = {
						{
							...
							["Icons"] = {
								...
								"TMW:icon:1bzTh96gkXSt", -- [6]
								"TMW:icon:1bfjTFwseiek", -- [7]
								"TMW:icon:1bfjTFwXdneA", -- [8]
								"TMW:icon:1beLH1g5Npa3", -- [9]
								"TMW:icon:1TeVAjjavXC6", -- [10]
								"TMW:icon:1bdLUubuioKL", -- [11]
								"TMW:icon:1bw6ubvO0jqM", -- [12]
								"TMW:icon:1bdMJVMKE3WE", -- [13]
