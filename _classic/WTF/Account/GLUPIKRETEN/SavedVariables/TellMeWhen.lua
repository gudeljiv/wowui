					...
					["Icons"] = {
						...
						}, -- [45]
						{
							...
							["Conditions"] = {
								...
								{
									["Type"] = "LUA",
									["Name"] = "-- select min range, 2 is max range\n-- select(1, xGetRange(\"target\")) >= 8\nInCombatLockdown() and not IsCurrentSpell(6603) and xInRange(5,\"target\",\"max\")",
								}, -- [2]
								{
									["Type"] = "CASTING",
									["Name"] = "Mend Pet",
					...
					["Icons"] = {
						{
							...
							["Icons"] = {
								...
								"TMW:icon:1ZEKCuryiveD", -- [8]
								"TMW:icon:1ayCWLUPE1CN", -- [9]
