...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Experience Bar - Luxthos"] = {
			...
			["information"] = {
				["forceEvents"] = true,
				["saved"] = "JrXkQ4ulU4mZpVYskNelUKicOLTCPIsnXCcj)sasKzUPYXZUwtPNyM5LAkreahASMGYnXkaYiytMuXLKyrLasfAKQG1ovWAYNullvWAIXcefKPbs2aYjXktnLGsTWstT4saQ0ovgWd",
			},
			["overlays"] = {
				{
					1, -- [1]
