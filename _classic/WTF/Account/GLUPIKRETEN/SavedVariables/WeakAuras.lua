...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Rogue"] = {
			...
			["borderBackdrop"] = "Blizzard Tooltip",
			["wagoID"] = "zwZMzGHTw",
			["parent"] = "simstar - SoD Runes Weak Aura",
			["preferToUpdate"] = false,
			["yOffset"] = 0,
			["anchorPoint"] = "CENTER",
			["fullCircle"] = true,
			...
			["triggers"] = {
				{
					["trigger"] = {
						...
						["genericShowOn"] = "showAlways",
						["unit"] = "player",
						["realSpellName"] = "Divine Sacrifice",
						["use_spellName"] = true,
						["spellIds"] = {
						},
						["names"] = {
