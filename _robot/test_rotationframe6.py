...
with keyboard.Listener(on_press=on_press) as listener:
    ...
    with mss.mss() as sct:
        ...
        while True:
            ...
            rotation = rotation_image.pixel(5, 5)
            mss.tools.to_png(rotation_image.rgb, rotation_image.size, output="_robot/rotation.png".format(**p_rotation))

            print('#%02x%02x%02x' % rotation, color_similarity(parse_hex_color("#89CFF0"), rotation))
