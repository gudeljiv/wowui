...
data = {
    ...
    "warrior": {
        "main": [
            ...
            {"name": "disarm", "type": "GetSpellTexture", "id": 676, "key": "r", "modifier": "lalt"},
            ...
            {"name": "shockwave", "type": "GetSpellTexture", "id": 46968, "key": "6"},
        ],
        "secondary": [
    ...
    "death knight": {
        "main": [
            ...
            {"name": "death and decay", "type": "GetSpellTexture", "id": 43265, "key": "r", "modifier": "lalt"},
            ...
            {"name": "bone shield", "type": "GetSpellTexture", "id": 49222, "key": "k"},
        ...
        "secondary": [
            ...
            {"name": "vampiric blood", "type": "GetSpellTexture", "id": 55233, "key": "1", "modifier": "lalt"},
    ...
    "hunter": {
        "main": [
            ...
            {"name": "steady shot", "type": "GetSpellTexture", "id": 56641, "key": "7"},
            {"name": "mend pet", "type": "GetSpellTexture", "id": 136, "key": "v"},
            {"name": "kill shot", "type": "GetSpellTexture", "id": 53351, "key": "e"},
            {"name": "explosive shot", "type": "GetSpellTexture", "id": 53301, "key": "3"},
            {"name": "black arrow", "type": "GetSpellTexture", "id": 3674, "key": "8"},
    ...
    "rogue": {
        "main": [
            ...
            {"name": "blade flurry not active", "type": "GetSpellTexture", "id": 13877, "key": "f5", "pause": 1},
