...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["LibClassicSwingTimerAPI_handler"] = {
			["sparkWidth"] = 10,
			["iconSource"] = 0,
			["xOffset"] = 0,
			["displayText"] = "%p",
			...
			["url"] = "https://wago.io/wrUDyiQzS/1",
			["actions"] = {
				["start"] = {
				},
				["init"] = {
					["custom"] = "local SwingTimerLib_HandlerLib = {}\nlocal SwingTimerLib = LibStub(\"LibClassicSwingTimerAPI\", true)\nif not SwingTimerLib then return end\n\nSwingTimerLib.RegisterCallback(SwingTimerLib_HandlerLib, \"SWING_TIMER_START\", function(event, speed, expirationTime, hand)\n        WeakAuras.ScanEvents(\"SWING_TIMER_START\", tonumber(speed), tonumber(expirationTime), hand)\nend)\nSwingTimerLib.RegisterCallback(SwingTimerLib_HandlerLib, \"SWING_TIMER_STOP\", function(event, hand)\n        WeakAuras.ScanEvents(\"SWING_TIMER_STOP\", hand)\nend)\nSwingTimerLib.RegisterCallback(SwingTimerLib_HandlerLib, \"SWING_TIMER_UPDATE\", function(event, speed, expirationTime, hand)\n        WeakAuras.ScanEvents(\"SWING_TIMER_UPDATE\", tonumber(speed), tonumber(expirationTime), hand)\nend)\nSwingTimerLib.RegisterCallback(SwingTimerLib_HandlerLib, \"SWING_TIMER_CLIPPED\", function(event, hand)\n        WeakAuras.ScanEvents(\"SWING_TIMER_CLIPPED\", hand)\nend)\nSwingTimerLib.RegisterCallback(SwingTimerLib_HandlerLib, \"SWING_TIMER_DELTA\", function(event, swingDelta)\n        WeakAuras.ScanEvents(\"SWING_TIMER_DELTA\", tonumber(swingDelta))\nend)\nSwingTimerLib.RegisterCallback(SwingTimerLib_HandlerLib, \"SWING_TIMER_PAUSED\", function(event, hand)\n        WeakAuras.ScanEvents(\"SWING_TIMER_PAUSED\", hand)\nend)",
					["do_custom"] = true,
				},
				["finish"] = {
				},
			...
			["justify"] = "LEFT",
			["icon"] = false,
			["id"] = "LibClassicSwingTimerAPI_handler",
			["sparkRotation"] = 0,
			["frameStrata"] = 1,
			["anchorFrameType"] = "SCREEN",
		...
		["Display Layer New"] = {
			...
			["authorOptions"] = {
				{
					["useName"] = true,
					["type"] = "header",
					["text"] = "OPTIONS TO TURN OFF AUTOMATION",
					["noMerge"] = false,
					["width"] = 2,
				}, -- [1]
				{
				...
				}, -- [2]
				{
					...
					["default"] = false,
					["width"] = 1,
					["name"] = "Turn off auto-invites",
					["useDesc"] = true,
					["key"] = "invite",
					["desc"] = "Check to turn off auto-inviting people that are using the ! commands",
				}, -- [3]
				{
					["type"] = "toggle",
					["default"] = false,
					["width"] = 1,
					["name"] = "Turn off !layer whispers",
					["useDesc"] = true,
					["key"] = "whisper",
					["desc"] = "Turns off auto whispering your layer to people that do the !layer command",
				}, -- [4]
				{
					["useName"] = true,
					["type"] = "header",
				...
				{
					["text"] = "***Commands must be typed into furylayerhop channel***",
					["type"] = "description",
					["fontSize"] = "medium",
					["width"] = 2,
				}, -- [6]
				...
				{
					["text"] = "!Layer - Everyone will whisper you their current layer\n!L1 - Get auto invite to group with someone in layer 1\n!L2 - Get auto invite to group with someone in layer 2",
					["type"] = "description",
					["fontSize"] = "medium",
					["width"] = 2,
				}, -- [8]
			...
			["displayText"] = "%c",
			["customText"] = "function()\n    if not aura_env.last or aura_env.last < GetTime() - 10 then\n        aura_env.last = GetTime()\n        if aura_env.layer == \"nil\" then aura_env.layer = \"0\"\n        end\n    end\n    return \"L\"..aura_env.layer\nend\n\n\n\n",
			["shadowYOffset"] = -1,
			["anchorPoint"] = "BOTTOMLEFT",
			["customTextUpdate"] = "update",
			["automaticWidth"] = "Auto",
			...
			["triggers"] = {
				{
					["trigger"] = {
						...
						["events"] = "UNIT_TARGET",
						["custom"] = "function()\n    if UnitExists(\"target\") then return true\n    end\nend\n\n\n",
						["subeventPrefix"] = "SPELL",
						["unevent"] = "auto",
						["custom_type"] = "event",
						["unit"] = "target",
				...
				}, -- [2]
				{
					["trigger"] = {
						...
						["subeventPrefix"] = "SPELL",
						["message"] = "!L2",
						["events"] = "CHAT_MSG_CHANNEL, CHAT_MSG_OFFICER",
						["custom"] = "function(event,message,sender,_,channel,...)\n    local message = string.lower(message)\n    local ch = string.match(strlower(channel),\"furylayerhop\")\n    local sender,_ = strsplit(\"-\",sender)    \n    if sender ~= UnitName(\"Player\") then\n        if not aura_env.config.whisper and ((ch or channel == \"OFFICER\") and (message == \"!layer\")) then \n            print(\"Sent message\")\n            SendChatMessage(aura_env.layer, WHISPER, _,sender)\n        end\n        if not aura_env.config.invite and ((ch or channel == \"OFFICER\") and (not IsInGroup() or (IsInGroup() and UnitIsGroupLeader(\"Player\")))) then\n            if message == \"!l1\" and aura_env.layer == \"1\" then \n                InviteUnit(sender)\n            elseif message == \"!l2\" and aura_env.layer == \"2\" then\n                InviteUnit(sender)\n            end\n        end\n    end\nend\n\n\n\n",
						["event"] = "Chat Message",
						["use_message"] = true,
						["unevent"] = "timed",
			...
			["conditions"] = {
				{
					...
					["changes"] = {
						{
							["value"] = {
								["custom"] = "local _,_,_,_,i = strsplit(\"-\", UnitGUID(TARGET)) \nif i then aura_env.layer = (tonumber(i) < 19300 and \"1\" or \"2\")\nend\n\n\n\n",
							},
							["property"] = "customcode",
						}, -- [1]
					},
		...
		["@ Avoidance / Defense Cap (Wrath of the Lich King)"] = {
			...
			["anchorPoint"] = "CENTER",
			["displayText_format_p_time_format"] = 0,
			["url"] = "https://wago.io/qYKsfPe_W/15",
			["icon"] = true,
			["keepAspectRatio"] = false,
			["wordWrap"] = "WordWrap",
			["desaturate"] = false,
			...
			["actions"] = {
				...
				["init"] = {
					["custom"] = "local  _, _, class = UnitClass(\"player\")\n\nlocal getDefense = function()\n  baseDefense, armorDefense = UnitDefense(\"player\")\n  \n  return baseDefense + armorDefense\nend\n\nlocal missChance = function(defense)\n  return 5 + ((defense - (UnitLevel(\"player\") * 5)) * 0.04)\nend\n\nlocal getBuffedDodge = function()\n  local kings = false\n  local motw = false\n  \n  --check for blessing of kings\n  --25898 and 20217\n  if WA_GetUnitAura(\"player\", GetSpellInfo('Blessing of Kings')) or \n  WA_GetUnitAura(\"player\", GetSpellInfo('Greater Blessing of Kings')) then\n    kings = true\n  end\n  \n  --check for mark/gift of the wild\n  if WA_GetUnitAura(\"player\", GetSpellInfo('Mark of the Wild')) or \n  WA_GetUnitAura(\"player\", GetSpellInfo('Gift of the Wild')) then\n    motw = true\n  end\n  \n  \n  local _, agi = UnitStat(\"player\", 2);\n  \n  if not motw and not kings then\n    agi = math.floor((agi + 18) * 1.1)\n  elseif motw and not kings then\n    agi = math.floor(agi * 1.1)\n  elseif not motw and kings then\n    agi = math.floor((math.ceil(agi/1.1) + 18) * 1.1) -- might cause rounding errors?\n  end\n  \n  if class == 11 then -- if druid\n    agi = agi/14.7\n  elseif class == 1 then -- warrior\n    agi = agi/30\n  elseif class == 2 then -- if paladin\n    agi = agi/25\n  end\n  \n  local dodge = agi + (GetCombatRating(3)/18.9) + ((getDefense() - 350) * 0.04) + 0.65\n  \n  return dodge\nend\n\nlocal getDefenseCap = function()\n  --Druid = 11\n  --Warrior = 1\n  --Paladin = 2\n  \n  local cap = 0\n  \n  --if druid\n  if class == 11 then\n    --get ranks of Survival of the Fittest Talent\n    local _,_,_,_,rank = GetTalentInfo(2, 16)\n    local talentOffset = rank * 25\n    \n    cap = 540 - talentOffset\n  else\n    cap = 540\n  end\n  \n  --crit reduction from resilience\n  local res = GetCombatRating(15) * (1/39.4)\n  local resOffset = res / 0.04\n  \n  return math.ceil(cap - resOffset)\nend\n\nlocal getAvoidance = function(dodge)\n  local miss = 5 + ((getDefense() - (UnitLevel(\"player\") * 5)) * 0.04)\n  local block = GetBlockChance()\n  local parry = GetParryChance()\n  \n  --local avoidance = math.floor((dodge + block + parry + miss) * mult + 0.5) / mult\n  local avoidance = string.format(\"%.2f\", (dodge + block + parry + miss))\n  return avoidance\nend\n\nlocal avoidance = function(dodge)\n  return \"|cff12ffff Avoidance|r: \" .. getAvoidance(dodge) .. \"% / \".. 102.4 .. \"%\\n|cff12ffff Defense|r: \" .. floor(getDefense()) .. \"/\" .. getDefenseCap()\nend\n\n\n--CREATE FRAME\nif not aura_env.AvoidanceFrame then\n  local f = CreateFrame(\"Frame\", nil, aura_env.region)\n  \n  f:SetAllPoints()\n  \n  f.text = f:CreateFontString(nil, \"OVERLAY\")\n  f.text:SetFontObject(\"GameFontHighlight\")\n  f.text:SetPoint(\"TOP\", 0, -5)\n  f.text:SetText(avoidance(GetDodgeChance()))\n  \n  f:RegisterEvent(\"COMBAT_RATING_UPDATE\")\n  f:RegisterEvent(\"PLAYER_ENTERING_WORLD\")\n  f:RegisterEvent(\"PLAYER_DAMAGE_DONE_MODS\")\n  f:SetScript(\"OnEvent\", function(self) \n      f.text:SetText(avoidance(GetDodgeChance()))    \n  end)\n  \n  f:SetScript(\"OnEnter\", function(self) \n      GameTooltip:SetOwner(self, \"ANCHOR_BOTTOM\", 0, -10)\n      GameTooltip:AddLine(\"|cffffffffDefensive Stats|r\")\n      GameTooltip:AddLine(\"Miss: \" .. string.format(\"%.2f\", missChance(getDefense()))..\"%\")\n      GameTooltip:AddLine(\"Dodge: \" .. string.format(\"%.2f\", GetDodgeChance())..\"%\")\n      \n      \n      -- dont put block chance on tooltip if bear\n      if class == 1 or class == 2 then\n        GameTooltip:AddLine(\"Parry: \" .. string.format(\"%.2f\", GetParryChance())..\"%\")\n        GameTooltip:AddLine(\"---\\n\")\n        GameTooltip:AddLine(\"Block: \" .. string.format(\"%.2f\", GetBlockChance())..\"%\")\n        GameTooltip:AddLine(\"Block val: \" .. GetShieldBlock())\n        GameTooltip:AddLine(\"---\\n\")\n      else\n        GameTooltip:AddLine(\"---\\n\")\n      end\n      \n      GameTooltip:Show()\n  end)\n  \n  f:SetScript(\"OnLeave\", function() \n      GameTooltip:Hide() \n  end)\n  \n  aura_env.AvoidanceFrame = f\nend",
					["do_custom"] = true,
				},
			},
			["uid"] = "pmBhPjLakzv",
	...
	["frame"] = {
		["xOffset"] = -1061.116577148438,
		["yOffset"] = -144.7667236328125,
		["height"] = 963.5496215820312,
		["width"] = 946.9991455078125,
	},
