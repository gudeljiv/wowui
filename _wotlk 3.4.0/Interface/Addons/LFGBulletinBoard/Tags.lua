...
GBB.dungeonTagsLoc={
	...
	deDE =langSplit({
 	 ...
 	 ruRU = langSplit({
		...
		["AQ20"] = "руины ра20 ак20",
		["AQ40"] = "ан40 ак40",
		["ARC"] = "аркатрац кба алькатрац аркатрас алькатрас алькатраз арка аркатраз",
		["ARENA"] = "2s 3s 5s 2с 3с 5с 2x2 3x3 5x5 2х2 3х3 5х5 кап",
		...
		["EOE"] = "око оечности малигос",
		["EOTS"] = "бури",
		["EYE"] = "Крепость Бурь: Око",
		["FOS"] = "кузня душ кузню кяз",
		["GD"] = "гундрак гуднрак гунд",
		["GL"] = "грул груула",
		...
		["NEX"] = "нексус",
		["OCC"] = "окулус",
		["OHB"] = "cтарые предгорья хилсбрада спх старый хилсбрад хилсбард побег",
