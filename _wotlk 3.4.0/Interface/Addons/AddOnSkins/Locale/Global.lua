...
ASL['Status Bars'] = true
ASL['Blizzard: Enable All'] = true
ASL['Blizzard: Disable All'] = true
ASL['General'] = true
ASL['Backdrop'] = true
ASL['Transparent Backdrop'] = true
ASL['One Window Embed System'] = true
ASL['Two Window Embed System'] = true
ASL['Enable'] = true
ASL['Embed'] = true
ASL['Out of Combat'] = true
ASL['Hide'] = true
ASL['Hide Delay'] = true
ASL['Strata and Frame Level'] = true
