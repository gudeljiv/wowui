...
LBIS:AddGem(spec1, "36767", "4", "False") --Solid Dragon's Eye
...
LBIS:AddGem(spec1, "40023", "3", "False") --Shifting Twilight Opal
...
LBIS:AddEnchant(spec1, "47766", LBIS.L["Chest"]) --Enchant Chest - Greater Defense

LBIS:AddEnchant(spec1, "57690", LBIS.L["Wrist"]) --Fur Lining - Stamina
LBIS:AddEnchant(spec1, "62256", LBIS.L["Wrist"]) --Enchant Bracers - Major Stamina

LBIS:AddEnchant(spec1, "63770", LBIS.L["Hands"]) --Reticulated Armor Webbing
LBIS:AddEnchant(spec1, "54999", LBIS.L["Hands"]) --Hyperspeed Accelerators
LBIS:AddEnchant(spec1, "54998", LBIS.L["Hands"]) --Hand-Mounted Pyro Rocket
LBIS:AddEnchant(spec1, "44625", LBIS.L["Hands"]) --Enchant Gloves - Armsman

LBIS:AddEnchant(spec1, "50965", LBIS.L["Legs"]) --Frosthide Leg Armor
LBIS:AddEnchant(spec1, "60583", LBIS.L["Legs"]) --Jormungar Leg Reinforcements
LBIS:AddEnchant(spec1, "50964", LBIS.L["Legs"]) --Jormungar Leg Armor

LBIS:AddEnchant(spec1, "44528", LBIS.L["Feet"]) --Enchant Boots - Greater Fortitude
LBIS:AddEnchant(spec1, "50963", LBIS.L["Feet"]) --Heavy Borean Armor Kit
