...
local ENCHANTING_MATERIALS = set(10940, 11083, 11137, 11176, 16204, 10938, 10939, 10998, 11082, 11134, 11135, 11174, 11175, 16202, 16203, 10978, 11084, 11138, 11139, 11177, 11178, 14343, 14344, 20725)
...
local CLASSES = {
	{
		...
		items = set(2512, 2515, 3030, 3464, 9399, 11285, 12654, 18042, 19316, 28053, 24417, 24412, 33803, 28056, 30611, 31949)
	},
	{
