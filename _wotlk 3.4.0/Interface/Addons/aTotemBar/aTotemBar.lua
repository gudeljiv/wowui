...
local aTotemBar = CreateFrame('Frame', 'aTotemBar', UIParent, BackdropTemplateMixin and 'BackdropTemplate')
aTotemBar:SetWidth(190 + (spacing * 5))
aTotemBar:SetHeight(38)
aTotemBar:SetPoint('BOTTOM', 'MainMenuBar', 'TOP', 0, 75)
...
local TotemTimers = {}
TotemTimers[1] = CreateFrame('Cooldown', 'TotemTimers1', MultiCastSlotButton2, BackdropTemplateMixin and 'BackdropTemplate')
TotemTimers[2] = CreateFrame('Cooldown', 'TotemTimers2', MultiCastSlotButton1, BackdropTemplateMixin and 'BackdropTemplate')
TotemTimers[3] = CreateFrame('Cooldown', 'TotemTimers3', MultiCastSlotButton3, BackdropTemplateMixin and 'BackdropTemplate')
TotemTimers[4] = CreateFrame('Cooldown', 'TotemTimers4', MultiCastSlotButton4, BackdropTemplateMixin and 'BackdropTemplate')
