	...
	local opt = {
		...
		args = {
			...
			mirrorSize = {
				...
				width = 'full',
				get = function(info)
					return NugKeyFeedback.db.mirrorSize
				end,
				set = function(info, v)
			...
			enableCooldown = {
				...
				order = 4.2,
				get = function(info)
					return NugKeyFeedback.db.enableCooldown
				end,
				set = function(info, v)
			...
			enableCast = {
				...
				order = 4.3,
				get = function(info)
					return NugKeyFeedback.db.enableCast
				end,
				set = function(info, v)
			...
			enablePushEffect = {
				...
				confirmText = L 'Warning: Requires UI reloading.',
				get = function(info)
					return NugKeyFeedback.db.enablePushEffect
				end,
				set = function(info, v)
			...
			enableCastLine = {
				...
				order = 4.5,
				get = function(info)
					return NugKeyFeedback.db.enableCastLine
				end,
				set = function(info, v)
			...
			enableCastFlash = {
				...
				order = 4.6,
				get = function(info)
					return NugKeyFeedback.db.enableCastFlash
				end,
				set = function(info, v)
			...
			lineIconSize = {
				...
				type = 'range',
				disabled = function()
					return not NugKeyFeedback.db.enableCastLine
				end,
				width = 'full',
				get = function(info)
					return NugKeyFeedback.db.lineIconSize
				end,
				set = function(info, v)
			...
			lineDirection = {
				...
				get = function(info)
					return NugKeyFeedback.db.lineDirection
				end,
				set = function(info, v)
			...
			forceUseActionHook = {
				...
				get = function(info)
					if NugKeyFeedback.autoDetectHookMode ~= nil then
						return NugKeyFeedback.autoDetectHookMode
					end
...
function NugKeyFeedback:HookOptionsFrame()
	CreateFrame('Frame', nil, InterfaceOptionsFrame):SetScript(
		'OnShow',
		function(frame)
