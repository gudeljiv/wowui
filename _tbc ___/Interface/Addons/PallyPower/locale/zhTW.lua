...
L["AUTOASSIGN_DESC"] = [=[Auto-Assign all Blessings based onthe number of available Paladinsand their available Blessings.|cffffffff[Shift-Left-Click]|r Use Battlegroundassignment template instead of Raidassignement template.]=]
...
L["BRPT_DESC"] = [=[Report all Blessing assignments to the Raid or Party channel.]=]
L["BSC"] = "Buff 縮放"
...
L["DRAGHANDLE"] = [=[|cffffffff[Left-Click]|r |cffff0000Lock|r/|cff00ff00Unlock|r PallyPower |cffffffff[Left-Click-Hold]|r Move PallyPower |cffffffff[Right-Click]|r Open Blessing Assignments |cffffffff[Shift-Right-Click]|r Open Options]=]
...
L["FREEASSIGN_DESC"] = [=[Allow others to change your blessings without being Party Leader / Raid Assistant.]=]
...
L["MINIMAPICON"] = [=[|cffffffff[Left-Click]|r Open Blessing Assignments|cffffffff[Right-Click]|r Open Options]=]
L["NONE"] = "None"
L["NONE_BUFFED"] = "None Buffed"
L["OPTIONS"] = "Options"
L["OPTIONS_DESC"] = [=[Opens the PallyPower addon options panel.]=]
...
L["PP_CLEAR"] = "Clear"
L["PP_CLEAR_DESC"] = [=[Clears all Blessing assignments for Self, Party, and Raid Paladins.]=]
...
L["PP_REFRESH_DESC"] = [=[Refreshes all Blessing assignments, Talents, and Symbol of Kings among Self, Party, and Raid Paladins.]=]
L["PP_RESET"] = "重設框架"
...
L["REPORTCHANNEL_DESC"] = [=[Set the desired chennel to broadcast the Bliessings Report to:|cffffd200[None]|r Selects channel based on group makeup. (Party/Raid)|cffffd200[Channel List]|r An auto populated channel list based on channels the player has joined. Default channels such as Trade, General, etc. are automatically filtered from the list.|cffffff00Note: If you change your Channel Order then you will need to reload your UI and verify that it is broadcasting to the correct channel.|r]=]
L["RESET"] = "Reset Frames"
L["RESET_DESC"] = "重設所有PallyPower的框架至螢幕中央"
L["RESIZEGRIP"] = [=[Left-Click-Hold to resize Right-Click resets default size]=]
L["RFM"] = "正義之怒"
L["RFM_DESC"] = "監控正義之怒"
L["SALVCOMBAT"] = "Salv in Combat"
L["SALVCOMBAT_DESC"] = [=[If you enable this option you will be able to buff Warriors, Druids and Paladins with Greater Blessing of Salvation while in combat.|cffffff00Note: This setting ONLY applies to raid groups because in our current culture, a lot of tanks use scripts/addons to cancel buffs which can only be done while not in combat. This option is basically a safety to prevent buffing a Tank with Salvation accidentally during combat.|r]=]
L["SEAL"] = "聖印"
L["SEAL_DESC"] = "監控聖印"
...
L["SHOWPETS_DESC"] = [=[If you enable this option pets will appear under their own class.|cffffff00Note: Due to the way Greater Blessings work and the way that pets are classified, Pets will need to be buffed separately. Additionally, Warlock Imps will be hidden automatically unless Phase Shift is off.|r]=]
