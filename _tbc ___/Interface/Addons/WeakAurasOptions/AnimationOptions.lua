...
function OptionsPrivate.GetAnimationOptions(data)
	...
	local animation = {
		...
		args = {
			...
			start_preset = {
				...
				order = 33,
				values = function()
					return filterAnimPresetTypes(anim_start_preset_types, id)
				end,
				hidden = function()
					return data.animation.start.type ~= 'preset'
				end
			},
			...
			start_easeStrength = {
				...
				disabled = function()
					return data.animation.start.easeType == 'none'
				end
			},
			start_use_alpha = {
				type = 'toggle',
			...
			start_use_scale = {
				...
				order = 42,
				hidden = function()
					return (data.animation.start.type ~= 'custom' or not WeakAuras.regions[id].region.Scale)
				end
			},
			start_scaleType = {
				type = 'select',
			...
			start_use_rotate = {
				...
				order = 46,
				hidden = function()
					return (data.animation.start.type ~= 'custom' or not WeakAuras.regions[id].region.Rotate)
				end
			},
			start_rotateType = {
				type = 'select',
			...
			start_use_color = {
				...
				order = 48.2,
				hidden = function()
					return (data.animation.start.type ~= 'custom' or not WeakAuras.regions[id].region.Color)
				end
			},
			start_colorType = {
				type = 'select',
			...
			start_color = {
				...
				get = function()
					return data.animation.start.colorR, data.animation.start.colorG, data.animation.start.colorB, data.animation.start.colorA
				end,
			...
			main_preset = {
				...
				order = 53,
				values = function()
					return filterAnimPresetTypes(anim_main_preset_types, id)
				end,
				hidden = function()
					return data.animation.main.type ~= 'preset'
				end
			},
			...
			main_easeStrength = {
				...
				disabled = function()
					return data.animation.main.easeType == 'none'
				end
			},
			main_use_alpha = {
				type = 'toggle',
			...
			main_use_scale = {
				...
				order = 62,
				hidden = function()
					return (data.animation.main.type ~= 'custom' or not WeakAuras.regions[id].region.Scale)
				end
			},
			main_scaleType = {
				type = 'select',
			...
			main_use_rotate = {
				...
				order = 66,
				hidden = function()
					return (data.animation.main.type ~= 'custom' or not WeakAuras.regions[id].region.Rotate)
				end
			},
			main_rotateType = {
				type = 'select',
			...
			main_use_color = {
				...
				order = 68.2,
				hidden = function()
					return (data.animation.main.type ~= 'custom' or not WeakAuras.regions[id].region.Color)
				end
			},
			main_colorType = {
				type = 'select',
			...
			main_color = {
				...
				get = function()
					return data.animation.main.colorR, data.animation.main.colorG, data.animation.main.colorB, data.animation.main.colorA
				end,
				set = function(info, r, g, b, a)
			...
			finish_preset = {
				...
				order = 73,
				values = function()
					return filterAnimPresetTypes(anim_finish_preset_types, id)
				end,
				hidden = function()
					return data.animation.finish.type ~= 'preset'
				end
			},
			...
			finish_easeStrength = {
				...
				disabled = function()
					return data.animation.finish.easeType == 'none'
				end
			},
			finish_use_alpha = {
				type = 'toggle',
			...
			finish_use_scale = {
				...
				order = 82,
				hidden = function()
					return (data.animation.finish.type ~= 'custom' or not WeakAuras.regions[id].region.Scale)
				end
			},
			finish_scaleType = {
				type = 'select',
			...
			finish_use_rotate = {
				...
				order = 86,
				hidden = function()
					return (data.animation.finish.type ~= 'custom' or not WeakAuras.regions[id].region.Rotate)
				end
			},
			finish_rotateType = {
				type = 'select',
			...
			finish_use_color = {
				...
				order = 88.2,
				hidden = function()
					return (data.animation.finish.type ~= 'custom' or not WeakAuras.regions[id].region.Color)
				end
			},
			finish_colorType = {
				type = 'select',
			...
			finish_color = {
				...
				get = function()
					return data.animation.finish.colorR, data.animation.finish.colorG, data.animation.finish.colorB, data.animation.finish.colorA
				end,
				set = function(info, r, g, b, a)
	...
	OptionsPrivate.commonOptions.AddCodeOption(
		...
		79.3,
		hideFinishTranslate,
		{'animation', 'finish', 'translateFunc'},
		false
	)
	...
	OptionsPrivate.commonOptions.AddCodeOption(
		...
		'https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Code-Blocks#rotate',
		87.3,
		hideFinishRotateFunc,
		{'animation', 'finish', 'rotateFunc'},
		false
	)
	...
	if (data.controlledChildren) then
		...
		animation.hidden = function(info, ...)
			return hiddenAll(data, info, ...)
		end
		animation.disabled = function(info, ...)
