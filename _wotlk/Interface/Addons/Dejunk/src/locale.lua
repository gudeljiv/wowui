...
L["INCLUDE_BELOW_AVERAGE_EQUIPMENT_TOOLTIP"] = "Include soulbound equipment with an item level slightly below your average equipped item level (%s).|n|nDoes not apply to generic items, cosmetic items, or fishing poles."
...
L["LIST_FRAME_TOOLTIP"] = "To add an item, drop it into the frame below. To remove an item, highlight an entry and Right-Click."
L["LISTS"] = "Lists"
...
L["AUTO_JUNK_FRAME_TOOLTIP"] = "Автоматически переключать нежелательное окно при взаимодействии с торговцем."
...
L["INCLUDE_BELOW_AVERAGE_EQUIPMENT_TOOLTIP"] = "Включает персональную экипировку, уровень которой немного ниже вашего среднего уровня экипировки (%s).|n|nНе применяется к обычным предметам, косметическим предметам или удочкам."
...
L["JUNK_FRAME_TOOLTIP"] = "В этом окне будут перечислены ненужные предметы, которыми вы сейчас владеете.|n|nЧтобы добавить предмет в %s, поместите его в окно ниже. Чтобы добавить предмет в %s, выделите заголовок и нажмите ПКМ."
L["JUNK_ITEMS"] = "Ненужные предметы"
L["KEYBINDS"] = "Назначение клавиш"
L["LEFT_CLICK"] = "ЛКМ"
L["LIST_FRAME_TOOLTIP"] = "Чтобы добавить предмет, перетащите его в окно ниже. Чтобы удалить предмет, выделите заголовок и нажмите ПКМ."
L["LISTS"] = "Списки"
...
L["AUTO_JUNK_FRAME_TOOLTIP"] = "在与商人交互时自动切换垃圾物品框架。"
...
L["GENERAL"] = "通用"
L["IMPORT"] = "导入"
L["INCLUDE_BELOW_AVERAGE_EQUIPMENT_TEXT"] = "包含低于平均装等的物品"
L["INCLUDE_BELOW_AVERAGE_EQUIPMENT_TOOLTIP"] = "包含装等略低于你已装备物品平均等级(%s)的灵魂绑定物品。|n|n对通用物品，装饰品，或鱼竿不生效。"
...
L["JUNK_FRAME_TOOLTIP"] = "你当前拥有的垃圾物品会被列在此框架中。|n|n想要添加一个物品至%s，把它拖进下方框架。想要添加一个物品至%s，高亮一个项目并点击右键。"
L["JUNK_ITEMS"] = "垃圾物品"
L["KEYBINDS"] = "按键绑定"
L["LEFT_CLICK"] = "点击左键"
L["LIST_FRAME_TOOLTIP"] = "想要添加一个物品，把它拖进下方框架中。想要移除一个物品，高亮一个项目并点击右键。"
L["LISTS"] = "列表"
...
L["GENERAL"] = "一般"
L["IMPORT"] = "匯入"
L["INCLUDE_BELOW_AVERAGE_EQUIPMENT_TEXT"] = "包括低於平均等級的設備"
L["INCLUDE_BELOW_AVERAGE_EQUIPMENT_TOOLTIP"] = "包括物品等級略低於平均裝備等級 (%s) 的靈魂綁定裝備。|n|n不適用於普通物品、裝飾物品或釣魚竿。"
