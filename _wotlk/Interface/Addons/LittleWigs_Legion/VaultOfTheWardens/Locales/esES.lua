...
L = BigWigs:NewBossLocale("Glazer", "esES") or BigWigs:NewBossLocale("Glazer", "esMX")
if L then
	--L.radiation_level = "%s: %d%%"
end

L = BigWigs:NewBossLocale("Tirathon Saltheril", "esES") or BigWigs:NewBossLocale("Tirathon Saltheril", "esMX")
if L then
