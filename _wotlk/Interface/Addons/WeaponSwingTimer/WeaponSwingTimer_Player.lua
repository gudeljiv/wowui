...
--[[============================================================================================]] addon_data.player.UpdateConfigPanelValues = function()
	...
	panel.main_text_color_picker.foreground:SetColorTexture(settings.main_text_r, settings.main_text_g, settings.main_text_b, settings.main_text_a)
	panel.off_color_picker.foreground:SetColorTexture(settings.off_r, settings.off_g, settings.off_b, settings.off_a)
	panel.off_text_color_picker.foreground:SetColorTexture(settings.off_text_r, settings.off_text_g, settings.off_text_b, settings.off_text_a)
...
addon_data.player.MainColorPickerOnClick = function()
	...
	local function MainOnActionFunc(restore)
		...
		addon_data.player.config_frame.main_color_picker.foreground:SetColorTexture(settings.main_r, settings.main_g, settings.main_b, settings.main_a)
	end
	ColorPickerFrame.func, ColorPickerFrame.opacityFunc, ColorPickerFrame.cancelFunc = MainOnActionFunc, MainOnActionFunc, MainOnActionFunc
...
addon_data.player.MainTextColorPickerOnClick = function()
	...
	local function MainTextOnActionFunc(restore)
		...
		addon_data.player.frame.main_left_text:SetTextColor(settings.main_text_r, settings.main_text_g, settings.main_text_b, settings.main_text_a)
		addon_data.player.frame.main_right_text:SetTextColor(settings.main_text_r, settings.main_text_g, settings.main_text_b, settings.main_text_a)
		addon_data.player.config_frame.main_text_color_picker.foreground:SetColorTexture(settings.main_text_r, settings.main_text_g, settings.main_text_b, settings.main_text_a)
	end
	ColorPickerFrame.func, ColorPickerFrame.opacityFunc, ColorPickerFrame.cancelFunc = MainTextOnActionFunc, MainTextOnActionFunc, MainTextOnActionFunc
	ColorPickerFrame.hasOpacity = true
...
addon_data.player.OffColorPickerOnClick = function()
	...
	local function OffOnActionFunc(restore)
		...
		addon_data.player.config_frame.off_color_picker.foreground:SetColorTexture(settings.off_r, settings.off_g, settings.off_b, settings.off_a)
	end
	ColorPickerFrame.func, ColorPickerFrame.opacityFunc, ColorPickerFrame.cancelFunc = OffOnActionFunc, OffOnActionFunc, OffOnActionFunc
	ColorPickerFrame.hasOpacity = true
...
addon_data.player.OffTextColorPickerOnClick = function()
	...
	local function OffTextOnActionFunc(restore)
		...
		addon_data.player.frame.off_left_text:SetTextColor(settings.off_text_r, settings.off_text_g, settings.off_text_b, settings.off_text_a)
		addon_data.player.frame.off_right_text:SetTextColor(settings.off_text_r, settings.off_text_g, settings.off_text_b, settings.off_text_a)
		addon_data.player.config_frame.off_text_color_picker.foreground:SetColorTexture(settings.off_text_r, settings.off_text_g, settings.off_text_b, settings.off_text_a)
	end
	ColorPickerFrame.func, ColorPickerFrame.opacityFunc, ColorPickerFrame.cancelFunc = OffTextOnActionFunc, OffTextOnActionFunc, OffTextOnActionFunc
	ColorPickerFrame.hasOpacity = true
...
addon_data.player.CreateConfigPanel = function(parent_panel)
	...
	-- Enabled Checkbox
	panel.enabled_checkbox = addon_data.config.CheckBoxFactory('PlayerEnabledCheckBox', panel, L['Enable'], L["Enables the player's swing bars."], addon_data.player.EnabledCheckBoxOnClick)
	panel.enabled_checkbox:SetPoint('TOPLEFT', 10, -40)
	-- Show Off-Hand Checkbox
	panel.show_offhand_checkbox = addon_data.config.CheckBoxFactory('PlayerShowOffHandCheckBox', panel, L['Show Off-Hand'], L["Enables the player's off-hand swing bar."], addon_data.player.ShowOffHandCheckBoxOnClick)
	panel.show_offhand_checkbox:SetPoint('TOPLEFT', 10, -60)
	-- Show Border Checkbox
	panel.show_border_checkbox = addon_data.config.CheckBoxFactory('PlayerShowBorderCheckBox', panel, L['Show border'], L["Enables the player bar's border."], addon_data.player.ShowBorderCheckBoxOnClick)
	panel.show_border_checkbox:SetPoint('TOPLEFT', 10, -80)
	-- Show Classic Bars Checkbox
	panel.classic_bars_checkbox = addon_data.config.CheckBoxFactory('PlayerClassicBarsCheckBox', panel, L['Classic bars'], L["Enables the classic texture for the player's bars."], addon_data.player.ClassicBarsCheckBoxOnClick)
	panel.classic_bars_checkbox:SetPoint('TOPLEFT', 10, -100)
	-- Fill/Empty Checkbox
	panel.fill_empty_checkbox = addon_data.config.CheckBoxFactory('PlayerFillEmptyCheckBox', panel, L['Fill / Empty'], L['Determines if the bar is full or empty when a swing is ready.'], addon_data.player.FillEmptyCheckBoxOnClick)
	panel.fill_empty_checkbox:SetPoint('TOPLEFT', 10, -120)
	-- Show Left Text Checkbox
	panel.show_left_text_checkbox = addon_data.config.CheckBoxFactory('PlayerShowLeftTextCheckBox', panel, L['Show Left Text'], L["Enables the player's left side text."], addon_data.player.ShowLeftTextCheckBoxOnClick)
	panel.show_left_text_checkbox:SetPoint('TOPLEFT', 10, -140)
	-- Show Right Text Checkbox
	panel.show_right_text_checkbox = addon_data.config.CheckBoxFactory('PlayerShowRightTextCheckBox', panel, L['Show Right Text'], L["Enables the player's right side text."], addon_data.player.ShowRightTextCheckBoxOnClick)
	panel.show_right_text_checkbox:SetPoint('TOPLEFT', 10, -160)
	-- Show Paladin Seal Twist Checkbox
	panel.show_paladin_blood_checkbox = addon_data.config.CheckBoxFactory('PlayerShowPaladingBloodCheckBox', panel, L['Show Paladin Twist'], L['Show 0.4s marker before swing to help with seal twisting. Apply seal after this.'], addon_data.player.ShowPaladinBloodCheckBoxOnClick)
	panel.show_paladin_blood_checkbox:SetPoint('TOPLEFT', 10, -180)
	-- Show Paladin Seal Twist Checkbox GCD
	panel.show_paladin_command_checkbox = addon_data.config.CheckBoxFactory('PlayerShowPaladinCommandCheckBox', panel, L['Show Paladin GCD'], L['Show GCD marker before swing to help with seal twisting. Apply first seal before this.'], addon_data.player.ShowPaladinCommandCheckBoxOnClick)
	panel.show_paladin_command_checkbox:SetPoint('TOPLEFT', 10, -200)

	-- Width EditBox
	panel.width_editbox = addon_data.config.EditBoxFactory('PlayerWidthEditBox', panel, L['Bar Width'], 75, 25, addon_data.player.WidthEditBoxOnEnter)
	panel.width_editbox:SetPoint('TOPLEFT', 240, -60, 'BOTTOMRIGHT', 275, -85)
	-- Height EditBox
	panel.height_editbox = addon_data.config.EditBoxFactory('PlayerHeightEditBox', panel, L['Bar Height'], 75, 25, addon_data.player.HeightEditBoxOnEnter)
	panel.height_editbox:SetPoint('TOPLEFT', 320, -60, 'BOTTOMRIGHT', 355, -85)
	-- Font Size EditBox
	panel.fontsize_editbox = addon_data.config.EditBoxFactory('FontSizeEditBox', panel, 'Font Size', 75, 25, addon_data.player.FontSizeEditBoxOnEnter)
	panel.fontsize_editbox:SetPoint('TOPLEFT', 160, -60)
	-- X Offset EditBox
	panel.x_offset_editbox = addon_data.config.EditBoxFactory('PlayerXOffsetEditBox', panel, L['X Offset'], 75, 25, addon_data.player.XOffsetEditBoxOnEnter)
	panel.x_offset_editbox:SetPoint('TOPLEFT', 200, -110, 'BOTTOMRIGHT', 275, -135)
	-- Y Offset EditBox
	panel.y_offset_editbox = addon_data.config.EditBoxFactory('PlayerYOffsetEditBox', panel, L['Y Offset'], 75, 25, addon_data.player.YOffsetEditBoxOnEnter)
	panel.y_offset_editbox:SetPoint('TOPLEFT', 280, -110, 'BOTTOMRIGHT', 355, -135)

	-- Main-hand color picker
	panel.main_color_picker = addon_data.config.color_picker_factory('PlayerMainColorPicker', panel, settings.main_r, settings.main_g, settings.main_b, settings.main_a, L['Main-hand Bar Color'], addon_data.player.MainColorPickerOnClick)
	panel.main_color_picker:SetPoint('TOPLEFT', 205, -150)
	-- Main-hand color text picker
	panel.main_text_color_picker = addon_data.config.color_picker_factory('PlayerMainTextColorPicker', panel, settings.main_text_r, settings.main_text_g, settings.main_text_b, settings.main_text_a, L['Main-hand Bar Text Color'], addon_data.player.MainTextColorPickerOnClick)
	panel.main_text_color_picker:SetPoint('TOPLEFT', 205, -170)
	-- Off-hand color picker
	panel.off_color_picker = addon_data.config.color_picker_factory('PlayerOffColorPicker', panel, settings.off_r, settings.off_g, settings.off_b, settings.off_a, L['Off-hand Bar Color'], addon_data.player.OffColorPickerOnClick)
	panel.off_color_picker:SetPoint('TOPLEFT', 205, -200)
	-- Off-hand color text picker
	panel.off_text_color_picker = addon_data.config.color_picker_factory('PlayerOffTextColorPicker', panel, settings.off_text_r, settings.off_text_g, settings.off_text_b, settings.off_text_a, L['Off-hand Bar Text Color'], addon_data.player.OffTextColorPickerOnClick)
	panel.off_text_color_picker:SetPoint('TOPLEFT', 205, -220)

	-- In Combat Alpha Slider
	panel.in_combat_alpha_slider = addon_data.config.SliderFactory('PlayerInCombatAlphaSlider', panel, L['In Combat Alpha'], 0, 1, 0.05, addon_data.player.CombatAlphaOnValChange)
	panel.in_combat_alpha_slider:SetPoint('TOPLEFT', 405, -60)
	-- Out Of Combat Alpha Slider
	panel.ooc_alpha_slider = addon_data.config.SliderFactory('PlayerOOCAlphaSlider', panel, L['Out of Combat Alpha'], 0, 1, 0.05, addon_data.player.OOCAlphaOnValChange)
	panel.ooc_alpha_slider:SetPoint('TOPLEFT', 405, -110)
	-- Backplane Alpha Slider
	panel.backplane_alpha_slider = addon_data.config.SliderFactory('PlayerBackplaneAlphaSlider', panel, L['Backplane Alpha'], 0, 1, 0.05, addon_data.player.BackplaneAlphaOnValChange)
	panel.backplane_alpha_slider:SetPoint('TOPLEFT', 405, -160)
	-- Backplane Alpha Slider
	panel.pala_offset_slider = addon_data.config.SliderFactory('PlayerPalaOffsetSlider', panel, L['Paladin Marker offset'], 0, 30, 1, addon_data.player.PaladinOffsetOnValChange)
