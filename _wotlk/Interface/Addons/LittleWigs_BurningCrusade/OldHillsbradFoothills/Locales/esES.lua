local L = BigWigs:NewBossLocale("Old Hillsbrad Foothills Trash", "esES") or BigWigs:NewBossLocale("Old Hillsbrad Foothills Trash", "esMX")
...
L = BigWigs:NewBossLocale("Lieutenant Drake", "esES") or BigWigs:NewBossLocale("Lieutenant Drake", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Captain Skarloc", "esES") or BigWigs:NewBossLocale("Captain Skarloc", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Epoch Hunter", "esES") or BigWigs:NewBossLocale("Epoch Hunter", "esMX")
if L then
