...
frame:SetScript(
	...
	function(frame)
		...
		options.exampleTooltip:SetScript(
			'OnEvent',
			function()
				showExampleTooltip()
			end
		...
		options.lockCharacterInfoPosition =
			newCheckbox(
