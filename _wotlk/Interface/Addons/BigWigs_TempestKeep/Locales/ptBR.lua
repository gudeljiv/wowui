local L = BigWigs:NewBossLocale("Void Reaver", "ptBR")
...
if L then
	...
	L.capernian = "Grã-astromante Capernian"
	L.sanguinar = "Lorde Sanguinar"
	L.telonicus = "Mestre Engenheiro Telônico"
	L.thaladred = "Thaladred, o Obscurecente"
end
