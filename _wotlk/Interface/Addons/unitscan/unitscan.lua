...
unitscan:SetScript(
	...
	function(_, event, arg1)
		...
		elseif event == 'ZONE_CHANGED_NEW_AREA' or 'PLAYER_LOGIN' then
			...
			if instance_type == 'raid' or instance_type == 'pvp' then
				return
			end
			if zone == nil then
				return
...
function unitscan.LOAD()
	...
	button:SetPoint('TOP', UIParent, 0, -150)
	button:SetWidth(225)
	button:SetHeight(42)
	button:SetScale(1.5)
...
function unitscan.print(msg)
	...
	elseif DEFAULT_CHAT_FRAME then
		DEFAULT_CHAT_FRAME:AddMessage('UnitScan: ' .. YELLOW_FONT_COLOR_CODE .. msg)
	else
		print('UnitScan: ' .. YELLOW_FONT_COLOR_CODE .. msg)
	end
end
