...
L["--- End of assignments ---"] = "--- 结束分配 ---"
L["--- Paladin assignments ---"] = "--- 骑士祝福分配 ---"
L["...with Normal..."] = "...以普通祝福..."
L["[|cffffd200Enable|r/|cffffd200Disable|r] The Aura Button or select the Aura you want to track."] = "[|cffffd200启用|r/|cffffd200禁用|r] 光环按钮或选择要跟踪的光环."
L["[|cffffd200Enable|r/|cffffd200Disable|r] The Auto Buff Button or [|cffffd200Enable|r/|cffffd200Disable|r] Wait for Players."] = "[|cffffd200启用|r/|cffffd200禁用|r] 自动Buff按钮，或 [|cffffd200启用|r/|cffffd200禁用|r] 等待玩家。"
...
L["[Enable/Disable] Righteous Fury"] = "[激活/禁用]正义之怒"
L["[Enable/Disable] The Aura Button"] = "显示或隐藏光环/圣印按钮"
L["[Enable/Disable] The Auto Buff Button"] = "[启用/禁用] 自动Buff按钮"
L["[Enable/Disable] The Drag Handle"] = "[启用/禁用]拖拽"
L["[Enable/Disable] The Seal Button"] = "[启用/禁用] 圣印按钮"
L["[Show/Hide] Minimap Icon"] = "[显示/隐藏] 小地图图标"
L["[Show/Hide] The PallyPower Tooltips"] = "[显示/隐藏] PallyPower鼠标提示"
L["a Normal Blessing from:"] = "正常的祝福来自:"
L["Aura Button"] = "光环按钮"
L["Aura Tracker"] = "光环监视"
...
L["Auto-Assign"] = "自动分配"
L["Auto-Buff Main Assistant"] = "自动Buff主助理"
L["Auto-Buff Main Tank"] = "自动Buff主坦克"
L["AUTOKEY1_DESC"] = "普通祝福的快捷键"
L["AUTOKEY2_DESC"] = "强效祝福的快捷键"
L["Background Textures"] = "皮肤"
L["Blessing Assignments Scale"] = "祝福分配面板比例"
L["BLESSING_REPORT_TOOLTIP"] = "报告所有祝福到团队或小队频道"
L["Blessings Report"] = "祝福报告"
L["Blessings Report Channel"] = "祝福报告发送频道"
L["Borders"] = "外框"
L["Buff Button | Player Button Layout"] = "Buff按钮 | 玩家按钮布局"
...
L["Change the way PallyPower looks"] = "改变PallyPower的样式"
L["Class & Player Buttons"] = "职业和玩家按钮"
L["Class Buttons"] = "启用职业按钮"
L["Clear"] = "清除"
L["Drag Handle"] = "启用拖拽"
L["Drag Handle Button"] = "拖拽按钮"
L["DRAGHANDLE_TOOLTIP"] = "|cffffffff[左键]|r |cffff0000锁定|r/|cff00ff00解锁|r PallyPower |cffffffff[按住左键]|r 移动 PallyPower |cffffffff[右键]|r 打开祝福分配 |cffffffff[Shift-右键]|r 打开设置"
L["Enable PallyPower"] = "全局显示"
...
L["If this option is disabled it will also disable the Player Buttons and you will only be able to buff using the Auto Buff button."] = "禁用后，也将禁用玩家按钮，并且您只能使用“自动Buff按钮”释放Buff"
...
L["Main Tank / Main Assist Roles"] = "主坦克 / 主助理角色"
L["MAIN_ROLES_DESCRIPTION"] = [=[这些选项可以用来|cffff0000且仅用于|r以普通祝福替换自动指派给战士、德鲁伊或圣骑士坦克的强效祝福。（注：本功针对团队角色标记为主坦克或主助理的玩家变更不同种类的普通祝福之用。）
...
L["Reset all PallyPower frames back to center"] = "将所有PallyPower框架的位置重置回屏幕中央"
L["Reset Frames"] = "重置框架"
L["RESIZEGRIP_TOOLTIP"] = "按住左键调整大小 ，右键重置默认大小"
L["Righteous Fury"] = "激活正义之怒"
L["Salv in Combat"] = "战斗中拯救祝福"
L["SALVCOMBAT_OPTION_TOOLTIP"] = [=[如果你允许了此选项，则可在战斗中对战士、德鲁伊、骑士施放拯救祝福。
...
L["SHOWPETS_OPTION_TOOLTIP_VANILLA"] = "启用后，宠物将会出现在对应的职业下面。|cffffff00(提示：由于强效祝福的工作方式和宠物的分类方式，宠物需要单独Buff。此外，除非关闭相位变换，否则术士小鬼将自动隐藏).|r"
L["Smart Buffs"] = "启用智能Buff"
L["This allows you to adjust the overall size of the Blessing Assignments Panel"] = "此处允许您来调整祝福分配面板的整体大小。"
L["This allows you to adjust the overall size of the PallyPower Buttons"] = "设置PallyPower按钮的整体大小"
