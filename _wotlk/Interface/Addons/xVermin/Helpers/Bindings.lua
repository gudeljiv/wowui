...
local function FixBindings()
	...
	SetBinding('SHIFT-ALT-1', 'BONUSACTIONBUTTON1', 1)
	SetBinding('SHIFT-ALT-1', 'BONUSACTIONBUTTON2', 1)
	SetBinding('SHIFT-ALT-3', 'BONUSACTIONBUTTON3', 1)
	SetBinding('SHIFT-ALT-4', 'BONUSACTIONBUTTON4', 1)
	SetBinding('SHIFT-ALT-5', 'BONUSACTIONBUTTON5', 1)
	SetBinding('SHIFT-ALT-6', 'BONUSACTIONBUTTON6', 1)
	SetBinding('SHIFT-ALT-7', 'BONUSACTIONBUTTON7', 1)
	-- else
