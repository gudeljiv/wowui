...
--L["Select when to show rating conversions in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "在提示框架中顯示屬性等級轉換結果"
-- /rb rating spell
...
--L["Select when to show base stat conversions in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "在物品提示中顯示基本屬性解析"
---------------------------------------------------------------------------
-- /rb stat str
L["Strength"] = "力量"
...
--L["Select when to show stat summary in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "在物品提示中顯示屬性統計"
-- /rb sum ignore
...
{pattern = string.lower(ATTACK_POWER), id = ATTACK_POWER},
--[[
