...
L["Note: This trigger internally stores the shape shift positon, and thus is incompatible with learning stances on the fly, like e.g. the Gladiator Rune."] = "注意：此觸發器在內部儲存變形位置，因此與動態學習姿勢不相容，例如角鬥士符文。"
