...
L["Dragonriding"] = "驭龙术"
L["Drain"] = "引导性吸取"
L["Dreamscythe and Weaver"] = "德姆塞卡尔与德拉维沃尔"
...
Supports Instance IDs prefixed with 'i'.]=] ] = [=[支持多个条目，由英文逗号分隔。如果需要包含子地图，使用前缀'c'，例如：'c2022'。
支持地图组ID，使用前缀'g'，例如：'g277'。
支持区域ID，使用前缀‘a’。详见：https://wago.tools/db2/AreaTable
支持副本ID，使用前缀'i'。]=]
L["Swing"] = "近战攻击"
...
L["Treat charged combo point as 7 combo points"] = "充能连击点视为7连击点"
L["Trigger"] = "触发器"
L["Trigger %i"] = "触发器 %i"
L["Trigger %s"] = "触发器%s"
L["Trigger 1"] = "触发器 1"
