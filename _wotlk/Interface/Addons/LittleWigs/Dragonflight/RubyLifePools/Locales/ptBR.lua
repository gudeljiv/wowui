local L = BigWigs:NewBossLocale("Ruby Life Pools Trash", "ptBR")
...
if L then
	...
	L.blazebound_destroyer = "Destruidor Preso às Chamas"
	L.primalist_shockcaster = "Lança-choques Primevista"
