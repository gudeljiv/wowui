...
function AuctionatorBagItemMixin:SetItemInfo(info)
	...
	if info ~= nil then
		...
		-- self.IconBorder:SetVertexColor(ITEM_QUALITY_COLORS[self.itemInfo.quality].r, ITEM_QUALITY_COLORS[self.itemInfo.quality].g, ITEM_QUALITY_COLORS[self.itemInfo.quality].b, 1)
		-- self.IconBorder:Show()
		self:CreateBeautyBorder(6)
		self:SetBeautyBorderTexture('white')
		self:SetBeautyBorderColor(ITEM_QUALITY_COLORS[self.itemInfo.quality].r, ITEM_QUALITY_COLORS[self.itemInfo.quality].g, ITEM_QUALITY_COLORS[self.itemInfo.quality].b, 1)

		self.Text:SetText(info.count)
		self.Text:SetScale(0.7)
