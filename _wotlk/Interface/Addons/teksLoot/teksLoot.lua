...
local function ClickRoll(frame)
	if IsShiftKeyDown() then
		ConfirmLootRoll(frame.parent.rollid, frame.rolltype)
	else
...
local function CreateRollFrame()
	...
	if not buttonborder.SetBackdrop then
		Mixin(buttonborder, BackdropTemplateMixin)
	end
...
anchor:SetScript(
	...
	function(frame, event, addon)
		...
		anchor:SetPoint('CENTER', UIParent, 'TOP', 0, -250)
	end
)
