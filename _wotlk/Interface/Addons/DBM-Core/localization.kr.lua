...
L.UPDATEREMINDER_DISABLE			= "경고: " .. L.DEADLY_BOSS_MODS .. "의 버전이 오래되어 새로운 DBM 버전과 호환되지 않아 강제로 비활성화되며 업데이트 전까진 사용할 수 없습니다. 이는 구버전 모드가 당신과 파티/공대원의 플레이에 악영향을 미치지 않게 하기 위함입니다."
...
L.AUTO_NAMEPLATE_OPTION_TEXT			= "호환되는 이름표 애드온이나 DBM을 사용하여 $spell:%s 오라를 이름표에 표시"
L.AUTO_NAMEPLATE_OPTION_TEXT_FORCED		= "DBM만을 사용하여 $spell:%s 오라를 이름표에 표시"
