...
local function MatchIDs_Init(self)
  ...
  if self.db.profile.moveHealthstone then
    Result[formatBagTitle(self, L["Healthstone"], converttohex(self.db.profile.color.Healthstone))] =
      AddToSet(database["Healthstone"])
  end
  ...
  if self.db.profile.moveMergedTemporaryPermanentEnhancements then
    Result[formatBagTitle(
      ...
      AddToSet(database["PermanentEnhancements"], database["TemporaryEnhancements"])
  else
...
local setFilter = AdiBags:RegisterFilter("Classic", 98, "ABEvent-1.0")
setFilter.uiName = string.format("|cffd6ff5a%s|r", L["Classic"])
setFilter.uiDesc =
  string.format("%s\n|cffffd800%s: 1.0.7|r", L["Items from the main game."], L["Filter version"])

function setFilter:OnInitialize()
  self.db = AdiBags.db:RegisterNamespace("Classic", {
    profile = {
      ...
      color = {
        prefix = converttorgb("d6ff5a", true),
        ...
        Healthstone = converttorgb("93e5ab", true),
  ...
  return {
      ...
      args = {
        ...
        prefixCategories = {
          ...
          values = {
            ...
            ["V"] = "V",
            ["V-"] = "V-",
            ["|T4279397:" .. AdiBags.HEADER_SIZE .. ":" .. AdiBags.HEADER_SIZE .. ":-2:-10|t"] = "|T4279397:"
              .. AdiBags.HEADER_SIZE
              .. "|t",
            ["|T1120721:" .. AdiBags.HEADER_SIZE .. ":" .. AdiBags.HEADER_SIZE .. ":-2:-10|t"] = "|T1120721:"
              .. AdiBags.HEADER_SIZE
              .. "|t",
            ["|T626006:" .. AdiBags.HEADER_SIZE .. ":" .. AdiBags.HEADER_SIZE .. ":-2:-10|t"] = "|T626006:"
              .. AdiBags.HEADER_SIZE
              .. "|t",
            ["|T626003:" .. AdiBags.HEADER_SIZE .. ":" .. AdiBags.HEADER_SIZE .. ":-2:-10|t"] = "|T626003:"
              .. AdiBags.HEADER_SIZE
              .. "|t",
            ["|T626008:" .. AdiBags.HEADER_SIZE .. ":" .. AdiBags.HEADER_SIZE .. ":-2:-10|t"] = "|T626008:"
              .. AdiBags.HEADER_SIZE
              .. "|t",
          },
        },
    ...
    Healthstone_config = {
      ...
      args = {
        Legendaries_desc = {
          type = "description",
          name = L["Just a healthstone."],
          order = 82,
        },
        moveHealthstone = {
          name = L["Healthstone"],
          desc = L["Just your typical healthstone."],
          type = "toggle",
          width = 1.5,
          order = 83,
        },
        colorHealthstone = {
          name = L["Color"],
          desc = string.format(L["Select a color for %s."], L["Healthstone"]),
          type = "color",
          order = 84,
          disabled = function()
            return self.db.profile.moveMergedHealthstone
          end,
          get = function()
            local color = self.db.profile.color.Healthstone
            AdiBags:UpdateFilters()
            return color.r, color.g, color.b
          end,
          set = function(_, r, g, b)
