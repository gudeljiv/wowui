...
if L then
	...
	L.dokigg_the_brutalizer_harugia_the_bloodthirsty = "야만전사 도키그 / 피에 굶주린 하루기아"
	L.dokigg_the_brutalizer = "야만전사 도키그"
	L.nekthara_the_mangler_heavin_the_breaker = "분쇄자 네크타라 / 파괴자 헤빈"
	L.nekthara_the_mangler_rek_the_hardened = "분쇄자 네크타라 / 완고한 렉"
	L.nekthara_the_mangler = "분쇄자 네크타라"
	L.heavin_the_breaker = "파괴자 헤빈"
	L.harugia_the_bloodthirsty_advent_nevermore = "피에 굶주린 하루기아 / 강림자 네버모어"
	L.harugia_the_bloodthirsty = "피에 굶주린 하루기아"
	L.ancient_captain = "고대의 대장"
	L.advent_nevermore = "강림자 네버모어"
	L.rek_the_hardened = "완고한 렉"
	L.portal_guardian = "차원문 수호자"
