...
function TSM.OnInitialize()
	...
	private.settings =
		Settings.NewView():AddKey('global', 'coreOptions', 'chatFrame'):AddKey('global', 'coreOptions', 'destroyValueSource'):AddKey('global', 'coreOptions', 'minimapIcon'):AddKey('global', 'debug', 'chatLoggingEnabled'):AddKey('global', 'internalData', 'appMessageId'):AddKey('global', 'internalData', 'lastCharacter'):AddKey(
		'global',
		'internalData',
		'whatsNewVersion'
	):AddKey('sync', 'internalData', 'classKey'):RegisterCallback(
		'destroyValueSource',
		function()
	...
	-- core price sources
	ItemInfo.RegisterInfoChangeCallback(
		function(itemString)
