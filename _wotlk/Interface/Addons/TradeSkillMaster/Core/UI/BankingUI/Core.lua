...
function private.UpdateCurrentModule(frame)
	...
	if private.settings.tab == "Warehousing" then
		...
		footerButtonsFrame:AddChildIf(ClientInfo.IsWarRetail(), UIElements.New("ActionButton", "depositWarboundBtn")
			:SetHeight(24)
			:SetMargin(0, 0, 8, 0)
			:SetFont("BODY_BODY2_MEDIUM")
			--:SetDisabled(C_PlayerInfo.HasAccountInventoryLock()) -- TODO: API currently unreliable?
