...
local IsInInstance, GetInstanceDifficulty, GetNumShapeshiftForms, GetShapeshiftFormInfo = IsInInstance, GetInstanceDifficulty, GetNumShapeshiftForms, GetShapeshiftFormInfo
local GetPetActionInfo = GetPetActionInfo

local ConditionCategory = CNDT:GetCategory('ATTRIBUTES_PLAYER', 2, L['CNDTCAT_ATTRIBUTES_PLAYER'], false, false)

ConditionCategory:RegisterCondition(
	3,
	'MOUNTED',
	{
...
ConditionCategory:RegisterCondition(
	...
	'RESTING',
	{
		...
		events = function(ConditionObject, c)
			return ConditionObject:GenerateNormalEventString('PLAYER_UPDATE_RESTING'), ConditionObject:GenerateNormalEventString('PLAYER_ENTERING_WORLD')
		end
	}
)
...
ConditionCategory:RegisterCondition(
	...
	'STANCE',
	{
		text = pclass == 'DRUID' and L['SHAPESHIFT'] or L['STANCE'],
		bool = true,
		...
		events = function(ConditionObject, c)
			return ConditionObject:GenerateNormalEventString('UPDATE_SHAPESHIFT_FORM')
		end,
...
ConditionCategory:RegisterCondition(
	...
	'AUTOCAST',
	{
		...
		events = function(ConditionObject, c)
			return ConditionObject:GenerateNormalEventString('PET_BAR_UPDATE')
		end
	}
)
...
ConditionCategory:RegisterCondition(
	...
	'PETMODE2',
	{
		...
		events = function(ConditionObject, c)
			return ConditionObject:GenerateNormalEventString('UNIT_PET', 'player'), ConditionObject:GenerateNormalEventString('PET_BAR_UPDATE')
		end
	}
)
...
ConditionCategory:RegisterCondition(
	...
	'TRACKING',
	{
		...
		events = function(ConditionObject, c)
			return ConditionObject:GenerateNormalEventString('MINIMAP_UPDATE_TRACKING')
		end
	}
)
