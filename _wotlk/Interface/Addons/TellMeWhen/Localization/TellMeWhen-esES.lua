...
L["CHANGELOG_DESC"] = "Muestra una lista de cambios realizados en las versiones actuales y pasadas de TellMeWhen."
L["CHANGELOG_INFO2"] = "Bienvenido a TellMeWhen v%s! <br/><br/> Cuando hayas revisado los cambios, haz click en la solapa %s o %s desplázate al final para empezar a configurar TellMeWhen."
L["CHANGELOG_LAST_VERSION"] = "Anterior versión instalada"
...
L["CLICK_TO_EDIT"] = "|cff7fffffClick|r para editar."
L["CMD_CHANGELOG"] = "registro de cambios"
...
L["CNDT_DEPRECATED_DESC"] = "La condición %s ya no funciona. Probablemente, esto se debe a un cambio en las mecánicas del juego. Elimínala o cámbiala."
L["CNDT_MULTIPLEVALID"] = "Puedes introducir múltiples nombres/ID a comprobar separándolos con punto y coma."
...
L["CNDT_RANGE"] = "Distancia de la unidad"
L["CNDT_RANGE_DESC"] = "Comprueba la distancia aproximada a la unidad usando LibRangeCheck-2.0. La condición será falsa si la unidad no existe.."
L["CNDT_RANGE_IMPRECISE"] = "%d yds. (|cffff1300Imprecisa|r)"
L["CNDT_RANGE_PRECISE"] = "%d yds. (|cff00c322Precisa|r)"
...
L["CNDT_UNKNOWN_DESC"] = "Tus ajustes contienen una condición con el identificador %s, pero dicha condición no existe. Podrías estar usando una versión antigua de RMW, o la condición puede haber sido eliminada."
...
L["CNDTCAT_LOCATION"] = "Grupo y Ubicación"
...
L["CNDTCAT_TALENTS"] = "Clase y talentos"
L["CODESNIPPET_ADD2"] = "Nuevo %s Snippet"
L["CODESNIPPET_ADD2_DESC"] = "|cff7fffffClick|r para añadir un nuevo %s snippet."
L["CODESNIPPET_AUTORUN"] = "Ejecutar al acceder"
L["CODESNIPPET_AUTORUN_DESC"] = "Si se activa, el snippet se ejecutará cuando TMW_INITIALIZE arranque (lo que ocurre durante el  PLAYER_LOGIN, pero antes de que los iconos o grupos se creen)."
...
L["CODESNIPPET_EDIT_DESC"] = "|cff7fffffClick|r para editar este snippet."
