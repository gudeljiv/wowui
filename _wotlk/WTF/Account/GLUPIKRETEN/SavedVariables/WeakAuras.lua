...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Fojji - Deathknight UI"] = {
			["controlledChildren"] = {
				"DK - Runes // Ipse Edit", -- [1]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["wagoID"] = "0N1K2wIv4",
			["authorOptions"] = {
			...
			["url"] = "https://wago.io/0N1K2wIv4/56",
			["actions"] = {
				["start"] = {
				},
				["finish"] = {
