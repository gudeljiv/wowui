...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Reminder: Time To Die"] = {
			...
			["internalVersion"] = 68,
			["selfPoint"] = "CENTER",
			["desc"] = "Time to Die\n\nAuthor - Merfin\nDiscord - https://discord.gg/q9z5Az6\nCompatibility - MerfinUI\n\nGet more auras by subscribing on tw.tv/merfin",
		...
		["nanShield:Text"] = {
			["outline"] = "OUTLINE",
			["wagoID"] = "_RQpchERj",
			["parent"] = "nanShield WotLK",
			["displayText_format_p_time_dynamic_threshold"] = 0,
			["shadowYOffset"] = -1,
			["anchorPoint"] = "CENTER",
			["displayText_format_p_time_format"] = 0,
			["customTextUpdate"] = "update",
			["url"] = "https://wago.io/_RQpchERj/16",
			["actions"] = {
				["start"] = {
				},
				["finish"] = {
		...
		["DK: Active Presence"] = {
			...
			["yOffset"] = -35,
			["anchorPoint"] = "CENTER",
			["url"] = "https://wago.io/iq3OGmE2F/25",
			["actions"] = {
				["start"] = {
				},
				["init"] = {
		...
		["focus cast bar - interruptable"] = {
			...
			["id"] = "focus cast bar - interruptable",
			["parent"] = "2. Focus Cast Bar",
			["frameStrata"] = 1,
			["width"] = 182,
			["backgroundColor"] = {
				0, -- [1]
		...
		["Merfin: Target Info"] = {
			["controlledChildren"] = {
				"Reminder: Target's Raw Threat", -- [1]
				"Reminder: Time To Die", -- [2]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["wagoID"] = "bzVZr5ODZ",
			["authorOptions"] = {
		...
		["nanShield WotLK"] = {
			...
			["yOffset"] = 150,
			["sortHybridTable"] = {
				["nanShield: Stoneclaw Totem"] = false,
		...
		["Vermin Warrior Stance"] = {
			...
			["controlledChildren"] = {
				"Warrior - Berserker Stance", -- [1]
				"Warrior - Defensive Stance", -- [2]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["scale"] = 1,
			["border"] = false,
		...
		["Equipped Items - Icon"] = {
			...
			["information"] = {
				["forceEvents"] = true,
				["saved"] = "JXYMKtjwsj5KAIfLRACS8xlwbcKAffKzrjwsM5NxizMBQ(hShoEZG6SGdv3V4yUoi2fycm3I(lFH5KVvuvHQHqWP7tprjlhR5UqvdyUffsIPKzsPwjxffwQfLBM5Lixo5BMfMixf5B(5NtILuLACmV3av9tXRmv7Li0oyUjbrxGDyGTzFytFT(4QGBN(WMsVSIRc4d",
			},
			["authorOptions"] = {
				{
					["subOptions"] = {
		...
		["DK - Runes"] = {
			...
			["rowSpace"] = 1,
			["url"] = "https://wago.io/0N1K2wIv4/58",
			["actions"] = {
				["start"] = {
				},
				["finish"] = {
		...
		["Runes"] = {
			...
			["actions"] = {
				...
				["init"] = {
					["custom"] = "aura_env.runeIndex = { 1, 2, 5, 6, 3, 4 }\nfor i = 1, 6 do \n    aura_env.runeIndex[i] = aura_env.config[tostring(i)]\nend\n\naura_env.spentInCombat = {\n    false, false, false, false, false, false,   \n}\nfunction aura_env.updateRune(allstates, rune)\n    local start, duration, runeReady = GetRuneCooldown(rune)\n    local runeType = GetRuneType(rune)\n    local now = GetTime()\n    local combat = InCombatLockdown()\n    allstates[rune] = allstates[rune] or {\n        show = true,\n        progressType = \"timed\",\n        autoHide = false,\n        additionalProgress = {{min = 0, max = 0}},\n        index = aura_env.runeIndex[rune]\n    }\n    local state = allstates[rune]\n    state.changed = true\n    state.duration = duration or 0\n    state.expirationTime = duration + start\n    state.runeType = runeType\n    state.runeReady = runeReady\n    state.overTimeStart = (runeReady and combat and now+2.47) or 0\n    state.overTimeRem = 0\n    local graceCheck = aura_env.spentInCombat[rune]\n    if combat then\n        if runeReady and not graceCheck then\n            aura_env.spentInCombat[rune] = \"fresh\"\n        elseif runeReady and graceCheck == \"fresh\" then\n            aura_env.spentInCombat[rune] = true\n            state.hasGrace = true\n        end\n    end\nend\n\n\n\n",
					["do_custom"] = true,
				},
			},
			["icon_color"] = {
			...
			["subRegions"] = {
				...
				{
					["text_text_format_p_time_format"] = 0,
					["text_text_format_overTimeRem_gcd_hide_zero"] = false,
					["text_shadowColor"] = {
						0, -- [1]
						0, -- [2]
						0, -- [3]
					...
					["text_fixedWidth"] = 64,
					["text_text_format_c_format"] = "none",
					["text_text_format_overTimeRem_gcd_gcd"] = true,
					["rotateText"] = "NONE",
					["text_text_format_overTimeRem_decimal_precision"] = 1,
					["text_color"] = {
						1, -- [1]
						0.76078431372549, -- [2]
						0.60392156862745, -- [3]
					...
					["text_text_format_overTimeRem_gcd_channel"] = false,
					["text_shadowYOffset"] = 0,
					["text_wordWrap"] = "WordWrap",
					["text_text_format_overTimeRem_format"] = "Number",
					["text_fontSize"] = 20,
					["anchorXOffset"] = 0,
					["text_text_format_p_time_mod_rate"] = true,
					["text_text_format_overTimeRem_time_dynamic_threshold"] = 60,
					...
					["type"] = "subtext",
					["text_shadowXOffset"] = 0,
					["text_text_format_overtimeDuration_format"] = "none",
					["text_font"] = "Numen",
					["text_text_format_p_time_precision"] = 1,
					["text_anchorYOffset"] = -20,
					["text_text_format_overTimeRem_time_legacy_floor"] = false,
					["text_text_format_runeType_format"] = "none",
					["text_text_format_overTimeRem_gcd_cast"] = false,
					["text_anchorPoint"] = "INNER_CENTER",
					["text_visible"] = true,
					["text_fontType"] = "OUTLINE",
					["text_text_format_overTimeRem_time_precision"] = 1,
					["text_text_format_overTimeRem_time_format"] = 0,
					["text_text"] = "%p",
				}, -- [3]
				{
					["text_text_format_p_time_format"] = 0,
					...
					["text_shadowYOffset"] = -1,
					["text_wordWrap"] = "WordWrap",
					["text_text_format_overTimeRem_format"] = "timed",
					["text_fontSize"] = 16,
					["anchorXOffset"] = 0,
					["text_text_format_p_time_mod_rate"] = true,
					["text_text_format_overTimeRem_time_dynamic_threshold"] = 3,
					["text_selfPoint"] = "CENTER",
					["text_automaticWidth"] = "Auto",
					["anchorYOffset"] = 0,
					["text_justify"] = "CENTER",
		...
		["nanShield: Stoneclaw Totem"] = {
			...
			["actions"] = {
				...
				["init"] = {
					["custom"] = "-- Package common/logging\naura_env.logPalette = {\n    \"ff6e7dda\",\n    \"ff21dfb9\",\n    \"ffe3f57a\",\n    \"ffed705a\",\n    \"fff8a3e6\",\n}\n\nfunction aura_env:log(...)\n    if self.config and self.config.debugEnabled then\n        local palette = self.logPalette\n        local args = {\n            self.cloneId and\n            format(\"[%s:%s]\", self.id, self.cloneId) or\n            format(\"[%s]\", self.id),\n            ...\n        }\n        for i = 1, #args do\n            args[i] = format(\n                \"|c%s%s|r\",\n                palette[1 + (i - 1) % #palette],\n                tostring(args[i]))\n        end\n        print(unpack(args))\n    end\nend\n-- Package end\n\n-- Package stoneclaw/init\naura_env.spellId = nil\naura_env.spellName = nil\n-- Package end",
					["do_custom"] = true,
				},
			},
			["triggers"] = {
			...
			["conditions"] = {
				{
					...
					["changes"] = {
						{
							["value"] = {
								["custom"] = "aura_env:log('Condition 1', aura_env.spellId, aura_env.spellName)\n\nWeakAuras.ScanEvents(\"WA_NAN_SHIELD_STONECLAW_TOTEM\", true, aura_env.spellId, aura_env.spellName)",
							},
							["property"] = "customcode",
						}, -- [1]
					},
				}, -- [1]
				{
					...
					["changes"] = {
						{
							["value"] = {
								["custom"] = "aura_env:log('Condition 2', aura_env.spellId, aura_env.spellName)\n\nWeakAuras.ScanEvents(\"WA_NAN_SHIELD_STONECLAW_TOTEM\", false, aura_env.spellId, aura_env.spellName)\n\n\n",
							},
							["property"] = "customcode",
						}, -- [1]
					},
		...
		["2. Focus Cast Bar"] = {
			["controlledChildren"] = {
				"focus cast bar - interruptable", -- [1]
				"focus cast bar - uninterruptable", -- [2]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["authorOptions"] = {
			},
		...
		["focus cast bar - uninterruptable"] = {
			["sparkWidth"] = 20,
			["iconSource"] = 0,
			["user_x"] = 0,
			["authorOptions"] = {
			...
			["id"] = "focus cast bar - uninterruptable",
			["actions"] = {
				["start"] = {
				},
				["init"] = {
		...
		["Reminder: Target's Raw Threat"] = {
			...
			["justify"] = "LEFT",
			["displayText_format_p_time_dynamic_threshold"] = 60,
			["id"] = "Reminder: Target's Raw Threat",
			["displayText_format_p_time_precision"] = 1,
			["frameStrata"] = 3,
