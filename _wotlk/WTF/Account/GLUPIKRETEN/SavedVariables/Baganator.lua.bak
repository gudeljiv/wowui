...
BAGANATOR_CONFIG = {
	...
	["category_display_order"] = {
		"default_auto_recents", -- [1]
		"----", -- [2]
		"default_hearthstone", -- [3]
		"default_consumable", -- [4]
		"default_questitem", -- [5]
		"_EQUIPMENT", -- [6]
		"default_auto_equipment_sets", -- [7]
		"default_weapon", -- [8]
		"default_armor", -- [9]
		"__end", -- [10]
		"_CRAFTING", -- [11]
		"default_reagent", -- [12]
		"default_tradegoods", -- [13]
		"default_recipe", -- [14]
		"__end", -- [15]
		"default_gem", -- [16]
		"default_container", -- [17]
		"default_key", -- [18]
		"default_miscellaneous", -- [19]
		"default_battlepet", -- [20]
		"default_other", -- [21]
		"----", -- [22]
		"default_junk", -- [23]
		"default_special_empty", -- [24]
	},
