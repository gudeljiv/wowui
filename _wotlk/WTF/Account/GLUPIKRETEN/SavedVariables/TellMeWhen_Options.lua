							...
							["Icons"] = {
								{
									...
									["Icons"] = {
										...
										"TMW:icon:1cHVGCLT5o8x", -- [7]
										"TMW:icon:1a9jdXHzXsKe", -- [8]
										"TMW:icon:1a7l2fmj178S", -- [9]
										"TMW:icon:1cHmgODPePq4", -- [10]
									},
									["States"] = {
										{
										}, -- [1]
