							...
							["Icons"] = {
								{
									["Type"] = "meta",
									["Icons"] = {
										"TMW:icon:1cKAkhk7ttuu", -- [1]
										"TMW:icon:1ZGiKdd7WnyK", -- [2]
										"TMW:icon:1ZGiKddAIuOA", -- [3]
										...
										"TMW:icon:1V6noP8ARoel", -- [11]
										"TMW:icon:1ZYXYoMjwNSI", -- [12]
										"TMW:icon:1ZXaz0p3YpOm", -- [13]
