							...
							["Icons"] = {
								{
									...
									["Icons"] = {
										...
										"TMW:icon:1ZM_VlmD27Ka", -- [2]
										"TMW:icon:1V6noP8ARoel", -- [3]
										"TMW:icon:1Z69muUKqqKC", -- [4]
										"TMW:icon:1bRqDvw9Jzmr", -- [5]
										"TMW:icon:1cLBDv2Q0aKk", -- [6]
										"TMW:icon:1ZJNiKMfEYOM", -- [7]
										"TMW:icon:1cLBDv16RMKP", -- [8]
