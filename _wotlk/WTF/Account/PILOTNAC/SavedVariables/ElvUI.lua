	...
	["profiles"] = {
		["Default"] = {
			...
			["movers"] = {
				...
				["LootFrameMover"] = "TOP,ElvUIParent,TOP,0,-280",
				...
				["ElvUF_RaidMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,4,-137",
				...
				["ElvUF_PlayerMover"] = "BOTTOM,ElvUIParent,BOTTOM,-294,256",
				...
				["ElvUF_TargetMover"] = "BOTTOM,ElvUIParent,BOTTOM,285,260",
				["AzeriteBarMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,415,22",
				["BuiDashboardMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,0,-3",
				["ElvUF_Raid40Mover"] = "TOPLEFT,ElvUIParent,TOPLEFT,4,-123",
				["AurasMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-190,-20",
				["ElvUF_TargetTargetMover"] = "BOTTOM,ElvUIParent,BOTTOM,348,232",
				...
				["ElvUF_PetMover"] = "BOTTOM,ElvUIParent,BOTTOM,-235,227",
