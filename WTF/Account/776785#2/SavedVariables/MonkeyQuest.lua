...
MonkeyQuestConfig = {
	["Golemagg|Verminz"] = {
		["m_aQuestList"] = {
			...
			["Between a Rock and a Thistlefur - false"] = {
				["m_bChecked"] = true,
			},
			["Amongst the Ruins - false"] = {
				["m_bChecked"] = true,
			},
			...
			["The Essence of Aku'Mai - false"] = {
				["m_bChecked"] = true,
			},
			["Vorsha the Lasher - false"] = {
				["m_bChecked"] = true,
			},
			["Warrior - true"] = {
				["m_bChecked"] = false,
	...
	["Global"] = {
		...
		["m_bShowQuestLevel"] = true,
		["m_bShowDailyNumQuests"] = false,
		["m_iFrameBottom"] = 765.733459472656,
		["m_bHideTitleButtons"] = false,
