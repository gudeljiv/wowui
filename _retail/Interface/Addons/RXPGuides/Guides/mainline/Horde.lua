...
step
#completewith next
+|cfff78300During the Anniversary Event pick up the gift from the mail, open it and use the Celebration Package.|r If nothing is in your mail then relog
.isQuestAvailable 60360
.nodmf

step
.goto 85,49.40,76.58
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to the Warchief's Herald
.accept 51443 >>Accept Battle for Azeroth: Mission Statement
.target Warchief's Herald
.isQuestAvailable 60360
step
.goto 85,49.34,74.02
>>Enter Grommash Hold. Press "Escape" on your keyboard to skip the cinematic
.complete 51443,1 
.isQuestAvailable 60360
step
#completewith next
...
.goto 85,38.55,78.23,40 >> Travel toward Revi
step
#label ReviR
.goto 85,38.55,78.23
...
.isQuestAvailable 60360
.goto 85,40.83,80.16
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to Chromie and select |cfff78300The Iron Horde|r campaign
...
step
.goto 85,53.56,78.79
>>Be sure to buy food/water if needed
...
.goto 85,53.83,82.60
.vendor >>Talk to Trak'gen. Buy Brown Leather Satchels from him. Skip this step if you already have better bags
.target Trak'gen
step
#completewith DMFDarkmoonPortalTaken
...
.dmf
step
#label TalkToDarkmoonFaireMage
#completewith next
.goto 125,50.29,50.38
.zone 7 >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to the Darkmoon Faire Mystic Mage again to be teleported to Mulgore
.skipgossip
.target Darkmoon Faire Mystic Mage
.dmf
step
#label DMFDarkmoonPortalTaken
#completewith TakePortalToMulgoreDMF
.goto 7,36.85,35.86
.zone 407 >>Take the Portal to the Darkmoon Faire
.dmf
step
#requires DMFDarkmoonPortalTaken
#completewith DMFBuff
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to Kae Ti and buy the 'Ride Ticket Book'
.goto 407,53.58,37.60,30,0
.goto 407,55.77,53.00,50,0
.goto 407,50.46,59.27
.collect 92788,1
.target Kae Ti
.dmf
step
#requires DMFDarkmoonPortalTaken
#completewith DMFBuff
>>Open the book in your bags
.use 92788
.collect 81055,1
.dmf
step
#label DMFBuff
+Go onto the Carousel and look at your buff bar.
*Leave the Carousel when the 'WHEE!' buff has a duration of 60 minutes and skip this step.
.goto 407,49.24,57.30
.dmf
step
#veteran
#requires DMFBuff
>> Use the previously bought items in your bags. Skip the quests you can't accept
...
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to Professor Thaddeus Paleo
...
.zoneskip 407,1
step
.goto 407,47.77,64.79
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to Gelvas Grimegate
.turnin 7926 >>Turn in The Darkmoon Fair
.target Gelvas Grimegate
.dmf
.zoneskip 407,1
.isOnQuest 7926
step
#completewith DMFHeartBackToOrgrimmar
#label DMFBuyHats
.goto 407,47.77,64.77
>> Buy 6 Darkmoon Top Hats
*Skip if you can't buy more or any
.collect 171364,6
.dmf
.zoneskip 407,1
step
...
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to Sayge for Buffs
.target Sayge
.dmf
.skipgossip 1
.collect 19422,1
...
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to Yebb Neblegear
...
step
.goto 85,51.26,77.09
>>Leave the building and mount the Sturdy Wyvern
.complete 60361,4 
...
step
.goto 85,54.43,78.43
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to Nathanos to get teleported to Zandalar
...
.isOnQuest 50769
step
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tFollow Talanji and talk to her
>>Press "Escape" on your keyboard to skip the cinematic
...
.goto 1165,48.18,32.27
.skipgossip
.complete 47439,1 
step
.isQuestTurnedIn 47443
#completewith next
.goto 1165,48.05,28.70,20,0
.goto 1165,48.56,26.87,20,0
