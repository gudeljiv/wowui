...
L["Are you sure you want to recreate this route? This will delete all customized settings for this route."] = "你是否确定重新创建此线路？这会删除此线路的所有设置。"
...
L["Background Route Clustering completed."] = "后台路线聚合完成。"
...
L["Cluster"] = "聚合"
L["Cluster (in Background)"] = "聚合（后台运行）"
L["Cluster Radius"] = "聚合半径"
L["Cluster this route"] = "聚合这条路线"
L["Cluster this route in the background"] = "在后台聚合此路线"
...
L["Normal lines"] = "标准线条"
L["Note"] = "便签"
L["Now running route clustering in the background..."] = "正在后台运行路线聚合..."
...
L["Recreate Route"] = "重新创建线路"
L["Recreate this route with the same creation settings. NOTE: This only works for data from GatherMate2 and Gatherer."] = "用相同的设置重新创建此线路。注意：只能用于 GatherMate2 和 Gatherer 的数据。"
L["Reset"] = "重置"
