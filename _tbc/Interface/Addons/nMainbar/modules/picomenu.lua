...
local function UpdateAddOnTable()
	if C_AddOns.IsAddOnLoaded("oUF_NeavRaid") and not v1 then
		x = true
	...
	if C_AddOns.IsAddOnLoaded("VuhDo") and not v2 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v2 = true
		addonMenuTable[2].menuList[n] = {
	...
	if (C_AddOns.IsAddOnLoaded("Grid") or C_AddOns.IsAddOnLoaded("Grid2")) and not v3 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v3 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("Omen") and not v4 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v4 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("PhoenixStyle") and not v5 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v5 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("DBM-Core") and not v6 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v6 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("Skada") and not v7 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v7 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("Recount") and not v8 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v8 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("TinyDPS") and not v9 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v9 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("Numeration") and not v10 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v10 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("AtlasLoot") and not v11 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v11 = true
		addonMenuTable[2].menuList[n] = {
	...
	if C_AddOns.IsAddOnLoaded("Altoholic") and not v12 then
		x = true
		n = #addonMenuTable[2].menuList + 1
		v12 = true
		addonMenuTable[2].menuList[n] = {
