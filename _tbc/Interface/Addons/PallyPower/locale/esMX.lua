...
L["AUTOASSIGN_DESC"] = [=[Asignar automáticamente todas las bendiciones basadas enla cantidad de paladines disponiblesy sus bendiciones disponibles.|cffffffff [Shift-clic izquierdo]|r Usar campo de batallaplantilla de asignación en lugar de Bandaplantilla de asignación.]=]
...
L["REPORTCHANNEL_DESC"] = [=[Establezca la ventana deseada para transmitir el Informe Bliessings a:|cffffd200 [Ninguno]|r Selecciona el canal en función de la composición del grupo. (Grupo / Banda)|cffffd200 [Lista de canales]|r Una lista de canales autocompletada basada en los canales a los que se ha unido el reproductor. Los canales predeterminados como Comercio, General, etc. se filtran automáticamente de la lista.|cffffff00Nota: Si cambia su orden de canal, deberá volver a cargar su IU y verificar que se está transmitiendo al canal correcto.|r]=]
...
L["SALVCOMBAT_DESC"] = [=[Si habilita esta opción, podrá pulir Guerreros, Druidas y Paladines con Mayor Bendición de Salvación durante el combate.|cffffff00Nota: Esta configuración SOLO se aplica a los grupos de banda porque en nuestra cultura actual, muchos tanques usan scripts / complementos para cancelar las mejoras que solo se pueden hacer mientras no están en combate. Esta opción es básicamente una seguridad para evitar pulir accidentalmente un tanque con salvación durante el combate.|r]=]
