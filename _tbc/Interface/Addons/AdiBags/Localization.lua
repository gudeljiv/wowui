...
if locale == "frFR" then
	...
	L["Click on this button to create the new association."] =
		"Cliquez sur ce bouton pour créer la nouvelle association."
	...
	L["Consider glyphs as a subcategory of trade goods"] =
		"Considère les glyphes comme une sous-catégorie d'artisanat."
	...
	L["Enter the name of the section to associate with the item."] =
		"Entrez le nom de la section à associer à l'objet."
	...
	L["Merge incomplete stacks with complete ones."] =
		"Fusionne les piles incomplètes avec celles qui sont complètes."
	...
	L["Show only one free slot for each kind of bags."] =
		"N'affiche qu'un seul emplacement vide pour chaque type de sac."
...
elseif locale == "deDE" then
	...
	L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
		"Aktiviere Sets die in einem einzigartigen Set-Bereich zusammengeführt werden sollen. Das ist offensichtlich eine Einstellung für jeden Charakter."
	L["Check this so armors are dispatched in four sections by type."] =
	...
	L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
		'Aktivieren um einen individuellen Bereich pro Set anzuzeigen. Wenn das hier nicht aktiviert ist wird nur ein großer "Set" Bereich angezeigt.'
	L["Check this to display only one value counting all equipped bags, ignoring their type."] =
	...
	L["Click there to reset the bag positions and sizes."] =
		"Hier klicken zum Zurücksetzen der Taschenposition und Größe."
	...
	L["Consider gems as a subcategory of trade goods"] =
		"Edelsteine als Unterkategorie von handelbaren Gegenständen betrachten"
	L["Consider glyphs as a subcategory of trade goods"] =
		"Glyphen als Unterkategorie von handelbaren Gegenständen betrachten"
	...
	L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] =
		"Zeigt Gegenstände die zu einem oder mehreren Sets des Ausrüstungsmanagers gehören in eigenen Bereichen an."
	L["Put items in sections depending on their first-level category at the Auction House."] =
...
elseif locale == "esES" then
	...
	L["Click there to reset the bag positions and sizes."] =
		"Apretar aqui para borrar la posicion y tamaño de la bolsa."
	...
	L["Consider glyphs as a subcategory of trade goods"] =
		"Considerar Glifos  como subcategoria de objetos comerciables."
...
elseif locale == "zhTW" then
	...
	L["Category"] = "種類"
	L["Change stacking at merchants', auction house, bank, mailboxes or when trading."] =
		"商人，拍賣行，銀行，郵箱或交易時更改堆疊。"
	L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
		'檢查"裝備組合"應合併成一個獨特的“組合”分類。此項根據每個角色設置有所不同。' -- Needs review
	L["Check this so armors are dispatched in four sections by type."] =
		"護甲將按四大類型分組（布甲/皮甲/鎖甲/鎧甲）。" -- Needs review
	...
	L["Display a smaller money frame. This setting will take effect on next reload."] =
		"顯示一個小的錢框架。此設置將在下一次重載後產生效果。" -- Needs review
	...
	L["Money"] = "金錢"
	L["Move items from and to the bank by right-clicking on section headers."] =
		"通過類別標題右鍵單擊進行，移動該類別物品到銀行。" -- Needs review
	L["Never"] = "從不"
	L["New"] = "新物品"
	L["New Override"] = "新覆蓋"
	...
	L["Press Alt while doing so to open a dropdown menu."] =
		"按下Alt鍵，而這樣做可以打開一個下拉菜單。" -- Needs review
	L["Priority"] = "優先順序"
	L["Provides a LDB data source to be displayed by LDB display addons."] = "提供LDB顯示插件的資料來源"
	L['Put any item that can be equipped (including bags) into the "Equipment" section.'] =
		"放置可裝備物品至「裝備」類別。" -- Needs review
	L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] =
		"按裝備管理設置的套裝類別放置物品。" -- Needs review
	L["Put items in sections depending on their first-level category at the Auction House."] =
		"按拍賣場主類型規則類別放置物品。" -- Needs review
	L['Put items of poor quality or labeled as junk in the "Junk" section.'] =
		"將劣質或垃圾裝備放置於垃圾類別。" -- Needs review
	...
	L["Virtual stacks display in one place items that actually spread over several bag slots."] =
		"將散落於各背包內的同一物品以虛擬堆疊顯示"
	L["Virtual stack slots"] = "虛擬堆疊插槽"
	L["Warning: You are using an alpha or beta version of AdiBags without displaying Lua errors. If anything goes wrong, AdiBags (or any other addon causing some error) will simply stop working for apparently no reason. Please either enable the display of Lua errors or install an error handler addon like BugSack or Swatter."] =
		"警告：您使用的是α或β版本的AdiBags不顯示的Lua錯誤。如果出現任何錯誤，AdiBags（或任何其他插件，導致一些錯誤的），只是停止工作，顯然沒有理由。請使顯示的Lua錯誤或安裝錯誤處理程序插件(UI)如BugSack 或 Swatter。" -- Needs review
	L["When alt is held down"] = "當 alt 按住"
	L["When any modifier key is held down"] = "當任何修改鍵按住"
	L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] =
		"檢閱時，在包的空白處點擊右鍵，打開配置面板。" -- Needs review
	L["When ctrl is held down"] = "當 ctrl 按住"
	L["When shift is held down"] = "當 shift 按住"
	L["Which color scheme should be used to display the item level ?"] =
		"應該使用哪種顏色設定顯示物品的等級?" -- Needs review
...
elseif locale == "zhCN" then
	...
	L["Check this so armors are dispatched in four sections by type."] =
		"护甲将按四大类型分组 (布甲/皮甲/锁甲/板甲)."
	L["Check this to display a bag type tag in the top left corner of items."] =
		"在物品左上角显示标签, 标示其放置的特殊背包类型."
...
elseif locale == "koKR" then
	...
	L["6.0"] = "6.0"
	L["Add a dropdown menu to bags that allow to hide the sections."] =
		"가방에 항목을 숨길 수 있는 드롭다운 메뉴를 추가합니다."
	L["Add association"] = "연결 추가"
	L["Add more information in tooltips related to items in your bags."] =
		"가방의 아이템과 관련된 추가 정보를 툴팁에 표시합니다."
	L["AdiBags Anchor"] = "AdiBags 고정기"
	L["Adjust the maximum height of the bags, relative to screen size."] =
		"화면 크기에 맞춰 가방의 최대 높이를 조절합니다."
	...
	L["Alt-right-click to configure the Junk module."] =
		"Alt-오른쪽 클릭으로 잡동사니 모듈을 설정합니다."
	L["Alt-right-click to switch to anchored placement."] =
		"Alt-오른쪽 클릭하여 고정된 위치로 전환합니다."
	...
	L["Automatically open the bags at merchant's, bank, ..."] =
		"상점과 은행 등을 사용할 때 자동으로 가방을 엽니다."
	L["auto-sort"] = "자동 정렬"
	L["Auto-sort can cause freeze when the bag is closed."] =
		"가방을 닫을 때 자동 정렬 기능이 오류를 발생시킬 수 있습니다."
	L["Backpack"] = "소지품"
	...
	L["By category, subcategory, quality and item level (default)"] =
		"분류, 하위 분류, 품질과 레벨 별(기본값)"
	L["By name"] = "아이템 이름 별"
	L["By quality and item level"] = "아이템 품질과 레벨 별"
	L["Category"] = "분류"
	L["Change stacking at merchants', auction house, bank, mailboxes or when trading."] =
		"상점, 은행, 경매장, 우편함 또는 거래 중일 때 아이템 중첩을 변경합니다."
	L['Check sets that should be merged into a unique "Sets" section. This is obviously a per-character setting.'] =
		'특별한 "구성" 항목으로 합칠 장비 구성을 선택하세요. 이 설정은 캐릭터 별로 저장됩니다.'
	L["Check this so armors are dispatched in four sections by type."] =
		"방어구를 유형에 따라 네가지 항목으로 분류합니다.(판금/사슬/가죽/천)"
	L["Check this to display a bag type tag in the top left corner of items."] =
		"아이템의 좌측 상단 모서리에 가방 유형 태그를 표시합니다."
	L["Check this to display a colored border around items, based on item quality."] =
		"아이템 테두리에 품질 색상을 표시합니다."
	L["Check this to display an icon after usage of each type of bags."] =
		"각 유형의 가방 사용량 다음에 아이콘을 표시합니다."
	L["Check this to display an indicator on quest items."] = "퀘스트 아이템의 테두리를 강조합니다."
	L["Check this to display an textual tag before usage of each type of bags."] =
		"각 유형의 가방 사용량 앞에 문자 태그를 표시합니다."
	L['Check this to display one individual section per set. If this is disabled, there will be one big "Sets" section.'] =
	...
	L["Click to toggle the equipped bag panel, so you can change them."] =
		"가방을 변경할 수 있도록 착용 중인 가방 창을 표시 전환합니다."
	L["Close"] = "닫기"
	L["Color"] = "색상"
	...
	L["Display character currency at bottom left of the backpack."] =
		"소지품의 좌측 하단에 캐릭터 화폐를 표시합니다."
	L["Display character money at bottom right of the backpack."] =
		"소지품 우측 하단에 캐릭터 소지금을 표시합니다."
	L["Display the level of equippable item in the top left corner of the button."] =
	...
	L["Highlight what changes in bags with a little sparkle."] =
		"가방에 변경 사항이 있을 경우 해당 아이콘이 반짝입니다."
	...
	L["Money"] = "소지금"
	L["Move items from and to the bank by right-clicking on section headers."] =
		"항목 이름을 오른쪽 클릭하면 아이템을 은행에 맡기거나 찾습니다."
	L["Never"] = "표시하지 않음"
	L["New"] = "새 아이템"
	...
	L["Priority"] = "우선 순위"
	L["Provides a LDB data source to be displayed by LDB display addons."] =
		"LDB 표시 애드온에 표시될 LDB 데이터 소스를 제공합니다."
	L['Put any item that can be equipped (including bags) into the "Equipment" section.'] =
	...
	L['Put items of poor quality or labeled as junk in the "Junk" section.'] =
		'하급 아이템이나 잡동사니 아이템을 "잡동사니" 항목으로 분류합니다.'
	...
	L["Right-click to (un)lock the bag anchor."] =
		"오른쪽 클릭하여 가방 위치 고정기를 잠그거나 잠금해제합니다."
	...
	L["Select how bag usage should be formatted in the plugin."] =
		"플러그인에서 가방 사용량을 어떻게 형식화 할지 선택합니다."
	L["Select how items should be sorted within each section."] =
		"각 항목 내에서 아이템을 정렬할 방법을 선택합니다."
	...
	L["Show only one free slot for each kind of bags."] =
		"가방의 종류에 따라 빈 공간을 하나로 표시합니다."
	L["Show only one slot of items that can be stacked."] =
		"겹칠 수 있는 아이템을 하나의 칸에 표시합니다."
	L["Show only one slot of items that cannot be stacked."] =
		"겹칠 수 없는 아이템을 하나의 칸에 표시합니다."
	L["Size"] = "크기"
	L["Skin"] = "스킨"
	L["Slot number"] = "슬롯 번호"
	L["Small"] = "작게"
	...
	L["Use this section to define any item-section association."] =
		"모든 아이템-항목 연결을 정의하는데 이 항목을 사용합니다."
...
elseif locale == "ptBR" then
	...
	L["Automatically open the bags at merchant's, bank, ..."] =
		"Abre as bolsas automaticamente nos mercadores, banco..."
	L["Backpack"] = "Mochila"
	...
	L["Do not show level of items that cannot be equipped."] =
		"Não mostrar o nível de itens que não podem ser equipados."
	...
	L["Press Alt while doing so to open a dropdown menu."] =
		"Pressione Alt enquanto faz isso para abrir o menu dropdown"
	...
	L["Show only one slot of items that can be stacked."] =
		"Mostre somente um espaço com itens que podem ser empilhados"
	L["Show only one slot of items that cannot be stacked."] =
