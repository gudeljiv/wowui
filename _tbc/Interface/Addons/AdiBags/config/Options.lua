					...
					themeControls = {
						...
						args = {
							...
							saveTheme = {
								...
								order = 10,
								confirm = function()
									return "Are you sure you want to save and overwrite the theme '"
										.. addon.db.profile.theme.currentTheme
										.. "'?"
								end,
								disabled = function()
									return addon.db.profile.theme.currentTheme == "default"
							...
							newThemeName = {
								...
								validate = function(_, value)
									return (not addon:ThemeExists(value) and true)
										or "A theme by that name already exists."
								end,
								get = function()
									return ""
								end,
								set = function(_, value)
									addon:NewTheme(value)
									addon:SetTheme(value)
								end,
							},
						},
