...
L["%s poder de ataque %s índice de golpe"] = { { Stats.AttackPower, Stats.RangedAttackPower, }, { Stats.HitRating, }, } -- e3052
...
L["%s poder de ataque y %s maná cada %s segundos"] = { { Stats.AttackPower, Stats.RangedAttackPower, }, { Stats.GenericManaRegen, }, false, } -- e3136
...
L["%s poder de ataque y %s índice de celeridad"] = { { Stats.AttackPower, Stats.RangedAttackPower, }, { Stats.HasteRating, }, } -- e3426
...
L["%s poder de ataque y reducción de duración de aturdir un %s%"] = { { Stats.AttackPower, Stats.RangedAttackPower, }, false, } -- e3638
