...
local baseLocale = {
    ...
    ["Resets the position of the waypoint arrow if it has been dragged off screen"] = "목표지점 안내 화살표의 위치를 초기화합니다.(실수로 화면밖으로 옮겨졌을때)",
    ...
    ["TomTom can display a tooltip containing information about waypoints, when they are moused over.  This setting toggles that functionality"] = "툴팁에 목표지점에 대한 정보를 표시할지를 결정합니다.",
    ...
    ["|cffffff78/way <x> <y> [desc]|r - Adds a waypoint at x,y with description desc"] = "|cffffff78/way <x> <y> [표시할 제목]|r - x,y 좌표에 목표지점 지정(표시할 제목은 생략가능)",
...
addon:RegisterLocale('koKR', baseLocale)
