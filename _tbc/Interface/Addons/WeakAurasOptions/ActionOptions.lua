...
function OptionsPrivate.GetActionOptions(data)
	local action = {
		...
		args = {
			...
			start_message_type = {
				...
				disabled = function()
					return not data.actions.start.do_message
				end,
			...
			start_message_warning = {
				...
				order = 2.5,
				hidden = function()
					return not RestrictedChannelCheck(data.actions.start)
				end
			},
			start_message_space = {
				type = 'execute',
				...
				hidden = function()
					return not (data.actions.start.message_type == 'WHISPER' or data.actions.start.message_type == 'COMBAT' or data.actions.start.message_type == 'PRINT' or data.actions.start.message_type == 'ERROR')
				end
			},
			start_message_color = {
				type = 'color',
				...
				hasAlpha = false,
				hidden = function()
					return not (data.actions.start.message_type == 'COMBAT' or data.actions.start.message_type == 'PRINT' or data.actions.start.message_type == 'ERROR')
				end,
				get = function()
					return data.actions.start.r or 1, data.actions.start.g or 1, data.actions.start.b or 1
				end,
			...
			start_message_tts_voice = {
				...
				hidden = function()
					return (WeakAuras.IsClassic()) or data.actions.start.message_type ~= 'TTS'
				end,
			...
			start_do_loop = {
				...
				order = 8.1,
				disabled = function()
					return not data.actions.start.do_sound
				end
			},
			start_sound_repeat = {
				type = 'range',
				...
				order = 8.2,
				hidden = function()
					return not data.actions.start.do_loop
				end,
				disabled = function()
					return not data.actions.start.do_sound
				end,
			...
			start_sound_channel = {
				...
				get = function()
					return data.actions.start.sound_channel or 'Master'
				end
			},
			start_sound_path = {
				type = 'input',
				...
				order = 9,
				hidden = function()
					return data.actions.start.sound ~= ' custom'
				end,
				disabled = function()
					return not data.actions.start.do_sound
				end
			...
			start_sound_kit_id = {
				...
				order = 9,
				hidden = function()
					return data.actions.start.sound ~= ' KitID'
				end,
				disabled = function()
					return not data.actions.start.do_sound
				end
			...
			start_glow_frame_type = {
				...
				width = WeakAuras.normalWidth,
				desc = function()
					return (data.actions.start.glow_frame_type == 'UNITFRAME' or data.actions.start.glow_frame_type == 'NAMEPLATE') and L['Require unit from trigger'] or nil
				end,
				...
				hidden = function()
					return not data.actions.start.do_glow or data.actions.start.glow_action == nil
				end
			},
			start_glow_type_spacer = {
				...
				order = 10.35,
				hidden = function()
					return not data.actions.start.do_glow or not (data.actions.start.glow_action == 'hide' and data.actions.start.glow_frame_type == 'FRAMESELECTOR')
				end
			},
			start_glow_type = {
				type = 'select',
				...
				hidden = function()
					return not data.actions.start.do_glow or data.actions.start.glow_action ~= 'show' or data.actions.start.glow_frame_type == nil
				end
			},
			start_glow_frame = {
				type = 'input',
				...
				order = 10.5,
				hidden = function()
					return not data.actions.start.do_glow or data.actions.start.glow_frame_type ~= 'FRAMESELECTOR'
				end
			},
			...
			start_use_glow_color = {
				...
				order = 10.7,
				hidden = function()
					return not data.actions.start.do_glow or data.actions.start.glow_action ~= 'show' or data.actions.start.glow_frame_type == nil or data.actions.start.glow_type == nil
				end
			},
			start_glow_color = {
				type = 'color',
				...
				disabled = function()
					return not data.actions.start.use_glow_color
				end
			},
			start_glow_lines = {
				type = 'range',
			...
			start_glow_length = {
				...
				hidden = function()
					return not data.actions.start.do_glow or data.actions.start.glow_action ~= 'show' or data.actions.start.glow_type ~= 'Pixel' or data.actions.start.glow_frame_type == nil
				end
			},
			...
			finish_message_type = {
				...
				values = OptionsPrivate.Private.send_chat_message_types,
				disabled = function()
					return not data.actions.finish.do_message
				end,
				control = 'WeakAurasSortedDropdown'
			},
			finish_message_warning = {
				...
				order = 22.5,
				hidden = function()
					return not RestrictedChannelCheck(data.actions.finish)
				end
			},
			...
			finish_message_color = {
				...
				hasAlpha = false,
				hidden = function()
					return not (data.actions.finish.message_type == 'COMBAT' or data.actions.finish.message_type == 'PRINT' or data.actions.finish.message_type == 'ERROR')
				end,
				get = function()
					return data.actions.finish.r or 1, data.actions.finish.g or 1, data.actions.finish.b or 1
				end,
				set = function(info, r, g, b)
			...
			finish_message_tts_voice = {
				...
				hidden = function()
					return (not WeakAuras.IsRetail()) or data.actions.finish.message_type ~= 'TTS'
				end,
				values = OptionsPrivate.Private.tts_voices,
				desc = L['Available Voices are system specific']
			},
			...
			finish_sound = {
				...
				values = OptionsPrivate.Private.sound_types,
				disabled = function()
					return not data.actions.finish.do_sound
				end,
				control = 'WeakAurasSortedDropdown'
			},
			finish_sound_channel = {
				...
				get = function()
					return data.actions.finish.sound_channel or 'Master'
				end
			},
			finish_sound_path = {
				type = 'input',
				...
				order = 29,
				hidden = function()
					return data.actions.finish.sound ~= ' custom'
				end,
				disabled = function()
					return not data.actions.finish.do_sound
				end
			...
			finish_sound_kit_id = {
				...
				order = 29,
				hidden = function()
					return data.actions.finish.sound ~= ' KitID'
				end,
				disabled = function()
					return not data.actions.finish.do_sound
				end
			...
			finish_glow_frame_type = {
				...
				width = WeakAuras.normalWidth,
				desc = function()
					return (data.actions.finish.glow_frame_type == 'UNITFRAME' or data.actions.finish.glow_frame_type == 'NAMEPLATE') and L['Require unit from trigger'] or nil
				end,
				name = L['Glow Frame Type'],
				order = 30.3,
				values = {
				...
				hidden = function()
					return not data.actions.finish.do_glow or data.actions.finish.glow_action == nil
				end
			},
			finish_glow_type_spacer = {
				...
				order = 30.35,
				hidden = function()
					return not data.actions.finish.do_glow or not (data.actions.finish.glow_action == 'hide' and data.actions.finish.glow_frame_type == 'FRAMESELECTOR')
				end
			},
			finish_glow_type = {
				type = 'select',
				...
				values = OptionsPrivate.Private.glow_types,
				hidden = function()
					return not data.actions.finish.do_glow or data.actions.finish.glow_action ~= 'show' or data.actions.finish.glow_frame_type == nil
				end
			},
			finish_glow_frame = {
				type = 'input',
				...
				order = 30.5,
				hidden = function()
					return not data.actions.finish.do_glow or data.actions.finish.glow_frame_type ~= 'FRAMESELECTOR'
				end
			},
			...
			finish_use_glow_color = {
				...
				order = 30.7,
				hidden = function()
					return not data.actions.finish.do_glow or data.actions.finish.glow_action ~= 'show' or data.actions.finish.glow_frame_type == nil or data.actions.finish.glow_type == nil
				end
			},
			finish_glow_color = {
				type = 'color',
				...
				disabled = function()
					return not data.actions.finish.use_glow_color
				end
			},
			finish_glow_lines = {
				type = 'range',
				...
				hidden = function()
					return not data.actions.finish.do_glow or data.actions.finish.glow_action ~= 'show' or not data.actions.finish.glow_type or data.actions.finish.glow_type == 'buttonOverlay' or
						data.actions.finish.glow_frame_type == nil
				end
			},
	...
	OptionsPrivate.commonOptions.AddCodeOption(
		...
		5,
		function()
			return not (data.actions.start.do_message and OptionsPrivate.Private.ContainsCustomPlaceHolder(data.actions.start.message))
		end,
	...
	local function startAddOption(key, option)
		...
		if option.hidden then
			...
			option.hidden = function()
				return not data.actions.start.do_message or hidden()
			end
		else
			option.hidden = function()
				return not data.actions.start.do_message
	...
	OptionsPrivate.commonOptions.AddCodeOption(
		...
		L['Custom Code'],
		'start',
		'https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Code-Blocks#on-show',
		13,
		function()
	...
	OptionsPrivate.commonOptions.AddCodeOption(
		...
		25,
		function()
			return not (data.actions.finish.do_message and OptionsPrivate.Private.ContainsCustomPlaceHolder(data.actions.finish.message))
		end,
	...
	local function finishAddOption(key, option)
		...
		if option.hidden then
			local hidden = option.hidden
			option.hidden = function()
				return not data.actions.finish.do_message or hidden()
			end
		else
			option.hidden = function()
				return not data.actions.finish.do_message
	...
	if data.controlledChildren then
		...
		action.hidden = function(info, ...)
			return hiddenAll(data, info, ...)
		end
		action.disabled = function(info, ...)
