...
local SLASH_COMMAND_ARGUMENTS = {
	{
		...
		print = function()
			return L['Spell switching is [%s]'], SlashCommands:GetColoredSettingState(TE.db.profile.autoTracking.spellSwitcher.enabled)
		end,
		hidden = false,
		callback = function()
	...
	},
	{
		...
		print = function()
			return L['Spell switching only while moving is [%s]'], SlashCommands:GetColoredSettingState(TE.db.profile.autoTracking.spellSwitcher.onmove)
		end,
		hidden = false,
		callback = function()
	...
	},
	{
		...
		print = function()
			return L['Mute spell use sound is [%s]'], SlashCommands:GetColoredSettingState(TE.db.profile.autoTracking.general.muteSpellUseSound)
		end,
		hidden = false,
		callback = function()
			TE.db.profile.autoTracking.general.muteSpellUseSound = not TE.db.profile.autoTracking.general.muteSpellUseSound
		end,
		order = 5
	},
	{
		...
		print = function()
			return L['Required profession level on World tooltips is [%s]'], SlashCommands:GetColoredSettingState(TE.db.profile.tooltip.requiredProfessionLevel.enableWorld)
		end,
		hidden = false,
		callback = function()
			TE.db.profile.tooltip.requiredProfessionLevel.enableWorld = not TE.db.profile.tooltip.requiredProfessionLevel.enableWorld
		end,
		order = 6
	},
	{
		...
		print = function()
			return L['Required profession level on Minimap tooltips is [%s]'], SlashCommands:GetColoredSettingState(TE.db.profile.tooltip.requiredProfessionLevel.enableMinimap)
		end,
		hidden = false,
		callback = function()
			TE.db.profile.tooltip.requiredProfessionLevel.enableMinimap = not TE.db.profile.tooltip.requiredProfessionLevel.enableMinimap
		end,
		order = 6
	},
	{
		...
		print = function()
			return L['Required profession level on World Map tooltips sis [%s]'], SlashCommands:GetColoredSettingState(TE.db.profile.tooltip.requiredProfessionLevel.enableWorldMap)
		end,
		hidden = false,
		callback = function()
			TE.db.profile.tooltip.requiredProfessionLevel.enableWorldMap = not TE.db.profile.tooltip.requiredProfessionLevel.enableWorldMap
		end,
		order = 6
	},
	{
	...
	},
	{
		...
		print = function()
			return L['Settings have been reset to default']
		end,
		hidden = false,
		callback = function()
	...
	},
	{
		...
		desc = '',
		print = function()
			return 'Debug is [%s]', SlashCommands:GetColoredSettingState(Log:GetDubugState())
		end,
		hidden = true,
		callback = function()
			Log:DebugToggle()
		...
		callback = function()
			if GameTooltip:IsShown() then
				for i = 1, GameTooltip:NumLines() do
					...
					if fontObject then
						fontObjectName = fontObject:GetName()
					end
