...
L["STRING_CUSTOM_EDIT_TOOLTIP_CODE"] = "Modifier le code de l'info-bulle"
...
L["STRING_CUSTOM_EDITTOOLTIP_DESC"] = "Il s'agit du code de l'info-bulle, qui s'exécute lorsque l'utilisateur survole une barre."
...
L["STRING_MEMORY_ALERT_BUTTON"] = "Je comprends"
...
L["STRING_MENU_CLOSE_INSTANCE_DESC"] = "Une fenêtre fermée est considérée comme inactive et peut être rouverte à tout moment à l'aide du menu de contrôle des fenêtres."
L["STRING_MENU_CLOSE_INSTANCE_DESC2"] = "Pour supprimer définitivement une fenêtre, allez dans l'onglet \"Fenêtre : Général\""
...
L["STRING_MINIMAP_TOOLTIP12"] = "|cFFCFCFCFclic gauche|r : afficher / masquer les fenêtres"
L["STRING_MINIMAP_TOOLTIP2"] = "|cFFCFCFCFclic droit|r : menu rapide"
L["STRING_MINIMAPMENU_CLOSEALL"] = "Tout fermer"
L["STRING_MINIMAPMENU_HIDEICON"] = "Cacher l'icône de la mini-carte"
...
L["STRING_NO_MYTHIC_PLUS_ADDON"] = "Pour suivre vos donjons Mythic+ incluant le butin, le score, les dégâts, les soins réalisés et avec qui vous avez joué, installez l’addon |cFFFFAA00Details! Damage Meter Mythic+|r sur |cFFfff1c1Wago AddOns|r ou |cFFfff1c1Curse Forge|r."
...
L["STRING_OPTIONS_DATABROKER_TEXT1_DESC"] = "|cFFFFFF00{dmg}|r : dégâts infligés du joueur|n|cFFFFFF00{dps}|r : dégâts par seconde effectifs du joueur|n|cFFFFFF00{rdps}|r : dégâts par seconde effectifs du raid|n|cFFFFFF00{dpos}|r : rang des dégâts entre les membres du raid ou du groupe de joueurs|n|cFFFFFF00{ddiff}|r : différence de dégâts entre vous et la première place|n|cFFFFFF00{heal}|r : soins prodigués du joueur|n|cFFFFFF00{hps}|r : soins par seconde effectifs du joueur|n|cFFFFFF00{rhps}|r : soins par seconde effectifs du raid|n|cFFFFFF00{hpos}|r : rang des soins entre les membres du raid ou du groupe de joueurs|n|cFFFFFF00{hdiff}|r : différence de soins entre vous et la première place|n|cFFFFFF00{time}|r : temps de combat écoulé"
...
L["STRING_OPTIONS_ED_DESC"] = "|cFFFFFF00Manuellement|r : l'utilisateur doit cliquer sur le bouton de réinitialisation|n|cFFFFFF00Demander|r : demander de réinitialiser en entrant dans une nouvelle instance|n|cFFFFFF00Automatique|r : effacer les données à l'entrée d'une nouvelle instance"
...
L["STRING_OPTIONS_GROUPING_HORIZONTAL_GAP"] = "\"Espace entre les fenêtres\""
...
L["STRING_OPTIONS_MPLUS_AUTO_CLOSE_TIME"] = "Délai avant fermeture automatique"
L["STRING_OPTIONS_MPLUS_AUTO_CLOSE_TIME_DESC"] = "Délai avant la fermeture automatique du panneau de fin de clé Mythique +"
L["STRING_OPTIONS_MPLUS_BOSSNEWCOMBAT"] = "Nouveau combat lors de l'engagement du boss"
L["STRING_OPTIONS_MPLUS_BOSSNEWCOMBAT_DESC"] = "Si un boss est lancé pendant un combat, cette option ferme la rencontre actuelle et en lance une nouvelle pour le boss."
L["STRING_OPTIONS_MPLUS_DPS_ANCHOR"] = "Calcul du DPS global du segment"
L["STRING_OPTIONS_MPLUS_MERGETRASH"] = "Fusionner les trashs"
L["STRING_OPTIONS_MPLUS_PANELS_ANCHOR"] = "Panneaux"
L["STRING_OPTIONS_MPLUS_SHOWENDPANEL"] = "Afficher le panneau à la fin de la clé Mythique+"
L["STRING_OPTIONS_MPLUS_TIME_INCOMBAT"] = "Temps en combat"
L["STRING_OPTIONS_MPLUS_TIME_INCOMBAT_DESC"] = "Pour calculer le DPS global, le segment de la clé Mythique+ utilisera la formule : « dégâts totaux / temps en combat »"
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME"] = "Durée du donjon"
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME_DESC"] = "Pour calculer le DPS global, le segment de la clé Mythique+ utilisera la formule : « dégâts totaux / temps de la clé »"
...
L["STRING_OPTIONS_OVERALL_MYTHICPLUS_DESC"] = "Lorsque cette option est activée, les données globales sont automatiquement effacées lorsqu'une nouvelle clé Mythique + commencera."
...
L["STRING_OPTIONS_TEXT_OUTLINE"] = "Contour du texte"
...
L["STRING_OPTIONS_TITLEBAR_MENUBUTTONS_HEADER"] = "Boutons et paramètres du menu"
