...
L["If checked, you can move the battlefield map by dragging any of its borders."] = "勾选后，你可以拖动区域地图的边框来移动它。"
...
L["If checked, you can move the battlefield map by dragging any of its borders."] = "勾選後，您可以通過拖動任何戰場地圖的邊框來移動它。"
...
L["If checked, you can move the battlefield map by dragging any of its borders."] = "Если флажок установлен, то вы можете перемещать карту поля боя за любую из её границ."
...
L["If checked, you can move the battlefield map by dragging any of its borders."] = "Si está seleccionado, puede mover el mapa de campo de batalla arrastrando sus bordes."
...
L["If checked, you can move the battlefield map by dragging any of its borders."] = "Si cette option est cochée, vous pouvez déplacer la carte du champ de bataille en faisant glisser n'importe laquelle de ses bordures."
...
L["If checked, you can move the battlefield map by dragging any of its borders."] = "Se marcada, você pode mover o mapa do campo de batalha arrastando qualquer uma de suas bordas."
