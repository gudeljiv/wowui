----------------------------------------------------------------------
-- 	Leatrix Maps Locale for Burning Crusade Anniversary
----------------------------------------------------------------------
...
L["If checked, text used throughout the addon will be shown in English regardless of your game locale."] = "如果选中，整个插件中使用的文本将以英语显示，与您的游戏地区设置无关。"
...
L["Burning Crusade Classic Anniversary"] = "燃燒的遠征經典紀念版"
...
L["Dungeon"] = "地下城"
L["Dungeon (requires Crescent Key)"] = "地下城（需要新月鑰匙）"
L["Durotar"] = "杜洛塔"
L["Duskwood"] = "暮色森林"
...
L["If checked, you will be able to scale the map by dragging the scale handle in the bottom-right corner.|n|nYou will be able to move the map by dragging any border."] = "勾選後，您將能夠通過拖動右下角的縮放桿來縮放地圖。n|n您將能夠通過拖動任何邊框來移動地圖。"
...
L["/ltm help - Show this information."] = "/ltm help - 이 정보를 표시합니다."
L["/ltm reset - Reset the panel position."] = "/ltm reset - 설정창 위치를 재설정합니다."
L["/ltm wipe - Wipe all settings and reload."] = "/ltm wipe - 모든 설정을 초기화하고 UI를 재시작 합니다."
L["A stop error has occurred but no need to worry.  It can happen from time to time.  Click the reload button to resolve it."] = "중지 오류가 발생했지만 걱정하지 않아도 됩니다. 가끔 발생할 수 있습니다. UI 재시작 버튼을 클릭하여 해결하세요."
...
L["Allow frame movement"] = "프레임 이동 허용"
L["Alpha"] = "투명도"
...
L["Cannot be used with Use default map."] = "기본 지도와 함께 사용할 수 없습니다."
L["Cannot be used with Use default map.|n|nTo adjust map opacity, right-click the map frame title bar."] = "기본 지도와 함께 사용할 수 없습니다.|n|n지도 투명도를 조정하려면 지도 프레임 제목 표시줄을 우클릭하세요."
...
L["Click to reset the position and scale of the map frame."] = "지도 프레임의 위치와 크기를 재설정하려면 클릭하세요."
L["Click to reset the settings on this page."] = "이 페이지의 설정을 재설정하려면 클릭하세요."
L["Click to return to the main menu."] = "메인 메뉴로 돌아가려면 클릭하세요."
...
L["Dawnrise Expedition"] = "던라이즈 원정대"
...
L["Dire Maul (East) (side entrance)"] = "혈투의 전장 (동쪽) (옆문)"
L["Dire Maul (East): Warpwood Quarter"] = "혈투의 전장 (동쪽): 굽이나무 지구"
L["Dire Maul (North)"] = "혈투의 전장(2북쪽)"
L["Dire Maul (North): Gordok Commons"] = "혈투의 전장 (북쪽): 고르독 광장"
L["Dire Maul (West)"] = "혈투의 전장(3서쪽)"
L["Dire Maul (West): Capital Gardens"] = "혈투의 전장 (서쪽): 수도 정원"
...
L["Disable map fade"] = "지도 흐려짐 효과 비활성화"
...
L["Drag"] = "이동"
L["Drag to set the amount of blue."] = "드래그하여 파란색을 설정하세요."
L["Drag to set the amount of green."] = "드래그하여 초록색을 설정하세요."
L["Drag to set the amount of red."] = "드래그하여 빨간색을 설정하세요."
L["Drag to set the battlefield map opacity."] = "드래그하여 전장 지도의 투명도를 설정하세요."
L["Drag to set the battlefield map size."] = "드래그하여 전장 지도 크기를 설정하세요."
L["Drag to set the battlefield map size.|n|nIf the map is unlocked, you can also resize the battlefield map by dragging the bottom-right corner."] = "드래그하여 전장 지도 크기를 설정하세요.|n|n지도가 잠금 해제된 경우, 오른쪽 하단 모서리를 드래그하여 전장 지도 크기를 조정할 수도 있습니다."
L["Drag to set the group icon size."] = "드래그하여 그룹 아이콘 크기를 설정하세요."
L["Drag to set the map opacity for when your character is moving."] = "드래그하여 캐릭터가 이동 중일 때 지도의 투명도를 설정하세요."
L["Drag to set the map opacity for when your character is stationary."] = "드래그하여 캐릭터가 정지 상태일 때 지도의 투명도를 설정하세요."
...
드래그하여 최대 줌 수준을 설정하세요.|n|n전장 지도를 열어 슬라이더를 드래그하면 최대 줌 수준이 변경되는 것을 확인할 수 있습니다.]=]
L["Drag to set the maximum zoom level.|n|nOpen the map to see the maximum zoom level change as you drag the slider."] = "드래그하여 최대 줌 수준을 설정하세요.|n|n지도를 열어 슬라이더를 드래그하여 최대 줌 수준이 변경되는 것을 확인하세요."
L["Drag to set the opacity."] = "드래그하여 투명도를 설정하세요."
L["Drag to set the player arrow size."] = "드래그하여 플레이어 화살표 크기를 설정하세요."
L["Drag to set the player arrow size.|n|nWow Classic default is 16.|nWow Retail default is 27."] = "드래그하여 플레이어 화살표 크기를 설정하세요.|n|n와우 클래식 기본값은 16입니다.|n와우 본섭 기본값은 27입니다."
L["Drag to set the scale for the maximised map."] = "드래그하여 최대화된 지도의 크기를 설정하세요."
L["Drag to set the scale for the windowed map."] = "드래그하여 창 모드 지도의 크기를 설정하세요."
L["Drag to set the world map scale.|n|nYou can also rescale the world map by dragging the bottom-right corner."] = "드래그하여 세계 지도 크기를 설정하세요.|n|n오른쪽 하단 모서리를 드래그하여 세계 지도의 크기를 재설정할 수도 있습니다."
L["Dragon Soul"] = "용의 영혼"
...
L["Eastvale Logging Camp"] = "동부 벌목지"
...
L["enabled"] = "사용"
L["End Time"] = "시간의 끝"
L["Enhance battlefield map"] = "전장 지도 개선"
...
L["Exodar"] = "엑소다르"
L["Explorer's League Digsite"] = "탐험가 연맹 발굴 현장"
...
L["from"] = "from"
L["Frosthold"] = "서리요새"
L["Fulbrow's Pumpkin Farm"] = "펄브라우 호박밭"
L["Furien's Post"] = "퓨리엔의 거점"
L["Fuselight"] = "점화등 마을"
L["Gadgetzan"] = "가젯잔"
L["Galen's Fall"] = "갈렌의 타락지"
L["Gao-Ran Battlepost"] = "가오란 전투초소"
L["Garadar"] = "가라다르"
...
L["Hide filter reset button"] = "필터 재설정 버튼 숨기기"
L["Hide town and city icons"] = "도시 아이콘 숨기기"
L["Highbank"] = "높은 둑"
L["Highmaul"] = "높은 망치"
...
L["Icons"] = "아이콘"
L["If checked, additional icons (such as portals) will be shown."] = "추가 아이콘 (포탈 등) 이 표시됩니다."
L["If checked, archaeology digsites will be shown."] = "고고학 발굴 현장이 표시됩니다."
L["If checked, coordinates will be shown."] = "좌표가 표시됩니다."
L["If checked, coordinates will have a dark background texture."] = "좌표에 어두운 배경 텍스처가 적용됩니다."
L["If checked, coordinates will use a large font."] = "좌표에 큰 글꼴이 사용됩니다."
L["If checked, dungeons and raids will be shown."] = "던전과 공격대가 표시됩니다."
L["If checked, group icons will use a modern, class-colored design."] = "파티 아이콘은 모던한 직업 색상 디자인을 사용합니다."
L["If checked, opening the map will use the same zoom level from when you last closed it as long as the map zone has not changed."] = "지도 영역이 변경되지 않은 한 지도를 열 때 마지막으로 닫았을 때와 동일한 확대/축소 수준이 사용됩니다."
L["If checked, pointing at the map while your character is moving will cause the stationary opacity setting to be applied."] = "캐릭터가 이동 중일 때 지도를 가리키면 정지 시 투명도 설정이 적용됩니다."
L["If checked, points of interest will be shown."] = "관심 지점이 표시됩니다."
L["If checked, quest objectives will be shown."] = "퀘스트 목표가 표시됩니다."
L["If checked, spirit healers will be shown."] = "영혼의 치유사가 표시됩니다."
L["If checked, text used throughout the addon will be shown in English regardless of your game locale."] = "애드온 전체에서 사용되는 텍스트는 게임 언어와 관계없이 영어로 표시됩니다."
L["If checked, the battlefield map will stay centered on your location as long as you are not in a dungeon.|n|nYou can hold shift while panning the map to temporarily prevent it from centering."] = "던전에 있지 않은 한 전장 지도가 항상 플레이어 위치 중심으로 유지됩니다.|n|n지도를 이동할 때 Shift 키를 누르고 있으면 일시적으로 중심 유지 기능을 해제할 수 있습니다."
L["If checked, the default fullscreen map will be used for the maximised map.|n|nNote that enabling this option will lock out some of the other options."] = "최대화된 지도에 기본 전체 화면 지도가 사용됩니다.|n|n이 옵션을 활성화하면 다른 일부 옵션이 사용 불가해집니다."
L["If checked, the default fullscreen map will be used.|n|nNote that enabling this option will lock out some of the other options."] = "기본 전체 화면 지도가 사용됩니다.|n|n이 옵션을 활성화하면 다른 일부 옵션이 사용 불가해집니다."
L["If checked, the map border will be removed."] = "지도 테두리가 제거됩니다."
L["If checked, the map frame will remain open until you close it."] = "지도 프레임은 사용자가 닫을 때까지 열린 상태로 유지됩니다."
L["If checked, the map will not fade while your character is moving."] = "캐릭터가 이동 중일 때 지도가 흐려지지 않습니다."
L["If checked, the map will stay centered on your location as long as you are not in a dungeon.|n|nYou can hold shift while panning the map to temporarily prevent it from centering."] = "던전에 있지 않은 한 지도가 항상 현재 플레이어 위치 중심으로 유지됩니다.|n|n지도를 이동할 때 Shift 키를 누르고 있으면 일시적으로 중심 유지 기능을 해제할 수 있습니다."
L["If checked, the minimap button will be shown."] = "미니맵 버튼이 표시됩니다."
L["If checked, the minimum fishing skill levels will be shown."] = "최소 낚시 숙련도가 표시됩니다."
L["If checked, the world map filter reset button will be hidden."] = "세계 지도 필터 재설정 버튼이 숨겨집니다."
L["If checked, town and city icons will not be shown on the continent maps."] = "대륙 지도에 마을 및 도시 아이콘이 표시되지 않습니다."
L["If checked, travel points for the opposing faction will be shown.|n|nThis includes flight points, boat harbors, zeppelin towers and tram stations."] = "상대 진영의 이동 지점이 표시됩니다.|n|n여기에는 비행 지점, 선박 항구, 비행선 탑, 지하철이 포함됩니다."
L["If checked, travel points for the same faction will be shown.|n|nThis includes flight points, boat harbors, zeppelin towers and tram stations."] = "동일 진영의 이동 지점이 표시됩니다.|n|n여기에는 비행 지점, 선박 항구, 비행선 탑, 지하철이 포함됩니다."
L["If checked, unexplored areas of the map will be shown on the world map and the battlefield map."] = "지도에서 탐험되지 않은 지역이 세계 지도와 전장 지도에 표시됩니다."
L["If checked, unexplored areas will be tinted."] = "탐험하지 않은 지역은 음영 처리됩니다."
L["If checked, when your character changes zones, the map will automatically change to the new zone."] = "캐릭터가 지역을 변경할 때 지도가 자동으로 새 지역으로 전환됩니다."
L["If checked, you can move the battlefield map by dragging any of its borders."] = "전장 지도의 가장자리를 드래그하여 이동할 수 있습니다."
L["If checked, you can move the battlefield map by dragging any of its borders.|n|nYou can resize the battlefield map by dragging the bottom-right corner."] = "전장 지도의 가장자리를 드래그하여 이동할 수 있습니다.|n|n전장 지도의 크기는 오른쪽 하단 모서리를 드래그하여 조정할 수 있습니다."
L["If checked, you will be able to customise the battlefield map."] = "전장 지도를 사용자 정의할 수 있습니다."
L["If checked, you will be able to enlarge the player arrow."] = "플레이어 화살표를 확대할 수 있습니다."
L["If checked, you will be able to move the frame by dragging the border."] = "테두리를 드래그하여 프레임을 이동할 수 있습니다."
L["If checked, you will be able to move the map.|n|nThe map position will be saved separately for the maximised and windowed maps."] = "지도를 이동할 수 있습니다.|n|n최대화 상태와 창 모드 상태의 지도 위치는 각각 별도로 저장됩니다."
L["If checked, you will be able to scale and move the map.|n|nScale the map by dragging the scale handle in the bottom-right corner.|n|nMove the map by dragging the border and frame edges."] = "지도를 크기 조정하고 이동할 수 있습니다.|n|n오른쪽 하단 모서리의 크기 조정 핸들을 드래그하여 지도를 확대/축소합니다.|n|n테두리와 프레임 가장자리를 드래그하여 지도를 이동합니다."
L["If checked, you will be able to scale the map by dragging the scale handle in the bottom-right corner.|n|nYou will be able to move the map by dragging any border."] = "오른쪽 하단 모서리의 크기 조정 핸들을 드래그하여 지도를 확대/축소할 수 있습니다.|n|n어떤 테두리든 드래그하여 지도를 이동할 수 있습니다."
L["If checked, you will be able to scale the map."] = "지도의 크기를 조정할 수 있습니다."
L["If checked, you will be able to set the opacity of the map."] = "지도의 투명도를 설정할 수 있습니다."
L["If checked, you will be able to zoom further into the world map."] = "세계 지도를 더 확대할 수 있습니다."
L["If checked, your character will not perform the reading emote when you open the map."] = "지도를 열 때 캐릭터가 읽는 감정 표현을 취하지 않습니다."
L["If checked, zone and continent dropdown menus will be shown in the map frame."] = "지도 프레임에 지역 및 대륙 드롭다운 메뉴가 표시됩니다."
L["If checked, zone and dungeon levels will be shown."] = "지역 및 던전 레벨이 표시됩니다."
L["If checked, zone crossings will be shown.|n|nThese are clickable arrows that indicate the zone exit pathways."] = "지역 경계가 표시됩니다.|n|n이 표시들은 지역 출구 경로를 나타내는 클릭 가능한 화살표입니다."
L["If checked, zone, dungeon and fishing skill levels will be shown."] = "지역, 던전 및 낚시 숙련도가 표시됩니다."
...
L["Rensai's Watchpost"] = "렌시아의 감시초소"
L["req"] = "입장가능 레벨"
L["Requires Key to Searing Gorge"] = "불타는 협곡 열쇠 필요"
L["Requires UI reload."] = "UI를 재시작해야 합니다."
L["Reset"] = "재설정"
L["Reset Map Layout"] = "지도 레이아웃 재설정"
...
L["Set map opacity"] = "지도 투명도 설정"
L["Set map opacity while stationary and while moving."] = "정지 상태와 이동 중에 지도 투명도를 설정하세요."
L["Set the group icon size."] = "그룹아이콘 크기 설정"
L["Set the maximum zoom scale."] = "최대 줌 비율을 설정하세요."
...
L["Show points of interest"] = "관심 지점 표시"
...
L["Southern Rocketway"] = "남부 로켓길 종착지"
...
L["Stratholme (Service Gate)"] = "스트라솔름 (공무용 입구)"
...
L["Tina Monastery"] = "티엔 수도원"
L["Tinker Town"] = "땜장이 마을"
L["Tint unexplored areas"] = "미탐험 지역 색상"
...
L["Uldaman"] = "울다만"
L["Uldaman (rear entrance)"] = "울다만 (후문)"
L["Uldaman (side entrance)"] = "울다만 (옆문)"
...
L["Unlock map frame"] = "세계 지도 잠금 해제"
L["Unu'pe"] = "우누페"
L["Upper Blackrock Spire"] = "검은바위 첨탑 상층"
L["Use default map"] = "기본 지도 사용"
L["Use English language"] = "영어 사용"
L["Use large font"] = "큰 글꼴 사용"
L["Use stationary opacity while pointing at map"] = "지도를 가리킬 때 고정된 투명도 사용"
L["Utgarde Keep"] = "우트가드 성채"
L["Utgarde Pinnacle"] = "우트가드 첨탑"
L["Valaar's Berth"] = "발라르의 나루"
L["Valdrakken Portals"] = "발드라켄 포탈"
...
L["World of Warcraft Classic"] = "월드 오브 워크래프트 클래식"
...
L["Your UI needs to be reloaded for some of the changes to take effect.|n|nYou don't have to click the reload button immediately but you do need to click it when you are done making changes and you want the changes to take effect."] = "일부 변경 사항이 적용되려면 UI를 재시작해야 합니다.|n|n변경 사항을 적용하려면 변경 작업을 완료한 후 UI 재시작 버튼을 클릭해야 합니다. 즉시 클릭할 필요는 없지만, 변경 사항을 적용하려면 반드시 클릭해야 합니다."
L["Your UI needs to be reloaded."] = "UI를 재시작해야 합니다."
L["Zabra'jin"] = "자브라진"
...
L["Burning Crusade Classic Anniversary"] = "Burning Crusade Aniversario Clásico"
...
L["If checked, text used throughout the addon will be shown in English regardless of your game locale."] = "Si está seleccionado, el texto usado en todo el addon se mostrará en inglés sin importar el idioma de tu juego."
...
L["Use English language"] = "Usar inglés"
...
L["If checked, text used throughout the addon will be shown in English regardless of your game locale."] = "Si cette option est cochée, le texte utilisé dans tout l’add-on sera affiché en anglais, quel que soit la langue de votre jeu."
...
L["Use English language"] = "Utiliser l’anglais"
...
L["If checked, text used throughout the addon will be shown in English regardless of your game locale."] = "Se marcado, o texto usado em todo o addon será mostrado em inglês, independentemente do idioma do seu jogo."
...
L["Uldaman"] = "Uldaman"
L["Uldaman (rear entrance)"] = "Uldaman (entrada traseira)"
L["Uldaman (side entrance)"] = "Uldaman (entrada lateral)"
L["Uldaman: Legacy of Tyr"] = "Uldaman: Legado de Tyr"
L["Uldir"] = "Uldir"
L["Ulduar"] = "Ulduar"
...
L["Use English language"] = "Usar inglês"
