...
View:ImplementsModule(
	'IconModule_CooldownSweep',
	20,
...
View:ImplementsModule(
	'IconModule_IconContainer_Masque',
	100,
	function(Module, icon)
