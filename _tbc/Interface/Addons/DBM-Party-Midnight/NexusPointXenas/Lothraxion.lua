...
mod:AddCustomAlertSoundOption(1255503, true, 1)--Searing Rend
...
mod:AddCustomTimerOptions(1255503, true, 5, 0)--Searing Rend
...
mod:AddPrivateAuraSoundOption(1255335, true, 1255503, 1, 1)--Searing Rend
mod:AddPrivateAuraSoundOption(1255310, true, 1255310, 1, 2)--Radiant Scar
mod:AddPrivateAuraSoundOption(1271956, true, 1271956, 1, 1)--Mirrored Rend

function mod:OnLimitedCombatStart()
	self:EnableAlertOptions(1255503, 109, "scattersoon", 2)--Pre spread
	self:EnableAlertOptions(1257567, 110, "phasechange", 2)
	if self:IsTank() then
		self:EnableAlertOptions(1255503, 111, "defensive", 2)
	end
	...
	self:EnableTimelineOptions(1255503, 111)
	self:EnableTimelineOptions(1255531, 112)

	self:EnablePrivateAuraSound(1255503, "debuffyou", 17)--Run out to place images?
