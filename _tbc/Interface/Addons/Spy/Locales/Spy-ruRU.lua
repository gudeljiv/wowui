...
|cffffd000автор:  Immolation from Cho'gall (US).|cffffffff

|cffffd000Clasic Update автор: Slipjack|cffffffff

|cffffd000Clasic TBC автор: Blackroot from Herod (US).|cffffffff
]]
