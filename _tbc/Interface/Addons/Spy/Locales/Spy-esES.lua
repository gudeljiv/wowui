...
|cffffd000Autor:  Immolation from Cho'gall (US).|cffffffff

|cffffd000Clasic Autor: Slipjack|cffffffff

|cffffd000Clasic TBC Autor: Blackroot from Herod (US).|cffffffff
