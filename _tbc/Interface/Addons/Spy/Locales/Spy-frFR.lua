...
|cffffd000Author:  Immolation from Cho'gall (US).|cffffffff

|cffffd000Clasic Author: Slipjack|cffffffff

|cffffd000Clasic TBC Author: Blackroot from Herod (US).|cffffffff
