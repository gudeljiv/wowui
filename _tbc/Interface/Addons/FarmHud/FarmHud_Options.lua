...
local function printFrames(key, value)
	...
	if keyType == "table" then
		...
		for k, v in pairs(_G) do
			if
				not (issecurevariable(_G, k))
				and not excludeFrames[key]
				and (type(value) == "table")
				and (type(value[0]) == "userdata")
				and not (value:IsProtected() or value:IsForbidden())
			then
...
local function optTracking(info, value)
	local key = info[#info]
	if not key:find("^tracking^%d+$") then
		return
	end
		...
		general = {
			...
			args = {
				...
				AddOnLoaded = {
					...
					order = 2,
					name = L.AddOnLoaded,
					desc = L["AddOnLoadedDesc"] .. "|n|n|cff44ff44" .. L["AddOnLoadedDescAlt"] .. "|r",
				},
				rotation = {
					type = "toggle",
					order = 3,
				...
				hud_scale = {
					type = "range",
					order = 11,
					name = L.HudSymbolScale,
					desc = L.HudSymbolScaleDesc,
					min = 1,
					max = 2.5,
					step = 0.1,
					isPercent = true,
				...
				placeholder = {
					...
					args = {
						...
						showDummy = {
							type = "toggle",
							order = 1,
							name = L.ShowPlaceholder,
							desc = L.ShowPlaceholderDesc,
						},
						showDummyBg = {
							type = "toggle",
							order = 2,
							name = L.ShowPlaceholderBg,
							desc = L.ShowPlaceholderBgDesc,
						},
					},
				},
				mouseover = {
		...
		rangecircles = {
			...
			args = {
				...
				gathercircle_show = {
					...
					order = 12,
					width = "double",
					name = L.GatherCircleShow,
					desc = L.GatherCircleShowDesc,
				},
				gathercircle_color = {
					type = "color",
					order = 13,
					name = COLOR,
					desc = L.GatherCircleColorDesc,
					hasAlpha = true,
				},
				...
				healcircle_show = {
					...
					order = 22,
					width = "double",
					name = L.HealcircleShow,
					desc = L.HealcircleShowDesc,
				},
				healcircle_color = {
					type = "color",
					order = 23,
					name = COLOR,
					desc = L.HealcircleColorDesc,
					hasAlpha = true,
				},
		...
		cardinalpoints = {
			...
			args = {
				...
				cardinalpoints_color1 = {
					...
					hasAlpha = true,
					name = COLOR,
					desc = L.CardinalPointsColorDesc:format(L.CardinalPointsGroup1),
				},
				cardinalpoints_resetcolor1 = {
					type = "execute",
					order = 5,
					name = L.ResetColor,
					desc = L.CardinalPointsColorResetDesc:format(L.CardinalPointsGroup1),
				},
				...
				cardinalpoints_color2 = {
					...
					hasAlpha = true,
					name = COLOR,
					desc = L.CardinalPointsColorDesc:format(L.CardinalPointsGroup2),
				},
				cardinalpoints_resetcolor2 = {
					type = "execute",
					order = 8,
					name = L.ResetColor,
					desc = L.CardinalPointsColorResetDesc:format(L.CardinalPointsGroup2),
				},
			},
		},
		coords = {
			...
			args = {
				...
				coords_color = {
					...
					hasAlpha = true,
					name = COLOR,
					desc = L.CoordsColorDesc,
				},
				coords_resetcolor = {
					type = "execute",
					order = 5,
					name = L.ResetColor,
					desc = L.CoordsColorResetDesc,
				},
			},
		},
		time = {
			...
			args = {
				...
				time_server = {
					...
					order = 2,
					name = L.TimeServer,
					desc = L.TimeServerDesc,
				},
				time_local = {
					type = "toggle",
					order = 3,
					name = L.TimeLocal,
					desc = L.TimeLocalDesc,
				},
				time_radius = {
					type = "range",
					order = 4,
				...
				time_color = {
					...
					hasAlpha = true,
					name = COLOR,
					desc = L.TimeColorDesc,
				},
				time_resetcolor = {
					type = "execute",
					order = 7,
					name = L.ResetColor,
					desc = L.TimeColorResetDesc,
				},
			},
		},
		onscreenbuttons = {
			...
			args = {
				buttons_show = {
					...
					width = "double",
					name = L.OnScreenShow,
					desc = L.OnScreenShowDesc,
				},
				buttons_bottom = {
					type = "toggle",
					order = 2,
					width = "double",
					name = L.OnScreenBottom,
					desc = L.OnScreenBottomDesc,
				},
				buttons_radius = {
					type = "range",
					order = 3,
		...
		keybindings = {
			...
			args = {
				TOGGLEFARMHUD = {
					...
					order = 1,
					width = "double",
					name = L.KeyBindToggle,
					desc = L.KeyBindToggleDesc,
				},
				TOGGLEFARMHUDMOUSE = {
					type = "keybinding",
					order = 2,
					width = "double",
					name = L.KeyBindMouse,
					desc = L.KeyBindMouseDesc,
				},
				TOGGLEFARMHUDBACKGROUND = {
					type = "keybinding",
					order = 3,
					width = "double",
					name = L.KeyBindBackground,
					desc = L.KeyBindBackgroundDesc,
				},
			},
		},
		debugging = {
