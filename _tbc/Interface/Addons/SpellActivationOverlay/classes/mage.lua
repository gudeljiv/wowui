...
local fire_blast_sod = { 400618, 400619, 400616, 400620, 400621, 400622, 400623 }
...
self:RegisterAura("firestarter", 0, 54741, "impact", "Top", 0.8, 255, 255, 255, true, { (GetSpellInfo(2120)) })
end
if self.IsSoD() then
