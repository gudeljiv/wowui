...
xVermin.CheckIfLoadedWithTimer("PallyPowerBlessingsFrame", function()
	if not PallyPowerBlessingsFrame.SetBackdrop then
		Mixin(PallyPowerBlessingsFrame, BackdropTemplateMixin)
	end
	PallyPowerBlessingsFrame:HookScript("OnLoad", function(self)
		self.TopEdge:Hide()
...
xVermin.CheckIfLoadedWithTimer("PallyPowerFrame", function()
	PallyPowerFrame:HookScript("OnUpdate", function(self)
