...
xVermin.CheckIfLoadedWithTimer("Arcana1 and CustomContainer_1", function()
	Arcana1:ClearAllPoints()
	Arcana1:SetPoint("LEFT", CustomContainer_1, "LEFT", 5, 0)
	Arcana1:SetWidth(145)
end)

xVermin.CheckIfLoadedWithTimer("Arcana2 and CustomContainer_1", function()
	Arcana2:ClearAllPoints()
	Arcana2:SetPoint("LEFT", CustomContainer_2, "LEFT", 5, 0)
	Arcana2:SetWidth(145)
end)
