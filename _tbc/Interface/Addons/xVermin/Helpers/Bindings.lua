...
local function FixBindings()
	...
	SetBinding("CTRL-SHIFT-R", "TOGGLEFPS", 1)
	...
	SetBinding("9", "MULTIACTIONBAR2BUTTON3", 1)
	SetBinding("0", "MULTIACTIONBAR2BUTTON4", 1)
	...
	SetBinding("F10", "MULTIACTIONBAR3BUTTON7", 1)
	SetBinding("SHIFT-5", "MULTIACTIONBAR3BUTTON8", 1)
	SetBinding("SHIFT-4", "MULTIACTIONBAR3BUTTON9", 1)
	SetBinding("SHIFT-3", "MULTIACTIONBAR3BUTTON10", 1)
	SetBinding("SHIFT-2", "MULTIACTIONBAR3BUTTON11", 1)
	SetBinding("SHIFT-1", "MULTIACTIONBAR3BUTTON12", 1)
	...
	SetBinding("CTRL-J", "MULTIACTIONBAR8BUTTON10", 1)
	SetBinding("CTRL-J", "MULTIBAR7ACTIONBUTTON10", 1)
...
local function ClearAllBindings()
	...
	SetBinding("CTRL-R", "NONE", 1)
	SetBinding("CTRL-SHIFT-R", "NONE", 1)
	SetBinding("Y", "NONE", 1)
	...
	SetBinding("F1", "NONE", 1)
	SetBinding("F2", "NONE", 1)
	SetBinding("F3", "NONE", 1)
	SetBinding("F4", "NONE", 1)
	SetBinding("F5", "NONE", 1)
	SetBinding("F6", "NONE", 1)
	...
	SetBinding("F1", "NONE", 2)
	SetBinding("F2", "NONE", 2)
	SetBinding("F3", "NONE", 2)
	SetBinding("F4", "NONE", 2)
	SetBinding("F5", "NONE", 2)
	SetBinding("F6", "NONE", 2)
