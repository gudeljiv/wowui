...
local RotationTextureFrame1 =
	CreateFrame("Frame", "RotationTextureFrame1", UIParent, BackdropTemplateMixin and "BackdropTemplate")
...
local RotationTextureFrame2 =
	CreateFrame("Frame", "RotationTextureFrame2", UIParent, BackdropTemplateMixin and "BackdropTemplate")
...
local RotationTextureFrame3 =
	CreateFrame("Frame", "RotationTextureFrame3", UIParent, BackdropTemplateMixin and "BackdropTemplate")
