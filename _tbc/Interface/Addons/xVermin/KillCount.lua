...
kc:SetScript(
	...
	function(self, event, ...)
		...
		if xKillCount and xKillCount.show then
			-- reset if in combat for next pull
			...
			if event == 'COMBAT_LOG_EVENT_UNFILTERED' then
				...
				-- print(eventType, sourceGUID, destName, select(12, CombatLogGetCurrentEventInfo()))

				if xKillCount.me then
...
local function kcMessages()
	...
	ChatFrame1:AddMessage('\124cffFFFF00(me/all)\124r Show only me or everybody in party / raid: ' .. (xKillCount.me and '\124cff00FF00me\124r' or '\124cffFF0000me\124r') .. '/' .. (not xKillCount.me and '\124cff00FF00everybody\124r' or '\124cffFF0000everybody\124r'))
end
