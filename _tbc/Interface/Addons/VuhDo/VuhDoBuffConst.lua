...
VUHDO_CLASS_BUFFS = {
	...
	["SHAMAN"] = {
		[VUHDO_I18N_BUFFC_FIRE_TOTEM] = {
			...
			{ VUHDO_SPELL_ID.BUFF_FIRE_RESISTANCE_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
			{ VUHDO_SPELL_ID.BUFF_FROST_RESISTANCE_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
			{ VUHDO_SPELL_ID.BUFF_FIRE_NOVA_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
		...
		[VUHDO_I18N_BUFFC_AIR_TOTEM] = {
			...
			{ VUHDO_SPELL_ID.BUFF_NATURE_RESISTANCE_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
			{ VUHDO_SPELL_ID.BUFF_SENTRY_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
			{ VUHDO_SPELL_ID.BUFF_WINDWALL_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
		...
		[VUHDO_I18N_BUFFC_WATER_TOTEM] = {
			...
			{ VUHDO_SPELL_ID.BUFF_DISEASE_CLEANSING_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
		},
		...
		[VUHDO_I18N_BUFFC_WEAPON_ENCHANT] = {
			...
			{ VUHDO_SPELL_ID.BUFF_WINDFURY_WEAPON, VUHDO_BUFF_TARGET_SELF },
			{ VUHDO_SPELL_ID.BUFF_FLAMETONGUE_WEAPON, VUHDO_BUFF_TARGET_SELF },
			{ VUHDO_SPELL_ID.BUFF_FROSTBAND_WEAPON, VUHDO_BUFF_TARGET_SELF },
		},
	},
