local function RepAvoidRating()
	...
	BaseDefValue = ((BaseDefValue + math.floor(GetCombatRatingBonus(2)))-350)*.04;
	...
	print("Your Total Avoidance Is:",string.format("%.2f%%",BaseDefValue + BaseDodgeValue + BaseParryValue + BaseBlockValue + BaseMissValue));
end
