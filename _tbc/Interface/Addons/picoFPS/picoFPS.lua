...
local string_format, math_modf, GetNetStats, GetFramerate, collectgarbage =
	string.format, math.modf, GetNetStats, GetFramerate, collectgarbage

local addons = {}
for i = 1, C_AddOns.GetNumAddOns() do
	table.insert(addons, (C_AddOns.GetAddOnInfo(i)))
end
...
local dataobj = LibStub:GetLibrary("LibDataBroker-1.1"):NewDataObject("picoFPS", {
	type = "data source",
	text = "75.0 FPS",
	OnClick = function()
...
function dataobj.OnEnter(self)
	...
	GameTooltip:AddDoubleLine(
		"Default UI memory:",
		string_format("%.2f MiB", (mem - addonmem) / 1024),
		nil,
		nil,
		nil,
		r,
