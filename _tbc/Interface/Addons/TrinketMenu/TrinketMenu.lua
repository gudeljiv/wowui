...
function TrinketMenu.ClearDocking()
	for i = 1, 4 do
		if _G["TrinketMenu_MainDock_"..TrinketMenu.Corners[i]] then _G["TrinketMenu_MainDock_"..TrinketMenu.Corners[i]]:Hide() end
		if _G["TrinketMenu_MenuDock_"..TrinketMenu.Corners[i]] then _G["TrinketMenu_MenuDock_"..TrinketMenu.Corners[i]]:Hide() end
	end
end
...
function TrinketMenu.BuildMenu()
	...
	if TrinketMenu.NumberOfTrinkets < 1 then
		...
		for i = 1, TrinketMenu.NumberOfTrinkets do
			...
			local name = TrinketMenu.BaggedTrinkets[i].name
			local itemName, itemLink, itemRarity, itemLevel, itemMinLevel, itemType, itemSubType, itemStackCount, itemEquipLoc, itemTexture, itemSellPrice
			local r, g, b, hex

			item:CreateBeautyBorder(6)
			item:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureNormal")
			item:SetBeautyBorderColor(1, 1, 1, 1)
			if name then 
				...
				if (itemRarity and itemRarity > 1) then
					...
					item:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureWhite")
					item:SetBeautyBorderColor(r, g, b, 1)
				end
			end
		end
...
function TrinketMenu.UpdateWornTrinkets()
	...
	texture, name = TrinketMenu.ItemInfo(13)
	...
	TrinketMenu_Trinket0:CreateBeautyBorder(6)
	TrinketMenu_Trinket0:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureNormal")
	TrinketMenu_Trinket0:SetBeautyBorderColor(1, 1, 1, 1)
	if name then 
		itemName, itemLink, itemRarity, itemLevel, itemMinLevel, itemType, itemSubType, itemStackCount, itemEquipLoc, itemTexture, itemSellPrice = GetItemInfo(name)
		if (itemRarity and itemRarity > 1) then
			r, g, b, hex = GetItemQualityColor(itemRarity)
			TrinketMenu_Trinket0:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureWhite")
			TrinketMenu_Trinket0:SetBeautyBorderColor(r, g, b, 1)
		end
	end
	...
	TrinketMenu_Trinket1:CreateBeautyBorder(6)
	TrinketMenu_Trinket1:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureNormal")
	TrinketMenu_Trinket1:SetBeautyBorderColor(1, 1, 1, 1)
	if name then 
		itemName, itemLink, itemRarity, itemLevel, itemMinLevel, itemType, itemSubType, itemStackCount, itemEquipLoc, itemTexture, itemSellPrice = GetItemInfo(name)
		if (itemRarity and itemRarity > 1) then
			r, g, b, hex = GetItemQualityColor(itemRarity)
			TrinketMenu_Trinket1:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureWhite")
			TrinketMenu_Trinket1:SetBeautyBorderColor(r, g, b, 1)
		end
	end
