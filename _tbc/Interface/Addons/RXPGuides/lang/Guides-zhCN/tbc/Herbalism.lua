...
step << !Mage
    ...
    .zone Undercity >>In Shattrath, take the 飞往幽暗城
    .skill herbalism,70,1
step
    .goto Undercity,54.0,49.5
    .train 2366 >>Train Apprentice 草药学-75) from Martha in Undercity
    .skill herbalism,70,1
step
    #completewith next
...
step
    ...
    .zone Tirisfal Glades >>离开幽暗城 into Tirisfal Glades
    .skill herbalism,70,1
step
...
step
    .goto Undercity,54.0,49.5
    .train 2368 >>Train Journeyman 草药学75-150) from Martha in Undercity
    .skill herbalism,115,1
step
    #completewith next
    .goto Undercity,65.9,44.1,50,0
    .goto Undercity,63.254,48.559
    .fly Sepulcher >>飞往瑟伯切尔，银松森林
    .skill herbalism,115,1
    .zoneskip Silverpine Forest
step
    .skill herbalism,115 >>等级 your 草药学 from 70-115 in Silverpine Forest
...
step
    .skill herbalism,150 >>等级 your 草药学 from 115-150 in Hillsbrad Foothills
...
step
    ...
    .train 3570 >>Train 导出 草药学150-225) from Aranae in Tarren Mill
...
step
    ...
    .skill herbalism,170 >>等级 your 草药学 from 150-170 in Swamp of Sorrows
...
step
    ...
    .skill herbalism,225 >>等级 your 草药学 from 170-225 in Swamp of Sorrows
...
step << !Mage
    ...
    .zone Hellfire Peninsula >>Go into Blasted Lands. Go 穿过黑暗之门
    .skill herbalism,300,1
    .cooldown item,6948,<0,1
step << !Mage
    #completewith next
...
step
    ...
    .train 11993 >>Train Artisan 草药学225-300) from Jandi in the building in Orgrimmar
    .skill herbalism,300,1
step << Mage
    #completewith next
    .zone Swamp of Sorrows >> Teleport to Stonard
...
step << !Mage
    ...
    .zone Durotar >>离开奥格瑞玛 into Durotar. Alternatively, pay a mage for a portal to Stonard
    .skill herbalism,300,1
...
step << !Mage
    ...
    .zoneskip Swamp of Sorrows
step
    .skill herbalism,300 >>等级 your 草药学 from 225-300 in Swamp of Sorrows
...
step
    ...
    .skill herbalism,325,1
step
    .skill herbalism,325 >>Level your Herbalism from 300-59-61 地狱火半岛
...
step
    #label Terokkar
    .skill herbalism,350 >>等级 your 草药学 from 325-63-64 泰罗卡森林
...
step
    ...
    .zone Netherstorm >>飞往 Netherstorm on your flying mount
...
step
    ...
    .goto Shattrath City,64.1,41.1
    .fly Area 52 >>飞往52区，虚空风暴
    .skill herbalism,375,1
    .skill riding,300,1
    .zoneskip Netherstorm
step
    #label Netherstorm
    .skill herbalism,375 >>等级 your 草药学 from 350-375 in Netherstorm
...
step
    +Congratulations on reaching 375 草药学
]])
...
step
    ...
    .train 2366 >>Train Apprentice 草药学-75) from Tannysa in Stormwind
    .skill herbalism,70,1
step
    #completewith next
...
step
    .goto Stormwind City,54.3,84.1
    .train 2368 >>Train Journeyman 草药学75-150) from Tannysa in Stormwind
...
step
    ...
    .skill herbalism,150,1
step
    .skill herbalism,150 >>Level your Herbalism from 70-飞往赤脊山
...
step
    ...
    .train 3570 >>Train 导出 草药学150-225) from Alma in Lakeshire
...
step
    ...
    .zone Redridge Mountains >>前往暴风城大教堂内，与 either Deadwind or Blasted Lands, whichever is closer
...
step
    .goto Redridge Mountains,21.7,45.8
    .train 11993 >>Train Artisan 草药学225-300) from Alma in Lakeshire
    .skill herbalism,300,1
step
    #completewith next
    .goto Redridge Mountains,30.6,59.4
