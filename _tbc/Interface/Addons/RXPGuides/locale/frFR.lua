...
--Words
L.words = {["Accept"] = _G.ACCEPT, ["Kill"] = "Tuez"}
...
L["Maximize Nameplate Distance"] = "Maximiser la distance des plaques de nom"
L["Automatically maximize nameplate visibility distance for better target detection (Requires reload)"] = "Maximise automatiquement la distance de visibilité des plaques de nom pour une meilleure détection des cibles (Nécessite un rechargement)"
...
L["Announce Step completion"] = "Annoncer les étapes de quêtes"
...
L["Announce Step collection"] = "Annoncer les objets de quêtes collectés"
...
L["Announce Step flying timers"] = "Annoncer le temps de trajet en vol"
