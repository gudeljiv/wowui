...
step
    +Follow this route to farm Mining & Herbalism nodes efficiently.
...
step
    ...
    .zone Nagrand >> Head to Nagrand
step
    +Follow this route to farm Herbalism nodes efficiently.
    .loop @20,107,72.3,79.8,64.5,69.6,61.9,73.5,56.6,66.3,59.4,81.5,52.5,80.2,48.4,73.3,50.3,60.7,49.3,51.5,42.8,51.3,36.3,59.2,44.3,65.6,40.5,81.7,33.6,81.0,29.6,79.2,27.4,73.4,28.7,62.8,24.9,52.8,19.0,50.5,21.6,45.2,25.5,43.8,22.5,39.8,18.7,38.7,9.0,44.5,7.1,40.3,10.5,37.2,14.1,38.2,12.1,34.5,27.8,30.1,25.2,27.1,27.2,19.4,32.9,26.4,36.0,19.9,41.2,22.6,36.3,31.7,39.5,34.4,49.3,21.0,54.7,23.3,47.6,43.0,54.3,48.0,59.9,46.2,66.4,39.4,71.7,42.9,70.4,58.6,75.0,63.0,72.3,79.8
    .openmap 107
]])
RXPGuides.RegisterGuide([[
#tbc
...
step
    #hidewindow
    +test
    .loop @20,Sholazar Basin,80.5,54.4,84.3,53.6,80.5,54.4
    .openmap Sholazar Basin
]])
RXPGuides.RegisterGuide([[
#wrath
...
step
    #hidewindow
    +test
    .loop @20,Howling Fjord,73.5,70.5,73.2,69.6,71.8,70.1,71.2,69.6,70.9,71.5,71.4,72.4,73.5,70.5
    .openmap Howling Fjord
]])
RXPGuides.RegisterGuide([[
#wotlk
...
step
    #hidewindow
    +test
    .loop @20,The Storm Peaks,46.7,55.3,49.1,52.5,47.7,50.8,47.1,48.7,48.5,48.2,48.1,46.5,47.4,46.1,46.7,55.3
    .openmap The Storm Peaks
]])
RXPGuides.RegisterGuide([[
#wotlk
...
step
    #hidewindow
    +test
    .loop @20,The Storm Peaks,62.5,41.5,63.2,39.6,62.5,41.5
    .openmap The Storm Peaks
]])
RXPGuides.RegisterGuide([[
#wotlk
...
step
    #hidewindow
    +test
    .loop @20,Wintergrasp,62.8,57.0,63.0,69.8,59.7,71.2,54.1,56.3,58.3,53.7,62.0,54.6,62.8,57.0,62.6,46.8,63.0,51.0,58.6,50.4,54.4,43.3,58.1,29.3,65.1,30.2,65.5,33.2,60.5,34.9,60.8,43.5,62.6,46.8
    .openmap Wintergrasp
]])
RXPGuides.RegisterGuide([[
#wotlk
