...
L.SearchMatch						= "%d correspondance"
...
L.LogCurrentRaids					= "Raids actuels"
...
L.LogDelves							= "Expéditions actuelles"--Retail Only
...
L.SetPAMaxIcons						= "Icônes max. : %d"--Slider, Reused for personal and tank
...
L.ShowGuildMessagesPlus				= "Afficher aussi les messages pull/victoire/défaite pour les groupes Mythique+ de la guilde (requiert l'option de raid)" --last part isn't great
...
L.DungeonDiffChangedAlert			= "Afficher une alerte lorsque la difficulté du donjon change"
...
L.CountdownStartTime				= "Définir l'heure de début du décompte pour les chronomètres de Blizzard"
L.CountStart						= "%d |4seconde restante:secondes restantes;"
...
L.BarBackgroundColor                = "Couleur de fond"
L.BarBackgroundOpacity              = "Opacité du fond : %0.2f"
L.EnableBarBorder                   = "Activer la bordure de la barre"
L.BarBorderSize                     = "Taille de la bordure : %0.1f"
L.BarBorderColor                    = "Couleur de la bordure"
