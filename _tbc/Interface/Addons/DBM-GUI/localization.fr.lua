...
L.SpecWarn_FlashColor				= "Couleur du clignotement %d"
L.SpecWarn_FlashDur					= "Durée : %0.1f"
L.SpecWarn_FlashAlpha				= "Transparence : %0.1f"
...
L.AnnouncementMidnightNotice		= "Les options de ce panneau concernent les avertissements que Blizzard classe comme 'mineurs'"
