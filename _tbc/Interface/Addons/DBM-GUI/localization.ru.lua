...
L.SearchMatch						= "%d совпадение"
L.SearchMatches						= "%d совпадений"
...
L.PosX								= "Положение по оси X"
L.PosY								= "Положение по оси Y"
...
L.Button_ShowMidnightWizard			= "Мастер установки 'Полночи'"
...
L.AutoExpandSpellGroups2			= "Автоматическое расширение опций, сгруппированных по заклинаниям"
...
L.Area_CombatAlertsRetail			= "Параметры боевых оповещений (только в открытом мире)"
...
L.Area_ImportExportProfile			= "Импорт/экспорт профиля"
...
L.RaidWarnColor 					= "Цвет"--Только один цвет используется в дополнении 'Полночь'
...
L.EnablePersonalPrivateAuraIcons	= "Отображать иконки личной ауры"--Флажок
L.EnablePersonalPrivateAuraText		= "Перезаписать масштаб текста сообщения частной ауры Blizzard"--Флажок
L.UpscaleDurationText				= "Увеличить продолжительность текста на иконках, чтобы он был более крупным"
...
L.EnableTankPrivateAuraIcons		= "Отображать иконки совместного танка (требуется специализация танка)"--Флажок
L.RIGHT								= "Справа"
L.LEFT								= "Слева"
L.UP								= "Сверху"
L.DOWN								= "Снизу"
...
L.CountdownStartTime				= "Установить время начала обратного отсчета для таймеров Blizzard"
L.CountStart						= "%d секунд осталось"
...
L.DisableBuiltInMusic				= "Отключить встроенные звуки событий и загружать только сторонние музыкальные пакеты"
...
L.Slider_TextOffSetX				= "Смещение текста по оси X: %d"
L.Slider_TextOffSetY				= "Смещение текста по оси Y: %d"
L.BarSaturation						= "Насыщенность полос для коротких интервалов времени (когда увеличенные полосы отключены): %0.2f"
L.BarBackgroundColor				= "Цвет фона"
L.BarBackgroundOpacity				= "Прозрачность фона: %0.2f"
L.EnableBarBorder					= "Включить границу полосы"
L.BarBorderSize						= "Размер границы: %0.1f"
L.BarBorderColor					= "Цвет границы"
L.MidnightNote						= "Примечание: Из-за ограничений API в Midnight, DBM не поддерживает разные начальный и конечный цвета. Будет использоваться только начальный цвет."
...
L.SAOne								= "Голосовой пакет / резервный вариант Спец. оповещения 1"
L.SATwo								= "Голосовой пакет / резервный вариант Спец. оповещения 2"
L.SAThree							= "Голосовой пакет / резервный вариант Спец. оповещения 3"
L.SAFour							= "Голосовой пакет / резервный вариант Спец. оповещения 4"
...
L.EnableVarianceBar 				= "Увеличить полосы таймера, чтобы показать максимальное время ожидания в очереди для данной способности"
...
L.BarIconPosition					= "Положение иконки"
...
L.BarInlineIcons					= "Показывать иконки журнала"--Устарело
...
L.InlineIconsDropdown				= "Стиль иконок журнала"
...
L.Area_Global_Toggles				= "Глобальные отключения функций"
L.NoWarnings						= "Полностью отключить объявления DBM"
L.NoTimers							= "Полностью отключить таймеры DBM"
L.Area_SpamFilter_SpecFeatures		= "Конкретные функции оповещения (применяется только в том случае, если они не отключены полностью выше)"
...
L.FilterTargetFocus					= "Не показывать, если заклинатель не является текущей целью или фокусом"
...
L.Area_HideBlizzard					= "Отключить и скрыть другие раздражающие функции Blizzard"
L.HideBossEmoteFrame				= "Скрывать рейдовые предупреждения Blizzard во время сражения с боссами"
