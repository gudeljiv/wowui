...
local function tpmAddObject(tt,parent,name,line,column,data)
	...
	if data.type=="spell" then
		start, duration, enabled = C_Spell.GetSpellCooldown(data.id);
...
local function init()
	...
	_itemIds = {
		...
		152964,156927,159224,166559,166560,184504,219222,253629,
	...
	-- toys
	_toyIds = {
		18984,18986,30542,30544,43824,48933,87215,95567,95568,95589,95590,110560,112059,129929,132517,136849,140192,140324,151016,151652,168807,168808,169297,169298,172924,198156,211788,230850,

		-- hearth stones
		54452,64488,93672,142542,162973,163045,165669,165670,165802,166746,166747,168862,168907,172179,184353,180290,182773,183716,184871,188952,190196,190237,193588,200630,206195,208704,209035,212337,228940,235016,236687,245970
	};
	...
	_hearthstones = {
		...
		[235016]=1, -- Toy - Redeployment Module
		[236687]=1, -- Toy - Explosive Hearthstone
		[245970]=1, -- Toy - P.O.S.T. Master's Express Hearthstone
	};
