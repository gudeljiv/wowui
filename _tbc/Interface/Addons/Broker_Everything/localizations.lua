...
L["AccountBankMoneyBrokerDesc"] = "Display current warband bank gold on broker button"
L["AccountBankMoneyDesc"] = "Display warband bank gold in tooltip"
L["AccountBankShortcut"] = "WB"
L["AccountBankShortcutBB"] = "Warband shortcut"
L["AccountBankShortcutBBDesc"] = "Prepend a shortcut of warband to the warband gold on broker button"
L["Action"] = "Action"
...
L["Bags"] = "Bags"
L["BagsBBMode"] = "Bags space display mode"
L["BagsBBModeDesc"] = "Display mode for count of free, used or total bag slots. This is also used for separate bags like reagents bags."
...
L["ClockPlayedTime"] = "Show played time"
L["ClockPlayedTimeDesc"] = "Display played time in tooltip"
L["ClockUTC"] = "Show UTC time"
L["ClockUTCDesc"] = "Display UTC time in tooltip"
...
L["ColorGradient"] = "Color gradient"
L["ColorGradientDescItemLevel"] = "Show differences between item levels with a smooth color gradient between red, yellow and green."
...
L["Connected with:"] = "Connected with:"
...
L["CrapSelling"] = "Crap selling"
L["CrapSellingArmorDesc"] = "Exclude gray armor from automatically crap selling for transmog."
L["CrapSellingArmorHold"] = "Gray armor held back for transmog:"
L["CrapSellingBloodCardsDesc"] = "Enable automatically selling of blood cards on opening a merchant window."
L["CrapSellingChatInfo"] = "Summary of earned gold in chat"
L["CrapSellingChatInfoDesc"] = "Post summary of earned gold in chat window"
L["CrapSellingEnable"] = "Enable auto crap selling"
L["CrapSellingEnableDesc"] = "Enable automatically crap selling on opening a mergant frame"
L["CrapSellingOpts"] = "Crap selling options"
L["CrapSellingSummary"] = "Auto crap selling - Summary"
L["CrapSellingWeaponsDesc"] = "Exclude gray weapons from automatically crap selling for transmog."
L["CrapSellingWeaponsHold"] = "Gray weapons held back for transmog:"
L["Critical low free slots"] = "Critical low free slots"
L["Ctrl+C to copy the URL for use in your web browser."] = "Ctrl+C to copy the URL for use in your web browser."
...
L["CurrencyHidden"] = "Show hidden currencies"
L["CurrencyHiddenDesc"] = "Display hidden currencies. That aren't the \"Unused\"."
L["CurrencyHiddenMenu"] = "Hidden currencies in menu"
L["CurrencyHiddenMenuDesc"] = "List hidden currencies in \"Currency on broker\" and \"Favorites\" menu."
L["CurrencyHiddenShiftKey"] = "Tip: Instead of activating the hidden currency display in the tooltip, you can also hold the Shift key and they will be displayed instead of the other currencies."
L["CurrencyHideEmpty"] = "Hide empty currencies"
L["CurrencyHideEmptyDesc"] = "Hide empty currencies in tooltip."
...
L["CurrencyShowDiscovered"] = "Show only discovered"
L["CurrencyShowDiscoveredDesc"] = "Display only discovered currencies in tooltip"
...
L["DelimiterBB"] = "Delimiter"
L["DelimiterBBDesc"] = "Select a delimitation that should be on the broker button between several information."
L["Demoted"] = "Demoted"
...
L["Display season cap in tooltip"] = "Display season cap in tooltip"
...
L["ErrorMsgGetMoney"] = "Error: Could not get player money. Function returns invalid value. Reason unknown. Could not calculate earn/loss."
L["ErrorMsgGetMoneyTaint"] = "Error: Could not get player money. Another addon (%s) has replaced required function. Could not calculate earn/loss."
...
L["FriendCopyIntoChatInput"] = "Copy name of friend into an opened chat input field"
L["FriendsTT2"] = "Second tooltip options"
L["FriendsTT2Class"] = "Show class"
L["FriendsTT2ClassDesc"] = "Display class in tooltip if available"
L["FriendsTT2Desc"] = "The secondary tooltip will be displayed by moving the mouse over a friend in main tooltip. The tooltip will be displayed if one of the following options activated."
...
L["GoldLosses"] = "Losses"
L["GoldProfitAll"] = "For all characters from this realm(-group)"
L["GoldProfitDaily"] = "Daily profits"
L["GoldProfitDailyAllDesc"] = "Display today and yesterday profit from all chars in tooltip"
L["GoldProfitDailyDesc"] = "Display today and yesterday profits in tooltip"
L["GoldProfitEmpty"] = "Show empty entries"
L["GoldProfitEmptyDesc"] = "Display empty entries in tooltip"
L["GoldProfitMonthly"] = "Monthly profits"
L["GoldProfitMonthlyAllDesc"] = "Display this and last month profit from all chars in tooltip"
L["GoldProfitMonthlyDesc"] = "Display this and last month profits in tooltip"
L["GoldProfits"] = "Profits"
L["GoldProfitSession"] = "Session profits"
L["GoldProfitSessionDesc"] = "Display profits of the current session in tooltip"
L["GoldProfitThis"] = "For this character"
L["GoldProfitTop"] = "Top profits"
L["GoldProfitTopDesc"] = "Display a list of top profits in an additional tooltip."
L["GoldProfitTopHeader"] = "Top %d of profits"
L["GoldProfitTopNum"] = "Number of top profits"
L["GoldProfitTopNumDesc"] = "Adjust the number of entries of top profits."
L["GoldProfitWeekly"] = "Weekly profits"
L["GoldProfitWeeklyAllDesc"] = "Display this and last week profit from all chars in tooltip"
L["GoldProfitWeeklyDesc"] = "Display this and last week profits in tooltip"
L["GPS"] = "GPS"
...
L["HideAllMinimapButtons"] = "Hide minimap buttons"
L["HideAllMinimapButtonsDesc"] = "Hide minimap buttons from all modules"
...
L["HideMoneyZero"] = "Show zero copper"
L["HideMoneyZeroDesc"] = "Display zero copper instead of empty line."
...
L["InstancesShowActiveTwinks"] = "Show active id's only"
L["InstancesShowActiveTwinksDesc"] = "Display only active ids for choosen instance from twinks in second tooltip"
...
L["MailInDelivery"] = "In delivery"
L["MailNew"] = "New mails"
L["MailNone"] = "No Mail"
L["Mails"] = "Mails"
L["MailStored"] = "Stored mails"
L["MailStoredOption"] = "Stored mail options"
L["MailStoredResetDesc"] = "With this button you can clear 'stored mail' data from all characters across factions and realms."
...
L["ModDesc-Ammo"] = "Broker to show current ammo or throwing weapons. (For hunders, rogues and warriors)"
...
L["MovieVolume"] = "Movie volume"
L["MovieVolumeDesc"] = "Activates the master volume at the beginning of the film and restores it at the end."
...
L["No ammo or throwing weapon found..."] = "No ammo or throwing weapon found..."
...
L["Stuff"] = "Stuff"
L["StuffToggleFullScreen"] = "Toggle fullscreen/window mode"
L["Subzone"] = "Subzone"
...
L["SystemRealmOnBrokerDesc"] = "Display realm name on broker button"
L["SystemRealmShowTTDesc"] = "Display realm name in tooltip"
L["SystemUpdateInInstances"] = "Disabled in instances"
L["SystemUpdateInInstancesDesc1"] = "Disable updating memory usage in instances (Dungeons, Scenarios and Raids)."
L["SystemUpdateInInstancesDesc2"] = "It is recommented for too much and/or bigger addons."
L["SystemUpdateInInstancesInfo"] = "Update disabled while you are in an instance."
L["SystemUpdateInterval"] = "Update interval"
L["SystemUpdateIntervalDesc"] = "Change the update interval or disable it."
L["SystemUpdateIntervalDescLong1"] = "Any update of the addon memory usage can cause results in fps drops and 'Script ran too long' error messages!"
L["SystemUpdateIntervalDescLong2"] = "The necessary time to collect memory usage of all addons depends on CPU speed, CPU usage, the number of running addons and more."
L["SystemUpdateIntervalDescLong3"] = "If you have more than one addon to display memory usage it is recommended to disable the update interval of this addon."
...
L["TitlesRow"] = "Titles per row"
L["TitlesRowDesc"] = "Number of titles per row in tooltip."
L["TitlesShow"] = "Show titles"
L["TitlesShowDesc"] = "This is the list of your collected titles. Here you can choose which titles are displayed in tooltip."
...
L["WoWProjectId14"] = "Cata Classic"
L["WoWProjectId19"] = "MoP Classic"
L["WoWProjectId5"] = "BC Classic"
L["XP bonus"] = "XP bonus"
L["XP gain disabled"] = "XP gain disabled"
L["XPChromieTimeBrokerDesc"] = "Display selected chromie time on broker button"
L["XPChromieTimeNotAvailable"] = "Chromie time is not available for this character. Your player level is not in required range."
L["XPChromieTimeShow"] = "Show chromie time"
L["XPChromieTimeTooltipDesc"] = "Display current chromie time status in tooltip"
L["XPChromieTimeTooltipLong"] = "List chromie timelines"
L["XPChromieTimeTooltipLongDesc"] = "Expands the chromie time status to display all available timelines"
...
L["AccountBankMoneyBrokerDesc"] = "Zeigt aktuelles Kriegsmeutenbank Gold auf dem Broker Button"
L["AccountBankMoneyDesc"] = "Zeigt Kriegsmeutenbank Gold im Tooltip"
L["AccountBankShortcut"] = "KM"
L["AccountBankShortcutBB"] = "Kriegsmeute Abkürzung"
L["AccountBankShortcutBBDesc"] = "Stellt die Abkürzung für Kriegsmeute dem Kriegsmeutengold auf dem Broker Button voran."
L["Action"] = "Aktion"
...
L["AddOnLoadedDescAlt"] = "Alternativ kannst du die Umschalt-Taste im Ladebildschirm gedrückt halten, um diese Nachricht nur für diesen Login anzeigen zu lassen."
...
L["Bags"] = "Taschen"
L["BagsBBMode"] = "Taschenplatz Anzeigenmodus"
L["BagsBBModeDesc"] = "Anzeigenmodus für Anzahl Freie, Belegt oder Gesammte Taschenplätze. Dies wird auch für einzelne Taschen wie beispielsweise Reagenzienbeutel verwendet."
L["BagsFreeOfSpace"] = "Freier Platz / Gesamter Platz"
L["BagsFreeSpace"] = "Freier Platz"
L["BagsItemsOfSpace"] = "Gesamte Gegenstände / Gesamter Platz"
...
L["Client info"] = "Client Info"
L["Client version"] = "Client-Version"
L["ClockPlayedTime"] = "Zeige gespielte Zeit"
L["ClockPlayedTimeDesc"] = "Zeigt die gespielte Zeit im Tooltip"
L["ClockUTC"] = "Zeige UTC Zeit"
L["ClockUTCDesc"] = "Zeigt UTC Zeit im Tooltip"
...
L["ColorGradient"] = "Farbverlauf"
L["ColorGradientDescItemLevel"] = "Zeige unterschiede zwischen den Gegenstandsstufen mit einem weichen Farbverlauf zwischen Rot, Gelb und Grün"
...
L["Connected with:"] = "Verbunden mit:"
...
L["CrapSelling"] = "Plunderverkauf"
L["CrapSellingArmorDesc"] = "Schließt graue Rüstung vom automatischen Plunderverkauf für Transmog aus."
L["CrapSellingArmorHold"] = "Graue Rüstung für Transmog zurückgehalten:"
L["CrapSellingBloodCardsDesc"] = "Aktiviere automatischen Verkauf von Karten des Bluts beim Öffnen eines Händlerfensters"
L["CrapSellingChatInfo"] = "Zusammenfassung des verdienten Goldes im Chat"
L["CrapSellingChatInfoDesc"] = "Schreibe Zusammenfassung des verdienten Goldes im Chatfenster"
L["CrapSellingEnable"] = "Automatischer Plunderverkauf aktivieren"
L["CrapSellingEnableDesc"] = "Aktiviere den automatischen Verkauf von grauen Gegenständen"
L["CrapSellingOpts"] = "Plunderverkauf-Optionen"
L["CrapSellingSummary"] = "Auto Plunder Verkauf - Zusammenfassung"
...
L["Ctrl+C to copy the URL for use in your web browser."] = "Strg+C zum Kopieren der URL zur Nutzung in deinem Web Browser."
...
L["CurrencyHidden"] = "Zeige versteckte Währungen"
L["CurrencyHiddenDesc"] = "Versteckte Währungen anzeigen. Das sind nicht die \"Ungenutzten\"."
L["CurrencyHiddenMenu"] = "Versteckte Abzeichen im Menü"
L["CurrencyHiddenMenuDesc"] = "Listet versteckte Abzeichen in \"Abzeichen auf dem Broker\"- und Favoritenmenü."
L["CurrencyHiddenShiftKey"] = "Tipp: Statt die Anzeige der versteckten Währung im Tooltip zu aktivieren, kannst du auch die Umschalt-Taste halten und sie werden anstelle der anderen Währungen angezeigt."
L["CurrencyHideEmpty"] = "Verstecke leere Abzeichen"
L["CurrencyHideEmptyDesc"] = "Vertstecke leere Abzeichen im Tooltip."
...
L["CurrencyShowDiscovered"] = "Nur entdeckte anzeigen"
L["CurrencyShowDiscoveredDesc"] = "Nur entdeckte Währungen im Tooltip anzeigen"
...
L["DelimiterBB"] = "Abgrenzer"
L["DelimiterBBDesc"] = "Wähle eine Abgrenzung, die auf dem Broker-Button zwischen mehreren Informationen liegen soll."
...
L["Display a list of my chars on same realm with her level and xp"] = "Zeige eine Liste meiner Charaktere auf demselben Realm mit deren Stufe und Erfahrung"
...
L["Display season cap in tooltip"] = "Zeit das Season Cap. im Tooltip an"
...
L["ErrorMsgGetMoney"] = "Fehler: Konnte Spielergeld nicht erhalten. Funktion gibt ungültigen Wert zurück. Grund unbekannt. Kann Gewinn/Verlust nicht berechnen."
L["ErrorMsgGetMoneyTaint"] = "Fehler: Konnte Spielergeld nicht erhalten. Ein anderes AddOn (%s) hat die erforderliche Funktion ersetzt. Kann Gewinn/Verlust nicht berechnen."
...
L["FollowersSummaryDesc"] = "Zusammenfassung der Follower von %s in der Charakterliste anzeigen"
...
L["FriendCopyIntoChatInput"] = "Kopiere den Name des Freunds in ein geöffnetes Chateingabefeld"
L["FriendsTT2"] = "Zweiter-Tooltip-Optionen"
L["FriendsTT2Class"] = "Zeige Klasse"
L["FriendsTT2ClassDesc"] = "Zeigt den Klasse im Tooltip, wenn verfügbar"
L["FriendsTT2Desc"] = "Der zweite Tooltip wird angezeigt, wenn du deine Maus über einen Freund im Haupttooltip bewegst. Der Tooltip wird angezeigt, wenn eine der folgenden Optionen aktiviert ist."
...
L["GoldLosses"] = "Verluste"
L["GoldProfitAll"] = "Für alle Charaktere von diese(m/r) Realm(-gruppe)"
L["GoldProfitDaily"] = "Täglichen Gewinne"
L["GoldProfitDailyAllDesc"] = "Anzeige der heutigen und gestrigen Gewinne aller Chars im Tooltip"
L["GoldProfitDailyDesc"] = "Anzeige der heutigen und gestrigen Gewinne im Tooltip"
L["GoldProfitEmpty"] = "Zeigt leere Einträge"
L["GoldProfitEmptyDesc"] = "Zeigt leere Einträge im Tooltip"
L["GoldProfitMonthly"] = "Monatliche Gewinne"
L["GoldProfitMonthlyAllDesc"] = "Gewinn dieses und des letzten Monats aller Chars im Tooltip anzeigen"
L["GoldProfitMonthlyDesc"] = "Gewinn dieses und des letzten Monats im Tooltip anzeigen"
L["GoldProfits"] = "Gewinne"
L["GoldProfitSession"] = "Sitzungsgewinne"
L["GoldProfitSessionDesc"] = "Zeigt die Sitzungsgewinne im Tooltip"
L["GoldProfitThis"] = "Für diesen Charakter"
L["GoldProfitTop"] = "Top Gewinne"
L["GoldProfitTopDesc"] = "Zeigt eine Liste der Top Gewinne in einem zusätzlichen Tooltip."
L["GoldProfitTopHeader"] = "Top %d der Gewinne"
L["GoldProfitTopNum"] = "Anzahl der Top Gewinne"
L["GoldProfitTopNumDesc"] = "Passen Sie die Anzahl der Einträge der höchsten Gewinne an."
L["GoldProfitWeekly"] = "Wöchentliche Gewinne"
L["GoldProfitWeeklyAllDesc"] = "Gewinn dieser und der letzten Woche aller Chars im Tooltip anzeigen"
L["GoldProfitWeeklyDesc"] = "Gewinn dieser und der letzten Woche im Tooltip anzeigen"
L["GPS"] = "GPS"
...
L["HideAllMinimapButtons"] = "Verstecke Minimap Buttons"
L["HideAllMinimapButtonsDesc"] = "Verstecke Minimap Buttons von allen Modulen"
...
L["HideMoneyZero"] = "Zeige 0 Kupfer"
L["HideMoneyZeroDesc"] = "Zeigt 0 Kupfer anstelle eine leeren Zeile"
...
L["InstancesShowActiveTwinks"] = "Zeige nur aktive ID's"
L["InstancesShowActiveTwinksDesc"] = "Zeige nur aktive ID's for ausgewähle Instanzen von Twinks im zweiten Tooltip"
...
L["MailInDelivery"] = "In Zustellung"
L["MailNew"] = "Neue Briefe"
L["MailNone"] = "Keine Post"
L["Mails"] = "Briefe"
L["MailStored"] = "Gelagerte Briefe"
L["MailStoredOption"] = "Gelagerte Briefe-Optionen"
L["MailStoredResetDesc"] = "Mit dieser Schaltfläche könnt Ihr die \"Gelagerte Briefe\"-Daten von allen Charakteren über alle Fraktionen und Realms hinweg löschen."
...
L["ModDesc-Ammo"] = "Broker zum anzeigen der aktuellen Munition oder Wurfwaffen. (Für Jäger, Schurken und Krieger)"
...
L["MovieVolume"] = "Filmlautstärke"
L["MovieVolumeDesc"] = "Aktiviert die Gesamtlautstärke zu Beginn des Films und stellt sie am Ende wieder her."
...
L["No ammo or throwing weapon found..."] = "Keine Munition oder Wurfwaffe gefunden..."
...
L["Recently"] = "Kürzlich"
L["Recipes from faction vendors"] = "Rezepte von Fraktionshändlern"
...
L["Show tainting entries"] = "Verderbnis-Einträge anzeigen"
...
L["SingleRepairSummary"] = "Einzelreparatur Zusammenfassung"
L["SizeSuffix-10E12"] = "T"
L["SizeSuffix-10E15"] = "Qa"
L["SizeSuffix-10E18"] = "Qi"
L["SizeSuffix-10E3"] = "K"
...
L["Stuff"] = "Dinge"
L["StuffToggleFullScreen"] = "Wechsel Vollbild-/Fenstermodus"
...
L["SystemRealmOnBrokerDesc"] = "Zeige Realmnamen am Broker Button"
L["SystemRealmShowTTDesc"] = "Zeige Realmnamen im Tooltip"
L["SystemUpdateInInstances"] = "In Instanzen deaktiviert"
L["SystemUpdateInInstancesDesc1"] = "Deaktiviert die Aktuallisierung der Speichernutzung in Instanzen (Dungeons, Scenarios und Schlachtzügen)."
L["SystemUpdateInInstancesDesc2"] = "Es ist empfohlen für zu viele und/oder schwere AddOns."
L["SystemUpdateInInstancesInfo"] = "Aktuallisierung deaktiviert solange du in einer Instanz bist."
L["SystemUpdateInterval"] = "Aktualisierungsintervall"
L["SystemUpdateIntervalDesc"] = "Wähle das Aktualisierungsintervall oder deaktiviere es."
L["SystemUpdateIntervalDescLong1"] = "Jedes Update der Addonspeichernutzung kann Verringerungen der FPS und 'Script ran too long'-Fehlermeldungen verursachen"
L["SystemUpdateIntervalDescLong2"] = "Die benötigte Zeit zum Sammeln der Speichernutzung aller Addons hängt von der CPU-Geschwindigkeit, der CPU-Auslastung, der Anzahl der laufenden Addons und mehr ab."
L["SystemUpdateIntervalDescLong3"] = "Falls du mehr als ein Addon zur Anzeige der Speichernutzung hast, wird es empfohlen, das Aktualisierungsintervall in diesem Addon zu deaktivieren."
...
L["TitlesRow"] = "Titel pro Zeile"
L["TitlesRowDesc"] = "Anzahl der Titel pro Zeile im Tooltip."
L["TitlesShow"] = "Zeige Titel"
L["TitlesShowDesc"] = "Das ist die Liste deiner gesammelten Titel. Hier kannst du auswählen, welche Titel im Tooltip angezeigt werden."
...
L["World quests status update requires min. level:"] = "Die Aktualisierung des Weltquest-Status erfordert Mindeststufe:"
L["WoWProjectId1"] = "Retail"
L["WoWProjectId11"] = "WotLK Classic"
L["WoWProjectId14"] = "Cata Classic"
L["WoWProjectId19"] = "MoP Classic"
...
L["XPChromieTimeBrokerDesc"] = "Zeige ausgewählte Chromie Zeit auf Broker Button"
L["XPChromieTimeNotAvailable"] = "Chromie Zeit ist nicht verfügbar für diesen Charakter. Dein Charakterstufe ist nicht im erforderlichen Bereich."
L["XPChromieTimeShow"] = "Zeige Chromie Zeit"
L["XPChromieTimeTooltipDesc"] = "Zeige aktuellen Chromie Zeit Status im Tooltip"
L["XPChromieTimeTooltipLong"] = "Liste Chromie Zeitlinien auf"
L["XPChromieTimeTooltipLongDesc"] = "Erweitert den Chromie Zeitstatus um alle verfügbaren Zeitlinien anzuzeigen."
...
L["* (Asterisk) behind character name if on foreign realm"] = "* (Astérisque) derrière le nom du personnage s'il se trouve dans un royaume étranger"
...
L["ArchaeologyInfoRequiredFragements"] = "Projets solvables"
...
L["Stuff"] = "Equippement"
L["Subzone"] = "Sous zone"
L["SystemUpdateIntervalDesc"] = "Changer l'intervalle de mise à jour ou le désactiver."
L["SystemUpdateIntervalDescLong1"] = "Toute mise à jour de l'utilisation de la mémoire de l'addon peut entraîner des baisses de fps et des messages d'erreur"
...
L["Ctrl+C to copy the URL for use in your web browser."] = "정말로 UI를 재시작할까요?"
...
L["SystemUpdateInterval"] = "업데이트 간격"
L["SystemUpdateIntervalDesc"] = "업데이트 간격을 바꾸거나 업데이트를 끕니다."
L["SystemUpdateIntervalDescLong1"] = "모든 애드온 메모리 사용량 업데이트는 FPS 하락과 '스크립트가 너무 오래 실행되었습니다'라는 오류 메시지 발생을 초래할 수 있습니다!"
L["SystemUpdateIntervalDescLong2"] = "모든 애드온의 메모리 사용량을 수집하는 데 필요한 시간은 CPU 속도, CPU 사용량, 실행 중인 애드온 수 등에 따라 다릅니다."
L["SystemUpdateIntervalDescLong3"] = "메모리 사용량을 표시하는 애드온이 하나 이상인 경우 이 애드온의 업데이트 간격을 끄는 것이 좋습니다."
...
L["CrapSellingSummary"] = "Авто продажа мусора - Суммарно"
L["Demoted"] = "Понижен:"
...
L["SystemUpdateIntervalDesc"] = "Измените интервал обновления или отключите его."
L["SystemUpdateIntervalDescLong1"] = "Любое обновление использования памяти аддона может привести к падению частоты кадров и сообщениям об ошибках 'Сценарий выполнялся слишком долго'!"
...
L["AddOnLoadedDescAlt"] = "或者您可以在加载屏幕上按住shift键，只显示此登录信息。"
...
L["and %d more"] = "和 %d 更多"
L["Append the BattleTag of your friends to the character name"] = "将好友的战网标签附加到角色名称中"
L["Applicant"] = "入会申请人"
L["Applicants"] = "入会申请"
L["ArchaeologyInfoMaxFragements"] = "碎片限制"
L["ArchaeologyInfoMaxFragementsDesc"] = "在broker按钮上显示即将达到碎片限制的种族的名称。"
L["ArchaeologyInfoRequiredFragements"] = "项目可解决"
L["ArchaeologyInfoRequiredFragementsDesc"] = "在broker按钮上显示其项目可以解决的种族的名称。"
...
L["CharDataError"] = "来自数据出错"
L["CharDataErrorTODO"] = "删除数据或登录到此字符进行修复"
L["CharsFrom"] = "显示角色"
...
L["ClockPlayedTime"] = "显示播放时间"
L["ClockPlayedTimeDesc"] = "在工具提示中显示播放时间"
L["ClockUTC"] = "显示UTC时间"
L["ClockUTCDesc"] = "在工具提示中显示UTC时间"
L["Close menu"] = "关闭菜单"
...
L["Cooldowns"] = "冷却"
L["Coordinates"] = "坐标"
L["Coordinates indeterminable"] = "坐标不确定"
L["Coordination format"] = "坐标格式"
L["Count"] = "|n总数"
L["Count of data to collect:"] = "已收集数据: "
L["Count of watched faction"] = "已追踪阵营声望值"
L["CrapSelling"] = "垃圾出售"
L["CrapSellingArmorDesc"] = "将灰色盔甲排除在transmog的自动垃圾销售之外。"
L["CrapSellingArmorHold"] = "为transmog保留的灰色盔甲："
...
L["CrapSellingWeaponsDesc"] = "将灰色武器排除在transmog的自动垃圾销售之外。"
L["CrapSellingWeaponsHold"] = "为transmog保留的灰色武器："
L["Critical low free slots"] = "低空格数警告"
L["Currency on broker"] = "货币在broker上"
...
L["Display a list of bag by types with free and total summary in tooltip"] = "按类型显示包的列表，并在工具提示中显示免费和完整的摘要"
...
L["Display a T-Set label on items"] = "在项目上显示 T-Set 标签"
L["Display a yellow # on items with empty sockets"] = "在鼠标提示中显示黄色#在未镶嵌物品后"
L["Display addon count on broker"] = "在代理上显示插件数量"
L["Display ammunition name on broker button"] = "在broker按钮上显示信息名称"
L["Display an item summary list by qualities in tooltip"] = "在鼠标提示中显示物品品质统计列表"
L["Display Battle.Net-Friends on DesktopApp in tooltip"] = "在工具提示中显示桌面应用程序上的Battle.Net的好友"
L["Display Battle.Net-Friends on MobileApp in tooltip"] = "在工具提示中显示MobileApp上的Battle.Net好友"
...
L["Display country flag behind realm names"] = "在域名后面显示国家/地区标志"
...
L["Display faction id's in tooltip"] = "在工具提示中显示派系id"
...
L["Display other bag types like herbalism or mining bags separated on broker button"] = "显示其他类型的袋子，如在broker按钮上分开草药袋或采矿袋"
...
L["Enable it from the character info"] = "从角色信息启用"
...
L["FollowersBgColorStatusDesc"] = "将%s状态的背景色行改为拆分为单独的表"
L["FollowersHeaderInfo"] = "显示标题信息"
L["FollowersHeaderInfoDesc"] = "显示其他标题行，如“%s”"
L["FollowersStatusLabelDesc"] = "显示状态为“%s”的字符列表"
L["FollowersSummaryDesc"] = "在字符列表中显示%s的追随者摘要"
...
L["Free slots"] = "空格数"
L["FriendsTT2"] = "副鼠标提示"
L["FriendsTT2Desc"] = "将鼠标移动至主提示中的一个好友时显示副提示, 提示将在下列任意选项启用时显示"
L["Game icon"] = "游戏图标"
...
L["Group leader"] = "组长"
L["Guild MotD"] = "今日信息"
L["GuildErrorInviteMissingFunction"] = "错误：缺少邀请功能"
L["GuildErrorInviteMobile"] = "错误：您试图邀请使用移动应用程序联机的成员"
L["GuildErrorInviteOffline"] = "错误：您试图邀请一个脱机成员"
L["GuildErrorWhisperOffline"] = "错误：您试图对脱机的成员M语"
L["GuildLog"] = "公会日志"
L["GuildShowChallengesDesc"] = "为鼠标悬停添加一行，以便在子工具提示上显示公会挑战"
L["GuildShowInfoDesc"] = "为鼠标悬停添加一行，以便在子工具提示上显示公会信息"
L["GuildTableBg"] = "表格背景"
L["GuildTableBgDesc"] = "在申请者和成员的工具提示上显示或隐藏表格背景色。"
L["has reached Level %d."] = "已升至%d级."
L["Hidden random zone dailies"] = "隐藏的随机区域每日任务"
...
L["HideMoneyDescBrokerButton"] = "在broker上隐藏可显示货币的部分"
L["HideMoneyDescEverywhere"] = "隐藏部分金币数"
L["HideMoneyDescTooltip"] = "在工具提示中隐藏部分可显示货币"
...
L["MissionsExpansionsDesc"] = "在工具提示和broker按钮上显示%s扩展中的任务"
...
L["Need excalted reputation:"] = "需要崇高的声望："
L["Need level"] = "需要等级"
...
L["No currencies discovered..."] = "未发现货币。。。"
L["No data"] = "无数据"
...
L["SystemUpdateInterval"] = "更新间隔"
L["SystemUpdateIntervalDesc"] = "选择更新间隔或禁用"
L["SystemUpdateIntervalDescLong1"] = "更新插件内存使用量有可能导致fps丢失和\"脚本运行时间过长\"的报错!"
L["SystemUpdateIntervalDescLong2"] = "收集所有插件内存使用量所需的时间取决于CPU速度, CPU利用率, 正在运行的插件数量等等"
L["SystemUpdateIntervalDescLong3"] = "如果有超过一个以上显示内存使用量的插件, 推荐禁用本插件的更新间隔"
...
L["(session only)"] = "(階段限定)"
L["(starts soon)"] = "(很快開始)"
L["* (Asterisk) behind character name if on foreign realm"] = "在其他伺服器玩家的角色名稱後添加星號(*)"
L["_ (undercore) > [_60 fps]"] = "_ (底線) > [_60 fps]"
...
L["Add new note"] = "添加新的備註"
L["Additional time zones"] = "其他時區"
L["Addon"] = "插件"
L["Addon list"] = "插件列表"
L["Addon panel"] = "插件介面"
L["AddOnLoaded"] = "插件已載入"
L["AddOnLoadedDesc"] = "在登入和重新載入使用者介面後顯示'插件已載入'"
L["AddOnLoadedDescAlt"] = "您可以在載入畫面上按住Shift鍵顯示此訊息（只限一次）"
L["AddOns and memory"] = "插件及記憶體"
L["Adjust the count of numbers behind the dot."] = "調整小數點後位數"
L["All 10 minutes"] = "每十分鐘"
L["All 20 minutes"] = "每二十分鐘"
L["All 30 seconds"] = "每三十分鐘"
L["All 40 minutes"] = "每四十分鐘"
L["All 5 minutes"] = "每五分鐘"
L["All realms"] = "全部伺服器"
L["All slots are empty"] = "全部插槽都是空的"
L["AllFactions"] = "全部陣營"
L["AllFactionsDesc"] = "在滑鼠提示中顯示全部陣營（聯盟，部落和中立）的角色"
L["and %d more"] = "和 %d 更多"
L["Append the BattleTag of your friends to the character name"] = "在角色名稱上附加好友的BattleTag"
L["Applicant"] = "申請者"
L["Applicants"] = "公會申請"
L["ArchaeologyInfoMaxFragements"] = "碎片上限"
L["ArchaeologyInfoMaxFragementsDesc"] = "在broker按鈕上顯示即將達到碎片上限的種族名稱。"
L["ArchaeologyInfoRequiredFragements"] = "可辨識的文物"
L["ArchaeologyInfoRequiredFragementsDesc"] = "在broker按鈕上顯示可辨識文物的種族名稱。"
L["Artifact frame"] = "神兵武器介面"
L["Artifact knowledge"] = "神兵知識"
...
L["Artifacts"] = "神兵"
L["Automatically repair failed. Not enough money..."] = "金幣不足無法修理裝備。"
L["Automatically repair your equipment on opening a merchant with repair option."] = "開啟交易介面時，如可修理裝備就自動修理"
L["Automatically repaired with guild money"] = "以工會資金修理裝備"
L["Automatically repaired with player money"] = "以個人資金修理裝備"
L["AutoRepair"] = "自動修理"
L["available"] = "可用"
L["Available blueprints level 3"] = "可用的3級要塞藍圖"
L["AvItemLvl"] = "顯示平均物品等級"
L["AvItemLvlDesc"] = "在broker按鈕上顯示平均物品等級"
L["Back from missions"] = "從任務返回"
L["Background reputation bar mode"] = "背景聲望條模式"
L["Bags"] = "背包"
L["BagsQualityAll"] = "全部品質類型"
L["BagsQualityCommon"] = "僅限於'粗糙'和'普通'品質類型"
L["BagsQualityJunk"] = "僅限於'粗糙'品質類型"
L["BagsQualityNoEmpty"] = "隱藏空白條目"
L["BagsQualityVendor"] = "商人價格"
...
L["Calendar"] = "日曆"
L["CalendarBlizzardEvents"] = "暴雪事件"
L["CalendarBlizzardEventsDesc"] = "顯示暴雪建立的事件列表"
L["CalendarCommunityEvents"] = "社群事件"
L["CalendarCommunityEventsDesc"] = "顯示社群事件列表"
L["CalendarGuildAnnouncements"] = "公會通知"
L["CalendarGuildEvents"] = "公會事件"
L["CalendarGuildEventsDesc"] = "顯示公會通知和事件列表"
L["CalendarInvites"] = "邀請"
L["CalendarInvitesDesc"] = "顯示玩家建立的邀請列表"
L["CalendarInviteStatus"] = "邀請狀態"
L["Change how much digits display after the dot."] = "改變小數點後顯示位數"
L["Change steps"] = "音量調整幅度"
L["Change the list style."] = "改變列表樣式"
L["Change the stepping width for volume changes with mousewheel and clicks."] = "使用滑鼠滾輪和點擊來調整音量幅度"
L["Chilling"] = "閒置"
