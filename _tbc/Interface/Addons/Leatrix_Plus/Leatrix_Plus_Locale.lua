...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "勾选后，你可以通过右键及鼠标滚轮来调整角色模型窗口。|n|n你可以鼠标中键点击改变模型状态，同时模型控制按钮将会隐藏。|n|n还会在试衣间添加去除装备按钮。"
...
L["Keyword"] = "关键词"
L["Lakeshire"] = "湖畔镇"
L["Leatrix Plus needs to be updated with the flight details.  Press CTRL/C to copy the flight details below then paste them into a ticket at github.com/leatrix or a message to leatrix via CurseForge website or an email to flight@leatrix.com.  When your report is received, Leatrix Plus will be updated and you will never see this window again for this flight."] = "LeatrixPlus需要为飞行计时进行更新。按住Ctrl+C来复制下方的信息，然后在github.com/leatrix或Curseforge上发送给我，也可以直接发送邮件至flight@leatrix.com。当你的报告收到后，LeatrixPlus会进行更新，你就不会再收到后续的提示了。"
...
L["If checked, you will be able to change the position and scale of the player frame, target frame and timer bar.|n|nNote that enabling this option will prevent you from using the default UI to move the player and target frames."] = "勾選後，您將能夠更改焦點框的位置和比例。|n|n請注意，啟用此選項將阻止您使用預設 UI 移動焦點框。"
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "勾選後，您將可以在角色框架，試衣框架和觀察框架中平移（右鍵）和縮放（滑鼠滾輪）。|n|n您將能夠在角色框架中中鍵點擊角色模型來切換角色屬性。|n|n模型旋轉控制將被隱藏。用於切換裝備的按鈕將添加到試衣框架。"
...
L["Keyword"] = "關鍵字"
L["Lakeshire"] = "湖畔鎮"
L["Leatrix Plus needs to be updated with the flight details.  Press CTRL/C to copy the flight details below then paste them into a ticket at github.com/leatrix or a message to leatrix via CurseForge website or an email to flight@leatrix.com.  When your report is received, Leatrix Plus will be updated and you will never see this window again for this flight."] = "Leatrix Plus需要更新航班詳細資訊。按 CTRL/C 複製下面的航班詳細訊息，然後將它們貼上到 github.com/leatrix 的ticket或通過 CurseForge 網站向 leatrix 發送消息或發送電子郵件至 flight@leatrix.com。收到您的報告後，Leatrix Plus將會更新，您將永遠不會再看到此航班的提醒視窗。"
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Если установлен этот флажок, то с помощью правой кнопки мыши вы сможете перемещать, а при помощи колеса мыши (средней кнопки) масштабировать изображение вашего персонажа в окне вашей экипировке, в примерочной и в окне осмотра персонажа другого игрока.|n|nВы сможете выполнить щелчок средней кнопкой мыши на модели персонажа в перечисленных окнах для переключения его атрибутов.|n|nКнопки управления вращением персонажа - будут скрыты. В окно примерочной будет добавлена кнопка переключения экипировки."
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "캐릭터, 미리보기, 살펴보기 프레임에서 이동 (오른쪽 버튼) 및 확대 축소 (마우스 휠)를 사용 할 수 있습니다.|n|n캐릭터 프레임에서 캐릭터 모델을 가운데 클릭하여 캐릭터 속성을 전환 할 수 있습니다.|n|n모델 회전 컨트롤이 숨겨집니다. 장비 전환 버튼이 미리보기 프레임에 추가됩니다. "
...
L["If checked, you will be able to change the position and scale of the focus frame."] = "Si está seleccionado, podrá cambiar la posición y la escala del cuadro de enfoque."
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Si está seleccionado, podrá desplazarse (botón derecho) y acercarse (rueda del ratón) en el marco del personaje, el marco del disfraz y el marco de inspección.|n|nPodrás hacer clic con el botón central en el modelo del personaje en el marco del personaje para alternar los atributos del personaje.|n|nSe ocultarán los controles de rotación del modelo. Los botones para alternar el equipo se agregarán al marco de disfraces."
