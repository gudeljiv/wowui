...
L.Reset = "Reiniciar"
L.Clear = "Limpar"
L.SearchFilters = "Filtros de pesquisa"
L.SearchFiltersInformation = "* Usa as configurações BagSync |cffff7d0a[CR]|r e |cff3587ff[BNet]|r."
L.SearchFiltersLocationInformation = "* Selecionar nenhum padrão para selecionar ALL."
L.Units = "Unidades:"
L.Locations = "Locais:"
L.Profiles = "Perfis"
...
L.AlwaysShowSearchFilters = "Mostrar sempre a janela de filtros de pesquisa do BagSync."
...
L.EnableAddonCompartment = "Ativar integração do Compartimento de Addons da Blizzard."
L.ResetMinimapBtn = "Redefinir a posição do botão do minimapa."
L.AddonCompartmentReloadMsg = "As mudanças no Compartimento de Addons exigem recarregar a interface. Use /reload para aplicar."
...
L.ConfigCache = "Cache"
L.ConfigCacheHeader = "Configurações do cache de itens e limitação do BagSync."
L.ConfigCacheHowTitle = "Como O Cache Funciona"
L.ConfigCacheHowText_1 = "As informações de itens não estão totalmente disponíveis ao entrar no jogo. APIs como |cFFB19CD9GetItemInfo|r ou |cFFB19CD9C_Item.GetItemInfo|r retornam nil (ou nada) até que o item seja armazenado em cache na sessão."
L.ConfigCacheHowText_2 = "O BagSync solicita dados ausentes em pequenos lotes e espera o cliente recebê-los (o mesmo fluxo que dispara GET_ITEM_INFO_RECEIVED)."
L.ConfigCacheHowText_3 = "A limitação mantém o desempenho estável enquanto o cache se aquece, para que buscas e tooltips sejam completados com o tempo."
L.ConfigCacheRatesTitle = "Taxas Atuais"
L.ConfigCacheSpeedTitle = "Velocidade do Cache"
L.ConfigCacheSpeedLabel = "Limitação"
L.ConfigCacheSpeedHelp = "|cFFB19CD9Lento|r é o padrão e o melhor para desempenho, mas as buscas demoram mais para cachear tudo.\n|cFFB19CD9Médio|r é mais rápido, mas pode causar pequenos picos ao entrar no jogo.\n|cFFB19CD9Rápido|r é o mais intenso e pode causar picos de lag ao entrar no jogo.\n|cFFFF4D4DDesativado|r |cFFFF4D4Dnão é recomendado|r (|cFFFFFFFFO BagSync usará |cFFB19CD9Rápido|r enquanto a janela de busca estiver aberta e durante as buscas.|r)"
L.CacheSpeedSlow = "Lento (Fundo + Rampa)"
L.CacheSpeedMedium = "Médio"
L.CacheSpeedFast = "Rápido"
L.CacheSpeedDisabled = "Desativado (Sem cache em segundo plano)"
L.CacheSpeedRampIntro = "O modo Lento aumenta a cada %d segundos."
L.CacheSpeedRampLine = "Etapa %d: %d itens a cada %.2fs (~%d por segundo)."
L.CacheSpeedSingleLine = "%d itens a cada %.2fs (~%d por segundo)."
L.CacheSpeedDisabledSummary = "O cache em segundo plano está desativado. Ao abrir o BagSync, usa Rápido e as buscas também usam Rápido."
...
L.ConfigFont = "Fonte"
L.ConfigExtTooltipAnchor = "Posição do GameTooltip"
L.ConfigExtTipPositionSettings = "Configurações de posição do tooltip externo"
L.ConfigExtTipCustomAnchorEnable = "Ativar posição de ancoragem personalizada"
L.ConfigExtTipCustomAnchorLocation = "Localização personalizada"
L.ConfigExtTipCustomAnchorShow = "Mostrar âncora do ExtTip"
L.ExtTipCustomAnchor_TopLeft = "Superior esquerda"
L.ExtTipCustomAnchor_TopRight = "Superior direita"
L.ExtTipCustomAnchor_BottomLeft = "Inferior esquerda"
L.ExtTipCustomAnchor_BottomRight = "Inferior direita"
L.ExtTipCustomAnchor_Center = "Centro"
L.ExtTipCustomAnchor_CenterTop = "Centro superior"
L.ExtTipCustomAnchor_CenterBottom = "Centro inferior"
L.ExtTipCustomAnchor_UseAnchor = "Usar âncora do ExtTip"
L.ExtTipAnchorLabel = "Ancoragem ExtTip do BagSync\\n\\n(Clique com o botão direito para salvar a posição)"
...
L.ExtTooltipAnchor_Bottom = "Embaixo"
L.ExtTooltipAnchor_Left = "Esquerda"
L.ExtTooltipAnchor_Right = "Direita"
L.ExtTipNoticeTitle = "Aviso do tooltip externo (ExtTip)"
L.ExtTipNoticeText = "|cFFFFFFFFOs |cFFFF0000Secret Values|r|cFFFFFFFF da Blizzard podem bloquear o posicionamento do ExtTip. O BagSync adiciona proteções, mas se nenhum tooltip seguro for encontrado, as contagens vão para o |cFFFF0000GameTooltip|r|cFFFFFFFF. Veja a FAQ sobre |cFFFF0000'Secret Values'|r|cFFFFFFFF.|r"
...
L.CachingItemData = "Armazenando dados dos itens... (%d restantes)"
...
|cffff7d0aFiltros de pesquisa|r (|cFF99CC33commands|r | |cFFFFD580example|r):
...
L.FAQ_Question_8 = "Erros de secret values e restrições de addons da Blizzard"
L.FAQ_Question_8_p1 = [[
O novo sistema de |cFFDF2B2B"secret values"|r da Blizzard foi feito para que addons possam |cFF99CC33exibir|r certos dados relacionados ao combate, mas |cFFDF2B2Bnão possam inspecionar ou calcular sobre eles com segurança|r. Em caminhos de código contaminados, operações aritméticas, comparações e até algumas indexações nesses valores geram erros de Lua imediatos. Esses valores também podem "infectar" frames e tooltips por meio de aspectos/âncoras secretas, de modo que |cFF99CC33o mesmo tooltip|r pode começar a retornar coordenadas secretas depois, mesmo que o addon que o tocou não tenha criado o valor secreto originalmente. Isso significa que um stack trace apontando para o BagSync |cFFDF2B2Bnão|r prova que o BagSync introduziu o valor secreto; muitas vezes só quer dizer que o BagSync foi o próximo addon a tocar no objeto já contaminado.

Isso não é um problema exclusivo do BagSync. A própria interface da Blizzard está gerando os mesmos erros "attempt to perform arithmetic on a secret value" (por exemplo, MoneyFrame / GameTooltip) mesmo sem addons de terceiros. Outros addons já estão lançando correções emergenciais ou proteções para a |cFF99CC33mesma exata classe de erro|r desencadeada por secret values em tooltips e money frames. |cFFDF2B2BEm resumo: é um problema amplo de plataforma, não um bug exclusivo do BagSync|r.

Eu |cFFDF2B2Btentei|r adicionar o máximo possível de salvaguardas e verificações defensivas para reduzir a chance de o BagSync disparar esses erros, mas a Blizzard tornou os secret values |cFFDF2B2Bincrivelmente difíceis de rastrear e controlar|r em um ambiente de addons mistos, por design. Este sistema impede ativamente que addons inspecionem o valor de forma confiável ou até mesmo confirmem |cFF99CC33onde|r ele se originou. É exatamente por isso que esses erros são difíceis de reproduzir e muitas vezes só aparecem quando o erro acontece.
]]
L.BagSyncInfoWindow = [[
