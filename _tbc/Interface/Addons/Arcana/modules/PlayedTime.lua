...
local function playedTimeEvent(_, _, totalTimeInSeconds, timeAtThisLevel)
...
function Module:Delete(charName)
    if charName and CB_PlayedTime[charName] then
        CB_PlayedTime[charName] = nil
        db = CB_PlayedTime
    end
end
