...
L['After you select item, AuctionFaster will automatically make a scan of first page and undercut set bid/buy according to price model selected.'] =
	'После того, как вы выберете предмет, AuctionFaster автоматически выполнит сканирование первой страницы и установит ставку в соответствии с выбранной ценовой моделью.'
L['Here you will see selected item. Max stacks means how much of stacks can you sell according to your setting. Remaining means how much quantity will still stay in bag after selling item.'] =
	'Здесь вы увидите выбранный предмет. Максимум паков означает, сколько паков вы можете продать в соответствии с вашими настройками. Оставшееся означает - сколько количества останется в сумке после продажи предмета.'
