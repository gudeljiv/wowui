...
L['Queue'] = true
L[
		'Fast Mode - Auction Faster will NOT wait until you actually buy an item.\n\n' ..
...
L['Welcome to AuctionFaster.\n\nI recommend checking out\ntutorial at least once\nbefore you ' .. 'accidentially\nbuy half of the auction house.\n\n:)'] =
	'欢迎使用AuctionFaster。\n\n诚挚地建议您，使用前先阅读一遍新手教程，' .. '以免不小心买下半个拍卖场。\n\n:)'
...
L['By default, AuctionFaster always undercuts price,\neven if you toggle "Remember Last Price"\n' .. 'If you uncheck this option AuctionFaster\nwill never undercut items for you'] =
	'AuctionFaster会自动压价，使上架的价格永远是最低价，就算你勾选了“记住上次价格”也一样。\n如果你取消这项，Auction Faster就不再替你自动压价。'
...
L['Here you will see selected item. Max stacks means how much of stacks can you sell according to your setting. Remaining means how much quantity will still stay in bag after selling item.'] =
	'你会在这里看见刚才选择的物品。“堆叠可售”的数量指的是按你设置的堆叠可以出售几叠。“剩馀”的数量指的是扣除那些预计要出售的数量后，包里还剩下多少个。'
