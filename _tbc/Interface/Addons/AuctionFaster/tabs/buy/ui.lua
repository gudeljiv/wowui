...
function Buy:DrawSearchPane()
	...
	filtersButton:SetScript(
		'OnClick',
		function()
			Buy:ToggleFilterFrame()
		end
	)
	sniperButton:SetScript(
		'OnClick',
		function()
			Buy:ToggleSniperFrame()
		end
	)
			...
			events = {
				OnEnter = function(table, cellFrame, rowFrame, rowData, columnData, rowIndex)
					if AuctionFaster.db.buy.tooltips.enabled then
						...
						AuctionFaster:ShowTooltip(cellFrame, rowData.itemLink, true, rowData.itemId, AuctionFaster.db.buy.tooltips.anchor)
					end
					return false
				end,
