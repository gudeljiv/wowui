...
function Sell:DrawItemSettingsPane()
	...
	pane:SetScript(
		'OnShow',
		function()
			AuctionFaster.db.itemSettingsOpened = true
		end
	)
	pane:SetScript(
		'OnHide',
		function()
			AuctionFaster.db.itemSettingsOpened = false
		end
	)
...
function Sell:InitItemSettingsTooltips()
	...
	StdUi:FrameTooltip(pane.rememberStack, L['Checking this option will make\nAuctionFaster remember how much\n' .. 'stacks you wish to sell at once\nand how big is stack'], 'AFInfoTT', 'TOPLEFT', true)
