...
local fastModeExplanation =
	L[
	'Fast Mode - AuctionFaster will NOT wait until you actually buy an item.\n\n' ..
...
function ChainBuy:UpdateWindow()
	if not self.currentRequest or not self.window then
		return
	end
