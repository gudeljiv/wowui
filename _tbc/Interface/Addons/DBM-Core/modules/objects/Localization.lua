...
local autoGeneratedLocales = {}
function DBM:RegisterGeneratedLocales(localeType, locales)
	if autoGeneratedLocales[localeType] then
		for k, v in pairs(locales) do
			autoGeneratedLocales[localeType][k] = v
		end
	else
		autoGeneratedLocales[localeType] = locales
	end
end

function DBM:GetGeneratedLocales(localeType)
	return autoGeneratedLocales[localeType] or {}
end
