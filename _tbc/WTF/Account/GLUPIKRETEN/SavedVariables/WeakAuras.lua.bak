...
["adjustedMax"] = "",
["displayText_format_c1_gcd_hide_zero"] = false,
["yOffset"] = 450,
["anchorPoint"] = "CENTER",
["displayText_format_c1_time_dynamic_threshold"] = 6,
["sparkRotation"] = 0,
["url"] = "https://wago.io/f1tzlceQj/3",
["actions"] = {
["start"] = {
},
["init"] = {
["do_custom_load"] = false,
["custom"] = "-- ACTIONS -> On Init:\n-- Clear everything on load\naura_env.combatTimers = nil\naura_env.lastCombatCheck = nil\nif aura_env.combatLogFrame then\n    aura_env.combatLogFrame:UnregisterAllEvents()\n    aura_env.combatLogFrame = nil\nend",
["do_custom"] = true,
},
["finish"] = {
},
...
["displayText_format_c1_time_mod_rate"] = false,
["shadowXOffset"] = 1,
["smoothProgress"] = true,
["useAdjustededMin"] = false,
["regionType"] = "text",
["displayText_format_c1_gcd_gcd"] = true,
["texture"] = "Flat",
["sparkTexture"] = "Interface\\CastingBar\\UI-CastingBar-Spark",
["displayText_format_c1_time_precision"] = 2,
["tocversion"] = 11507,
["alpha"] = 1,
["sparkColor"] = {
1,
...
["adjustedMin"] = "",
["shadowYOffset"] = -1,
["displayText_format_c1_time_format"] = 0,
...
["customText"] = "-- CUSTOM TEXT FUNCTION:\n-- This does all the heavy lifting\nfunction()\n    local currentTime = GetTime()\n    \n    -- Helper functions\n    local function getUnitGUID(unit)\n        return UnitExists(unit) and UnitGUID(unit) or nil\n    end\n    \n    local function isHostileNPC(unit)\n        return UnitExists(unit) and \n        not UnitIsPlayer(unit) and \n        UnitCanAttack(\"player\", unit) and\n        not UnitIsDead(unit) and\n        UnitAffectingCombat(unit)\n    end\n    \n    local function findUnitByGUID(destGUID)\n        local units = {\"target\", \"focus\"}\n        for i = 1, 40 do\n            table.insert(units, \"nameplate\" .. i)\n        end\n        \n        for _, unit in ipairs(units) do\n            if isHostileNPC(unit) then\n                local guid = getUnitGUID(unit)\n                if guid and guid == destGUID then\n                    return unit\n                end\n            end\n        end\n        return \"target\" -- default fallback\n    end\n    \n    local function getEstLeashTimer(unit)\n        local lvl = UnitLevel(unit)\n        \n        if lvl >= 50 and lvl <= 60 then\n            return 15\n        elseif lvl >= 45 and lvl <= 49 then\n            return 14\n        elseif lvl >= 40 and lvl <= 44 then\n            return 13\n        elseif lvl >= 39 and lvl <= 30 then\n            return 12\n        else\n            return 11\n        end\n    end\n    \n    if not aura_env.last or aura_env.last < GetTime() - 0.25 then\n        aura_env.last = GetTime()\n    end\n    \n    -- Initialize aura_env and combatTimers if they don't exist\n    if not aura_env then\n        return \"\"\n    end\n    \n    -- Initialize on first run\n    if not aura_env.combatTimers then\n        aura_env.combatTimers = {}\n        aura_env.lastCombatCheck = 0\n        aura_env.combatLogFrame = CreateFrame(\"Frame\")\n        aura_env.combatLogFrame:RegisterEvent(\"COMBAT_LOG_EVENT_UNFILTERED\")\n        \n        -- Capture aura_env in local scope for the event handler\n        local env = aura_env or {}\n        \n        env.combatLogFrame:SetScript(\"OnEvent\", function(self, event, ...)\n                local timestamp, subevent, _, sourceGUID, sourceName, sourceFlags, sourceRaidFlags,\n                destGUID, destName, destFlags, destRaidFlags = CombatLogGetCurrentEventInfo()\n                \n                -- Only process player actions\n                if sourceGUID ~= UnitGUID(\"player\") then\n                    return\n                end\n                \n                local shouldReset = false\n                \n                if subevent == \"SWING_DAMAGE\" or \n                subevent == \"RANGE_DAMAGE\" or \n                subevent == \"SPELL_DAMAGE\" or\n                subevent == \"SPELL_AURA_REFRESH\" or\n                (subevent == \"SPELL_AURA_APPLIED\" and select(12, CombatLogGetCurrentEventInfo()) == \"DEBUFF\") then\n                    shouldReset = true\n                end\n                \n                -- Reset timer for the affected unit\n                if shouldReset and env.combatTimers[destGUID] then\n                    local unit = findUnitByGUID(destGUID)\n                    env.combatTimers[destGUID].endTime = GetTime() + getEstLeashTimer(unit)\n                end\n        end)\n    end\n    \n    -- Add new combat targets (throttled check)\n    if InCombatLockdown() and currentTime - aura_env.lastCombatCheck > 0.1 then\n        aura_env.lastCombatCheck = currentTime\n        \n        local units = {\"target\", \"focus\"}\n        for i = 1, 40 do\n            table.insert(units, \"nameplate\" .. i)\n        end\n        \n        for _, unit in ipairs(units) do\n            if isHostileNPC(unit) then\n                local guid = getUnitGUID(unit)\n                if guid and not aura_env.combatTimers[guid] then\n                    aura_env.combatTimers[guid] = {\n                        endTime = currentTime + getEstLeashTimer(unit),\n                        unitName = UnitName(unit):gsub('^[a-zA-Z ]+ ', ''),\n                        raidMarker = GetRaidTargetIndex(unit) and string.format(\"{rt%s}\", GetRaidTargetIndex(unit)) or false\n                    }\n                end\n            end\n        end\n    end\n    \n    -- Clean up expired timers and build display\n    local display = {}\n    for guid, timer in pairs(aura_env.combatTimers) do\n        local remaining = timer.endTime - currentTime\n        \n        -- Check if unit is dead and remove if so\n        local unit = nil\n        for _, checkUnit in ipairs({\"target\", \"focus\"}) do\n            if UnitExists(checkUnit) and UnitGUID(checkUnit) == guid then\n                unit = checkUnit\n                break\n            end\n        end\n        -- Also check nameplates\n        if not unit then\n            for i = 1, 40 do\n                local nameplateUnit = \"nameplate\" .. i\n                if UnitExists(nameplateUnit) and UnitGUID(nameplateUnit) == guid then\n                    unit = nameplateUnit\n                    break\n                end\n            end\n        end\n        \n        -- Remove if unit is dead, out of combat, or timer expired\n        if remaining <= 0 or (unit and (UnitIsDead(unit) or not UnitAffectingCombat(unit))) then\n            aura_env.combatTimers[guid] = nil\n        else\n            color = \"|cFFFBF2EF\"\n            if remaining < 7 and remaining > 3 then\n                color = \"|cFFEAB676\"\n            elseif remaining < 3 then\n                color = \"|cFFD85C2B\"\n            end\n            \n            if timer.raidMarker then\n                table.insert(display, string.format(\"%s %s: %s%.1fs|r\", timer.raidMarker, timer.unitName or \"Unknown\", color, remaining))\n            else\n                table.insert(display, string.format(\"%s: %s%.1fs|r\", timer.unitName or \"Unknown\", color, remaining))\n            end\n        end\n    end\n    \n    -- Clean up when out of combat\n    if not InCombatLockdown() and next(aura_env.combatTimers) then\n        aura_env.combatTimers = {}\n        display = {}\n    end\n    \n    -- Return display text\n    if #display > 0 then\n        return table.concat(display, \"\\n\")\n    else\n        return InCombatLockdown() and \"No tracked enemies\" or \"\"\n    end\nend",
["customTextUpdate"] = "update",
["automaticWidth"] = "Auto",
["displayText_format_c1_pad_max"] = 8,
["triggers"] = {
{
["trigger"] = {
["use_amount"] = true,
...
["use_cloneId"] = false,
["debuffType"] = "HELPFUL",
["events"] = "COMBAT_LOG_EVENT_UNFILTERED PLAYER_REGEN_DISABLED PLAYER_TARGET_CHANGED PLAYER_FOCUS_CHANGED NAME_PLATE_UNIT_ADDED NAME_PLATE_UNIT_REMOVED UPDATE_MOUSEOVER_UNIT UNIT_TARGET",
["type"] = "unit",
["custom_type"] = "status",
...
["displayText_format_c1_pad"] = false,
["progressSource"] = {
-1,
"",
},
...
["displayText_format_c1_time_legacy_floor"] = false,
["wordWrap"] = "WordWrap",
["internalVersion"] = 88,
["displayText_format_p_time_precision"] = 1,
["displayText_format_p_time_format"] = 0,
["spark"] = false,
["displayText_format_c1_gcd_cast"] = false,
["displayText_format_c1_pad_mode"] = "left",
["icon_side"] = "RIGHT",
["subRegions"] = {
{
["type"] = "subbackground",
...
["displayText_format_c1_gcd_channel"] = false,
},
["Vermin Priest"] = {
["grow"] = "LEFT",
["controlledChildren"] = {
...
["preferToUpdate"] = false,
["inverse"] = false,
["customText"] = "function()\n    local maxHp = UnitHealthMax(\"player\")\n    local percent = maxHp > 0 and math.floor(UnitHealth(\"player\") * 100 / maxHp) or 0\n    return percent ..\"%\"\nend",
["orientation"] = "HORIZONTAL",
["conditions"] = {
},
["information"] = {
...
["xOffset"] = 0,
["adjustedMax"] = "",
["customText"] = "function()\n  return aura_env.current_tracking or \"\"\nend",
["yOffset"] = -105,
["anchorPoint"] = "CENTER",
["zoom"] = 0,
["sparkOffsetX"] = 0,
...
["text_text_format_c_format"] = "none",
["type"] = "subtext",
["text_text_format_what_format"] = "none",
["text_color"] = {
1,
1,
1,
...
["text_shadowYOffset"] = -1,
["text_visible"] = true,
["text_text_format_current_tracking_format"] = "none",
["text_fontType"] = "OUTLINE",
["text_anchorYOffset"] = 490,
["text_text_format_n_format"] = "none",
...
["default"] = 0.03,
["name"] = "Throttle",
["desc"] = "Updates range indicator every x seconds. Don't set it to less than 0.05? Do you really need to check this more than 20 times per second?",
},
},
["preferToUpdate"] = false,
["yOffset"] = -40,
...
["sparkRotation"] = 0,
["sameTexture"] = true,
["url"] = "https://wago.io/BwnSiYNbm/16",
["actions"] = {
["start"] = {
...
["custom"] = "function(allstates)\n    if aura_env.enable then\n        if GetTime() > aura_env.last + aura_env.config.throttle then\n            aura_env.last = GetTime()\n            allstates[1] = {\n                show = true,\n                changed = true,\n            }\n            if IsItemInRange(13289, aura_env.unit) then -- 25\n                if IsItemInRange(17626, aura_env.unit) then --10\n                    if IsSpellInRange(GetSpellInfo(75),aura_env.unit) == 1 then -- autoshot \n                        allstates[1].name = \"8-10 yards\"        \n                        allstates[1].ColorCode = 3       \n                    elseif not aura_env.WCSpellName or IsSpellInRange(aura_env.WCSpellName,aura_env.unit) == 1  then -- wing clip \n                        allstates[1].name = \"Melee Range\"  \n                        allstates[1].ColorCode = 1\n                    else \n                        allstates[1].name = \"Dead Zone\"  \n                        allstates[1].ColorCode = 2           \n                    end\n                else\n                    aura_env.FirstCheck(allstates) \n                end\n            else\n                if IsItemInRange(18904, aura_env.unit) then   --35\n                    \n                    if IsItemInRange(7734, aura_env.unit) then -- 30 yards     \n                        allstates[1].name = \"25-30 yards\"\n                        allstates[1].ColorCode = 5             \n                    else \n                        allstates[1].name = \"30-35 yards\"\n                        allstates[1].ColorCode = 6       \n                    end  \n                else\n                    if IsSpellInRange(GetSpellInfo(75),aura_env.unit) == 1 then -- autoshot\n                        aura_env.SecondCheck(allstates) \n                    else\n                        allstates[1].name = \"Out of Range\"\n                        allstates[1].ColorCode = 8   \n                    end\n                end\n            end\n            return true\n        end\n    end\nend",
["custom_type"] = "stateupdate",
["check"] = "update",
["names"] = {
},
...
["debuffType"] = "HELPFUL",
["type"] = "custom",
["events"] = "PLAYER_TARGET_CHANGED UNIT_FACTION:target",
["custom_type"] = "status",
["check"] = "event",
["custom"] = "function(allstates, e )\n    if UnitExists(aura_env.unit) and UnitIsVisible(aura_env.unit) and UnitCanAttack(\"player\", aura_env.unit) and not UnitIsDead(aura_env.unit)then\n        aura_env.enable = true\n        aura_env.last = 0\n        return true\n    else\n        aura_env.enable = false\n        aura_env.last = 0\n        return false\n    end\nend",
["custom_hide"] = "timed",
["unit"] = "player",
},
["untrigger"] = {
...
["trigger"] = {
["type"] = "custom",
["events"] = "LEARNED_SPELL_IN_TAB CHARACTER_POINTS_CHANGED",
["custom_type"] = "status",
["check"] = "event",
["debuffType"] = "HELPFUL",
["custom"] = "function()\n    local rank = select(5,GetTalentInfo(2, 7)) -- Hawk eye rank      \n    local LearnedScatter = DoesSpellExist(GetSpellInfo(19503))\n    \n    aura_env.WCSpellName = nil  --wingclip spellid\n    if DoesSpellExist(GetSpellInfo(2974)) then\n        aura_env.WCSpellName = GetSpellInfo(2974)\n    elseif DoesSpellExist(GetSpellInfo(14267)) then\n        aura_env.WCSpellName = GetSpellInfo(14267)\n    elseif DoesSpellExist(GetSpellInfo(14268)) then\n        aura_env.WCSpellName = GetSpellInfo(14268)\n    end\n    if LearnedScatter then \n        if rank == 3 then\n            aura_env.FirstCheck =\n            function(allstates)                 \n                if IsItemInRange(10645, aura_env.unit) then\n                    allstates[1].name = \"10-20 yards\"\n                    allstates[1].ColorCode = 4\n                elseif IsSpellInRange(GetSpellInfo(19503),aura_env.unit) == 1 then\n                    allstates[1].name = \"20-21 yards\"\n                    allstates[1].ColorCode = 4\n                else\n                    allstates[1].name = \"21-25 yards\"\n                    allstates[1].ColorCode = 5\n                end\n            end           \n        elseif rank == 0 then\n            aura_env.FirstCheck=\n            function(allstates) \n                if IsSpellInRange(GetSpellInfo(19503),aura_env.unit) == 1 then\n                    allstates[1].name = \"10-15 yards\"\n                    allstates[1].ColorCode = 4\n                elseif IsItemInRange(10645, aura_env.unit) then \n                    allstates[1].name = \"15-20 yards\"\n                    allstates[1].ColorCode = 4\n                else\n                    allstates[1].name = \"20-25 yards\"\n                    allstates[1].ColorCode = 5\n                end\n            end     \n        elseif rank == 2 then    \n            aura_env.FirstCheck=\n            function(allstates) \n                if IsSpellInRange(GetSpellInfo(19503),aura_env.unit) == 1 then\n                    allstates[1].name = \"10-19 yards\"\n                    allstates[1].ColorCode = 4\n                elseif IsItemInRange(10645, aura_env.unit) then \n                    allstates[1].name = \"19-20 yards\"\n                    allstates[1].ColorCode = 4\n                else\n                    allstates[1].name = \"20-25 yards\"\n                    allstates[1].ColorCode = 5\n                end\n            end \n        elseif rank == 1 then   \n            aura_env.FirstCheck=\n            function(allstates) \n                if IsSpellInRange(GetSpellInfo(19503),aura_env.unit) == 1 then\n                    allstates[1].name = \"10-17 yards\"\n                    allstates[1].ColorCode = 4\n                elseif IsItemInRange(10645, aura_env.unit) then \n                    allstates[1].name = \"17-20 yards\"\n                    allstates[1].ColorCode = 4\n                else\n                    allstates[1].name = \"20-25 yards\"\n                    allstates[1].ColorCode = 5\n                end\n            end \n        end\n    else\n        aura_env.FirstCheck=\n        function(allstates) \n            if IsItemInRange(10645, aura_env.unit) then\n                allstates[1].name = \"10-20 yards\"\n                allstates[1].ColorCode = 4\n            else\n                allstates[1].name = \"20-25 yards\"\n                allstates[1].ColorCode = 5\n            end\n        end\n    end\n    \n    if rank == 3 then\n        aura_env.SecondCheck = \n        function(allstates) \n            if IsItemInRange(4945, aura_env.unit) then\n                allstates[1].name = \"35-40 yards\"\n                allstates[1].ColorCode = 6\n            else\n                allstates[1].name = \"40-41 yards\"\n                allstates[1].ColorCode = 7\n            end\n        end    \n    elseif rank == 0 then        \n        aura_env.SecondCheck = \n        function()end -- this will never be called :(    \n    elseif rank == 2 then     \n        aura_env.SecondCheck = \n        function(allstates) \n            allstates[1].name = \"35-39 yards\"\n            allstates[1].ColorCode = 7\n        end\n    elseif rank == 1 then   \n        aura_env.SecondCheck = \n        function(allstates) \n            allstates[1].name = \"35-37 yards\"\n            allstates[1].ColorCode = 7\n        end\n    end\nend",
["unit"] = "player",
},
["untrigger"] = {
},
...
["text_font"] = "Arial Narrow",
["text_shadowYOffset"] = 0.3,
["text_wordWrap"] = "WordWrap",
["text_fontType"] = "None",
["text_anchorYOffset"] = 0,
["text_shadowXOffset"] = -0.3,
["anchor_point"] = "CENTER",
["text_fontSize"] = 8,
["anchorXOffset"] = 0,
["text_visible"] = true,
...
["startAngle"] = 0,
["semver"] = "1.0.15",
["id"] = "Ultimate Range Check [detailed]",
["sparkHidden"] = "NEVER",
["desc"] = "One the most optimized range checkers for classic hunters (detailed version for any level and spec)\nShows every possible range.",
["frameStrata"] = 4,
["anchorFrameType"] = "SCREEN",
["load"] = {
["talent2"] = {
...
["anchorFrameFrame"] = "PlayerFrame",
["uid"] = "yOsku6l08b8",
["customText"] = "function()\n    local maxMana = UnitPowerMax(\"player\", 0)\n    if maxMana == 0 then\n        return \"\"\n    end\n    \n    local mana = UnitPower(\"player\", 0)\n    local percent = math.floor(mana * 100 / maxMana)\n    \n    return (\"|cff3399ff%d%%|r\"):format(percent)\nend",
["config"] = {
},
["icon_side"] = "RIGHT",
["anchorFrameParent"] = false,
...
["customSort"] = "function(a, b)\n    local a_Sort = aura_env.child_envs[a.dataIndex].Sorters[a.cloneId]\n    local b_Sort = aura_env.child_envs[b.dataIndex].Sorters[b.cloneId]\n    local Sorters = aura_env.child_envs[a.dataIndex]\n    local MainSort = Sorters.MainSort\n    local SecondarySort = Sorters.SecondarySort\n    \n    if not (a_Sort or b_Sort) then\n        return\n    end\n    \n    local main = MainSort(a_Sort, b_Sort)\n    \n    if main ~= nil then\n        return main\n    end\n    \n    local secondary = SecondarySort(a_Sort, b_Sort)\n    \n    if secondary ~= nil then\n        return secondary\n    end\nend\n\n\n\n\n",
["backdropColor"] = {
1,
1,
1,
...
["type"] = "toggle",
["default"] = false,
["desc"] = "Unlock to be able to set a manual position",
["key"] = "unlockPosition",
["useDesc"] = true,
...
["debuffType"] = "HELPFUL",
["subeventPrefix"] = "SPELL",
["custom"] = "function(allStates,e)\n return aura_env.happiness:trigger(allStates,e)\nend",
["names"] = {
},
["check"] = "update",
["custom_type"] = "stateupdate",
...
["trigger"] = {
["type"] = "custom",
["events"] = "UNIT_HAPPINESS,UNIT_PET,UNIT_DIED,UNIT_SPELLCAST_SUCCEEDED,PLAYER_ENTERING_WORLD,CLEU:SPELL_PERIODIC_ENERGIZE",
["custom_type"] = "stateupdate",
["check"] = "event",
["unit"] = "player",
["custom"] = "function(allStates,e,...)\n return aura_env.happiness:eventTrigger(allStates,e,...)\nend",
["debuffType"] = "HELPFUL",
},
["untrigger"] = {
},
...
["preferToUpdate"] = false,
["information"] = {
["saved"] = "Jr1CQGulP4T1Kbg4QRM4QZgA2IYiXckOsFsTSuZXdhk58z49Te6BxcKyzMxQfxCqjMx2mxuo5xzI5usLmdwxMAGjoB2fy2dhA26Rye)VDDxGfwVaRScXan0eJu7cSWoiz7u22zr7)TiiI7MPUcwlDzIJNv3hpFqkHvWMMzUAPXwcwQEvzn6ZUjBbSuCcXIm2qis15f(Nu9eSDi0fqxUfgcZI6nBw3q0S2hiTyU5w6MBGnT2)0kwZhn9SxGvEbQliMMjwyayPkCrcwKggpTlWcZqDdUAQPgarQ(U0Ro0hk2beUbZn3cNmgKUoqk)9XVpa24eIUccyyONUCb(a8d",
},
["icon_side"] = "LEFT",
["xOffset"] = 0,
["sparkHeight"] = 30,
...
["value"] = "function()\n return aura_env.config.unlockPosition\nend",
},
["changes"] = {
{
["value"] = {
["custom"] = "aura_env.region:SetScale(1)",
},
["property"] = "customcode",
},
},
...
["init"] = {
["custom"] = "--print(\"Frizlerrr's Skill Tracker\")\n\n--Table for when ItemType dosen't match the name of the skill\naura_env.TypeConvert = {}\naura_env.TypeConvert[\"One-Handed Axes\"] = \"Axes\"\naura_env.TypeConvert[\"One-Handed Maces\"] = \"Maces\"\naura_env.TypeConvert[\"One-Handed Swords\"] = \"Swords\"\n\n--Table for storing variables that are used when sorting\naura_env.Sorters = {}\n\n--Sorting functions\nlocal CategorySort = function(a, b)\n    if a[\"Category\"] < b[\"Category\"] then\n        return true\n    elseif a[\"Category\"] > b[\"Category\"] then\n        return false\n    end\nend\n\nlocal BlizzOrderSort = function(a, b)\n    if a[\"BlizzOrder\"] < b[\"BlizzOrder\"] then\n        return true\n    elseif a[\"BlizzOrder\"] > b[\"BlizzOrder\"] then\n        return false\n    end\nend\n\nlocal SkillSort = function(a, b)\n    if a[\"Skill\"] > b[\"Skill\"] then\n        return true\n    elseif a[\"Skill\"] < b[\"Skill\"] then\n        return false\n    end\nend\n\nlocal SkillMaxSort = function(a, b)\n    if a[\"SkillMax\"] > b[\"SkillMax\"] then\n        return true\n    elseif a[\"SkillMax\"] < b[\"SkillMax\"] then\n        return false\n    end\nend\n\nlocal PercentSort = function(a, b)\n    if a[\"Percent\"] > b[\"Percent\"] then\n        return true\n    elseif a[\"Percent\"] < b[\"Percent\"] then\n        return false\n    end\nend\n\nlocal SortingFunctions = {\n    CategorySort,\n    SkillSort,\n    PercentSort,\n    SkillMaxSort,\n    BlizzOrderSort\n}\n\nlocal SortConfig = aura_env.config[\"sorting\"]\n\naura_env.MainSort = SortingFunctions[SortConfig[\"main\"]]\naura_env.SecondarySort = SortingFunctions[SortConfig[\"secondary\"]]\n\n--Skill categories\naura_env.PrimProf = {\n    \"Alchemy\", \n    \"Herbalism\", \n    \"Mining\", \n    \"Blacksmithing\", \n    \"Jewelcrafting\", \n    \"Engineering\", \n    \"Skinning\", \n    \"Leatherworking\", \n    \"Tailoring\", \n    \"Enchanting\" \n}\n\naura_env.SecProf = {\n    \"Fishing\",\n    \"Cooking\",\n    \"First Aid\"\n}\n\naura_env.ClassProf = {\n    \"Lockpicking\",\n    \"Poisons\"\n}\n\naura_env.MeleeWeap = {\n    \"Daggers\",\n    \"Axes\",\n    \"Maces\",\n    \"Swords\",\n    \"Polearms\",\n    \"Staves\",\n    \"Two-Handed Axes\",\n    \"Two-Handed Maces\",\n    \"Two-Handed Swords\",\n    \"Unarmed\"\n}\n\naura_env.RangedWeap = {\n    \"Bows\",\n    \"Crossbows\",\n    \"Guns\",\n    \"Thrown\",\n    \"Wands\"\n}\n\naura_env.Defense = {\n    \"Defense\"\n}\n\n\naura_env.PrimProfLearned = {}\naura_env.SecProfLearned = {}\naura_env.ClassProfLearned = {}\naura_env.MeleeWeapLearned = {}\naura_env.RangedWeapLearned = {}\naura_env.DefenseLearned = {}\n\naura_env.Skills = {}\naura_env.SkillsLearned = {}\n\naura_env.Skills[\"Primary Profession\"]          = aura_env.PrimProf\naura_env.SkillsLearned[\"Primary Profession\"]   = aura_env.PrimProfLearned\n\naura_env.Skills[\"Secondary Profession\"]        = aura_env.SecProf\naura_env.SkillsLearned[\"Secondary Profession\"] = aura_env.SecProfLearned\n\naura_env.Skills[\"Class Profession\"]            = aura_env.ClassProf\naura_env.SkillsLearned[\"Class Profession\"]     = aura_env.ClassProfLearned\n\naura_env.Skills[\"Melee Weapon\"]                = aura_env.MeleeWeap\naura_env.SkillsLearned[\"Melee Weapon\"]         = aura_env.MeleeWeapLearned\n\naura_env.Skills[\"Ranged Weapon\"]               = aura_env.RangedWeap\naura_env.SkillsLearned[\"Ranged Weapon\"]        = aura_env.RangedWeapLearned\n\naura_env.Skills[\"Defense\"]                     = aura_env.Defense\naura_env.SkillsLearned[\"Defense\"]              = aura_env.DefenseLearned\n\n\naura_env.UpdateWeapons = function()\n    local Equiped = {}\n    for i=16, 18 do\n        local ItemLink = GetInventoryItemLink(\"player\", i)\n        if ItemLink then\n            local ItemLinkTable = {GetItemInfo(ItemLink)}\n            local ItemType = ItemLinkTable[7]\n            \n            Equiped[i] = aura_env.TypeConvert[ItemType] or ItemType\n            \n        end\n        Equiped[16] = Equiped[16] or \"Unarmed\"\n        aura_env.EquipedWeapons = Equiped\n    end\nend\n\naura_env.IsWeaponEquiped = function(SkillCategory, SkillName)\n    --if tContains({\"Melee Weapon\", \"Ranged Weapon\"}, SkillCategory) then\n    --print(\"IsWeaponEquiped\")\n    --print(SkillCategory, SkillName, tContains(aura_env.EquipedWeapons, SkillName))\n    --end\n    \n    \n    if not tContains({\"Melee Weapon\", \"Ranged Weapon\"}, SkillCategory) then\n        return true\n    end\n    \n    if tContains(aura_env.EquipedWeapons, SkillName) then\n        return true\n    else \n        return false\n    end\nend    \n\n\naura_env.SkillLineTable = function(n)\n    --print(\"SkillLineTable\", n)\n    local SkillName, IsHeader, _, SkillRank, TempPoints, _, SkillMaxRank = GetSkillLineInfo(n)\n    if not IsHeader then\n        local SkillLineTable = {\n            SkillRank    = SkillRank, \n            SkillMaxRank = SkillMaxRank,\n            TempPoints   = TempPoints\n        }\n        return SkillName, SkillLineTable\n    end\n    return false, false\nend\n\n\naura_env.SkillCategory = function(SkillName)\n    --print(\"SkillCategory\", SkillName)\n    --local n = 0\n    for SkillCategory, SkillTable in pairs(aura_env.Skills) do \n        --n = n + 1\n        --print(\"tContains\", n, SkillCategory, tContains(SkillTable, SkillName))\n        \n        if tContains(SkillTable, SkillName) then\n            return SkillCategory\n        end\n    end\n    return false\nend\n\n\naura_env.NewSkillLearned = function(n)\n    --print(\"NewSkillLearned\", n)\n    aura_env.SkillLines = n\n    for i = 1, n do \n        local SkillName, SkillLineTable = aura_env.SkillLineTable(i)\n        if SkillName then\n            local SkillCategory = aura_env.SkillCategory(SkillName)\n            --print(SkillCategory)\n            if SkillCategory then\n                if not aura_env.SkillsLearned[SkillCategory][SkillName] then\n                    aura_env.SkillsLearned[SkillCategory][SkillName] = SkillLineTable\n                end \n            end\n        end\n    end\nend\n\naura_env.SkillChanged = function(n)\n    --print(\"SkillChanged\", n)\n    local SkillName, SkillLineTable = aura_env.SkillLineTable(n)\n    \n    if SkillName then\n        local SkillCategory = aura_env.SkillCategory(SkillName)\n        \n        if SkillCategory then\n            \n            --print(SkillCategory, aura_env.SkillsLearned[SkillCategory])\n            \n            for Index, Value in pairs(aura_env.SkillsLearned[SkillCategory][SkillName]) do\n                --print(Index, Value)\n                if Value ~= SkillLineTable[Index] then\n                    \n                    aura_env.SkillsLearned[SkillCategory][SkillName][Index] = SkillLineTable[Index]\n                    return true, SkillCategory, SkillName\n                end\n            end\n            return false, SkillCategory, SkillName\n        end\n    end\n    return false, false, false\nend\n\naura_env.UpdateWeapons()\naura_env.NewSkillLearned(GetNumSkillLines())\n\nC_Timer.After(5, function() WeakAuras.ScanEvents(\"INITIATION_DONE\") end)\n--WeakAuras.ScanEvents(\"INITIATION_DONE\")\n\n\n\n",
["do_custom"] = true,
},
},
["icon_color"] = {
...
["Ranged Weapon"] = 5,
["Defense"] = 6,
["Secondary Profession"] = 2,
},
["CategoryVis"] = {
["Primary Profession"] = true,
["Class Profession"] = true,
["Melee Weapon"] = true,
["Ranged Weapon"] = true,
["Defense"] = true,
["Secondary Profession"] = true,
},
["HideFull"] = false,
["sorting"] = {
["main"] = 1,
...
["events"] = "CHAT_MSG_SKILL, SKILL_LINES_CHANGED, PLAYER_EQUIPMENT_CHANGED, INITIATION_DONE, LEARNED_SPELL_IN_TAB",
["spellIds"] = {
},
["custom_type"] = "stateupdate",
["check"] = "event",
["subeventPrefix"] = "SPELL",
["custom"] = "function(allstates, event, arg1, ...)\n    --print(event)\n    local PrevSkillLines = aura_env.SkillLines or 0\n    local CurrentSkillLines = GetNumSkillLines()\n    local EquipChanged = event == \"PLAYER_EQUIPMENT_CHANGED\"\n    \n    if (tContains({16, 17, 18}, arg1) and EquipChanged) or event == \"INITIATION_DONE\" then\n        aura_env.UpdateWeapons()\n    end\n    \n    if PrevSkillLines ~= CurrentSkillLines then\n        aura_env.NewSkillLearned(CurrentSkillLines)\n    end\n    for i = 1, aura_env.SkillLines do\n        local Changed, SkillCategory, SkillName = aura_env.SkillChanged(i)\n        if (SkillCategory and SkillName) and ((Changed and event ==\"CHAT_MSG_SKILL\") or (event == \"INITIATION_DONE\" or event == \"OPTIONS\" or event == \"STATUS\" or event == \"LEARNED_SPELL_IN_TAB\" or EquipChanged)) then\n            local SkillRank = aura_env.SkillsLearned[SkillCategory][SkillName][\"SkillRank\"]\n            local SkillMaxRank = aura_env.SkillsLearned[SkillCategory][SkillName][\"SkillMaxRank\"]\n            local HideOnFull = not (aura_env.config[\"HideFull\"] and SkillRank == SkillMaxRank)\n            local WeaponEquiped = aura_env.IsWeaponEquiped(SkillCategory, SkillName) or not aura_env.config[\"EquipedWeapons\"]\n            local Category = aura_env.config[\"CategoryOrder\"][SkillCategory]\n            local CategoryVis = aura_env.config[\"CategoryVis\"][SkillCategory]\n            \n            --print(CategoryVis, SkillCategory)\n            allstates[SkillName] = {\n                name = SkillName,\n                resort = true,\n                show = CategoryVis and HideOnFull and WeaponEquiped,\n                changed = true,\n                value = SkillRank,\n                total = SkillMaxRank,\n                progressType = \"static\"\n            }\n            aura_env.Sorters[SkillName] = {\n                Category = Category,\n                BlizzOrder = i,\n                Skill = SkillRank,\n                SkillMax = SkillMaxRank,\n                Percent = SkillRank / SkillMaxRank\n            }\n        end\n    end\n    \n    \n    return true\n    \nend\n\n\n",
["debuffType"] = "HELPFUL",
},
["untrigger"] = {
},
...
["information"] = {
["forceEvents"] = true,
["saved"] = "JrXkQ4ulU4mZpVYskNelUKicqf(UurPMyoHKFjajYm3uFYsAk9eZmVutjIaymOCtSIicWflMuXLKyrLaswnYmOfYbyn4tQLLken4tbIcYOajDa5KyLPMsqPwyPPwCjAKPBVihap",
},
["authorOptions"] = {
{
["type"] = "toggle",
