...
WeakAurasSaved = {
		...
		["MobHPPercentYELLOW"] = {
			...
			["triggers"] = {
				...
				}, -- [2]
				{
					["trigger"] = {
						["type"] = "custom",
						["custom"] = "function()\n    local region = aura_env.region\n    local plate = C_NamePlate.GetNamePlateForUnit(\"target\")\n    \n    \n    if plate then\n        region:ClearAllPoints()\n        region:SetPoint(\"RIGHT\", plate, \"LEFT\", 0, 0)\n        return true\n    else\n        return false\n    end\nend",
						["custom_type"] = "status",
						["check"] = "update",
						["unit"] = "player",
						["debuffType"] = "HELPFUL",
	...
	["instanceHistoryDb"] = {
		...
		["HistoryDay"] = {
			["Vermin - Golemagg:Zul'Farrak:party:1:231"] = {
				["last"] = 1642801579,
				["create"] = 1642796483,
				["desc"] = "Vermin - Golemagg: Zul'Farrak - Normal",
			},
			["Vermin - Golemagg:Zul'Farrak:party:1:229"] = {
				["last"] = 1642796470,
				["create"] = 1642790887,
				["desc"] = "Vermin - Golemagg: Zul'Farrak - Normal",
			},
