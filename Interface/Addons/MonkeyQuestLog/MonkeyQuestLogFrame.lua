...
function MkQL_SetQuest(iQuestNum)
	...
	for i=1, numQuestChoices, 1 do
		...
		---------------------------------------------------------------------------------------------------------------------------------------------------------------------
		---------------------------------------------------------------------------------------------------------------------------------------------------------------------
		itemLink = GetQuestLogItemLink(rewardItem.type, i)
		rewardItem:CreateBeautyBorder(8)
		rewardItem:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureNormal")
		rewardItem:SetBeautyBorderColor(1, 1, 1, 1)
		
		if (itemLink) then
			_, _, itemRarity = GetItemInfo(itemLink)
			if (itemRarity and itemRarity > 1) then
				r, g, b = GetItemQualityColor(itemRarity)
				rewardItem:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureWhite")
				rewardItem:SetBeautyBorderColor(r, g, b, 1)
			else
				rewardItem:SetBeautyBorderTexture("Interface\\AddOns\\xVermin\\Media\\textureNormal")
				rewardItem:SetBeautyBorderColor(1, 1, 1, 1)
			end
