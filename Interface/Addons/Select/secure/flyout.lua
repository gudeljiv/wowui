...
function s.flyout:Style(flyout)
	...
	elseif s.settings:Get("UseFlatStyle") then
		...
		flyout:SetBackdrop(
			{bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background", insets = {left = 1, right = 1, top = 1, bottom = 1}, tileSize = 16, tile = true, edgeFile = "Interface\\ChatFrame\\ChatFrameBackground", edgeSize = 1}
		)
