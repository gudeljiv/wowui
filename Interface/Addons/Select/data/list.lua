...
lists = {} -- indexed by name, an ordered list of {attribClass,attribType,attribKey,attribValue}
sizes = {} -- indexed by name, the number of valid entries in above lists[name] of same name
