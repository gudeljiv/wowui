...
do
	...
	if L then
		...
		L["%sShift+Left-click%s to enable/disable auto swithing"] = true
		...
		L["Mute spell use sound while auto swithing"] = true
		L["Next tracking spell"] = true
		L["Only while moving in [%s]"] = true
...
do
	...
	if L then
		...
		L["%sShift+Left-click%s to enable/disable auto swithing"] = "%sШифт+ЛКМ%s включить/выключить автоматическое переключение"
		...
		L["Mute spell use sound while auto swithing"] = "Заглушить звук использования заклинания во время авто переключения"
		L["Next tracking spell"] = "Следующая способность отслеживания"
		L["Only while moving in [%s]"] = "Только в движении [%s]"
