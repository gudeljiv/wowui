...
MONKEYQUESTLOG_LOADED_MSG =
	MONKEYQUESTLOG_INFO_COLOUR .. MONKEYQUESTLOG_TITLE .. " v" .. MONKEYQUESTLOG_VERSION .. " loaded"
...
if (GetLocale() == "deDE") then
	MONKEYQUESTLOG_DESCRIPTION = "Zeigt die volle Quest Beschreibung f�r MonkeyQuest an"
	MONKEYQUESTLOG_LOADED_MSG =
		MONKEYQUESTLOG_INFO_COLOUR .. MONKEYQUESTLOG_TITLE .. " v" .. MONKEYQUESTLOG_VERSION .. " geladen"
