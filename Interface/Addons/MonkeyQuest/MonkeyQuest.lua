			...
			if (bNextHeader == false) then
				...
				if (isHeader) then
					if (MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_aQuestList[strQuestLogTitleText .. " - " .. tostring(isHeader)].m_bChecked == true) then
						if (MonkeyQuestConfig[MonkeyQuest.m_global].m_bNoHeaders == false or MonkeyQuestConfig[MonkeyQuest.m_global].m_bShowHidden == true or MonkeyQuestConfig[MonkeyQuest.m_global].m_bAlwaysHeaders == true) then
						...
						if (MonkeyQuestConfig[MonkeyQuest.m_global].m_bShowHidden == true or MonkeyQuestConfig[MonkeyQuest.m_global].m_bAlwaysHeaders == true) then
							strMonkeyQuestBody = strMonkeyQuestBody .. format(MonkeyQuestConfig[MonkeyQuest.m_global].m_strHeaderClosedColour .. "%s|r", "+ " .. strQuestLogTitleText) .. "\n"
					...
					if
						((MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_aQuestList[strQuestLogTitleText .. " - " .. tostring(isHeader)].m_bChecked == true or MonkeyQuestConfig[MonkeyQuest.m_global].m_bShowHidden) and
							(MonkeyQuestConfig[MonkeyQuest.m_global].m_bHideCompletedQuests == false or (MonkeyQuestConfig[MonkeyQuest.m_global].m_bHideCompletedQuests == true and not isComplete) or MonkeyQuestConfig[MonkeyQuest.m_global].m_bShowHidden))
					 then
						...
						if (MonkeyQuestConfig[MonkeyQuest.m_global].m_bShowQuestLevel == true) then
							...
							strMonkeyQuestBody = strMonkeyQuestBody .. format("|c%02X%02X%02X%02X%s|r", 255, colour.r * 255, colour.g * 255, colour.b * 255, "[" .. strQuestLevel .. chars .. "]")
						end
						...
						if (isComplete and isComplete < 0) then
							strMonkeyQuestBody = strMonkeyQuestBody .. format(strTitleFailColor .. "%s|r", strQuestLogTitleText) .. "|cFFFF8080" .. " (" .. MONKEYQUEST_QUEST_FAILED .. ")\n"
						elseif (isComplete and isComplete > 0) then
							strMonkeyQuestBody = strMonkeyQuestBody .. format(strTitleDoneColor .. "%s|r", strQuestLogTitleText) .. "|cFF80FF80" .. " (" .. MONKEYQUEST_QUEST_DONE .. ")\n"
						else
						...
						elseif (MonkeyQuestConfig[MonkeyQuest.m_global].m_bObjectives) then
							...
							strMonkeyQuestBody = strMonkeyQuestBody .. "    " .. format(MonkeyQuestConfig[MonkeyQuest.m_global].m_strOverviewColour .. "%s|r", strQuestObjectives) .. "\n"
...
function MonkeyQuest_Resize()
	...
	if (MonkeyQuestConfig[MonkeyQuest.m_global].m_bGrowUp == false) then
		...
		-- grow down
		MonkeyQuestFrame:SetPoint("TOPLEFT", "UIParent", "BOTTOMLEFT", MonkeyQuestConfig[MonkeyQuest.m_global].m_iFrameLeft, MonkeyQuestConfig[MonkeyQuest.m_global].m_iFrameTop)
	else
		-- check to see if it grew off the screen
		...
		MonkeyQuestFrame:ClearAllPoints()
		-- grow up
		MonkeyQuestFrame:SetPoint("BOTTOMLEFT", "UIParent", "BOTTOMLEFT", MonkeyQuestConfig[MonkeyQuest.m_global].m_iFrameLeft, MonkeyQuestConfig[MonkeyQuest.m_global].m_iFrameBottom)
	end
