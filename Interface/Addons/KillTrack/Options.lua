...
function Opt:Show()
	...
	local showTarget =
		button(
		"Target",
		"Show information about the currently selected target",
		function()
	...
	local purge =
		button(
		"Purge",
		"Purge mob entries with a kill count below a specified number",
		function()
			KT:ShowPurge()
		end
	)
	...
	local reset =
		button(
		"Reset",
		"Clear the database of ALL mob entries",
		function()
			KT:ShowReset()
		end
	)
	...
	local minimap =
		checkbox(
		"Show minimap icon",
		"Adds the KillTrack broker to your minimap",
		function(check, checked)
	...
	local disableDungeons =
		checkbox(
		"Disable in dungeons (save CPU)",
