...
local find_nearest_types = {
	...
	[5] = {name="Mailbox",icon="Interface\\Minimap\\Tracking\\Mailbox",func = function() ZGV.WhoWhere:FindMailbox() end},
	[6] = {name="Profession Trainers",icon="Interface\\Minimap\\Tracking\\Profession", func = function() hide_timer_proff=0 ZGV.WhoWhere.ProfessionFrame:DoFadeIn() end},
	[7] = {name="Repair",icon="Interface\\Minimap\\Tracking\\Repair"},
	[8] = {name="Stable Master",icon="Interface\\Minimap\\Tracking\\StableMaster"},
	[9] = {name="Vendors",icon="Interface\\Minimap\\Tracking\\Food", func = function() hide_timer_proff=0 ZGV.WhoWhere.VendorFrame:DoFadeIn() end},
