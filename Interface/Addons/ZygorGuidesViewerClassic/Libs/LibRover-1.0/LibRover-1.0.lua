			...
			for neigh,neighlink in current:IterNeighs() do
				...
				then
					...
					-- If high level zones are avoided... avoid.
						if mode=="walk" and Lib.cfg.avoid_highlevel_zones and (Lib.data.ZoneMeta[neigh.m].hostile or (Lib.data.ZoneMeta[neigh.m].minlevel or 0)>TMP_PLAYERLEVEL) then -- was: zone.level-TMP_PLAYERLEVEL>=2
