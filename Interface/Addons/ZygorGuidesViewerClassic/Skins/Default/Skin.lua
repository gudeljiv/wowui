...
function Skin:UpdateSkin()
	...
	AssignButtonTexture(ZygorGuidesViewerFrame_Border_Guides_SISButton,BUTTONTEXTURE,12,count)
	...
	ZygorGuidesViewerFrame_Border_Guides_SISButton:SetSize(size,size)
