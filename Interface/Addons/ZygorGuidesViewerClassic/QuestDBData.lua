ZGV.Quest_Cache_Accept_Alliance = {
	...
	["PROFESSIONS\\Blacksmithing\\Blacksmithing (1-300)"] = {
		{ids="7655", cond=[[skill("Blacksmithing") < 295]]},
		{ids="7654", cond=[[skill("Blacksmithing") < 300]]},
		{ids="7652"},
	},
	...
	["DUNGEONS\\Uldaman Quests"] = {
		{ids="2278,2279,2439", cond=[[level >=40]]},
	...
	["EVENTS\\Midsummer Fire Festival\\Midsummer Fire Festival Quests"] = {
		{ids="9326,9325,9324", cond=[[level >= 50]]},
		{ids="9365", cond=[[completedallq(9325,9324,9326)]]},
		{ids="9319", cond_if=[[level >= 50 ]]},
	...
	["LEVELING\\Stranglethorn Vale (36-37)"] = {
		{ids="338,342,338,342,338,342", cond=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342)))]]},
		{ids="338,339,338,339,338,339", cond=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339)))]]},
		{ids="338,341,338,341,338,341", cond=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341)))]]},
		{ids="338,340,338,340,338,340", cond=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340)))]]},
		{ids="1180,1112,1040,1181,1041,1042,1043,1044,605,201,198,189,213,1182,578,575,196,188,193,203,204,215,200,328,574,329,330,331,1183,577"},
	},
	["LEVELING\\Feralas (44-46)"] = {
		{ids="2821,4124,2866,2939,2982,4125,2867,3130,2869,2870,4127,4129,2871,4130,4131,2766,2969,2970,2972,4135,4281,4265,4266,4267,2940,2941,3661"},
	},
	["LEVELING\\Redridge Mountains (18-20)"] = {
		{ids="1717,1716,1738,1739", cond=[[Warlock]]},
		{ids="244,246,20,125,118,3741,89,127,129,92,130,119,131,122,124,150,3765"},
	},
	["LEVELING\\Ashenvale (24-24)"] = {
		{ids="4581,1035,1140,1016"},
	},
	["LEVELING\\Teldrassil (1-12) [Night Elf Starter]"] = {
		{ids="3119,5629", cond=[[NightElf Priest]]},
		{ids="3116", cond=[[NightElf Warrior]]},
		{ids="3118", cond=[[NightElf Rogue]]},
		{ids="3117,6063,6101,6102,6103", cond=[[NightElf Hunter]]},
		{ids="3120,5923,5921,5929,5931,6001", cond=[[NightElf Druid]]},
		{ids="6344,6341,6342,6343", cond=[[NightElf]]},
	...
	["LEVELING\\Felwood (53-54)"] = {
		{ids="4101,5155,4421,5249,5156,8460,8462,5157,4906,5158,939,8461,8465"},
	},
	["LEVELING\\Wetlands (30-30)"] = {
		{ids="321,324,322"},
	},
	["LEVELING\\Hillsbrad Foothills (31-33)"] = {
		{ids="565,564,536,559,560,561,562,563,555,681,1453,1179,700,690,336"},
	},
	["LEVELING\\Azshara (53-53)"] = {
		{ids="3601,5534,3461"},
	},
	["LEVELING\\Ashenvale (30-31)"] = {
		{ids="1719", cond=[[Warrior]]},
		{ids="1022,1021,1027,1011,1031,1037,1032,1028,1055,1029,1030,1045,1046,2925,1038,1039"},
	},
	["LEVELING\\Temple of Ahn'Qiraj Legs Quest"] = {
	...
	["LEVELING\\Stranglethorn Vale (39-40)"] = {
		{ids="338,342", cond=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342)))]]},
		{ids="338,339", cond=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339)))]]},
		{ids="338,341", cond=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341)))]]},
		{ids="338,340", cond=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340)))]]},
		{ids="595,606,1116,601,597,197,628,599,607"},
	},
	...
	["LEVELING\\Winterspring (59-60)"] = {
		...
		{ids="5087,4809,4970,4810"},
	},
	["LEVELING\\Thousand Needles (34-34)"] = {
		{ids="1100,1110,1111,5762,1104,1105,1176,1175,1178,1260,6141"},
	},
	["LEVELING\\Wetlands (31-31)"] = {
		{ids="292,293,472,631,632,633,634"},
	},
	["LEVELING\\Wetlands (24-27)"] = {
		{ids="2360,2359,2607,2608", cond=[[Rogue]]},
		{ids="279,288,463,943,289,470,464,484,305,294,306,295,299,296,469,276,277,275,281,471,465,284,285,286,637,290,683,1073,686,689,335"},
	},
	["LEVELING\\Temple of Ahn'Qiraj Chest Quest"] = {
	...
	["LEVELING\\Hillsbrad Foothills (37-38)"] = {
		{ids="707,500,505,510,511,514,512,659"},
	},
	["LEVELING\\Temple of Ahn'Qiraj Boots Quest"] = {
	...
	["LEVELING\\Duskwood (33-33)"] = {
		{ids="75,78,79,80,97,98"},
	},
	["LEVELING\\Tanaris (49-50)"] = {
		{ids="626,82,3362,4504,2741,5863,2605,3444,3161,1560,4324,2606,2641,10,351,110,113,162,1189"},
	},
	["LEVELING\\Ashenvale (21-22)"] = {
		{ids="1008,1070,1056,991,1054,1033,1023,1007,1009,1024,1025,1134,1026,1034"},
	},
	["LEVELING\\Desolace (34-36)"] = {
		{ids="1437,1382,1387,1454,1458,1465,1438,1459,5501,5561,1384,1455,6161,5741,1439,1440,1456,6027,1457,1370,1373"},
	},
	["LEVELING\\Tanaris (43-44)"] = {
		{ids="992,2781,2875,3022,1707,1690,1118,1188,1190,1190,1194,8365,3520,8366,2873,2876,1691,2874"},
	},
	["LEVELING\\Burning Steppes (55-56)"] = {
		{ids="3702,3701,3823,4283,4182,4726,4296,4022,4808,3824,4183,3825,4184,4185,4186,4223,4224"},
	},
	["LEVELING\\Loch Modan (17-18)"] = {
		{ids="5061", cond=[[NightElf Druid]]},
		{ids="1338", cond=[[NightElf]]},
		{ids="436,297,298,385,257,258,2038,250,199,301,2041,6661,6662"},
	},
	["LEVELING\\Eastern Plaguelands (57-58)"] = {
		{ids="5542,5543,5544,5149,5152,5241,6021,5281,5211,6026,5237,5903,6164,5742,5781,5845,5097,6186,5904,5846"},
	},
	...
	["LEVELING\\Dun Morogh (1-12) [Dwarf & Gnome Starter]"] = {
		...
		{ids="3110,5635,6661,6662", cond=[[Dwarf Priest]]},
		{ids="3115,1599,1715,1688,1689", cond=[[Gnome Warlock]]},
		{ids="3108,6064,6084,6085,6086", cond=[[Dwarf Hunter]]},
		{ids="6387,6391,6388,6392", cond=[[Dwarf or Gnome]]},
		{ids="3107,2997,1645,1646,1646,1647,1648,1778,1779,1783,1784,1785", cond=[[Dwarf Paladin]]},
		{ids="3114", cond=[[Gnome Mage]]},
		{ids="3106", cond=[[Dwarf Warrior]]},
		{ids="3113", cond=[[Gnome Rogue]]},
		{ids="1679,1678", cond=[[(Dwarf Warrior) or (Gnome Warrior)]]},
	...
	["LEVELING\\Ruins of Ahn'Qiraj Ring Quest"] = {
	...
	["LEVELING\\Arathi Highlands (38-38)"] = {
		{ids="691,642,651,658,657,660,661,693,663,662,664,665,666,668,669,1114,1106,1115,1186,1187"},
	},
	["LEVELING\\Western Plaguelands (58-58)"] = {
		{ids="5153,5154,4971,4972,5210,6389,6004,6023,5533,5537,8275,4902,6761,6762,1124,4442"},
	},
	["LEVELING\\Elwynn Forest (1-13) [Human Starter]"] = {
		{ids="3100,1638,1639,1640,1665", cond=[[Human Warrior]]},
		{ids="3105,1598,1685,1688,1689", cond=[[Human Warlock]]},
		{ids="3104", cond=[[Human Mage]]},
		{ids="3102", cond=[[Human Rogue]]},
		{ids="3103,5637", cond=[[Human Priest]]},
		{ids="3101,2998,1641,1642,1643,1644,1780,1781,1786,1787,1788", cond=[[Human Paladin]]},
	...
	["LEVELING\\Extra Zones\\Westfall"] = {
		{ids="6181,6281,6261,6285", cond=[[Human]]},
		{ids="64,36,151,9,22,38,153,12,102,13,14,65,132,135,141,142,155,103,104"},
	},
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8829", cond=[[itemcount(21514) >= 1 or havequest(8829)]]},
		{ids="8783", cond=[[itemcount(21265) >= 1 or havequest(8783)]]},
		{ids="8496", cond=[[itemcount(20806) >= 1 or havequest(8496)]]},
		{ids="8782", cond=[[itemcount(21262) >= 1 or havequest(8782)]]},
		{ids="8805", cond=[[itemcount(20939) >= 1 or havequest(8805)]]},
		{ids="8779", cond=[[itemcount(21259) >= 1 or havequest(8779)]]},
		{ids="8497", cond=[[itemcount(20807) >= 1 or havequest(8497)]]},
		{ids="8778", cond=[[itemcount(21257) >= 1 or havequest(8778)]]},
		{ids="8541", cond=[[itemcount(20940) >= 1 or havequest(8541)]]},
		{ids="8780", cond=[[itemcount(21263) >= 1 or havequest(8780)]]},
		{ids="8781", cond=[[itemcount(21260) >= 1 or havequest(8781)]]},
		{ids="8507,8508"},
	},
	["LEVELING\\The Hinterlands (46-46)"] = {
		{ids="2944,603,1450,1451,2988,2877,2880,1452,485,2989,3448,3449,3450,3451"},
	},
	["LEVELING\\Duskwood (27-30)"] = {
		{ids="1718", cond=[[Warrior]]},
		{ids="66,101,56,67,173,163,165,164,174,175,177,57,221,181,222,5,148,225,95,68,93,240,58,69,227,223,149,154,157,230,158,262,156,265,266,453,268,323,269,159,133,134,160,251,401,252,2923,270,1274,1241,1242,70,1243,72,74"},
	},
	["LEVELING\\Badlands (40-41)"] = {
		{ids="2500,738,720,719,718,733,732,703,705,1108,739,1137,710,713,714,715,711,712,734,777,716,778"},
	},
	["LEVELING\\Searing Gorge (47-48)"] = {
		{ids="4449,3367,3368,4450,3441,3442,7701,7728,7729,7723,7724,7727,7722,3371,4451,3443,3452,3453,3454,3462,3463,3181,3481,3182,3201,3790,625,4512,2943"},
	},
	["LEVELING\\Western Plaguelands (56-57)"] = {
		{ids="1019,5215,5216,5217,5021,5022,5048,5050,6182,6183,6184,5219,6185,5051,5220,5058,5059,5060,5222,5223,4984,4985,4986,5225,5226"},
	},
	["LEVELING\\Cenarion Field Duty Combat Assignments"] = {
		{ids="8539", cond=[[itemcount(21249) >= 1 or havequest(8539)]]},
		{ids="8501", cond=[[itemcount(20941) >= 1 or havequest(8501)]]},
		{ids="8770", cond=[[itemcount(21749) >= 1 or havequest(8770)]]},
		{ids="8777", cond=[[itemcount(21256) >= 1 or havequest(8777)]]},
		{ids="8776", cond=[[itemcount(21255) >= 1 or havequest(8776)]]},
		{ids="8775", cond=[[itemcount(21253) >= 1 or havequest(8775)]]},
		{ids="8774", cond=[[itemcount(21252) >= 1 or havequest(8774)]]},
		{ids="8773", cond=[[itemcount(21248) >= 1 or havequest(8773)]]},
		{ids="8771", cond=[[itemcount(21750) >= 1 or havequest(8771)]]},
		{ids="8502", cond=[[itemcount(20942) >= 1 or havequest(8502)]]},
		{ids="8772", cond=[[itemcount(21250) >= 1 or havequest(8772)]]},
		{ids="8687", cond=[[itemcount(21251) >= 1 or havequest(8687)]]},
		{ids="8507,8508"},
	},
	["LEVELING\\Cenarion Battlegear"] = {
		{ids="8800,8548,8572,8573,8574"},
	},
	["LEVELING\\Signet Ring of the Bronze Dragonflight"] = {
	...
	["LEVELING\\Temple of Ahn'Qiraj Helm Quest"] = {
	...
	["LEVELING\\Winterspring (54-54)"] = {
		{ids="8464,4842,5082,6604,5244,5159"},
	},
	["LEVELING\\Temple of Ahn'Qiraj Shoulder Quest"] = {
	...
	["LEVELING\\Darkshore (12-17)"] = {
		{ids="6121,6122,6123,6124,6125,26,29,272", cond=[[NightElf Druid]]},
		{ids="963,983,3524,947,4811,954,958,2118,984,1001,4681,4723,1002,955,956,957,953,4812,2138,985,4761,965,982,4762,4725,1003,4727,2139,4763,729,1138,4813,4722,4728,986,966,967,948"},
	},
	["LEVELING\\Dustwallow Marsh (38-39)"] = {
		{ids="1203", cond_if=[[(itemcount(3853) >= 1 or completedq(1203)) ]]},
		{ids="1282,1204,1218,1206,1219,1222,1177,1284,1252,1253,1258,1220,1259,1319,1285,1286,1320,1287"},
	},
	["LEVELING\\Winterspring (54-55)"] = {
		{ids="5083", cond=[[itemcount(12771) > 0]]},
		{ids="979,3783,6028,6030,5601,4861,5245,4863,4864,4901,977,5084,5163,5085,5086"},
	},
	["LEVELING\\Ruins of Ahn'Qiraj Cloak Quest"] = {
	...
	["LEVELING\\Stranglethorn Vale (46-47)"] = {
		...
		{ids="338,341", cond=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341)))]]},
		{ids="338,340", cond=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340)))]]},
		{ids="610,608,624,611,208"},
	},
	["LEVELING\\Ashenvale (20-21)"] = {
		{ids="1010,1020,973"},
	},
	["LEVELING\\Silithus (58-59)"] = {
		{ids="1125,8280,8283,8277,8284,8318,8304,9415,1126,8308,6844,8281,8278,8282,8285,8306,8279,8287,8323,5181,6845,1185"},
	},
	["LEVELING\\Western Plaguelands (55-55)"] = {
		{ids="4513,5092,5401"},
	},
	["LEVELING\\Ruins of Ahn'Qiraj Weapon Quest"] = {
	...
	["LEVELING\\Desolace (42-43)"] = {
		{ids="261,1466,6134,1374,1052,1467"},
	},
	["LEVELING\\Felwood (54-54)"] = {
		{ids="5165,4441,5882"},
	},
	["LEVELING\\Swamp of Sorrows (41-42)"] = {
		{ids="1448,1363,1364,1477,1396,1392,1423,1389,1421,1393,1398,1395,1425,1449"},
	},
	["LEVELING\\Un'Goro Crater (51-53)"] = {
		{ids="3884", cond=[[itemcount(11116) > 0]]},
		{ids="4493,2661,4496,2662,4289,4290,4243,4503,4141,4501,3882,3883,3881,4244,4245,4291,4301,3844,3845,4292,974,4492,4284,4285,4287,4288,3908,4491,980,4321,978,5091,3764,3781"},
	},
	["LEVELING\\Blasted Lands (50-51)"] = {
		{ids="3501", cond=[[itemcount(10593) > 0]]},
	...
	["LEVELING\\The Hinterlands (50-50)"] = {
		{ids="3842,3843,4297,4298,2990,4502,2783,2801"},
	},
	["LEVELING\\Feralas (48-49)"] = {
		{ids="7733,2879,3445,7003,7721,7725,7735,2844,2942,2845,2767,3841"},
	},
	["LEVELING\\Stranglethorn Vale (42-42)"] = {
		{ids="587,1117,2864,209,604,600,621,617,609,576,580,602,623,2872"},
	},
	["LEVELING\\Darkshore (23-24)"] = {
		{ids="2098,2078,994,995,990,942"},
	},
	["LEVELING\\Cenarion Field Duty Tactical Assignments"] = {
		{ids="8537", cond=[[itemcount(20945) >= 1 or havequest(8537)]]},
		{ids="8737", cond=[[itemcount(21245) >= 1 or havequest(8737)]]},
		{ids="8498", cond=[[itemcount(20943) >= 1 or havequest(8498)]]},
		{ids="8738", cond=[[itemcount(21166) >= 1 or havequest(8738)]]},
		{ids="8739", cond=[[itemcount(21167) >= 1 or havequest(8739)]]},
		{ids="8538", cond=[[itemcount(20948) >= 1 or havequest(8538)]]},
		{ids="8534", cond=[[itemcount(21165) >= 1 or havequest(8534)]]},
		{ids="8740", cond=[[itemcount(20944) >= 1 or havequest(8740)]]},
		{ids="8535", cond=[[itemcount(20947) >= 1 or havequest(8535)]]},
		{ids="8536", cond=[[itemcount(21751) >= 1 or havequest(8536)]]},
		{ids="8507,8508"},
	},
	["LEVELING\\Redridge Mountains (27-27)"] = {
		{ids="128,91,180,34,219"},
	},
}
ZGV.Quest_Cache_Turnin_Alliance = {
	...
	["LEVELING\\Stranglethorn Vale (36-37)"] = {
		{ids="342,342,342", cond=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342)))]]},
		{ids="339,339,339", cond=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339)))]]},
		{ids="338,338,338", cond=[[((itemcount(2756) >= 1) and (itemcount(2757) >= 1) and (itemcount(2758) >= 1) and (itemcount(2759) >= 1) and (not completedq(338)))]]},
		{ids="341,341,341", cond=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341)))]]},
		{ids="340,340,340", cond=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340)))]]},
	...
	["LEVELING\\Feralas (44-46)"] = {
		{ids="4124,2866,2867,3130,2869,4125,4127,2870,2871,4129,4130,2766,2969,2970,4131,4135,2821,2982,4265,4266,4281,2939,2940,4267,2972,3022"},
	},
	["LEVELING\\Redridge Mountains (18-20)"] = {
		{ids="1717,1716,1738,1739", cond=[[Warlock]]},
	...
	["LEVELING\\Stranglethorn Vale (39-40)"] = {
		{ids="342", cond=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342)))]]},
		{ids="339", cond=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339)))]]},
		{ids="338", cond=[[((itemcount(2756) >= 1) and (itemcount(2757) >= 1) and (itemcount(2758) >= 1) and (itemcount(2759) >= 1) and (not completedq(338)))]]},
		{ids="341", cond=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341)))]]},
		{ids="340", cond=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340)))]]},
	...
	["LEVELING\\Winterspring (59-60)"] = {
		{ids="8798", cond=[[havequest(8798) or completedq(8798)]]},
	...
	["LEVELING\\Loch Modan (17-18)"] = {
		{ids="272,5061", cond=[[NightElf Druid]]},
	...
	["LEVELING\\Dun Morogh (1-12) [Dwarf & Gnome Starter]"] = {
		{ids="3112", cond=[[Gnome Warrior]]},
		{ids="3109", cond=[[Dwarf Rogue]]},
		{ids="3110,6661,6662,5635", cond=[[Dwarf Priest]]},
		{ids="3115,1599,1715,1688,1689", cond=[[Gnome Warlock]]},
		{ids="3108,6064,6084,6085,6086", cond=[[Dwarf Hunter]]},
		{ids="6387,6391,6388,6392", cond=[[Dwarf or Gnome]]},
		{ids="3107,2997,1646,1647,1648,1778,1779,1783,1784,1785", cond=[[Dwarf Paladin]]},
		{ids="3113", cond=[[Gnome Rogue]]},
		{ids="3106", cond=[[Dwarf Warrior]]},
		{ids="3114", cond=[[Gnome Mage]]},
		{ids="1679,1678", cond=[[(Dwarf Warrior) or (Gnome Warrior)]]},
	...
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8496", cond=[[havequest(8496)]]},
		{ids="8780", cond_if=[[havequest(8780) ]]},
		{ids="8497", cond=[[havequest(8497)]]},
		{ids="8778", cond=[[havequest(8778)]]},
		{ids="8781", cond_if=[[havequest(8781) ]]},
		{ids="8829", cond=[[havequest(8829)]]},
		{ids="8782", cond=[[havequest(8782)]]},
		{ids="8783", cond=[[havequest(8783)]]},
		{ids="8805", cond_if=[[havequest(8805) ]]},
		{ids="8541", cond_if=[[havequest(8541) ]]},
		{ids="8779", cond=[[havequest(8779)]]},
		{ids="8507"},
	},
	["LEVELING\\The Hinterlands (46-46)"] = {
	...
	["LEVELING\\Darkshore (12-17)"] = {
		{ids="6121,6122,6123,6124,6125,26,29", cond=[[NightElf Druid]]},
		{ids="952", cond=[[NightElf]]},
	...
	["LEVELING\\Dustwallow Marsh (38-39)"] = {
		{ids="1203", cond=[[(itemcount(3853) >= 1 or completedq(1203))]]},
	...
	["LEVELING\\Silithus (58-59)"] = {
		{ids="1124,8275,1125,1126,8280,8277,8318,9415,8308,8281,8278,8284,8304,8285,8279,8323,8282,8287,8283,4513,5210,5181,6844,6845"},
	},
	["LEVELING\\Western Plaguelands (55-55)"] = {
	...
	["LEVELING\\Blasted Lands (50-51)"] = {
		{ids="3501", cond=[[havequest(3501) or completedq(3501)]]},
	...
	["LEVELING\\Cenarion Field Duty Tactical Assignments"] = {
		{ids="8737", cond_if=[[havequest(8737) ]]},
		{ids="8739", cond=[[havequest(8739)]]},
		{ids="8498", cond_if=[[havequest(8498) ]]},
		{ids="8534", cond_if=[[havequest(8534) ]]},
		{ids="8536", cond_if=[[havequest(8536) ]]},
		{ids="8538", cond_if=[[havequest(8538) ]]},
		{ids="8738", cond_if=[[havequest(8738) ]]},
		{ids="8537", cond_if=[[havequest(8537) ]]},
		{ids="8740", cond_if=[[havequest(8740) ]]},
		{ids="8535", cond_if=[[havequest(8535) ]]},
		{ids="8507"},
	},
	["LEVELING\\Redridge Mountains (27-27)"] = {
...
ZGV.Quest_Cache_Accept_Horde = {
	...
	["DUNGEONS\\Scarlet Monastery Library Quests"] = {
		...
		{ids="1049", cond=[[Orc,Tauren,Troll]]},
	},
	["DUNGEONS\\Razorfen Downs Quests"] = {
	...
	["LEVELING\\Ashenvale (25-27)"] = {
		{ids="2460,2458,2478,2479,2480", cond=[[Rogue]]},
	...
	["LEVELING\\Dustwallow Marsh (43-44)"] = {
		{ids="1166,1169,1168,1273,1276,1170,1171,1262"},
	},
	["LEVELING\\The Hinterlands (51-52)"] = {
		{ids="7815,7816,7843,7840,4502"},
	},
	["LEVELING\\Stranglethorn Vale (42-43)"] = {
		{ids="604,209,587,600,621,617,609,576,1117,2864,2932,2872"},
	},
	["LEVELING\\Stonetalon Mountains (23-25)"] = {
		{ids="1087,6301,5881,6282,6393,6381,1096"},
	},
	["LEVELING\\Thousand Needles (38-38)"] = {
		{ids="1147,1114,1106,1115,1186,1187,1148,1184"},
	},
	["LEVELING\\Thousand Needles (25-25)"] = {
		{ids="4542,4767,4821,4841,5064"},
	},
	["LEVELING\\Arathi Highlands (36-37)"] = {
		{ids="1164,676,671,701,642,651,677,702,847,678"},
	},
	["LEVELING\\Felwood (55-56)"] = {
		{ids="5887,5157,8460,8462,4506,5085"},
	},
	["LEVELING\\Temple of Ahn'Qiraj Legs Quest"] = {
		{ids="8560", cond=[[Warrior]]},
		{ids="8629", cond=[[Paladin]]},
	...
	["LEVELING\\Swamp of Sorrows (42-42)"] = {
		{ids="1430,1429,1426,1427"},
	},
	["LEVELING\\Swamp of Sorrows (39-40)"] = {
		{ids="1372,1392,1389,698,1424,699,1393,1422"},
	},
	["LEVELING\\Winterspring (55-55)"] = {
		{ids="5083", cond=[[itemcount(12771) > 0]]},
		{ids="8464,4842,5082,3783,6029,6030,5601,977,5084"},
	},
	["LEVELING\\Mulgore (1-12) [Tauren Starter]"] = {
		{ids="748,754,756,758,759,760,854", cond=[[Tauren]]},
		{ids="3091,1505,1498", cond=[[Tauren Warrior]]},
		{ids="3092,6061,6087,6088,6089", cond=[[Tauren Hunter]]},
		{ids="3093,1519,1520,1521,2984,1524,1525,1526,1527", cond=[[Tauren Shaman]]},
		{ids="3094,5926,5922,5930,5932,6002", cond=[[Tauren Druid]]},
	...
	["LEVELING\\Stonetalon Mountains (21-22)"] = {
		{ids="1058,6542,6461,1093,1094,6421,6562,1068"},
	},
	["LEVELING\\Temple of Ahn'Qiraj Chest Quest"] = {
		{ids="8562,8562", cond=[[Warrior]]},
		{ids="8627,8627", cond=[[Paladin]]},
	...
	["LEVELING\\Stranglethorn Vale (34-36)"] = {
		...
		{ids="338,341,338,341,338,341", cond=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341)))]]},
		{ids="338,340,338,340,338,340", cond=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340)))]]},
		{ids="1181,575,605,201,189,213,1182,568,570,581,596,569,582,192,188,196,1183,577,638"},
	},
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8810", cond=[[itemcount(21385) >= 1 or havequest(8810)]]},
		{ids="8804", cond=[[itemcount(21378) >= 1 or havequest(8804)]]},
		{ids="8829", cond=[[itemcount(21514) >= 1 or havequest(8829)]]},
		{ids="8807", cond=[[itemcount(21382) >= 1 or havequest(8807)]]},
		{ids="8809", cond=[[itemcount(21381) >= 1 or havequest(8809)]]},
		{ids="8808", cond=[[itemcount(21384) >= 1 or havequest(8808)]]},
		{ids="8806", cond=[[itemcount(21380) >= 1 or havequest(8806)]]},
		{ids="8805", cond=[[itemcount(21379) >= 1 or havequest(8805)]]},
		{ids="8787", cond=[[itemcount(21264) >= 1 or havequest(8787)]]},
		{ids="8786", cond=[[itemcount(21261) >= 1 or havequest(8786)]]},
		{ids="8785", cond=[[itemcount(21258) >= 1 or havequest(8785)]]},
		{ids="8731,8732"},
	},
	["LEVELING\\Hillsbrad Foothills (29-30)"] = {
		{ids="493,494", cond=[[not Rogue or Shaman]]},
		{ids="501,509,527,567,552,502,553,1361"},
	},
	["LEVELING\\Desolace (32-34)"] = {
		{ids="1146,1431,1432,2,247,5561,1365,1368,5386,1433,1434,1435,1366,1370,5763,5381,6143,6142,6161,5741,1480,1481,5501,1482,6027,1484,1373"},
	},
	["LEVELING\\Durotar (1-12) [Orc & Troll Starter]"] = {
		{ids="3086", cond=[[Troll Mage]]},
		{ids="3083", cond=[[Troll Rogue]]},
		{ids="6062,6083,6082,6081", cond=[[Hunter]]},
		{ids="792", cond=[[not Orc Warlock]]},
		{ids="3084", cond=[[Troll Shaman]]},
		{ids="1505,1498", cond=[[Warrior]]},
		{ids="1516,1517,1518,2983,1524,1525,1526,1527", cond=[[Shaman]]},
		{ids="3065", cond=[[Troll Warrior]]},
		{ids="3085,5652", cond=[[Troll Priest]]},
		{ids="3087", cond=[[Orc Hunter]]},
		{ids="1506,1501,1504", cond=[[Warlock]]},
		{ids="2383", cond=[[Orc Warrior]]},
		{ids="1485,3090,1499", cond=[[Orc Warlock]]},
	...
	["LEVELING\\Eastern Plaguelands (57-58)"] = {
		{ids="5542,5543,5544,6022,6042,5149,5152,5241,6021,5281,5211,6026,6164,5742,5781,5845,5846,5049,5050,7492,1004"},
	},
	["LEVELING\\Azshara (46-46)"] = {
		{ids="5535,5536,2995,3568,232,238,243"},
	},
	...
	["LEVELING\\Feralas (49-50)"] = {
		{ids="3124,3380,7734,3062,3063,4120,3125,3126,3127,2767,7003,7721,7725,7738,3129"},
	},
	["LEVELING\\Ruins of Ahn'Qiraj Ring Quest"] = {
		{ids="8556", cond=[[Warrior]]},
		{ids="8703", cond=[[Paladin]]},
	...
	["LEVELING\\The Hinterlands (46-48)"] = {
		{ids="77,7839,7844,7841,7828,7829,7830,485,2933,2742,81,2782,7842,2934,1444,8273"},
	},
	["LEVELING\\Silithus (58-59)"] = {
		{ids="1125,8280,8283,8277,8284,8318,8304,1126,8308,6844,9416,8281,8278,8282,8285,8306,8279,8287,8323,5181,4741,6845,1185"},
	},
	["LEVELING\\Arathi Highlands (30-31)"] = {
		{ids="1718,1719", cond=[[Warrior]]},
		{ids="1531", cond=[[Shaman]]},
		{ids="655,672,674,675"},
	},
	["LEVELING\\Feralas (45-46)"] = {
		{ids="2973,2975,2987,2862,2822,3121,2978,2863,2974,2980,2979,2902,2903,7730,7731,2976,2766,7732,3002,649,650,3504,3122,7541,3128,3123"},
	},
	["LEVELING\\Western Plaguelands (56-57)"] = {
		{ids="5094,4642,5901,5096,5503,5021,5023,5228,5229,5230,5231,5232,5058,5059,5060,5233,4984,5234,5235,4985,4987,5236"},
	},
	["LEVELING\\Signet Ring of the Bronze Dragonflight"] = {
		{ids="8753,8754,8755,8756", cond_if=[[completedq(8752) ]]},
		{ids="8758,8759,8760,8761", cond_if=[[completedq(8757) ]]},
	...
	["LEVELING\\The Barrens (12-15)"] = {
		{ids="6126,6127,6128,6129,6130", cond=[[Druid]]},
		{ids="6365,6384,6385,6386", cond=[[Orc or Troll]]},
	...
	["LEVELING\\Tirisfal Glades (1-12) [Undead Starter]"] = {
		...
		{ids="1818,1819,1820", cond=[[Scourge Warrior]]},
		{ids="5658", cond=[[Scourge Priest]]},
		{ids="1470,1478,1473,1471", cond=[[Scourge Warlock]]},
		{ids="3098", cond_if=[[Scourge Mage ]]},
		{ids="3097", cond_if=[[Scourge Priest ]]},
		{ids="3099", cond_if=[[Scourge Warlock ]]},
	...
	["LEVELING\\Dustwallow Marsh (38-39)"] = {
		{ids="1203", cond_if=[[(itemcount(3853) >= 1 or completedq(1203)) ]]},
		{ids="1205,1201,1322,1177,1270,1218,1206,1238,1202,1323,1239,1240"},
	},
	["LEVELING\\The Barrens (16-21)"] = {
		{ids="26,28,30,31", cond=[[Druid]]},
		{ids="5644", cond=[[Scourge Priest]]},
		{ids="1507,1508,1509,1510,1511,1515,1512,1513", cond=[[Warlock]]},
		{ids="5680", cond=[[Troll Priest]]},
		{ids="875,881,877,3281,853,878,900,901,902,858,863,6541,876,905,1483,3921,1069,880,852,3922,1060,868,3261,1489,882,1130,883,1131,1490,1195,742,822,907,913,5052"},
	},
	["LEVELING\\Silithus (60)"] = {
		{ids="8320,8361,8321"},
	},
	["LEVELING\\Arathi Highlands (40-40)"] = {
		{ids="663,662,664,665,666,668,669"},
	},
	["LEVELING\\Winterspring (59-60)"] = {
		{ids="8798", cond_if=[[skill('Engineering') >= 250 ]]},
		{ids="5087,4809,4721,4882,4810,4883"},
	},
	["LEVELING\\Western Plaguelands (58-58)"] = {
		{ids="5902,5098,5238,5051,6390,6004,6023,5153,5154,4971,4972,5210,838,964,8276,1123,1124"},
	},
	...
	["LEVELING\\Felwood (54-55)"] = {
		{ids="5155,5156,4102,4505,6162,4521,8461,8465"},
	},
	["LEVELING\\Azshara (54-54)"] = {
		{ids="3505,3601,3506,5534,3507"},
	},
	["LEVELING\\Tanaris (50-51)"] = {
		{ids="3362,4504,5863,379,2741,2605,82,3444,3161,1560,4324,2606,2641,10,654,351,864,110,113,32"},
	},
	["LEVELING\\Dustwallow Marsh (49-49)"] = {
		{ids="1172,626,1173"},
	},
	["LEVELING\\Swamp of Sorrows (49-49)"] = {
		{ids="2784,2621,625,2622,2623,1428,2801,580"},
	},
	["LEVELING\\Tanaris (44-45)"] = {
		{ids="2781,2875,1707,1690,992,1118,1188,1190,1194,8365,3520,8366,2873,2876,1691,2874"},
	},
	["LEVELING\\Badlands (40-42)"] = {
		{ids="705,703,1108,1137,710,713,714,715,711,1419,1420,2258,782,712,734,777,716,778"},
	},
	["LEVELING\\Stranglethorn Vale (39-39)"] = {
		...
		{ids="338,341", cond=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341)))]]},
		{ids="338,340", cond=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340)))]]},
		{ids="595,606,1116,572,629,1261,571,197,628,597,607,599,573,598"},
	},
	...
	["LEVELING\\Ashenvale (22-22)"] = {
		{ids="1528,1530,1535,1536,1534", cond=[[Shaman]]},
		{ids="6383,6442"},
	},
	["EVENTS\\Darkmoon Faire\\Mulgore\\Kerri Hicks Turn-Ins (Mulgore)"] = {
		{ids="7889,7890,7891,7892,7893,7939"},
	...
	["EVENTS\\Midsummer Fire Festival\\Midsummer Fire Festival Quests"] = {
		{ids="9332,9330,9331", cond=[[level >= 50]]},
		{ids="9339", cond=[[completedallq(9332,9330,9331)]]},
		{ids="9319", cond_if=[[level >= 50 ]]},
...
ZGV.Quest_Cache_Turnin_Horde = {
	...
	["LEVELING\\Dustwallow Marsh (43-44)"] = {
		{ids="1273,1169,1168,1170,1166,1171,1261,1276,1205"},
	},
	["LEVELING\\The Hinterlands (51-52)"] = {
		{ids="626,7843,7840,7815,7816,3563,3562,3564,2767,580"},
	},
	["LEVELING\\Stranglethorn Vale (42-43)"] = {
	...
	["LEVELING\\Felwood (55-56)"] = {
		{ids="4521,4102,5155,5156,8460,4505,6162,4506,5157,8462,5084"},
	},
	["LEVELING\\Temple of Ahn'Qiraj Legs Quest"] = {
		{ids="8560", cond=[[Warrior]]},
		{ids="8629", cond=[[Paladin]]},
	...
	["LEVELING\\Mulgore (1-12) [Tauren Starter]"] = {
		{ids="748,754,756,758,759,760,854", cond=[[Tauren]]},
		{ids="3092,6061,6087,6089", cond=[[Tauren Hunter]]},
		{ids="3093,1519,1520,1521,2984,1524,1525,1526,1527", cond=[[Tauren Shaman]]},
		{ids="3091,1505,1498", cond=[[Tauren Warrior]]},
		{ids="3094,5926,5922,5930,5932,6002", cond=[[Tauren Druid]]},
	...
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8786", cond_if=[[havequest(8786) ]]},
		{ids="8807", cond=[[havequest(8807)]]},
		{ids="8787", cond_if=[[havequest(8787) ]]},
		{ids="8806", cond_if=[[havequest(8806) ]]},
		{ids="8805", cond_if=[[havequest(8805) ]]},
		{ids="8829", cond=[[havequest(8829)]]},
		{ids="8804", cond=[[havequest(8804)]]},
		{ids="8809", cond=[[havequest(8809)]]},
		{ids="8808", cond=[[havequest(8808)]]},
		{ids="8810", cond=[[havequest(8810)]]},
		{ids="8785", cond=[[havequest(8785)]]},
		{ids="8507"},
	},
	["LEVELING\\Hillsbrad Foothills (29-30)"] = {
	...
	["LEVELING\\Durotar (1-12) [Orc & Troll Starter]"] = {
		...
		{ids="1506,1501,1504", cond=[[Warlock]]},
		{ids="2383", cond=[[Orc Warrior]]},
		{ids="3090,1485,1499", cond=[[Orc Warlock]]},
		{ids="3088", cond=[[Orc Rogue]]},
		{ids="3084", cond=[[Troll Shaman]]},
		{ids="3082", cond=[[Troll Hunter]]},
	...
	["LEVELING\\The Barrens (22-23)"] = {
		{ids="1534,220,63,100,96", cond=[[Shaman]]},
		{ids="1094,1069,843,893,884,885,879,822,906,868"},
	},
	["LEVELING\\Stonetalon Mountains (15-16)"] = {
		{ids="6548,6629,6523"},
	},
	...
	["LEVELING\\Silithus (58-59)"] = {
		{ids="1124,8276,1125,1126,8280,8277,8318,9416,8308,8281,8278,8284,8304,8285,8279,8323,8282,8287,8283,4642,5210,5181,6844,6845"},
	},
	["LEVELING\\Extra Zones\\Silverpine Forest"] = {
		{ids="6321,6323,6322,6324", cond=[[Scourge]]},
		{ids="445", cond_if=[[Scourge ]]},
	...
	["LEVELING\\Feralas (45-46)"] = {
		{ids="2862,2987,2973,2975,2978,2863,2902,2903,2974,2766,2822,7730,7731,2980,2979,7732,649,2976,3121,1262,3002,3122,3128"},
	},
	["LEVELING\\Western Plaguelands (56-57)"] = {
	...
	["LEVELING\\The Barrens (12-15)"] = {
		{ids="6126,6127,6128,6129,6130", cond=[[Druid]]},
		{ids="809,6365,6384,6385,6386", cond=[[Orc or Troll]]},
		{ids="840,842,844,871,845,1492,819,887,895,890,892,5041,872,855,850"},
	},
	["LEVELING\\Tirisfal Glades (1-12) [Undead Starter]"] = {
		{ids="3099,1470,1478,1473,1471", cond=[[Scourge Warlock]]},
		{ids="3096", cond=[[Scourge Rogue]]},
		{ids="3097,5658", cond=[[Scourge Priest]]},
		{ids="3095,1818,1819,1820", cond=[[Scourge Warrior]]},
		{ids="3098", cond=[[Scourge Mage]]},
	...
	["LEVELING\\Dustwallow Marsh (38-39)"] = {
		{ids="1203", cond=[[havequest(1203) or completedq(1203)]]},
	...
	["LEVELING\\Badlands (40-42)"] = {
		{ids="705,1106,1108,713,714,715,710,711,2258,782,1419,712,734,716,777,778,703"},
	},
	["LEVELING\\Stranglethorn Vale (39-39)"] = {
		{ids="342", cond=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342)))]]},
		{ids="339", cond=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339)))]]},
	...
	["LEVELING\\Ashenvale (22-22)"] = {
		{ids="1528,1530,1535,1536", cond=[[Shaman]]},
