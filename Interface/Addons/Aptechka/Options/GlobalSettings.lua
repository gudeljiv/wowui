			...
			switches = {
				...
				args = {
					RMBClickthrough = {
						...
						get = function(info)
							return Aptechka.db.global.RMBClickthrough
						end,
						set = function(info, v)
					...
					sortUnitsByRole = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.sortUnitsByRole
						end,
						set = function(info, v)
					...
					mouseoverStatus = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.enableMouseoverStatus
						end,
						set = function(info, v)
					...
					thickBorder = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.borderWidth == 2
						end,
						set = function(info, v)
					...
					disableBlizzardParty = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.disableBlizzardParty
						end,
						set = function(info, v)
					...
					hideBlizzardRaid = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.hideBlizzardRaid
						end,
						set = function(info, v)
					...
					supportNickTag = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.enableNickTag
						end,
						set = function(info, v)
					...
					disableTooltip = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.disableTooltip
						end,
						set = function(info, v)
					...
					showAFK = {
						...
						type = "toggle",
						get = function(info)
							return Aptechka.db.global.showAFK
						end,
						set = function(info, v)
					...
					useDebuffOrdering = {
						...
						order = 11.2,
						get = function(info)
							return Aptechka.db.global.useDebuffOrdering
						end,
						set = function(info, v)
					...
					forceShamanColor = {
						...
						get = function(info)
							return Aptechka.db.global.forceShamanColor
						end,
						set = function(info, v)
					...
					useCLH = {
						...
						order = 18,
						get = function(info)
							return Aptechka.db.global.useCombatLogHealthUpdates
						end,
						set = function(info, v)
