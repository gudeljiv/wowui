...
config.layouts = {
	-- works ONLY with group anchors disabled.
...
config.AwayStatus = {
	name = "AFK",
	assignto = {"text2", "text3"},
	color = {.15, .15, .15},
	textcolor = {1, 0.8, 0},
	text = "AFK",
	priority = 60
}
config.IncomingHealStatus = {
	name = "IncomingHeal",
	assignto = "healthtext",
	inchealtext = true,
	color = {0, 1, 0},
...
config.HealthDeficitStatus = {
	name = "HPD",
	assignto = "healthtext",
	healthtext = true,
	color = {54 / 255, 201 / 255, 99 / 256},
	priority = 10
}
...
config.MindControlStatus = {
	name = "MIND_CONTROL",
	assignto = {"border", "mindcontrol", "innerglow", "unhealable"},
	color = {0.5, 0, 1},
	priority = 52
}
