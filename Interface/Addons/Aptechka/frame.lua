...
local SetJob_HealthBar = function(self, job, state)
	...
	if job.name == "HealthBar" then
		...
		if not c1 then
			return
		end -- At some point during initialization health updates before colors are determined
		if isGradient then
...
local StatusBarOnUpdate = function(self, time)
	...
	if self.OnUpdateCounter < 0.05 then
		return
	end
...
local function SetJob_DebuffIcon(self, debuffType, expirationTime, duration, icon, count, isBossAura, spellID)
	...
	if count then
		self.stacktext:SetText(count > 1 and count)
	end
...
local CreateTextTimer = function(parent, point, frame, to, x, y, hjustify, fontsize, font, flags)
	...
	text3:SetPoint(point, frame, to, x, y)
	--"TOPLEFT",self,"TOPLEFT",-2,0)
...
local border_backdrop = {
	edgeFile = "Interface\\Addons\\Aptechka\\border",
	tileEdge = true,
	edgeSize = 14,
...
local optional_widgets = {
	raidbuff = function(self)
		return CreateIndicator(self, 5, 5, "TOPLEFT", self, "TOPLEFT", 0, 0)
	end,
	totemCluster1 = function(self)
		return CreateIndicator(self, 5, 5, "TOPLEFT", self, "TOPLEFT", 7, 0)
	end,
	totemCluster2 = function(self)
		return CreateIndicator(self, 5, 5, "TOPLEFT", self, "TOPLEFT", 14, 0)
	end,
	totemCluster3 = function(self)
		return CreateIndicator(self, 5, 5, "TOPLEFT", self, "TOPLEFT", 21, 0)
	end,
	--top
	spell1 = function(self)
		return CreateIndicator(self, 9, 9, "BOTTOMRIGHT", self, "BOTTOMRIGHT", 0, 0)
	end,
	--bottomright
	spell2 = function(self)
		return CreateIndicator(self, 9, 9, "TOP", self, "TOP", 0, 0)
	end,
	--topright
	spell3 = function(self)
		return CreateIndicator(self, 9, 9, "TOPRIGHT", self, "TOPRIGHT", 0, 0)
	end,
	--bottom
	spell4 = function(self)
		return CreateIndicator(self, 7, 7, "BOTTOM", self, "BOTTOM", 0, 0)
	end,
	--left
	spell5 = function(self)
		return CreateIndicator(self, 7, 7, "LEFT", self, "LEFT", 0, 0)
	end,
	-- shieldicon = function(self) return CreateShieldIcon(self,15,15,1,"CENTER",self,"TOPLEFT",14,0) end,
	shieldicon = function(self)
		return CreateProgressIcon(self, 15, 15, 1, "TOPRIGHT", self, "TOPRIGHT", 2, -12)
	end,
	bar1 = function(self)
		return CreateStatusBar(self, 21, 6, "BOTTOMRIGHT", self, "BOTTOMRIGHT", 0, 0)
	end,
	bar2 = function(self)
		if self.bar1 then
	...
	bar4 = function(self)
		return CreateStatusBar(self, 21, 5, "TOPRIGHT", self, "TOPRIGHT", 0, 2)
	end,
	bar3a = function(self)
		if self.bar3 then
	...
	vbar1 = function(self)
		return CreateStatusBar(self, 4, 20, "TOPRIGHT", self, "TOPRIGHT", -9, 2, nil, true)
	end,
	smist = function(self)
		return CreateIndicator(self, 7, 7, "TOPRIGHT", self.vbar1, "TOPLEFT", -1, 0)
	end
}
...
AptechkaDefaultConfig.GridSkin = function(self)
	...
	centericon:SetWidth(20)
	centericon:SetHeight(20)
	...
	roleicon:SetWidth(13)
	roleicon:SetHeight(13)
	...
	local text3 = CreateTextTimer(self, "TOPLEFT", self, "TOPLEFT", 2, 0, "LEFT", fontsize - 3, font)
	--,"OUTLINE")
