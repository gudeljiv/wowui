...
ex.options = {
	...
	{
		var = "combineAdditiveStats",
		default = true,
		label = "Combine Additive Stats",
		tip = "This option will combine certain stats which stacks with others.\n- Spell Power to specific schools\n- Intellect to Spell Power\n- AP to Ranged AP"
	},
...
SlashCmdList[modName] = function(cmd)
	HandleSlashCommand(cmd, ex.slashCommands)
end
