...
cmtk.text:SetFont(xVermin.config.font.arial, 10, "NONE")
...
cmxg.text:SetFont(xVermin.config.font.arial, 10, "NONE")
...
cpxf.text:SetFont(xVermin.config.font.arial, 8, "NONE")
