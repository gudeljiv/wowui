...
local function FixBindings()
	...
	if xVermin.Class == ("HUNTER" or "WARLOCK") then
		...
		SetBinding("ALT-8", "BONUSACTIONBUTTON8", 1)
		SetBinding("ALT-9", "BONUSACTIONBUTTON9", 1)
		SetBinding("ALT-0", "BONUSACTIONBUTTON10", 1)
	else
	...
	SetBinding("K", "MULTIACTIONBAR4BUTTON12", 1)
