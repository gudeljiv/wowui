local function FixBindings()
	...
	SetBinding("SHIFT-I", "EXAMINER_MOUSEOVER", 1)
	...
	SetBinding("CTRL-T", "INTERACTTARGET", 1)
	SetBinding("CTRL-A", "ATTACKTARGET", 1)
	SetBinding("CTRL-I", "TOGGLELFGPARENT", 1)
	SetBinding("Y", "NONE", 1)
	SetBinding("J", "NONE", 1)
	SetBinding("ALT-P", "TOGGLEPERFORMANCEDISPLAY", 1)
