...
addon_data.player = {} --[[===================================== SETTINGS RELATED =====================================]] --[[============================================================================================]]
--
--
--
...
--[[============================================================================================]] addon_data.player.OnUpdate = function(
	elapsed)
...
addon_data.player.UpdateVisualsOnSettingsChange = function()
	...
	if settings.enabled then
		...
		frame.main_left_text:SetTextColor(
			settings.main_text_r,
			settings.main_text_g,
			settings.main_text_b,
			settings.main_text_a
		)
		frame.main_right_text:SetPoint("TOPRIGHT", -5, -(settings.height / 2) + 5)
		frame.main_right_text:SetTextColor(
			settings.main_text_r,
			settings.main_text_g,
			settings.main_text_b,
			settings.main_text_a
...
--[[============================================================================================]] addon_data.player.UpdateConfigPanelValues = function()
	...
	panel.main_color_picker.foreground:SetColorTexture(settings.main_r, settings.main_g, settings.main_b, settings.main_a)
	...
	panel.off_color_picker.foreground:SetColorTexture(settings.off_r, settings.off_g, settings.off_b, settings.off_a)
...
addon_data.player.MainColorPickerOnClick = function()
	...
	local function MainOnActionFunc(restore)
		...
		addon_data.player.frame.main_bar:SetVertexColor(settings.main_r, settings.main_g, settings.main_b, settings.main_a)
...
addon_data.player.OffColorPickerOnClick = function()
	...
	local function OffOnActionFunc(restore)
		...
		addon_data.player.frame.off_bar:SetVertexColor(settings.off_r, settings.off_g, settings.off_b, settings.off_a)
...
addon_data.player.CreateConfigPanel = function(parent_panel)
	...
	-- Enabled Checkbox
	panel.enabled_checkbox =
		addon_data.config.CheckBoxFactory(
	...
	panel.show_right_text_checkbox =
		addon_data.config.CheckBoxFactory(
	...
	-- Width EditBox
	panel.width_editbox =
		addon_data.config.EditBoxFactory(
		"PlayerWidthEditBox",
		panel,
		"Bar Width",
		75,
	...
	panel.main_color_picker =
		addon_data.config.color_picker_factory(
	...
	panel.in_combat_alpha_slider =
		addon_data.config.SliderFactory(
