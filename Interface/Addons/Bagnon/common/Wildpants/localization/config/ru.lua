...
-- general
L.GeneralOptionsDesc = 'Общие функции, которые могут быть переключены в зависимости от ваших предпочтений.'
...
L.FrameOptionsDesc = 'Параметры конфигурации для конкретного окна %s.'
L.Frame = 'Окно'
...
L.DisplayOptionsDesc = 'Эти параметры позволяют настроить ваш инвентарь. Автоматически открывается или закрывается из-за игровых событий.'
...
-- colors
L.ColorOptions = 'Настройка окраски'
L.ColorOptionsDesc = 'Эти параметры позволяют изменять рамки ячеек предметов в %s для удобной идентификации.'
