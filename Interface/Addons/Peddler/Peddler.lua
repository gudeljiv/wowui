...
local function handleItemClick(self, button)
	...
	local modifierDown =
		(ModifierKey == "CTRL" and ctrlKeyDown or
		(ModifierKey == "SHIFT" and shiftKeyDown or
			(ModifierKey == "ALT" and altKeyDown or
				(ModifierKey == "CTRL-SHIFT" and ctrlKeyDown and shiftKeyDown or (ModifierKey == "CTRL-ALT" and ctrlKeyDown and altKeyDown or (ModifierKey == "ALT-SHIFT" and altKeyDown and shiftKeyDown))))))
