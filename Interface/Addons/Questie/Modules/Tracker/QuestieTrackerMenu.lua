...
function QuestieTracker.menu:GetMenuForQuest(quest)
	...
	for _, objective in pairs(quest.Objectives) do
		...
		if Questie.db.char.TrackerFocus and type(Questie.db.char.TrackerFocus) == "string" and Questie.db.char.TrackerFocus == tostring(quest.Id) .. " " .. tostring(objective.Index) then
			tinsert(
				objectiveMenu,
				{text = QuestieLocale:GetUIString("TRACKER_UNFOCUS"), func = function()
			...
			tinsert(
				objectiveMenu,
				{text = QuestieLocale:GetUIString("TRACKER_FOCUS_OBJECTIVE"), func = function()
						LQuestie_CloseDropDownMenus()
		...
		tinsert(
			objectiveMenu,
			{
				text = QuestieLocale:GetUIString("TRACKER_SET_TOMTOM"),
				func = function()
					LQuestie_CloseDropDownMenus()
		...
		if objective.HideIcons then
			tinsert(
				objectiveMenu,
				{
					text = QuestieLocale:GetUIString("TRACKER_SHOW_ICONS"),
					func = function()
						LQuestie_CloseDropDownMenus()
			...
			tinsert(
				objectiveMenu,
				{
					text = QuestieLocale:GetUIString("TRACKER_HIDE_ICONS"),
					func = function()
						LQuestie_CloseDropDownMenus()
		...
		tinsert(
			objectiveMenu,
			{
				text = QuestieLocale:GetUIString("TRACKER_SHOW_ON_MAP"),
				func = function()
					LQuestie_CloseDropDownMenus()
					local needHiddenUpdate
					if (Questie.db.char.TrackerFocus and type(Questie.db.char.TrackerFocus) == "string" and Questie.db.char.TrackerFocus ~= tostring(quest.Id) .. " " .. tostring(objective.Index)) or (Questie.db.char.TrackerFocus and type(Questie.db.char.TrackerFocus) == "number" and Questie.db.char.TrackerFocus ~= quest.Id) then
						QuestieTracker:UnFocus()
		...
		for _, Objective in pairs(quest.SpecialObjectives) do
			...
			if Questie.db.char.TrackerFocus and type(Questie.db.char.TrackerFocus) == "string" and Questie.db.char.TrackerFocus == tostring(quest.Id) .. " " .. tostring(Objective.Index) then
				...
				tinsert(
					...
					{text = QuestieLocale:GetUIString("TRACKER_FOCUS_OBJECTIVE"), func = function()
							LQuestie_CloseDropDownMenus()
							QuestieTracker:FocusObjective(quest, Objective, true)
							QuestieQuest:UpdateHiddenNotes()
						end}
				)
			end
	...
	tinsert(
		menu,
		{
			text = QuestieLocale:GetUIString("TRACKER_SHOW_QUESTLOG"),
			func = function()
				LQuestie_CloseDropDownMenus()
	...
	tinsert(
		menu,
		{
			text = QuestieLocale:GetUIString("TRACKER_UNTRACK"),
			func = function()
				LQuestie_CloseDropDownMenus()
	...
	if Questie.db.char.TrackerFocus and type(Questie.db.char.TrackerFocus) == "number" and Questie.db.char.TrackerFocus == quest.Id then
		...
		tinsert(
			menu,
			{text = QuestieLocale:GetUIString("TRACKER_FOCUS_QUEST"), func = function()
					LQuestie_CloseDropDownMenus()
	...
	if Questie.db.global.trackerLocked then
		tinsert(
			menu,
			{text = QuestieLocale:GetUIString("TRACKER_UNLOCK"), func = function()
					LQuestie_CloseDropDownMenus()
		...
		tinsert(
			menu,
			{text = QuestieLocale:GetUIString("TRACKER_LOCK"), func = function()
					LQuestie_CloseDropDownMenus()
	...
	tinsert(
		menu,
		{text = QuestieLocale:GetUIString("TRACKER_CANCEL"), func = function()
			end}
	)
