...
function EavesDrop:SetupHistory()
  ...
  for i=1, arrDisplaySize do
    ...
    arrHistoryFrames[i].texture = _G[string_format("EavesDropHistoryEvent%d_Texture", i)]
    arrHistoryFrames[i].skill = _G[string_format("EavesDropHistoryEvent%d_Skill", i)]
