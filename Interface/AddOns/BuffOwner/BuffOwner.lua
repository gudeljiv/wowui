...
local function ProcessAura(tooltip,func,...)
	...
	if ok and caster then
		local pet=caster; caster=(UnitIsUnit(caster,"pet") and "player" or caster:gsub("[pP][eE][tT]",""));
...
hooksecurefunc(GTT_Meta,"SetUnitAura",function(self,...) return ProcessAura(self,UnitAura,...); end);
hooksecurefunc(GTT_Meta,"SetUnitBuff",function(self,...) return ProcessAura(self,UnitBuff,...); end);
hooksecurefunc(GTT_Meta,"SetUnitDebuff",function(self,...) return ProcessAura(self,UnitDebuff,...); end);
