...
do  -- timer bar
	...
	-----------------------------
		...
		sb:Hide()
		sb:SetPoint(InFlight.defaults.profile.p, InFlight.defaults.profile.parent, InFlight.defaults.profile.rp, InFlight.defaults.profile.x, InFlight.defaults.profile.y)
		sb:SetMovable(true)
		sb:EnableMouse(true)
